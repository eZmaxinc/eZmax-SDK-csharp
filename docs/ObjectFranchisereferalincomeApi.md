...
#### Using the FranchisereferalincomeCreateObjectV1WithHttpInfo variant
...
{
    // Create a new Franchisereferalincome
    ApiResponse<FranchisereferalincomeCreateObjectV1Response> response = apiInstance.FranchisereferalincomeCreateObjectV1WithHttpInfo(franchisereferalincomeCreateObjectV1Request);
...
{
    Debug.Print("Exception when calling ObjectFranchisereferalincomeApi.FranchisereferalincomeCreateObjectV1WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
