...
namespace Example
{
    public class ModuleGetAutocompleteV2Example
    {
        public static void Main()
        {
            ...
            var apiInstance = new ObjectModuleApi(config);
            var sSelector = "Forms";  // string | The type of Modules to return
            ...
            {
                Debug.Print("Exception when calling ObjectModuleApi.ModuleGetAutocompleteV2: " + e.Message);
...
#### Using the ModuleGetAutocompleteV2WithHttpInfo variant
...
{
    // Retrieve Modules and IDs
    ApiResponse<ModuleGetAutocompleteV2Response> response = apiInstance.ModuleGetAutocompleteV2WithHttpInfo(sSelector, eFilterActive, sQuery, acceptLanguage);
...
{
    Debug.Print("Exception when calling ObjectModuleApi.ModuleGetAutocompleteV2WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
