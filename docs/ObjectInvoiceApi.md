...
> System.IO.Stream InvoiceBatchDownloadV1 (int pkiInvoiceID, InvoiceBatchDownloadV1Request invoiceBatchDownloadV1Request)
...
namespace Example
{
    public class InvoiceBatchDownloadV1Example
    {
        public static void Main()
        {
            ...
            var invoiceBatchDownloadV1Request = new InvoiceBatchDownloadV1Request(); // InvoiceBatchDownloadV1Request | 

            try
            {
                // Download multiples attachments from an Invoice
                System.IO.Stream result = apiInstance.InvoiceBatchDownloadV1(pkiInvoiceID, invoiceBatchDownloadV1Request);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling ObjectInvoiceApi.InvoiceBatchDownloadV1: " + e.Message);
...
#### Using the InvoiceBatchDownloadV1WithHttpInfo variant
...
{
    // Download multiples attachments from an Invoice
    ApiResponse<System.IO.Stream> response = apiInstance.InvoiceBatchDownloadV1WithHttpInfo(pkiInvoiceID, invoiceBatchDownloadV1Request);
...
{
    Debug.Print("Exception when calling ObjectInvoiceApi.InvoiceBatchDownloadV1WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="invoicegetlistv1"></a>
# **InvoiceGetListV1**
> InvoiceGetListV1Response InvoiceGetListV1 (string? eOrderBy = null, int? iRowMax = null, int? iRowOffset = null, HeaderAcceptLanguage? acceptLanguage = null, string? sFilter = null)
...
namespace Example
{
    public class InvoiceGetListV1Example
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            var apiInstance = new ObjectInvoiceApi(config);
            var eOrderBy = "pkiInvoiceID_ASC";  // string? | Specify how you want the results to be sorted (optional) 
            ...
            {
                // Retrieve Invoice list
                InvoiceGetListV1Response result = apiInstance.InvoiceGetListV1(eOrderBy, iRowMax, iRowOffset, acceptLanguage, sFilter);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling ObjectInvoiceApi.InvoiceGetListV1: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the InvoiceGetListV1WithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieve Invoice list
    ApiResponse<InvoiceGetListV1Response> response = apiInstance.InvoiceGetListV1WithHttpInfo(eOrderBy, iRowMax, iRowOffset, acceptLanguage, sFilter);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling ObjectInvoiceApi.InvoiceGetListV1WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class InvoiceImportIntoEDMV1Example
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            var apiInstance = new ObjectInvoiceApi(config);
            var pkiInvoiceID = 56;  // int | 
            var invoiceImportIntoEDMV1Request = new InvoiceImportIntoEDMV1Request(); // InvoiceImportIntoEDMV1Request | 
            ...
            {
                Debug.Print("Exception when calling ObjectInvoiceApi.InvoiceImportIntoEDMV1: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the InvoiceImportIntoEDMV1WithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Import attachments into the Invoice
    ApiResponse<InvoiceImportIntoEDMV1Response> response = apiInstance.InvoiceImportIntoEDMV1WithHttpInfo(pkiInvoiceID, invoiceImportIntoEDMV1Request);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling ObjectInvoiceApi.InvoiceImportIntoEDMV1WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
