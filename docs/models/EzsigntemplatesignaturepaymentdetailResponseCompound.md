# eZmaxApi.Model.EzsigntemplatesignaturepaymentdetailResponseCompound
...
------------ | ------------- | ------------- | -------------
**PkiEzsigntemplatesignaturepaymentdetailID** | **int** | The unique ID of the Ezsignsignaturepaymentdetail | 
