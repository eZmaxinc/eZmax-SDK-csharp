# eZmaxApi.Model.EzsigndocumentResponseCompoundV3
...
**IEzsigndocumentSteptotal** | **int** | The total number of steps | 
**IEzsigndocumentStepcurrent** | **int** | The current step | 
**AObjEzsignfoldersignerassociationstatus** | [**List&lt;CustomEzsignfoldersignerassociationstatusResponseV3&gt;**](CustomEzsignfoldersignerassociationstatusResponseV3.md) |  | 
