...
> CommunicationGetListV1Response CommunicationGetListV1 (string eOrderBy = null, int? iRowMax = null, int? iRowOffset = null, HeaderAcceptLanguage? acceptLanguage = null, string sFilter = null)
...
namespace Example
{
    public class CommunicationGetListV1Example
    {
        public static void Main()
        {
            ...
            var eOrderBy = "pkiCommunicationID_ASC";  // string | Specify how you want the results to be sorted (optional) 
            ...
            {
                Debug.Print("Exception when calling ObjectCommunicationApi.CommunicationGetListV1: " + e.Message );
