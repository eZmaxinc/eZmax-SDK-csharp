...
namespace Example
{
    public class InfrastructureregionGetAutocompleteV2Example
    {
        public static void Main()
        {
            ...
            var apiInstance = new ObjectInfrastructureregionApi(config);
            var sSelector = "AWS";  // string | The type of Infrastructureregions  to return
            ...
            {
                Debug.Print("Exception when calling ObjectInfrastructureregionApi.InfrastructureregionGetAutocompleteV2: " + e.Message);
...
#### Using the InfrastructureregionGetAutocompleteV2WithHttpInfo variant
...
{
    // Retrieve Infrastructureregions and IDs
    ApiResponse<InfrastructureregionGetAutocompleteV2Response> response = apiInstance.InfrastructureregionGetAutocompleteV2WithHttpInfo(sSelector, eFilterActive, sQuery, acceptLanguage);
...
{
    Debug.Print("Exception when calling ObjectInfrastructureregionApi.InfrastructureregionGetAutocompleteV2WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
