...
namespace Example
{
    public class PaymenttermCreateObjectV1Example
    {
        public static void Main()
        {
            ...
            var apiInstance = new ObjectPaymenttermApi(Configuration.Default);
...
> PaymenttermDeleteObjectV1Response PaymenttermDeleteObjectV1 (int pkiPaymenttermID)
...
namespace Example
{
    public class PaymenttermDeleteObjectV1Example
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://prod.api.appcluster01.ca-central-1.ezmax.com/rest";
            ...
            {
                Debug.Print("Exception when calling ObjectPaymenttermApi.PaymenttermDeleteObjectV1: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
