...
> CommonGetAutocompleteV1Response SecretquestionGetAutocompleteV1 (string sSelector, string eFilterActive = null, string sQuery = null, HeaderAcceptLanguage? acceptLanguage = null)
...
namespace Example
{
    public class SecretquestionGetAutocompleteV1Example
    {
        public static void Main()
        {
            ...
            {
                // Retrieve Secretquestions and IDs
                CommonGetAutocompleteV1Response result = apiInstance.SecretquestionGetAutocompleteV1(sSelector, eFilterActive, sQuery, acceptLanguage);
...
namespace Example
{
    public class SecretquestionGetAutocompleteV2Example
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://prod.api.appcluster01.ca-central-1.ezmax.com/rest";
            ...
            {
                Debug.Print("Exception when calling ObjectSecretquestionApi.SecretquestionGetAutocompleteV2: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
