...
namespace Example
{
    public class PaymentmethodGetAutocompleteV2Example
    {
        public static void Main()
        {
            ...
            var apiInstance = new ObjectPaymentmethodApi(config);
            var sSelector = "All";  // string | The type of Paymentmethods to return
            ...
            {
                Debug.Print("Exception when calling ObjectPaymentmethodApi.PaymentmethodGetAutocompleteV2: " + e.Message);
...
#### Using the PaymentmethodGetAutocompleteV2WithHttpInfo variant
...
{
    // Retrieve Paymentmethods and IDs
    ApiResponse<PaymentmethodGetAutocompleteV2Response> response = apiInstance.PaymentmethodGetAutocompleteV2WithHttpInfo(sSelector, eFilterActive, sQuery, acceptLanguage);
...
{
    Debug.Print("Exception when calling ObjectPaymentmethodApi.PaymentmethodGetAutocompleteV2WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
