...
namespace Example
{
    public class GlaccountGetAutocompleteV2Example
    {
        public static void Main()
        {
            ...
            var apiInstance = new ObjectGlaccountApi(config);
            var sSelector = "All";  // string | The type of Glaccounts to return
            ...
            {
                Debug.Print("Exception when calling ObjectGlaccountApi.GlaccountGetAutocompleteV2: " + e.Message);
...
#### Using the GlaccountGetAutocompleteV2WithHttpInfo variant
...
{
    // Retrieve Glaccounts and IDs
    ApiResponse<GlaccountGetAutocompleteV2Response> response = apiInstance.GlaccountGetAutocompleteV2WithHttpInfo(sSelector, eFilterActive, sQuery, acceptLanguage);
...
{
    Debug.Print("Exception when calling ObjectGlaccountApi.GlaccountGetAutocompleteV2WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
