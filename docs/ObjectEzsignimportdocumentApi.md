...
namespace Example
{
    public class EzsignimportdocumentDownloadV1Example
    {
        public static void Main()
        {
            ...
            var apiInstance = new ObjectEzsignimportdocumentApi(config);
            var pkiEzsignimportdocumentID = 56;  // int | 
            ...
            {
                Debug.Print("Exception when calling ObjectEzsignimportdocumentApi.EzsignimportdocumentDownloadV1: " + e.Message);
...
#### Using the EzsignimportdocumentDownloadV1WithHttpInfo variant
...
{
    // Retrieve the content
    ApiResponse<EzsignimportdocumentDownloadV1Response> response = apiInstance.EzsignimportdocumentDownloadV1WithHttpInfo(pkiEzsignimportdocumentID);
...
{
    Debug.Print("Exception when calling ObjectEzsignimportdocumentApi.EzsignimportdocumentDownloadV1WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
