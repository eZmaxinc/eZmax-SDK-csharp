...
> CommonGetAutocompleteV1Response UsergroupGetAutocompleteV1 (string sSelector, string eFilterActive = null, string sQuery = null, HeaderAcceptLanguage? acceptLanguage = null)
...
namespace Example
{
    public class UsergroupGetAutocompleteV1Example
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ObjectUsergroupApi.UsergroupGetAutocompleteV1: " + e.Message );
