# eZmaxinc/eZmax-SDK-csharp.Api.EzsignfolderApi
...
namespace Example
{
    public class EzsignfolderCreateObjectV1Example
    {
        public static void Main()
        {
            ...
            var apiInstance = new EzsignfolderApi(Configuration.Default);
            ...
            {
                Debug.Print("Exception when calling EzsignfolderApi.EzsignfolderCreateObjectV1: " + e.Message );
...
namespace Example
{
    public class EzsignfolderDeleteObjectV1Example
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling EzsignfolderApi.EzsignfolderDeleteObjectV1: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class EzsignfolderEditObjectV1Example
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling EzsignfolderApi.EzsignfolderEditObjectV1: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class EzsignfolderGetObjectGetChildrenV1Example
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling EzsignfolderApi.EzsignfolderGetObjectGetChildrenV1: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class EzsignfolderGetObjectV1Example
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling EzsignfolderApi.EzsignfolderGetObjectV1: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class EzsignfolderSendV1Example
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling EzsignfolderApi.EzsignfolderSendV1: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
