...
namespace Example
{
    public class CurrencyGetAutocompleteV2Example
    {
        public static void Main()
        {
            ...
            var apiInstance = new ObjectCurrencyApi(config);
            var sSelector = "All";  // string | The type of Currencies to return
            ...
            {
                Debug.Print("Exception when calling ObjectCurrencyApi.CurrencyGetAutocompleteV2: " + e.Message);
...
#### Using the CurrencyGetAutocompleteV2WithHttpInfo variant
...
{
    // Retrieve Currencies and IDs
    ApiResponse<CurrencyGetAutocompleteV2Response> response = apiInstance.CurrencyGetAutocompleteV2WithHttpInfo(sSelector, eFilterActive, sQuery, acceptLanguage);
...
{
    Debug.Print("Exception when calling ObjectCurrencyApi.CurrencyGetAutocompleteV2WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
