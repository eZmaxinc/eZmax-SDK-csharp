...
# eZmaxApi.Model.EzsigntemplateformfieldResponse
...
**SEzsigntemplateformfieldValue** | **string** | The value for the Ezsigntemplateformfield  This can only be set if eEzsigntemplateformfieldgroupType is Checkbox or Radio | 
