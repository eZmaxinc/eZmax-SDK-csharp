...
namespace Example
{
    public class SystemconfigurationtypeGetAutocompleteV2Example
    {
        public static void Main()
        {
            ...
            var apiInstance = new ObjectSystemconfigurationtypeApi(config);
            var sSelector = "All";  // string | The type of Systemconfigurationtype to return
            ...
            {
                Debug.Print("Exception when calling ObjectSystemconfigurationtypeApi.SystemconfigurationtypeGetAutocompleteV2: " + e.Message);
...
#### Using the SystemconfigurationtypeGetAutocompleteV2WithHttpInfo variant
...
{
    // Retrieve Systemconfigurationtype and IDs
    ApiResponse<SystemconfigurationtypeGetAutocompleteV2Response> response = apiInstance.SystemconfigurationtypeGetAutocompleteV2WithHttpInfo(sSelector, eFilterActive, sQuery, acceptLanguage);
...
{
    Debug.Print("Exception when calling ObjectSystemconfigurationtypeApi.SystemconfigurationtypeGetAutocompleteV2WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
