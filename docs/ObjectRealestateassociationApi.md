...
namespace Example
{
    public class RealestateassociationGetAutocompleteV2Example
    {
        public static void Main()
        {
            ...
            var apiInstance = new ObjectRealestateassociationApi(config);
            var sSelector = "All";  // string | The type of Realestateassociations to return
            ...
            {
                Debug.Print("Exception when calling ObjectRealestateassociationApi.RealestateassociationGetAutocompleteV2: " + e.Message);
...
#### Using the RealestateassociationGetAutocompleteV2WithHttpInfo variant
...
{
    // Retrieve Realestateassociations and IDs
    ApiResponse<RealestateassociationGetAutocompleteV2Response> response = apiInstance.RealestateassociationGetAutocompleteV2WithHttpInfo(sSelector, eFilterActive, sQuery, acceptLanguage);
...
{
    Debug.Print("Exception when calling ObjectRealestateassociationApi.RealestateassociationGetAutocompleteV2WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
