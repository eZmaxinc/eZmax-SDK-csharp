...
> System.IO.Stream CustomerBatchDownloadV1 (int pkiCustomerID, CustomerBatchDownloadV1Request customerBatchDownloadV1Request)
...
namespace Example
{
    public class CustomerBatchDownloadV1Example
    {
        public static void Main()
        {
            ...
            var customerBatchDownloadV1Request = new CustomerBatchDownloadV1Request(); // CustomerBatchDownloadV1Request | 

            try
            {
                // Download multiples attachments from a Customer
                System.IO.Stream result = apiInstance.CustomerBatchDownloadV1(pkiCustomerID, customerBatchDownloadV1Request);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling ObjectCustomerApi.CustomerBatchDownloadV1: " + e.Message);
...
#### Using the CustomerBatchDownloadV1WithHttpInfo variant
...
{
    // Download multiples attachments from a Customer
    ApiResponse<System.IO.Stream> response = apiInstance.CustomerBatchDownloadV1WithHttpInfo(pkiCustomerID, customerBatchDownloadV1Request);
...
{
    Debug.Print("Exception when calling ObjectCustomerApi.CustomerBatchDownloadV1WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
> CustomerGetAttachmentsV1Response CustomerGetAttachmentsV1 (int pkiCustomerID)
...
namespace Example
{
    public class CustomerGetAttachmentsV1Example
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling ObjectCustomerApi.CustomerGetAttachmentsV1: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CustomerGetAttachmentsV1WithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieve Customer's attachments
    ApiResponse<CustomerGetAttachmentsV1Response> response = apiInstance.CustomerGetAttachmentsV1WithHttpInfo(pkiCustomerID);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling ObjectCustomerApi.CustomerGetAttachmentsV1WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
