...
#### Using the PeriodGetAutocompleteV2WithHttpInfo variant
...
{
    // Retrieve Periods and IDs
    ApiResponse<PeriodGetAutocompleteV2Response> response = apiInstance.PeriodGetAutocompleteV2WithHttpInfo(sSelector, eFilterActive, sQuery, acceptLanguage);
...
{
    Debug.Print("Exception when calling ObjectPeriodApi.PeriodGetAutocompleteV2WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
