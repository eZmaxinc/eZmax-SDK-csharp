...
namespace Example
{
    public class EzsignbulksendtransmissionGetBatchFileV1Example
    {
        public static void Main()
        {
            ...
            {
                // Retrieve file to download documents in batch
                System.IO.Stream result = apiInstance.EzsignbulksendtransmissionGetBatchFileV1(pkiEzsignbulksendtransmissionID, bIncludeSigned, bIncludeAttachment, bIncludeProofdocument, bIncludeProof);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling ObjectEzsignbulksendtransmissionApi.EzsignbulksendtransmissionGetBatchFileV1: " + e.Message);
...
#### Using the EzsignbulksendtransmissionGetBatchFileV1WithHttpInfo variant
...
{
    // Retrieve file to download documents in batch
    ApiResponse<System.IO.Stream> response = apiInstance.EzsignbulksendtransmissionGetBatchFileV1WithHttpInfo(pkiEzsignbulksendtransmissionID, bIncludeSigned, bIncludeAttachment, bIncludeProofdocument, bIncludeProof);
...
{
    Debug.Print("Exception when calling ObjectEzsignbulksendtransmissionApi.EzsignbulksendtransmissionGetBatchFileV1WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
