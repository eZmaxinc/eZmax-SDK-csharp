...
namespace Example
{
    public class ClonehistoryGetListV1Example
    {
        public static void Main()
        {
            ...
            var apiInstance = new ObjectClonehistoryApi(config);
...
#### Using the ClonehistoryGetListV1WithHttpInfo variant
...
{
    // Retrieve Clonehistory list
    ApiResponse<ClonehistoryGetListV1Response> response = apiInstance.ClonehistoryGetListV1WithHttpInfo(eOrderBy, iRowMax, iRowOffset, acceptLanguage, sFilter);
...
{
    Debug.Print("Exception when calling ObjectClonehistoryApi.ClonehistoryGetListV1WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
