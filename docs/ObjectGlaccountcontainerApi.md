...
namespace Example
{
    public class GlaccountcontainerGetAutocompleteV2Example
    {
        public static void Main()
        {
            ...
            var apiInstance = new ObjectGlaccountcontainerApi(config);
            var sSelector = "All";  // string | The type of Glaccountcontainers to return
            ...
            {
                Debug.Print("Exception when calling ObjectGlaccountcontainerApi.GlaccountcontainerGetAutocompleteV2: " + e.Message);
...
#### Using the GlaccountcontainerGetAutocompleteV2WithHttpInfo variant
...
{
    // Retrieve Glaccountcontainers and IDs
    ApiResponse<GlaccountcontainerGetAutocompleteV2Response> response = apiInstance.GlaccountcontainerGetAutocompleteV2WithHttpInfo(sSelector, eFilterActive, sQuery, acceptLanguage);
...
{
    Debug.Print("Exception when calling ObjectGlaccountcontainerApi.GlaccountcontainerGetAutocompleteV2WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
