...
> CommonGetAutocompleteV1Response DepartmentGetAutocompleteV1 (string sSelector, string eFilterActive = null, string sQuery = null, HeaderAcceptLanguage? acceptLanguage = null)
...
namespace Example
{
    public class DepartmentGetAutocompleteV1Example
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ObjectDepartmentApi.DepartmentGetAutocompleteV1: " + e.Message );
...
namespace Example
{
    public class DepartmentGetMembersV1Example
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://prod.api.appcluster01.ca-central-1.ezmax.com/rest";
            ...
            {
                Debug.Print("Exception when calling ObjectDepartmentApi.DepartmentGetMembersV1: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
