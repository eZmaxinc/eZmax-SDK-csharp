...
namespace eZmaxApi.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "OpenAPI-Generator/1.0.48/csharp";
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "OpenAPI-Generator/1.0.48/csharp"
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 1.0.48\n";
            report += "    SDK Package Version: 1.0.48\n";
