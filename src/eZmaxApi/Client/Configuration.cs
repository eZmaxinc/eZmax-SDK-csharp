...
namespace eZmaxApi.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/1.3.2/csharp");
                    ...
                    new Dictionary<string, object> {
                        ...
                        {"description", "The server endpoint where to send your region specific API requests."},
                        {
                            "variables", new Dictionary<string, object> {
                                {
                                    "sInfrastructureenvironmenttypeDescription", new Dictionary<string, object> {
                                ...
                                {
                                    "sInfrastructureregionCode", new Dictionary<string, object> {
        ...
        {
            string report = "C# SDK (eZmaxApi) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 1.3.2\n";
            report += "    SDK Package Version: 1.3.2\n";
