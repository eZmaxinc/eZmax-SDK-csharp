...
namespace eZmaxApi.Client
{
    ...
    public interface ICustomHttpStatusCode352<TType> : IApiResponse
    {
        /// <summary>
        /// Deserializes the response if the response is CustomHttpStatusCode352
        /// </summary>
        /// <returns></returns>
        TType CustomHttpStatusCode352();

        /// <summary>
        /// Returns true if the response is CustomHttpStatusCode352 and the deserialized response is not null
        /// </summary>
        /// <param name="result"></param>
        /// <returns></returns>
        bool TryCustomHttpStatusCode352([NotNullWhen(true)]out TType? result);
    }
