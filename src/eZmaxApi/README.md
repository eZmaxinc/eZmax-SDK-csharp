...
inputSpec: /git/github/eZmaxinc/eZmax-API/specs/ezmax.v1.3.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{806109D5-D979-4197-B50F-0F9D9332A260}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IGlobalCustomerApi>();
            IGlobalCustomerGetEndpointV1ApiResponse apiResponse = await api.GlobalCustomerGetEndpointV1Async("todo");
            GlobalCustomerGetEndpointV1Response? model = apiResponse.Ok();
        }
...
## Api Information
- appName: eZmax API Definition (Full)
- appVersion: 1.3.1
- appDescription: This API expose all the functionnalities for the eZmax and eZsign applications.
