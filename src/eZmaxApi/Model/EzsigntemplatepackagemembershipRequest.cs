...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatepackagemembershipRequest : IValidatableObject
    {
        ...
        public EzsigntemplatepackagemembershipRequest(int pkiEzsigntemplatepackagemembershipID = default, int fkiEzsigntemplatepackageID = default, int fkiEzsigntemplateID = default)
        {
