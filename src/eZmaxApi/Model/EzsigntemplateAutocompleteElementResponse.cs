...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplateAutocompleteElementResponse : IValidatableObject
    {
        ...
        public EzsigntemplateAutocompleteElementResponse(FieldEEzsignfoldertypePrivacylevel eEzsignfoldertypePrivacylevel = default, string sEzsigntemplateDescription = default, int pkiEzsigntemplateID = default, bool bEzsigntemplateIsactive = default)
        {
