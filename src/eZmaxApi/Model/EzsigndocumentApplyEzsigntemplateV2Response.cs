...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigndocumentApplyEzsigntemplateV2Response : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        /// <param name="">.</param>
        public EzsigndocumentApplyEzsigntemplateV2Response(CommonResponseObjDebugPayload  = default(CommonResponseObjDebugPayload), CommonResponseObjDebug  = default(CommonResponseObjDebug), List<CommonResponseWarning>  = default(List<CommonResponseWarning>))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigndocumentApplyEzsigntemplateV2Response and cannot be null");
            }
