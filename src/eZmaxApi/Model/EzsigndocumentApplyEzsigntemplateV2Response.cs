...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigndocumentApplyEzsigntemplateV2Response : CommonResponse, IValidatableObject
    {
        /// <summary>
        ...
        public EzsigndocumentApplyEzsigntemplateV2Response(List<CommonResponseWarning> aObjWarning = default(List<CommonResponseWarning>), CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug)) : base()
        {
