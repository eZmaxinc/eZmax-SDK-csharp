...
namespace eZmaxApi.Model
{
    ...
    public partial class BrandingListElement : IValidatableObject
    {
        ...
        public BrandingListElement(int pkiBrandingID = default, string sBrandingDescriptionX = default, int iBrandingColortext = default, int iBrandingColortextlinkbox = default, int iBrandingColortextbutton = default, int iBrandingColorbackground = default, int iBrandingColorbackgroundbutton = default, int iBrandingColorbackgroundsmallbox = default, bool bBrandingIsactive = default)
        {
