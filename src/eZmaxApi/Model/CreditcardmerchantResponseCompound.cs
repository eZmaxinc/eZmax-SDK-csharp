...
namespace eZmaxApi.Model
{
    ...
    public partial class CreditcardmerchantResponseCompound : IValidatableObject
    {
        ...
        /// <param name="fkiCurrencyID">The unique ID of the Currency. (required).</param>
        ...
        public CreditcardmerchantResponseCompound(int pkiCreditcardmerchantID = default, int fkiBankaccountID = default, int fkiLanguageID = default, string sLanguageNameX = default, int fkiCurrencyID = default, string sCurrencyDescriptionX = default, string sBankaccountBankname = default, bool bCreditcardmerchantDenyvisa = default, bool bCreditcardmerchantDenymastercard = default, bool bCreditcardmerchantDenyamex = default, bool bCreditcardmerchantIsactive = default, string sCreditcardmerchantDescription = default, string sCreditcardmerchantStoreid = default)
        {
            ...
            {
                throw new ArgumentNullException("sLanguageNameX is a required property for CreditcardmerchantResponseCompound and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sCurrencyDescriptionX is a required property for CreditcardmerchantResponseCompound and cannot be null");
            }
        ...
        */
        ...
        <example>1</example>
        */
        [DataMember(Name = "fkiCurrencyID", IsRequired = true, EmitDefaultValue = true)]
