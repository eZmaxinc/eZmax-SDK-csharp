...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignatureattachmentResponse : IValidatableObject
    {
        ...
        public EzsignsignatureattachmentResponse(int pkiEzsignsignatureattachmentID = default, int fkiEzsignsignatureID = default, string binEzsignsignatureattachmentMD5 = default, string sEzsignsignatureattachmentName = default, string sDownloadUrl = default)
        {
