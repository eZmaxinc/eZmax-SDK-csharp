...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignfoldersignerassociation-createObject-v3-Response-mPayload")]
    public partial class EzsignfoldersignerassociationCreateObjectV3ResponseMPayload : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignfoldersignerassociationCreateObjectV3ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsignfoldersignerassociationCreateObjectV3ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignfoldersignerassociationCreateObjectV3ResponseMPayload" /> class.
        /// </summary>
        ...
        public EzsignfoldersignerassociationCreateObjectV3ResponseMPayload(List<int> aPkiEzsignfoldersignerassociationID = default)
        {
            // to ensure "aPkiEzsignfoldersignerassociationID" is required (not null)
            if (aPkiEzsignfoldersignerassociationID == null)
            {
                throw new ArgumentNullException("aPkiEzsignfoldersignerassociationID is a required property for EzsignfoldersignerassociationCreateObjectV3ResponseMPayload and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EzsignfoldersignerassociationCreateObjectV3ResponseMPayload {\n");
