...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignbulksend-ResponseV4")]
    public partial class EzsignbulksendResponseV4 : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignbulksendResponseV4" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsignbulksendResponseV4() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignbulksendResponseV4" /> class.
        /// </summary>
        ...
        public EzsignbulksendResponseV4(int pkiEzsignbulksendID = default, int fkiEzsignfoldertypeID = default, int fkiLanguageID = default, string sLanguageNameX = default, FieldEEzsignbulksendEzsignformfieldorder eEzsignbulksendEzsignformfieldorder = default, FieldEEzsignfoldertypePrivacylevel eEzsignfoldertypePrivacylevel = default, string sEzsignfoldertypeNameX = default, string sEzsignbulksendDescription = default, string tEzsignbulksendNote = default, bool bEzsignbulksendNeedvalidation = default, bool bEzsignbulksendIsactive = default, CommonAudit objAudit = default)
        {
            ...
            {
                throw new ArgumentNullException("sLanguageNameX is a required property for EzsignbulksendResponseV4 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sEzsignfoldertypeNameX is a required property for EzsignbulksendResponseV4 and cannot be null");
            }
            this.SEzsignfoldertypeNameX = sEzsignfoldertypeNameX;
            // to ensure "sEzsignbulksendDescription" is required (not null)
            if (sEzsignbulksendDescription == null)
            {
                throw new ArgumentNullException("sEzsignbulksendDescription is a required property for EzsignbulksendResponseV4 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("tEzsignbulksendNote is a required property for EzsignbulksendResponseV4 and cannot be null");
            }
            ...
            if (objAudit == null)
            {
                throw new ArgumentNullException("objAudit is a required property for EzsignbulksendResponseV4 and cannot be null");
            }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EzsignbulksendResponseV4 {\n");
