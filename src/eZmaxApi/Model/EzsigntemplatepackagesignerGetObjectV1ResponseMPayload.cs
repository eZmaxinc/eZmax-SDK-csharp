...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsigntemplatepackagesignerGetObjectV1ResponseMPayload :  IEquatable<EzsigntemplatepackagesignerGetObjectV1ResponseMPayload>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatepackagesignerGetObjectV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplatepackagesignerGetObjectV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatepackagesignerGetObjectV1ResponseMPayload" /> class.
        /// </summary>
        ...
        public EzsigntemplatepackagesignerGetObjectV1ResponseMPayload(int pkiEzsigntemplatepackagesignerID = default(int), int fkiEzsigntemplatepackageID = default(int), string sEzsigntemplatepackagesignerDescription = default(string))
        {
            // to ensure "pkiEzsigntemplatepackagesignerID" is required (not null)
            if (pkiEzsigntemplatepackagesignerID == null)
            {
                throw new InvalidDataException("pkiEzsigntemplatepackagesignerID is a required property for EzsigntemplatepackagesignerGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("fkiEzsigntemplatepackageID is a required property for EzsigntemplatepackagesignerGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sEzsigntemplatepackagesignerDescription is a required property for EzsigntemplatepackagesignerGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EzsigntemplatepackagesignerGetObjectV1ResponseMPayload);
        }

        /// <summary>
        /// Returns true if EzsigntemplatepackagesignerGetObjectV1ResponseMPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of EzsigntemplatepackagesignerGetObjectV1ResponseMPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EzsigntemplatepackagesignerGetObjectV1ResponseMPayload input)
        {
            if (input == null)
                return false;
