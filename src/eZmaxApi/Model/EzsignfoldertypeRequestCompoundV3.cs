...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfoldertypeRequestCompoundV3 : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        /// <param name="">.</param>
        public EzsignfoldertypeRequestCompoundV3(int  = default(int), MultilingualEzsignfoldertypeName  = default(MultilingualEzsignfoldertypeName), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), List<int>  = default(List<int>), List<int>  = default(List<int>), List<int>  = default(List<int>), List<int>  = default(List<int>), List<int>  = default(List<int>), FieldEEzsignfoldertypeDocumentdependency?  = default(FieldEEzsignfoldertypeDocumentdependency?), string  = default(string), string  = default(string), FieldEEzsignfoldertypePdfarequirement?  = default(FieldEEzsignfoldertypePdfarequirement?), FieldEEzsignfoldertypePdfanoncompliantaction?  = default(FieldEEzsignfoldertypePdfanoncompliantaction?), FieldEEzsignfoldertypePrivacylevel  = default(FieldEEzsignfoldertypePrivacylevel), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), FieldEEzsignfoldertypeDisposal  = default(FieldEEzsignfoldertypeDisposal), FieldEEzsignfoldertypeCompletion  = default(FieldEEzsignfoldertypeCompletion), int  = default(int), int  = default(int), bool  = default(bool), int  = default(int), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), FieldEEzsignfoldertypeSigneraccess?  = default(FieldEEzsignfoldertypeSigneraccess?), bool  = default(bool), List<int>  = default(List<int>), List<int>  = default(List<int>))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignfoldertypeRequestCompoundV3 and cannot be null");
            }
            ...
            this.AFkiUsergroupIDAll = ;
            this.AFkiUsergroupIDRestricted = ;
            this.AFkiUsergroupIDTemplate = ;
