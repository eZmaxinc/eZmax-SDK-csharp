...
namespace eZmaxApi.Model
{
    ...
    public partial class EzdoctemplatedocumentAutocompleteElementResponse : IValidatableObject
    {
        ...
        public EzdoctemplatedocumentAutocompleteElementResponse(int pkiEzdoctemplatedocumentID = default, string sEzdoctemplatedocumentNameX = default, bool bEzdoctemplatedocumentIsactive = default)
        {
