...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigndiscussion-createObject-v1-Request")]
    public partial class EzsigndiscussionCreateObjectV1Request : IValidatableObject
    {
        ...
        protected EzsigndiscussionCreateObjectV1Request() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigndiscussionCreateObjectV1Request" /> class.
        /// </summary>
        /// <param name="aObjEzsigndiscussion">aObjEzsigndiscussion (required).</param>
        public EzsigndiscussionCreateObjectV1Request(List<EzsigndiscussionRequestCompound> aObjEzsigndiscussion = default)
        {
