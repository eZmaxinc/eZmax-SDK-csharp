...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UsergroupDeleteObjectV1Response :  IEquatable<UsergroupDeleteObjectV1Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UsergroupDeleteObjectV1Response" /> class.
        /// </summary>
        /// <param name="objDebugPayload">objDebugPayload.</param>
        /// <param name="objDebug">objDebug.</param>
        public UsergroupDeleteObjectV1Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UsergroupDeleteObjectV1Response {\n");
        ...
        {
            return this.Equals(input as UsergroupDeleteObjectV1Response);
        }

        /// <summary>
        /// Returns true if UsergroupDeleteObjectV1Response instances are equal
        /// </summary>
        /// <param name="input">Instance of UsergroupDeleteObjectV1Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsergroupDeleteObjectV1Response input)
        {
            if (input == null)
                return false;
