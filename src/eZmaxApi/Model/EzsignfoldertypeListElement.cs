...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfoldertypeListElement : IValidatableObject
    {
        ...
        public EzsignfoldertypeListElement(int pkiEzsignfoldertypeID = default, FieldEEzsignfoldertypePrivacylevel eEzsignfoldertypePrivacylevel = default, string sEzsignfoldertypeNameX = default, bool bEzsignfoldertypeIsactive = default)
        {
