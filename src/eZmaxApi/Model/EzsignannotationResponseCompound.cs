...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignannotation-ResponseCompound")]
    public partial class EzsignannotationResponseCompound : IValidatableObject
    {
        ...
        public EzsignannotationResponseCompound(int pkiEzsignannotationID = default, int fkiEzsigndocumentID = default, EnumHorizontalalignment? eEzsignannotationHorizontalalignment = default, EnumVerticalalignment? eEzsignannotationVerticalalignment = default, FieldEEzsignannotationType eEzsignannotationType = default, int iEzsignannotationX = default, int iEzsignannotationY = default, int iEzsignannotationWidth = default, int iEzsignannotationHeight = default, string sEzsignannotationText = default, int iEzsignpagePagenumber = default, TextstylestaticResponseCompound objTextstylestatic = default)
        {
