...
namespace eZmaxApi.Model
{
    ...
    public partial class VariableexpenseListElement : IValidatableObject
    {
        ...
        public VariableexpenseListElement(int pkiVariableexpenseID = default, string sVariableexpenseCode = default, string sVariableexpenseDescriptionX = default, FieldEVariableexpenseTaxable? eVariableexpenseTaxable = default, bool bVariableexpenseIsactive = default)
        {
