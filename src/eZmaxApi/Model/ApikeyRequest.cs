...
namespace eZmaxApi.Model
{
    ...
    public partial class ApikeyRequest : IValidatableObject
    {
        ...
        public ApikeyRequest(int pkiApikeyID = default, int fkiUserID = default, MultilingualApikeyDescription objApikeyDescription = default, bool bApikeyIsactive = default, bool bApikeyIssigned = default)
        {
