...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplateelementdependency-RequestCompound")]
    public partial class EzsigntemplateelementdependencyRequestCompound : IValidatableObject
    {
        ...
        protected EzsigntemplateelementdependencyRequestCompound() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplateelementdependencyRequestCompound" /> class.
        /// </summary>
        ...
        public EzsigntemplateelementdependencyRequestCompound(int pkiEzsigntemplateelementdependencyID = default, int fkiEzsigntemplateformfieldIDValidation = default, int fkiEzsigntemplateformfieldgroupIDValidation = default, string sEzsigntemplateelementdependencyEzsigntemplateformfieldgrouplabel = default, string sEzsigntemplateelementdependencyEzsigntemplateformfieldlabel = default, FieldEEzsigntemplateelementdependencyValidation eEzsigntemplateelementdependencyValidation = default, bool bEzsigntemplateelementdependencySelected = default, FieldEEzsigntemplateelementdependencyOperator? eEzsigntemplateelementdependencyOperator = default, string sEzsigntemplateelementdependencyValue = default)
        {
