...
namespace eZmaxApi.Model
{
    ...
    public partial class CommonResponseObjDebugPayload : IValidatableObject
    {
        ...
        public CommonResponseObjDebugPayload(int iVersionMin = default, int iVersionMax = default, List<int> aRequiredPermission = default, bool bVersionDeprecated = default, string dtResponseDate = default)
        {
