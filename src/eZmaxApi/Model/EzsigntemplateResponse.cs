...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplateResponse : IValidatableObject
    {
        ...
        public EzsigntemplateResponse(int pkiEzsigntemplateID = default, int fkiEzsigntemplatedocumentID = default, int fkiEzsignfoldertypeID = default, int fkiLanguageID = default, int fkiEzdoctemplatedocumentID = default, string sLanguageNameX = default, string sEzsigntemplateDescription = default, string sEzsigntemplateExternaldescription = default, string tEzsigntemplateComment = default, string sEzsigntemplateFilenamepattern = default, bool bEzsigntemplateAdminonly = default, string sEzsignfoldertypeNameX = default, CommonAudit objAudit = default, bool bEzsigntemplateEditallowed = default, FieldEEzsigntemplateType? eEzsigntemplateType = default)
        {
