...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignerRequestCompoundContact : IValidatableObject
    {
        ...
        public EzsignsignerRequestCompoundContact(string sContactFirstname = default, string sContactLastname = default, int fkiLanguageID = default, string sEmailAddress = default, string sPhoneE164 = default, string sPhoneExtension = default, string sPhoneE164Cell = default, string sPhoneNumber = default, string sPhoneNumberCell = default)
        {
