...
namespace eZmaxApi.Model
{
    ...
    public partial class UserlogintypeAutocompleteElementResponse : IValidatableObject
    {
        ...
        public UserlogintypeAutocompleteElementResponse(int pkiUserlogintypeID = default, string sUserlogintypeDescriptionX = default, bool bUserlogintypeIsactive = default)
        {
