...
namespace eZmaxApi.Model
{
    ...
    public partial class UsergroupRequest : IValidatableObject
    {
        ...
        public UsergroupRequest(int  = default(int), EmailRequest  = default(EmailRequest), MultilingualUsergroupName  = default(MultilingualUsergroupName))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for UsergroupRequest and cannot be null");
            }
