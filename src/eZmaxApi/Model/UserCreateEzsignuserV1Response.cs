...
namespace eZmaxApi.Model
{
    ...
    public partial class UserCreateEzsignuserV1Response : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        /// <param name=""> (required).</param>
        public UserCreateEzsignuserV1Response(CommonResponseObjDebugPayload  = default(CommonResponseObjDebugPayload), CommonResponseObjDebug  = default(CommonResponseObjDebug), UserCreateEzsignuserV1ResponseMPayload  = default(UserCreateEzsignuserV1ResponseMPayload))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for UserCreateEzsignuserV1Response and cannot be null");
            }
