...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserCreateEzsignuserV1Response :  IEquatable<UserCreateEzsignuserV1Response>
    {
        /// <summary>
        ...
        public UserCreateEzsignuserV1Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), UserCreateEzsignuserV1ResponseMPayload mPayload = default(UserCreateEzsignuserV1ResponseMPayload))
        {
            // to ensure "objDebugPayload" is required (not null)
            if (objDebugPayload == null)
            {
                throw new InvalidDataException("objDebugPayload is a required property for UserCreateEzsignuserV1Response and cannot be null");
            }
            else
            {
