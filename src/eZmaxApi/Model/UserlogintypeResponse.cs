...
namespace eZmaxApi.Model
{
    ...
    public partial class UserlogintypeResponse : IValidatableObject
    {
        ...
        public UserlogintypeResponse(int  = default(int), MultilingualUserlogintypeDescription  = default(MultilingualUserlogintypeDescription), string  = default(string))
        {
            this.PkiUserlogintypeID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for UserlogintypeResponse and cannot be null");
            }
            this.ObjUserlogintypeDescription = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for UserlogintypeResponse and cannot be null");
