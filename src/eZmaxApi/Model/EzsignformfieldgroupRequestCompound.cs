...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignformfieldgroup-RequestCompound")]
    public partial class EzsignformfieldgroupRequestCompound : IValidatableObject
    {
        ...
        public EzsignformfieldgroupRequestCompound(int pkiEzsignformfieldgroupID = default, int fkiEzsigndocumentID = default, FieldEEzsignformfieldgroupType eEzsignformfieldgroupType = default, FieldEEzsignformfieldgroupSignerrequirement? eEzsignformfieldgroupSignerrequirement = default, string sEzsignformfieldgroupLabel = default, int iEzsignformfieldgroupStep = default, string sEzsignformfieldgroupDefaultvalue = default, int iEzsignformfieldgroupFilledmin = default, int iEzsignformfieldgroupFilledmax = default, bool bEzsignformfieldgroupReadonly = default, int iEzsignformfieldgroupMaxlength = default, bool bEzsignformfieldgroupEncrypted = default, string sEzsignformfieldgroupRegexp = default, string sEzsignformfieldgroupTextvalidationcustommessage = default, string tEzsignformfieldgroupTooltip = default, FieldEEzsignformfieldgroupTooltipposition? eEzsignformfieldgroupTooltipposition = default, EnumTextvalidation? eEzsignformfieldgroupTextvalidation = default, List<EzsignformfieldgroupsignerRequestCompound> aObjEzsignformfieldgroupsigner = default, List<CustomDropdownElementRequestCompound> aObjDropdownElement = default, List<EzsignformfieldRequestCompound> aObjEzsignformfield = default)
        {
            ...
            {
                throw new ArgumentNullException("sEzsignformfieldgroupLabel is a required property for EzsignformfieldgroupRequestCompound and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("aObjEzsignformfieldgroupsigner is a required property for EzsignformfieldgroupRequestCompound and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("aObjEzsignformfield is a required property for EzsignformfieldgroupRequestCompound and cannot be null");
            }
