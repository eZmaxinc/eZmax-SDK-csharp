...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignformfieldgroupRequestCompound : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        /// <param name=""> (required).</param>
        public EzsignformfieldgroupRequestCompound(int  = default(int), int  = default(int), FieldEEzsignformfieldgroupType  = default(FieldEEzsignformfieldgroupType), FieldEEzsignformfieldgroupSignerrequirement?  = default(FieldEEzsignformfieldgroupSignerrequirement?), string  = default(string), int  = default(int), string  = default(string), int  = default(int), int  = default(int), bool  = default(bool), int  = default(int), bool  = default(bool), string  = default(string), string  = default(string), string  = default(string), FieldEEzsignformfieldgroupTooltipposition?  = default(FieldEEzsignformfieldgroupTooltipposition?), EnumTextvalidation?  = default(EnumTextvalidation?), List<EzsignformfieldgroupsignerRequestCompound>  = default(List<EzsignformfieldgroupsignerRequestCompound>), List<CustomDropdownElementRequestCompound>  = default(List<CustomDropdownElementRequestCompound>), List<EzsignformfieldRequestCompound>  = default(List<EzsignformfieldRequestCompound>))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignformfieldgroupRequestCompound and cannot be null");
            }
