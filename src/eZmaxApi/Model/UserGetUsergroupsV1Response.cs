...
namespace eZmaxApi.Model
{
    ...
    public partial class UserGetUsergroupsV1Response : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        /// <param name=""> (required).</param>
        public UserGetUsergroupsV1Response(CommonResponseObjDebugPayload  = default(CommonResponseObjDebugPayload), CommonResponseObjDebug  = default(CommonResponseObjDebug), UserGetUsergroupsV1ResponseMPayload  = default(UserGetUsergroupsV1ResponseMPayload))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for UserGetUsergroupsV1Response and cannot be null");
            }
