...
namespace eZmaxApi.Model
{
    ...
    public partial class UserGetUsergroupsV1Response : CommonResponse, IValidatableObject
    {
        /// <summary>
        ...
        public UserGetUsergroupsV1Response(UserGetUsergroupsV1ResponseMPayload mPayload = default(UserGetUsergroupsV1ResponseMPayload), CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug)) : base()
        {
