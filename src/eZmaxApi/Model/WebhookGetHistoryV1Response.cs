...
namespace eZmaxApi.Model
{
    ...
    public partial class WebhookGetHistoryV1Response : CommonResponse, IValidatableObject
    {
        /// <summary>
        ...
        public WebhookGetHistoryV1Response(WebhookGetHistoryV1ResponseMPayload mPayload = default(WebhookGetHistoryV1ResponseMPayload), CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug)) : base()
        {
