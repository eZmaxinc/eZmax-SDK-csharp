...
namespace eZmaxApi.Model
{
    ...
    public partial class ActivesessionGenerateFederationTokenV1ResponseMPayload : IValidatableObject
    {
        ...
        public ActivesessionGenerateFederationTokenV1ResponseMPayload(CustomApikeyfederation  = default(CustomApikeyfederation), string  = default(string))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for ActivesessionGenerateFederationTokenV1ResponseMPayload and cannot be null");
            }
