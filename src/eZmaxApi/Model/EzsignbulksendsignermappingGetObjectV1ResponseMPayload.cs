...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsignbulksendsignermappingGetObjectV1ResponseMPayload :  IEquatable<EzsignbulksendsignermappingGetObjectV1ResponseMPayload>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignbulksendsignermappingGetObjectV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsignbulksendsignermappingGetObjectV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignbulksendsignermappingGetObjectV1ResponseMPayload" /> class.
        /// </summary>
        ...
        public EzsignbulksendsignermappingGetObjectV1ResponseMPayload(int pkiEzsignbulksendsignermappingID = default(int), int fkiEzsignbulksendID = default(int), int fkiUserID = default(int), string sEzsignbulksendsignermappingDescription = default(string))
        {
            // to ensure "pkiEzsignbulksendsignermappingID" is required (not null)
            if (pkiEzsignbulksendsignermappingID == null)
            {
                throw new InvalidDataException("pkiEzsignbulksendsignermappingID is a required property for EzsignbulksendsignermappingGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("fkiEzsignbulksendID is a required property for EzsignbulksendsignermappingGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sEzsignbulksendsignermappingDescription is a required property for EzsignbulksendsignermappingGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EzsignbulksendsignermappingGetObjectV1ResponseMPayload);
        }

        /// <summary>
        /// Returns true if EzsignbulksendsignermappingGetObjectV1ResponseMPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of EzsignbulksendsignermappingGetObjectV1ResponseMPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EzsignbulksendsignermappingGetObjectV1ResponseMPayload input)
        {
            if (input == null)
                return false;
