...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplatesigner-RequestCompoundV2")]
    public partial class EzsigntemplatesignerRequestCompoundV2 : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatesignerRequestCompoundV2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplatesignerRequestCompoundV2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatesignerRequestCompoundV2" /> class.
        /// </summary>
        ...
        public EzsigntemplatesignerRequestCompoundV2(int pkiEzsigntemplatesignerID = default, int fkiEzsigntemplateID = default, int fkiUserID = default, int fkiUsergroupID = default, int fkiEzdoctemplatedocumentID = default, FieldEEzsigntemplatesignerRole? eEzsigntemplatesignerRole = default, FieldEEzsigntemplatesignerMapping? eEzsigntemplatesignerMapping = default, string sEzsigntemplatesignerDescription = default)
        {
            this.FkiEzsigntemplateID = fkiEzsigntemplateID;
            // to ensure "sEzsigntemplatesignerDescription" is required (not null)
            if (sEzsigntemplatesignerDescription == null)
            {
                throw new ArgumentNullException("sEzsigntemplatesignerDescription is a required property for EzsigntemplatesignerRequestCompoundV2 and cannot be null");
            }
