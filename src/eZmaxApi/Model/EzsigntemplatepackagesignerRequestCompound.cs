...
getter                              : 
setter                              : 
dataType                            : EzsigntemplatepackagesignerRequest
datatypeWithEnum                    : 
name                                : ezsigntemplatepackagesigner-RequestCompound
defaultValue                        : 
...
*/
    ...
    public partial class EzsigntemplatepackagesignerRequestCompound :  IEquatable<EzsigntemplatepackagesignerRequestCompound>, IValidatableObject
    {
        ...
        public EzsigntemplatepackagesignerRequestCompound(int pkiEzsigntemplatepackagesignerID = default(int), int fkiEzsigntemplatepackageID = default(int), string sEzsigntemplatepackagesignerDescription = default(string))
        {
            ...
            {
                throw new InvalidDataException("fkiEzsigntemplatepackageID is a required property for EzsigntemplatepackagesignerRequestCompound and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sEzsigntemplatepackagesignerDescription is a required property for EzsigntemplatepackagesignerRequestCompound and cannot be null");
            }
            else
            {
