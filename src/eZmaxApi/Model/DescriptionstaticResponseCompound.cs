...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "descriptionstatic-ResponseCompound")]
    public partial class DescriptionstaticResponseCompound : IEquatable<DescriptionstaticResponseCompound>, IValidatableObject
    {
        ...
        public DescriptionstaticResponseCompound(int pkiDescriptionstaticID = default(int), string sDescriptionstaticDescription = default(string))
        {
            ...
            {
                throw new ArgumentNullException("sDescriptionstaticDescription is a required property for DescriptionstaticResponseCompound and cannot be null");
            }
