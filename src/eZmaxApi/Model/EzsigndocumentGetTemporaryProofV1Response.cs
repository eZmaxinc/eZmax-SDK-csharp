...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigndocument-getTemporaryProof-v1-Response")]
    public partial class EzsigndocumentGetTemporaryProofV1Response : IEquatable<EzsigndocumentGetTemporaryProofV1Response>, IValidatableObject
    {
        ...
        public EzsigndocumentGetTemporaryProofV1Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), EzsigndocumentGetTemporaryProofV1ResponseMPayload mPayload = default(EzsigndocumentGetTemporaryProofV1ResponseMPayload))
        {
            // to ensure "objDebugPayload" is required (not null)
            if (objDebugPayload == null)
            {
                throw new ArgumentNullException("objDebugPayload is a required property for EzsigndocumentGetTemporaryProofV1Response and cannot be null");
            }
            this.ObjDebugPayload = objDebugPayload;
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new ArgumentNullException("mPayload is a required property for EzsigndocumentGetTemporaryProofV1Response and cannot be null");
            }
