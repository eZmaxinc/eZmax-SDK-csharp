...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Custom-EzsignsignatureCreateEzsignelementsPositionedByWord-Request")]
    public partial class CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest : IValidatableObject
    {
        ...
        protected CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest" /> class.
        /// </summary>
        ...
        public CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest(int pkiEzsignsignatureID = default, int fkiEzsignfoldersignerassociationID = default, int fkiPaymentgatewayID = default, int iEzsignpagePagenumber = default, int iEzsignsignatureX = default, int iEzsignsignatureY = default, int iEzsignsignatureWidth = default, int iEzsignsignatureHeight = default, int iEzsignsignatureStep = default, FieldEEzsignsignatureType eEzsignsignatureType = default, FieldEEzsignsignatureSignaturepad? eEzsignsignatureSignaturepad = default, FieldEEzsignsignatureSignaturepadrequired? eEzsignsignatureSignaturepadrequired = default, int fkiEzsigndocumentID = default, string tEzsignsignatureTooltip = default, FieldEEzsignsignatureTooltipposition? eEzsignsignatureTooltipposition = default, FieldEEzsignsignatureFont? eEzsignsignatureFont = default, int fkiEzsignfoldersignerassociationIDValidation = default, bool bEzsignsignatureHandwritten = default, bool bEzsignsignatureReason = default, bool bEzsignsignatureRequired = default, FieldEEzsignsignatureAttachmentnamesource? eEzsignsignatureAttachmentnamesource = default, string sEzsignsignatureAttachmentdescription = default, FieldEEzsignsignatureConsultationtrigger? eEzsignsignatureConsultationtrigger = default, int iEzsignsignatureValidationstep = default, int iEzsignsignatureMaxlength = default, string sEzsignsignatureDefaultvalue = default, EnumTextvalidation? eEzsignsignatureTextvalidation = default, string sEzsignsignatureTextvalidationcustommessage = default, string sEzsignsignatureRegexp = default, FieldEEzsignsignatureDependencyrequirement? eEzsignsignatureDependencyrequirement = default, string sEzsignsignatureCreditcardamountdescription = default, string dEzsignsignatureCreditcardamount = default, bool bEzsignsignatureCreditcardcustomamount = default, bool bEzsignsignatureCustomdate = default, List<EzsignsignaturecustomdateRequestCompound> aObjEzsignsignaturecustomdate = default, List<EzsignelementdependencyRequestCompound> aObjEzsignelementdependency = default, List<EzsignsignaturepaymentdetailRequestCompound> aObjEzsignsignaturepaymentdetail = default, CustomCreateEzsignelementsPositionedByWordRequest objCreateezsignelementspositionedbyword = default)
        {
        ...
        */
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.SEzsignsignatureCreditcardamountdescription != null) {
                ...
                if (!regexSEzsignsignatureCreditcardamountdescription.Match(this.SEzsignsignatureCreditcardamountdescription).Success)
                {
