...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsigntemplateformfieldgroupGetObjectV1Response :  IEquatable<EzsigntemplateformfieldgroupGetObjectV1Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplateformfieldgroupGetObjectV1Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplateformfieldgroupGetObjectV1Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplateformfieldgroupGetObjectV1Response" /> class.
        /// </summary>
        ...
        public EzsigntemplateformfieldgroupGetObjectV1Response(EzsigntemplateformfieldgroupGetObjectV1ResponseMPayload mPayload = default(EzsigntemplateformfieldgroupGetObjectV1ResponseMPayload), CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug))
        {
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new InvalidDataException("mPayload is a required property for EzsigntemplateformfieldgroupGetObjectV1Response and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EzsigntemplateformfieldgroupGetObjectV1Response);
        }

        /// <summary>
        /// Returns true if EzsigntemplateformfieldgroupGetObjectV1Response instances are equal
        /// </summary>
        /// <param name="input">Instance of EzsigntemplateformfieldgroupGetObjectV1Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EzsigntemplateformfieldgroupGetObjectV1Response input)
        {
            if (input == null)
                return false;
