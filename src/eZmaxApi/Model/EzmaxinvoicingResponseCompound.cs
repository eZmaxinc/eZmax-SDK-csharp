...
namespace eZmaxApi.Model
{
    ...
    public partial class EzmaxinvoicingResponseCompound : IValidatableObject
    {
        ...
        public EzmaxinvoicingResponseCompound(int pkiEzmaxinvoicingID = default, int fkiEzmaxinvoicingcontractID = default, int fkiEzmaxpricingID = default, int fkiSystemconfigurationtypeID = default, string sSystemconfigurationtypeDescriptionX = default, string yyyymmEzmaxinvoicing = default, int iEzmaxinvoicingDays = default, FieldEEzmaxinvoicingPaymenttype eEzmaxinvoicingPaymenttype = default, string dEzmaxinvoicingRebatepaymenttype = default, int iEzmaxinvoicingContractlength = default, string dEzmaxinvoicingRebatecontractlength = default, bool bEzmaxinvoicingRebateEzsignallagents = default, CommonAudit objAudit = default, EzmaxinvoicingcontractResponseCompound objEzmaxinvoicingcontract = default, CustomEzmaxpricingResponse objEzmaxpricing = default, List<EzmaxinvoicingsummaryglobalResponseCompound> aObjEzmaxinvoicingsummaryglobal = default, List<EzmaxinvoicingsummaryexternalResponseCompound> aObjEzmaxinvoicingsummaryexternal = default, List<EzmaxinvoicingsummaryinternalResponseCompound> aObjEzmaxinvoicingsummaryinternal = default, List<EzmaxinvoicingagentResponseCompound> aObjEzmaxinvoicingagent = default, List<EzmaxinvoicinguserResponseCompound> aObjEzmaxinvoicinguser = default, List<CustomEzmaxinvoicingEzsignfolderResponse> aObjEzmaxinvoicingezsignfolder = default, List<CustomEzmaxinvoicingEzsigndocumentResponse> aObjEzmaxinvoicingezsigndocument = default)
        {
