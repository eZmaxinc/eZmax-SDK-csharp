...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigndiscussionResponseCompound : IValidatableObject
    {
        ...
        public EzsigndiscussionResponseCompound(int pkiEzsigndiscussionID = default, int fkiEzsignpageID = default, int fkiDiscussionID = default, int iEzsigndiscussionX = default, int iEzsigndiscussionY = default, int iEzsigndiscussionPagenumber = default, DiscussionResponseCompound objDiscussion = default)
        {
