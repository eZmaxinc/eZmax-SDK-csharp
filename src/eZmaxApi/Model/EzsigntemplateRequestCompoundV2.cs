...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplate-RequestCompoundV2")]
    public partial class EzsigntemplateRequestCompoundV2 : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplateRequestCompoundV2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplateRequestCompoundV2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplateRequestCompoundV2" /> class.
        /// </summary>
        ...
        public EzsigntemplateRequestCompoundV2(int pkiEzsigntemplateID = default(int), int fkiEzsignfoldertypeID = default(int), int fkiLanguageID = default(int), string sEzsigntemplateDescription = default(string), string sEzsigntemplateFilenamepattern = default(string), bool bEzsigntemplateAdminonly = default(bool), FieldEEzsigntemplateType eEzsigntemplateType = default(FieldEEzsigntemplateType))
        {
            this.FkiLanguageID = fkiLanguageID;
            // to ensure "sEzsigntemplateDescription" is required (not null)
            if (sEzsigntemplateDescription == null)
            {
                throw new ArgumentNullException("sEzsigntemplateDescription is a required property for EzsigntemplateRequestCompoundV2 and cannot be null");
            }
