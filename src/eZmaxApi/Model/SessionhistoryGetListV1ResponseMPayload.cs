...
namespace eZmaxApi.Model
{
    ...
    public partial class SessionhistoryGetListV1ResponseMPayload : IValidatableObject
    {
        ...
        public SessionhistoryGetListV1ResponseMPayload(int iRowReturned = default, int iRowFiltered = default, List<SessionhistoryListElement> aObjSessionhistory = default)
        {
