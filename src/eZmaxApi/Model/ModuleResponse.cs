...
namespace eZmaxApi.Model
{
    ...
    public partial class ModuleResponse : IValidatableObject
    {
        ...
        public ModuleResponse(int pkiModuleID = default, int fkiModulegroupID = default, string eModuleInternalname = default, string sModuleNameX = default, bool bModuleRegistered = default, bool bModuleRegisteredapi = default)
        {
