...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "folder-getAttachments-v1-Response-mPayload")]
    public partial class FolderGetAttachmentsV1ResponseMPayload : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FolderGetAttachmentsV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FolderGetAttachmentsV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FolderGetAttachmentsV1ResponseMPayload" /> class.
        /// </summary>
        /// <param name="aObjAttachmentdocumenttype">aObjAttachmentdocumenttype (required).</param>
        public FolderGetAttachmentsV1ResponseMPayload(List<CustomAttachmentdocumenttypeResponse> aObjAttachmentdocumenttype = default)
        {
            // to ensure "aObjAttachmentdocumenttype" is required (not null)
            if (aObjAttachmentdocumenttype == null)
            {
                throw new ArgumentNullException("aObjAttachmentdocumenttype is a required property for FolderGetAttachmentsV1ResponseMPayload and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FolderGetAttachmentsV1ResponseMPayload {\n");
