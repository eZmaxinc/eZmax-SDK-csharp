...
namespace eZmaxApi.Model
{
    ...
    public partial class CommonResponseError : IValidatableObject
    {
        ...
        public CommonResponseError(string  = default(string), FieldEErrorCode  = default(FieldEErrorCode), List<string>  = default(List<string>))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for CommonResponseError and cannot be null");
            }
            this.SErrorMessage = ;
            this.EErrorCode = ;
