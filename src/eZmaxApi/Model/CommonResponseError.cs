...
namespace eZmaxApi.Model
{
    ...
    public partial class CommonResponseError :  IEquatable<CommonResponseError>, IValidatableObject
    {
        ...
        /// <param name="eErrorCode">The error code. See documentation for valid values.</param>
        public CommonResponseError(string sErrorMessage = default(string), string eErrorCode = default(string))
        {
        ...
        [DataMember(Name="eErrorCode", EmitDefaultValue=false)]
