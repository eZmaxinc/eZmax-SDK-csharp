...
namespace eZmaxApi.Model
{
    ...
    public partial class CommonResponseError : IValidatableObject
    {
        ...
        public CommonResponseError(string sErrorMessage = default(string), FieldEErrorCode eErrorCode = default(FieldEErrorCode), List<string> aSErrorMessagedetail = default(List<string>))
        {
            // to ensure "sErrorMessage" is required (not null)
            if (sErrorMessage == null)
            {
                throw new ArgumentNullException("sErrorMessage is a required property for CommonResponseError and cannot be null");
            }
