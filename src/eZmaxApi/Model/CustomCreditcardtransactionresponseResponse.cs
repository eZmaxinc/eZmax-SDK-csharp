...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomCreditcardtransactionresponseResponse : IValidatableObject
    {
        ...
        public CustomCreditcardtransactionresponseResponse(string sCreditcardtransactionISOcode = default, string sCreditcardtransactionResponsecode = default, string sCreditcardtransactionResponseterminalmessage = default, FieldECreditcardtransactionAvsresult? eCreditcardtransactionAvsresult = default, FieldECreditcardtransactionCvdresult? eCreditcardtransactionCvdresult = default)
        {
