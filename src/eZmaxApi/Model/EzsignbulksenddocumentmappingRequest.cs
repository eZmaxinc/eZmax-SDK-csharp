...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignbulksenddocumentmappingRequest : IValidatableObject
    {
        ...
        public EzsignbulksenddocumentmappingRequest(int pkiEzsignbulksenddocumentmappingID = default, int fkiEzsignbulksendID = default, int fkiEzsigntemplatepackageID = default, int fkiEzsigntemplateID = default)
        {
