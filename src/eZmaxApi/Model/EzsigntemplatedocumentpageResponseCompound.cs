...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatedocumentpageResponseCompound : IValidatableObject
    {
        ...
        public EzsigntemplatedocumentpageResponseCompound(int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), string  = default(string))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplatedocumentpageResponseCompound and cannot be null");
            }
