...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatedocumentpageResponseCompound : IValidatableObject
    {
        ...
        public EzsigntemplatedocumentpageResponseCompound(int pkiEzsigntemplatedocumentpageID = default, int iEzsigntemplatedocumentpageWidthimage = default, int iEzsigntemplatedocumentpageHeightimage = default, int iEzsigntemplatedocumentpageWidthpdf = default, int iEzsigntemplatedocumentpageHeightpdf = default, int iEzsigntemplatedocumentpagePagenumber = default, string sComputedImageurl = default)
        {
