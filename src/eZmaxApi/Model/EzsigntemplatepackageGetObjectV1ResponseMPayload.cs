...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsigntemplatepackageGetObjectV1ResponseMPayload :  IEquatable<EzsigntemplatepackageGetObjectV1ResponseMPayload>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatepackageGetObjectV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplatepackageGetObjectV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatepackageGetObjectV1ResponseMPayload" /> class.
        /// </summary>
        ...
        public EzsigntemplatepackageGetObjectV1ResponseMPayload(int pkiEzsigntemplatepackageID = default(int), int fkiEzsignfoldertypeID = default(int), int fkiLanguageID = default(int), string sLanguageNameX = default(string), string sEzsigntemplatepackageDescription = default(string), bool bEzsigntemplatepackageAdminonly = default(bool), bool bEzsigntemplatepackageNeedvalidation = default(bool), bool bEzsigntemplatepackageIsactive = default(bool), string sEzsignfoldertypeNameX = default(string), List<EzsigntemplatepackagesignerResponseCompound> aObjEzsigntemplatepackagesigner = default(List<EzsigntemplatepackagesignerResponseCompound>), List<EzsigntemplatepackagemembershipResponseCompound> aObjEzsigntemplatepackagemembership = default(List<EzsigntemplatepackagemembershipResponseCompound>))
        {
            ...
            {
                throw new InvalidDataException("fkiEzsignfoldertypeID is a required property for EzsigntemplatepackageGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("fkiLanguageID is a required property for EzsigntemplatepackageGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sLanguageNameX is a required property for EzsigntemplatepackageGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sEzsigntemplatepackageDescription is a required property for EzsigntemplatepackageGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("bEzsigntemplatepackageAdminonly is a required property for EzsigntemplatepackageGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("bEzsigntemplatepackageNeedvalidation is a required property for EzsigntemplatepackageGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("bEzsigntemplatepackageIsactive is a required property for EzsigntemplatepackageGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sEzsignfoldertypeNameX is a required property for EzsigntemplatepackageGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("aObjEzsigntemplatepackagesigner is a required property for EzsigntemplatepackageGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("aObjEzsigntemplatepackagemembership is a required property for EzsigntemplatepackageGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EzsigntemplatepackageGetObjectV1ResponseMPayload);
        }

        /// <summary>
        /// Returns true if EzsigntemplatepackageGetObjectV1ResponseMPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of EzsigntemplatepackageGetObjectV1ResponseMPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EzsigntemplatepackageGetObjectV1ResponseMPayload input)
        {
            if (input == null)
                return false;
