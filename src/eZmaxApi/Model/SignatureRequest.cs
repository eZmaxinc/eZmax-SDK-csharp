...
namespace eZmaxApi.Model
{
    ...
    public partial class SignatureRequest : IValidatableObject
    {
        ...
        public SignatureRequest(int pkiSignatureID = default(int), int fkiFontID = default(int), FieldESignaturePreference eSignaturePreference = default(FieldESignaturePreference), string tSignatureSvg = default(string), string tSignatureSvginitials = default(string))
        {
