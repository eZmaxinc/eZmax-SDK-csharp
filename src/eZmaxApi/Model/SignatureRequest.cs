...
namespace eZmaxApi.Model
{
    ...
    public partial class SignatureRequest : IValidatableObject
    {
        ...
        public SignatureRequest(int pkiSignatureID = default, int fkiFontID = default, FieldESignaturePreference eSignaturePreference = default, string tSignatureSvg = default, string tSignatureSvginitials = default)
        {
