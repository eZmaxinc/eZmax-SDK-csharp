...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfoldersignerassociationCreateObjectV1ResponseMPayload : IValidatableObject
    {
        ...
        public EzsignfoldersignerassociationCreateObjectV1ResponseMPayload(List<int>  = default(List<int>))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignfoldersignerassociationCreateObjectV1ResponseMPayload and cannot be null");
            }
