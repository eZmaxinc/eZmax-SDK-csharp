...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignbulksenddocumentmappingRequestCompound : IValidatableObject
    {
        ...
        public EzsignbulksenddocumentmappingRequestCompound(int pkiEzsignbulksenddocumentmappingID = default, int fkiEzsignbulksendID = default, int fkiEzsigntemplatepackageID = default, int fkiEzsigntemplateID = default)
        {
