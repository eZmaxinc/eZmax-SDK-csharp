...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatedocumentpagerecognitionResponse : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="EzsigntemplatedocumentpagerecognitionResponse" /> class.
        /// </summary>
        /// <param name="">The unique ID of the Ezsigntemplatedocumentpagerecognition (required).</param>
        ...
        public EzsigntemplatedocumentpagerecognitionResponse(int  = default(int), int  = default(int), FieldEEzsigntemplatedocumentpagerecognitionOperator  = default(FieldEEzsigntemplatedocumentpagerecognitionOperator), FieldEEzsigntemplatedocumentpagerecognitionSection  = default(FieldEEzsigntemplatedocumentpagerecognitionSection), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), string  = default(string))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplatedocumentpagerecognitionResponse and cannot be null");
            }
