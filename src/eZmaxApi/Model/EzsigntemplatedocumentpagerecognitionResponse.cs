...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplatedocumentpagerecognition-Response")]
    public partial class EzsigntemplatedocumentpagerecognitionResponse : IValidatableObject
    {
        ...
        protected EzsigntemplatedocumentpagerecognitionResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatedocumentpagerecognitionResponse" /> class.
        /// </summary>
        ...
        public EzsigntemplatedocumentpagerecognitionResponse(int pkiEzsigntemplatedocumentpagerecognitionID = default, int fkiEzsigntemplatedocumentpageID = default, FieldEEzsigntemplatedocumentpagerecognitionOperator eEzsigntemplatedocumentpagerecognitionOperator = default, FieldEEzsigntemplatedocumentpagerecognitionSection eEzsigntemplatedocumentpagerecognitionSection = default, int iEzsigntemplatedocumentpagerecognitionSimilarpercentage = default, int iEzsigntemplatedocumentpagerecognitionX = default, int iEzsigntemplatedocumentpagerecognitionY = default, int iEzsigntemplatedocumentpagerecognitionWidth = default, int iEzsigntemplatedocumentpagerecognitionHeight = default, string tEzsigntemplatedocumentpagerecognitionText = default)
        {
            ...
            {
                throw new ArgumentNullException("tEzsigntemplatedocumentpagerecognitionText is a required property for EzsigntemplatedocumentpagerecognitionResponse and cannot be null");
            }
        ...
        <example>126</example>
        */
        [DataMember(Name = "pkiEzsigntemplatedocumentpagerecognitionID", IsRequired = true, EmitDefaultValue = true)]
