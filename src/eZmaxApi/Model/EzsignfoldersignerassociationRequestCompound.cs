...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfoldersignerassociationRequestCompound : IValidatableObject
    {
        ...
        public EzsignfoldersignerassociationRequestCompound(int pkiEzsignfoldersignerassociationID = default, int fkiUserID = default, int fkiEzsignsignergroupID = default, int fkiEzsignfolderID = default, bool bEzsignfoldersignerassociationReceivecopy = default, string tEzsignfoldersignerassociationMessage = default, EzsignsignerRequestCompound objEzsignsigner = default)
        {
