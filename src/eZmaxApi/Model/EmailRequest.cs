...
namespace eZmaxApi.Model
{
    ...
    public partial class EmailRequest : IValidatableObject
    {
        ...
        public EmailRequest(int  = default(int), int  = default(int), string  = default(string))
        {
            this.FkiEmailtypeID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EmailRequest and cannot be null");
            }
            this.SEmailAddress = ;
            this.PkiEmailID = ;
        }
