...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplate-copy-v1-Response")]
    public partial class EzsigntemplateCopyV1Response : IEquatable<EzsigntemplateCopyV1Response>, IValidatableObject
    {
        ...
        public EzsigntemplateCopyV1Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), EzsigntemplateCopyV1ResponseMPayload mPayload = default(EzsigntemplateCopyV1ResponseMPayload))
        {
            // to ensure "objDebugPayload" is required (not null)
            if (objDebugPayload == null)
            {
                throw new ArgumentNullException("objDebugPayload is a required property for EzsigntemplateCopyV1Response and cannot be null");
            }
            this.ObjDebugPayload = objDebugPayload;
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new ArgumentNullException("mPayload is a required property for EzsigntemplateCopyV1Response and cannot be null");
            }
