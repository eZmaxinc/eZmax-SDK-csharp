...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomAutocompleteElementDisabledResponse :  IEquatable<CustomAutocompleteElementDisabledResponse>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="CustomAutocompleteElementDisabledResponse" /> class.
        /// </summary>
        /// <param name="bDisabled">bDisabled (required).</param>
        ...
        public CustomAutocompleteElementDisabledResponse(bool bDisabled = default(bool), string sCategory = default(string), string sLabel = default(string), string sValue = default(string), string mValue = default(string))
        {
