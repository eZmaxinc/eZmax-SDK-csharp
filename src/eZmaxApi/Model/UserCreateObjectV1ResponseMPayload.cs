...
namespace eZmaxApi.Model
{
    ...
    public partial class UserCreateObjectV1ResponseMPayload : IValidatableObject
    {
        ...
        public UserCreateObjectV1ResponseMPayload(List<int>  = default(List<int>))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for UserCreateObjectV1ResponseMPayload and cannot be null");
            }
            this.APkiUserID = ;
        }
