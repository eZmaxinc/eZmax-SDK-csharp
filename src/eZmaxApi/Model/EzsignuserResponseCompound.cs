...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignuserResponseCompound : IValidatableObject
    {
        ...
        public EzsignuserResponseCompound(int pkiEzsignuserID = default, int fkiContactID = default, ContactResponseCompound objContact = default, CommonAudit objAudit = default)
        {
