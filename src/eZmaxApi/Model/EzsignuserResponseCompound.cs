...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignuserResponseCompound : IValidatableObject
    {
        ...
        /// <param name=""> (required).</param>
        public EzsignuserResponseCompound(int  = default(int), int  = default(int), ContactResponseCompound  = default(ContactResponseCompound), CommonAudit  = default(CommonAudit))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignuserResponseCompound and cannot be null");
            }
            this.ObjContact = ;
            // to ensure "" is required (not null)
            if ( == null)
