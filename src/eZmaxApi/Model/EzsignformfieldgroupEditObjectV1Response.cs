...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignformfieldgroup-editObject-v1-Response")]
    public partial class EzsignformfieldgroupEditObjectV1Response : IEquatable<EzsignformfieldgroupEditObjectV1Response>, IValidatableObject
    {
        ...
        public EzsignformfieldgroupEditObjectV1Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug))
        {
            ...
            {
                throw new ArgumentNullException("objDebugPayload is a required property for EzsignformfieldgroupEditObjectV1Response and cannot be null");
            }
