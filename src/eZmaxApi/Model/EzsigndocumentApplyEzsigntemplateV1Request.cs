...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigndocumentApplyEzsigntemplateV1Request : IValidatableObject
    {
        ...
        public EzsigndocumentApplyEzsigntemplateV1Request(int fkiEzsigntemplateID = default, List<string> aSEzsigntemplatesigner = default, List<int> aPkiEzsignfoldersignerassociationID = default)
        {
