...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatepublicListElement : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="EzsigntemplatepublicListElement" /> class.
        /// </summary>
        /// <param name="">The unique ID of the Ezsigntemplatepublic (required).</param>
        ...
        /// <param name="">The limitexceeded of the Ezsigntemplatepublic (required).</param>
        /// <param name="">The limitexceededsince of the Ezsigntemplatepublic (required).</param>
        /// <param name="">The total number of Ezsignfolders using the Ezsigntemplatepublic (required).</param>
        /// <param name="">The total number of Ezsigndocuments using the Ezsigntemplatepublic (required).</param>
        /// <param name="">The Ezsigntemplate/Ezsigntemplatepackage description (required).</param>
        public EzsigntemplatepublicListElement(int  = default(int), int  = default(int), string  = default(string), int  = default(int), int  = default(int), int  = default(int), string  = default(string), bool  = default(bool), string  = default(string), FieldEEzsigntemplatepublicLimittype  = default(FieldEEzsigntemplatepublicLimittype), int  = default(int), int  = default(int), string  = default(string), int  = default(int), int  = default(int), string  = default(string))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplatepublicListElement and cannot be null");
            }
            ...
            this.IEzsigntemplatepublicLimitexceeded = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplatepublicListElement and cannot be null");
            ...
            this.SEzsigntemplatepublicEzsigntemplatedescription = ;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for IEzsigntemplatepublicLimitexceeded, must be a value less than or equal to 65535.", new [] { "IEzsigntemplatepublicLimitexceeded" });
            }

            // IEzsigntemplatepublicLimitexceeded (int) minimum
            if (this.IEzsigntemplatepublicLimitexceeded < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for IEzsigntemplatepublicLimitexceeded, must be a value greater than or equal to 0.", new [] { "IEzsigntemplatepublicLimitexceeded" });
            }
