...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatepublicListElement : IValidatableObject
    {
        ...
        public EzsigntemplatepublicListElement(int pkiEzsigntemplatepublicID = default, int fkiEzsignfoldertypeID = default, string sEzsignfoldertypeNameX = default, int fkiUserlogintypeID = default, int fkiEzsigntemplateID = default, int fkiEzsigntemplatepackageID = default, string sEzsigntemplatepublicDescription = default, bool bEzsigntemplatepublicIsactive = default, string tEzsigntemplatepublicNote = default, FieldEEzsigntemplatepublicLimittype eEzsigntemplatepublicLimittype = default, int iEzsigntemplatepublicLimit = default, int iEzsigntemplatepublicLimitexceeded = default, string dtEzsigntemplatepublicLimitexceededsince = default, int iEzsignfolder = default, int iEzsigndocument = default, string sEzsigntemplatepublicEzsigntemplatedescription = default)
        {
