...
namespace eZmaxApi.Model
{
    ...
    public partial class EzmaxinvoicingsummaryexternalResponseCompound : IValidatableObject
    {
        ...
        public EzmaxinvoicingsummaryexternalResponseCompound(int pkiEzmaxinvoicingsummaryexternalID = default, int fkiEzmaxinvoicingID = default, int fkiBillingentityexternalID = default, string sBillingentityexternalDescription = default, string sEzmaxinvoicingsummaryexternalDescription = default, List<EzmaxinvoicingsummaryexternaldetailResponseCompound> aObjEzmaxinvoicingsummaryexternaldetail = default)
        {
