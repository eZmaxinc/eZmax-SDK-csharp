...
namespace eZmaxApi.Model
{
    ...
    public partial class CountryAutocompleteElementResponse : IValidatableObject
    {
        ...
        public CountryAutocompleteElementResponse(int pkiCountryID = default, string sCountryNameX = default, string sCountryShortname = default, bool bCountryIsactive = default)
        {
