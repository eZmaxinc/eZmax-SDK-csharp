...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatepublicGetEzsigntemplatepublicDetailsV1Request : IValidatableObject
    {
        ...
        public EzsigntemplatepublicGetEzsigntemplatepublicDetailsV1Request(string pksEzmaxcustomerCode = default, string sEzsigntemplatepublicReferenceid = default)
        {
