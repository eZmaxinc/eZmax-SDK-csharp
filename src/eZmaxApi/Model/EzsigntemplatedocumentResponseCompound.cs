...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatedocumentResponseCompound :  IEquatable<EzsigntemplatedocumentResponseCompound>, IValidatableObject
    {
        ...
        public EzsigntemplatedocumentResponseCompound(int pkiEzsigntemplatedocumentID = default(int), int fkiEzsigntemplateID = default(int), string sEzsigntemplatedocumentName = default(string), int iEzsigntemplatedocumentPagetotal = default(int), int iEzsigntemplatedocumentSignaturetotal = default(int))
        {
