...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatedocumentResponseCompound : IValidatableObject
    {
        ...
        public EzsigntemplatedocumentResponseCompound(int pkiEzsigntemplatedocumentID = default, int fkiEzsigntemplateID = default, string sEzsigntemplatedocumentName = default, int iEzsigntemplatedocumentPagetotal = default, int iEzsigntemplatedocumentSignaturetotal = default, int iEzsigntemplatedocumentFormfieldtotal = default, bool bEzsigntemplatedocumentHassignedsignatures = default)
        {
