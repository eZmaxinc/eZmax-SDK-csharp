...
namespace eZmaxApi.Model
{
    ...
    public partial class VariableexpenseResponseCompound : IValidatableObject
    {
        ...
        public VariableexpenseResponseCompound(int pkiVariableexpenseID = default, string sVariableexpenseCode = default, MultilingualVariableexpenseDescription objVariableexpenseDescription = default, FieldEVariableexpenseTaxable? eVariableexpenseTaxable = default, bool bVariableexpenseIsactive = default)
        {
