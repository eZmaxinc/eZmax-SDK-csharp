...
namespace eZmaxApi.Model
{
    ...
    public partial class DiscussionmembershipRequestCompound : IValidatableObject
    {
        ...
        public DiscussionmembershipRequestCompound(int pkiDiscussionmembershipID = default, int fkiDiscussionID = default, int fkiUserID = default, int fkiUsergroupID = default, int fkiModulesectionID = default, string dtDiscussionmembershipJoined = default)
        {
