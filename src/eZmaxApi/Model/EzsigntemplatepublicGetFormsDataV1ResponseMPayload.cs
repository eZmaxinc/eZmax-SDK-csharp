...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplatepublic-getFormsData-v1-Response-mPayload")]
    public partial class EzsigntemplatepublicGetFormsDataV1ResponseMPayload : IValidatableObject
    {
        ...
        protected EzsigntemplatepublicGetFormsDataV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatepublicGetFormsDataV1ResponseMPayload" /> class.
        /// </summary>
        /// <param name="aObjFormsDataFolder">aObjFormsDataFolder (required).</param>
        public EzsigntemplatepublicGetFormsDataV1ResponseMPayload(List<CustomFormsDataFolderResponse> aObjFormsDataFolder = default)
        {
