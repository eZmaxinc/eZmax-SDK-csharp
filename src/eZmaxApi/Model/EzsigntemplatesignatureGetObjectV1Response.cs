...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsigntemplatesignatureGetObjectV1Response :  IEquatable<EzsigntemplatesignatureGetObjectV1Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatesignatureGetObjectV1Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplatesignatureGetObjectV1Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatesignatureGetObjectV1Response" /> class.
        /// </summary>
        ...
        public EzsigntemplatesignatureGetObjectV1Response(EzsigntemplatesignatureGetObjectV1ResponseMPayload mPayload = default(EzsigntemplatesignatureGetObjectV1ResponseMPayload), CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug))
        {
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new InvalidDataException("mPayload is a required property for EzsigntemplatesignatureGetObjectV1Response and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EzsigntemplatesignatureGetObjectV1Response {\n");
        ...
        {
            return this.Equals(input as EzsigntemplatesignatureGetObjectV1Response);
        }

        /// <summary>
        /// Returns true if EzsigntemplatesignatureGetObjectV1Response instances are equal
        /// </summary>
        /// <param name="input">Instance of EzsigntemplatesignatureGetObjectV1Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EzsigntemplatesignatureGetObjectV1Response input)
        {
            if (input == null)
                return false;
