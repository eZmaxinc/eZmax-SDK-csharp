...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomNotificationsubsectiongetnotificationtestsResponse : IValidatableObject
    {
        ...
        public CustomNotificationsubsectiongetnotificationtestsResponse(int pkiNotificationsubsectionID = default, int fkiNotificationsectionID = default, MultilingualNotificationsubsectionName objNotificationsubsectionName = default, string sNotificationsectionNameX = default, string sNotificationsubsectionNameX = default, List<CustomNotificationtestgetnotificationtestsResponse> aObjNotificationtest = default)
        {
