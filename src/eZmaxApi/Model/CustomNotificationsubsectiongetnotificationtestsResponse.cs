...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomNotificationsubsectiongetnotificationtestsResponse :  IEquatable<CustomNotificationsubsectiongetnotificationtestsResponse>, IValidatableObject
    {
        ...
        public CustomNotificationsubsectiongetnotificationtestsResponse(int pkiNotificationsubsectionID = default(int), int fkiNotificationsectionID = default(int), string sNotificationsubsectionNameX = default(string), List<CustomNotificationtestgetnotificationtestsResponse> aObjNotificationtest = default(List<CustomNotificationtestgetnotificationtestsResponse>))
        {
