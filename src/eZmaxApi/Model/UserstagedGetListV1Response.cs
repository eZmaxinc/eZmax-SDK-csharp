...
namespace eZmaxApi.Model
{
    ...
    public partial class UserstagedGetListV1Response : IValidatableObject
    {
        ...
        public UserstagedGetListV1Response(CommonResponseObjDebugPayloadGetList objDebugPayload = default, CommonResponseObjDebug objDebug = default, UserstagedGetListV1ResponseMPayload mPayload = default)
        {
            // to ensure "objDebugPayload" is required (not null)
            if (objDebugPayload == null)
            {
                throw new ArgumentNullException("objDebugPayload is a required property for UserstagedGetListV1Response and cannot be null");
            }
