...
namespace eZmaxApi.Model
{
    ...
    public partial class UserstagedGetListV1Response : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        /// <param name=""> (required).</param>
        public UserstagedGetListV1Response(CommonResponseObjDebugPayloadGetList  = default(CommonResponseObjDebugPayloadGetList), CommonResponseObjDebug  = default(CommonResponseObjDebug), UserstagedGetListV1ResponseMPayload  = default(UserstagedGetListV1ResponseMPayload))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for UserstagedGetListV1Response and cannot be null");
            }
