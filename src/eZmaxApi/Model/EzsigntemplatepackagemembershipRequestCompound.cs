...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatepackagemembershipRequestCompound : IValidatableObject
    {
        ...
        public EzsigntemplatepackagemembershipRequestCompound(int pkiEzsigntemplatepackagemembershipID = default, int fkiEzsigntemplatepackageID = default, int fkiEzsigntemplateID = default)
        {
