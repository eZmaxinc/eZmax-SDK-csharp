...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplateglobalsignerResponseCompound : IValidatableObject
    {
        ...
        public EzsigntemplateglobalsignerResponseCompound(int pkiEzsigntemplateglobalsignerID = default, int fkiEzsigntemplateglobalID = default, string sEzsigntemplateglobalsignerDescription = default)
        {
