...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignerResponse :  IEquatable<EzsignsignerResponse>, IValidatableObject
    {
        ...
        public EzsignsignerResponse(int fkiTaxassignmentID = default(int), int fkiSecretquestionID = default(int), EEzsignsignerLogintypeEnum eEzsignsignerLogintype = default(EEzsignsignerLogintypeEnum), string sEzsignsignerSecretanswer = default(string))
        {
            ...
            {
                throw new InvalidDataException("eEzsignsignerLogintype is a required property for EzsignsignerResponse and cannot be null");
            }
            else
            {
