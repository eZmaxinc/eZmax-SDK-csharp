...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignerResponse : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="EzsignsignerResponse" /> class.
        /// </summary>
        /// <param name="">The unique ID of the Ezsignsigner (required).</param>
        ...
        public EzsignsignerResponse(int  = default(int), int  = default(int), int  = default(int), int  = default(int), string  = default(string))
        {
            this.PkiEzsignsignerID = ;
            this.FkiTaxassignmentID = ;
            this.FkiUserlogintypeID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignsignerResponse and cannot be null");
            }
