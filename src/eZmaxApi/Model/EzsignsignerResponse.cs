...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignsigner-Response")]
    public partial class EzsignsignerResponse : IEquatable<EzsignsignerResponse>, IValidatableObject
    {
        ...
        public EzsignsignerResponse(int pkiEzsignsignerID = default(int), int fkiTaxassignmentID = default(int), int fkiSecretquestionID = default(int), int fkiUserlogintypeID = default(int), string sUserlogintypeDescriptionX = default(string))
        {
            ...
            {
                throw new ArgumentNullException("sUserlogintypeDescriptionX is a required property for EzsignsignerResponse and cannot be null");
            }
