...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignerResponse : IValidatableObject
    {
        ...
        public EzsignsignerResponse(int pkiEzsignsignerID = default, int fkiTaxassignmentID = default, int fkiSecretquestionID = default, int fkiUserlogintypeID = default, string sUserlogintypeDescriptionX = default)
        {
