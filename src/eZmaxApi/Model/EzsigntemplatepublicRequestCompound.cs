...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatepublicRequestCompound : IValidatableObject
    {
        ...
        public EzsigntemplatepublicRequestCompound(int pkiEzsigntemplatepublicID = default(int), int fkiEzsignfoldertypeID = default(int), int fkiUserlogintypeID = default(int), int fkiEzsigntemplateID = default(int), int fkiEzsigntemplatepackageID = default(int), string sEzsigntemplatepublicDescription = default(string), bool bEzsigntemplatepublicIsactive = default(bool), string tEzsigntemplatepublicNote = default(string), FieldEEzsigntemplatepublicLimittype eEzsigntemplatepublicLimittype = default(FieldEEzsigntemplatepublicLimittype), int iEzsigntemplatepublicLimit = default(int))
        {
            ...
            {
                throw new ArgumentNullException("sEzsigntemplatepublicDescription is a required property for EzsigntemplatepublicRequestCompound and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("tEzsigntemplatepublicNote is a required property for EzsigntemplatepublicRequestCompound and cannot be null");
            }
