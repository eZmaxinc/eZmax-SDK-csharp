...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatepublicRequestCompound : IValidatableObject
    {
        ...
        public EzsigntemplatepublicRequestCompound(int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), string  = default(string), bool  = default(bool), string  = default(string), FieldEEzsigntemplatepublicLimittype  = default(FieldEEzsigntemplatepublicLimittype), int  = default(int))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplatepublicRequestCompound and cannot be null");
            }
