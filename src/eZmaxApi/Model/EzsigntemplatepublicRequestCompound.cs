...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatepublicRequestCompound : IValidatableObject
    {
        ...
        public EzsigntemplatepublicRequestCompound(int pkiEzsigntemplatepublicID = default, int fkiEzsignfoldertypeID = default, int fkiUserlogintypeID = default, int fkiEzsigntemplateID = default, int fkiEzsigntemplatepackageID = default, string sEzsigntemplatepublicDescription = default, bool bEzsigntemplatepublicIsactive = default, string tEzsigntemplatepublicNote = default, FieldEEzsigntemplatepublicLimittype eEzsigntemplatepublicLimittype = default, int iEzsigntemplatepublicLimit = default)
        {
