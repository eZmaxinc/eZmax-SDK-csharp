...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "variableexpense-Request")]
    public partial class VariableexpenseRequest : IEquatable<VariableexpenseRequest>, IValidatableObject
    {
        ...
        public VariableexpenseRequest(int pkiVariableexpenseID = default(int), string sVariableexpenseCode = default(string), MultilingualVariableexpenseDescription objVariableexpenseDescription = default(MultilingualVariableexpenseDescription), FieldEVariableexpenseTaxable eVariableexpenseTaxable = default(FieldEVariableexpenseTaxable), bool bVariableexpenseIsactive = default(bool))
        {
            ...
            {
                throw new ArgumentNullException("sVariableexpenseCode is a required property for VariableexpenseRequest and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("objVariableexpenseDescription is a required property for VariableexpenseRequest and cannot be null");
            }
