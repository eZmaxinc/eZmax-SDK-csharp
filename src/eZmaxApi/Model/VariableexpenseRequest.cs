...
namespace eZmaxApi.Model
{
    ...
    public partial class VariableexpenseRequest : IValidatableObject
    {
        ...
        public VariableexpenseRequest(int pkiVariableexpenseID = default, string sVariableexpenseCode = default, MultilingualVariableexpenseDescription objVariableexpenseDescription = default, FieldEVariableexpenseTaxable eVariableexpenseTaxable = default, bool bVariableexpenseIsactive = default)
        {
