...
namespace eZmaxApi.Model
{
    ...
    public partial class VariableexpenseRequest : IValidatableObject
    {
        ...
        public VariableexpenseRequest(int  = default(int), string  = default(string), MultilingualVariableexpenseDescription  = default(MultilingualVariableexpenseDescription), FieldEVariableexpenseTaxable  = default(FieldEVariableexpenseTaxable), bool  = default(bool))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for VariableexpenseRequest and cannot be null");
            }
