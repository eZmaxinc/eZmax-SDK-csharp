...
namespace eZmaxApi.Model
{
    ...
    public partial class CommonResponseErrorTooManyRequests : CommonResponseError, IValidatableObject
    {
        /// <summary>
        ...
        public CommonResponseErrorTooManyRequests(string sErrorMessage = default(string), FieldEErrorCode eErrorCode = default(FieldEErrorCode), List<string> aSErrorMessagedetail = default(List<string>)) : base()
        {
        }
