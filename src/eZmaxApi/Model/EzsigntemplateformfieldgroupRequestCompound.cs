...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplateformfieldgroupRequestCompound : IValidatableObject
    {
        ...
        public EzsigntemplateformfieldgroupRequestCompound(int pkiEzsigntemplateformfieldgroupID = default, int fkiEzsigntemplatedocumentID = default, FieldEEzsigntemplateformfieldgroupType eEzsigntemplateformfieldgroupType = default, FieldEEzsigntemplateformfieldgroupSignerrequirement? eEzsigntemplateformfieldgroupSignerrequirement = default, string sEzsigntemplateformfieldgroupLabel = default, int iEzsigntemplateformfieldgroupStep = default, string sEzsigntemplateformfieldgroupDefaultvalue = default, int iEzsigntemplateformfieldgroupFilledmin = default, int iEzsigntemplateformfieldgroupFilledmax = default, bool bEzsigntemplateformfieldgroupReadonly = default, int iEzsigntemplateformfieldgroupMaxlength = default, bool bEzsigntemplateformfieldgroupEncrypted = default, string sEzsigntemplateformfieldgroupRegexp = default, string sEzsigntemplateformfieldgroupTextvalidationcustommessage = default, EnumTextvalidation? eEzsigntemplateformfieldgroupTextvalidation = default, string tEzsigntemplateformfieldgroupTooltip = default, FieldEEzsigntemplateformfieldgroupTooltipposition? eEzsigntemplateformfieldgroupTooltipposition = default, List<EzsigntemplateformfieldgroupsignerRequestCompound> aObjEzsigntemplateformfieldgroupsigner = default, List<CustomDropdownElementRequestCompound> aObjDropdownElement = default, List<EzsigntemplateformfieldRequestCompound> aObjEzsigntemplateformfield = default)
        {
            ...
            {
                throw new ArgumentNullException("sEzsigntemplateformfieldgroupLabel is a required property for EzsigntemplateformfieldgroupRequestCompound and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sEzsigntemplateformfieldgroupDefaultvalue is a required property for EzsigntemplateformfieldgroupRequestCompound and cannot be null");
            }
