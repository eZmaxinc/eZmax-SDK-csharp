...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplateformfieldgroupRequestCompound : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        /// <param name=""> (required).</param>
        public EzsigntemplateformfieldgroupRequestCompound(int  = default(int), int  = default(int), FieldEEzsigntemplateformfieldgroupType  = default(FieldEEzsigntemplateformfieldgroupType), FieldEEzsigntemplateformfieldgroupSignerrequirement?  = default(FieldEEzsigntemplateformfieldgroupSignerrequirement?), string  = default(string), int  = default(int), string  = default(string), int  = default(int), int  = default(int), bool  = default(bool), int  = default(int), bool  = default(bool), string  = default(string), string  = default(string), EnumTextvalidation?  = default(EnumTextvalidation?), string  = default(string), FieldEEzsigntemplateformfieldgroupTooltipposition?  = default(FieldEEzsigntemplateformfieldgroupTooltipposition?), List<EzsigntemplateformfieldgroupsignerRequestCompound>  = default(List<EzsigntemplateformfieldgroupsignerRequestCompound>), List<CustomDropdownElementRequestCompound>  = default(List<CustomDropdownElementRequestCompound>), List<EzsigntemplateformfieldRequestCompound>  = default(List<EzsigntemplateformfieldRequestCompound>))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplateformfieldgroupRequestCompound and cannot be null");
            }
            ...
            this.AObjEzsigntemplateformfieldgroupsigner = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplateformfieldgroupRequestCompound and cannot be null");
            }
            this.AObjEzsigntemplateformfield = ;
