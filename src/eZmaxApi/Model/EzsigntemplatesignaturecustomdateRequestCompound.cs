...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatesignaturecustomdateRequestCompound : IValidatableObject
    {
        ...
        public EzsigntemplatesignaturecustomdateRequestCompound(int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), string  = default(string))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplatesignaturecustomdateRequestCompound and cannot be null");
            }
