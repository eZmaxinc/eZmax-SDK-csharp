...
getter                              : 
setter                              : 
dataType                            : EzsigntemplatesignaturecustomdateRequest
datatypeWithEnum                    : 
name                                : ezsigntemplatesignaturecustomdate-RequestCompound
defaultValue                        : 
...
*/
    ...
    /// </summary>
    [DataContract]
    public partial class EzsigntemplatesignaturecustomdateRequestCompound :  IEquatable<EzsigntemplatesignaturecustomdateRequestCompound>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatesignaturecustomdateRequestCompound" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplatesignaturecustomdateRequestCompound() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatesignaturecustomdateRequestCompound" /> class.
        /// </summary>
        ...
        public EzsigntemplatesignaturecustomdateRequestCompound(int pkiEzsigntemplatesignaturecustomdateID = default(int), int iEzsigntemplatesignaturecustomdateX = default(int), int iEzsigntemplatesignaturecustomdateY = default(int), string sEzsigntemplatesignaturecustomdateFormat = default(string))
        {
            // to ensure "iEzsigntemplatesignaturecustomdateX" is required (not null)
            if (iEzsigntemplatesignaturecustomdateX == null)
            {
                throw new InvalidDataException("iEzsigntemplatesignaturecustomdateX is a required property for EzsigntemplatesignaturecustomdateRequestCompound and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iEzsigntemplatesignaturecustomdateY is a required property for EzsigntemplatesignaturecustomdateRequestCompound and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sEzsigntemplatesignaturecustomdateFormat is a required property for EzsigntemplatesignaturecustomdateRequestCompound and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EzsigntemplatesignaturecustomdateRequestCompound);
        }

        /// <summary>
        /// Returns true if EzsigntemplatesignaturecustomdateRequestCompound instances are equal
        /// </summary>
        /// <param name="input">Instance of EzsigntemplatesignaturecustomdateRequestCompound to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EzsigntemplatesignaturecustomdateRequestCompound input)
        {
            if (input == null)
                return false;
