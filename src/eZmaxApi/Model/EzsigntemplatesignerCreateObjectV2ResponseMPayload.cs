...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplatesigner-createObject-v2-Response-mPayload")]
    public partial class EzsigntemplatesignerCreateObjectV2ResponseMPayload : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatesignerCreateObjectV2ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplatesignerCreateObjectV2ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatesignerCreateObjectV2ResponseMPayload" /> class.
        /// </summary>
        ...
        public EzsigntemplatesignerCreateObjectV2ResponseMPayload(List<int> aPkiEzsigntemplatesignerID = default, bool bEzsigntemplatepackageNeedvalidation = default, bool bEzsignbulksendNeedvalidation = default)
        {
            // to ensure "aPkiEzsigntemplatesignerID" is required (not null)
            if (aPkiEzsigntemplatesignerID == null)
            {
                throw new ArgumentNullException("aPkiEzsigntemplatesignerID is a required property for EzsigntemplatesignerCreateObjectV2ResponseMPayload and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EzsigntemplatesignerCreateObjectV2ResponseMPayload {\n");
