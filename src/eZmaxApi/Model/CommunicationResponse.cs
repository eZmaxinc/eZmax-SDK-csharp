...
namespace eZmaxApi.Model
{
    ...
    public partial class CommunicationResponse :  IEquatable<CommunicationResponse>, IValidatableObject
    {
        ...
        public CommunicationResponse(int pkiCommunicationID = default(int), FieldECommunicationEmailimportance? eCommunicationEmailimportance = default(FieldECommunicationEmailimportance?), FieldECommunicationType eCommunicationType = default(FieldECommunicationType), string sCommunicationSubject = default(string), string dtCommunicationSentdate = default(string), CustomContactNameResponse objContactFrom = default(CustomContactNameResponse))
        {
            ...
            {
                throw new InvalidDataException("dtCommunicationSentdate is a required property for CommunicationResponse and cannot be null");
            }
            else
            {
