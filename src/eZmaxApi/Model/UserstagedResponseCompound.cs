...
namespace eZmaxApi.Model
{
    ...
    public partial class UserstagedResponseCompound : IValidatableObject
    {
        ...
        public UserstagedResponseCompound(int pkiUserstagedID = default, int fkiEmailID = default, string sEmailAddress = default, string sUserstagedFirstname = default, string sUserstagedLastname = default, string sUserstagedExternalid = default)
        {
