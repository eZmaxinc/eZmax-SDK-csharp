...
namespace eZmaxApi.Model
{
    ...
    public partial class TextstylestaticResponseCompound : IValidatableObject
    {
        ...
        public TextstylestaticResponseCompound(int  = default(int), int  = default(int), string  = default(string), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), int  = default(int), int  = default(int))
        {
            this.FkiFontID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for TextstylestaticResponseCompound and cannot be null");
            }
            this.SFontName = ;
