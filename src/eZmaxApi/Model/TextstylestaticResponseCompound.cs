...
namespace eZmaxApi.Model
{
    ...
    public partial class TextstylestaticResponseCompound : IValidatableObject
    {
        ...
        public TextstylestaticResponseCompound(int pkiTextstylestaticID = default, int fkiFontID = default, string sFontName = default, bool bTextstylestaticBold = default, bool bTextstylestaticUnderline = default, bool bTextstylestaticItalic = default, bool bTextstylestaticStrikethrough = default, int iTextstylestaticFontcolor = default, int iTextstylestaticSize = default)
        {
