...
namespace eZmaxApi.Model
{
    ...
    public partial class FranchiseofficeAutocompleteElementResponse : IValidatableObject
    {
        ...
        public FranchiseofficeAutocompleteElementResponse(string sFranchiseofficeDescription = default, int pkiFranchiseofficeID = default, bool bFranchiseofficeIsactive = default)
        {
