...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "creditcardmerchant-Response")]
    public partial class CreditcardmerchantResponse : IValidatableObject
    {
        ...
        protected CreditcardmerchantResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreditcardmerchantResponse" /> class.
        /// </summary>
        ...
        public CreditcardmerchantResponse(int pkiCreditcardmerchantID = default, int fkiBankaccountID = default, int fkiLanguageID = default, string sLanguageNameX = default, int fkiCurrencyID = default, string sCurrencyDescriptionX = default, string sBankaccountBankname = default, bool bCreditcardmerchantDenyvisa = default, bool bCreditcardmerchantDenymastercard = default, bool bCreditcardmerchantDenyamex = default, bool bCreditcardmerchantIsactive = default, string sCreditcardmerchantDescription = default, string sCreditcardmerchantStoreid = default)
        {
            ...
            {
                throw new ArgumentNullException("sLanguageNameX is a required property for CreditcardmerchantResponse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sCurrencyDescriptionX is a required property for CreditcardmerchantResponse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sCreditcardmerchantDescription is a required property for CreditcardmerchantResponse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sCreditcardmerchantStoreid is a required property for CreditcardmerchantResponse and cannot be null");
            }
