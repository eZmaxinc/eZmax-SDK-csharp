...
namespace eZmaxApi.Model
{
    ...
    public partial class ContactResponse : IValidatableObject
    {
        ...
        public ContactResponse(int pkiContactID = default, int fkiLanguageID = default, int fkiContacttitleID = default, int fkiContactinformationsID = default, string dtContactBirthdate = default, FieldEContactType eContactType = default, string sContactFirstname = default, string sContactLastname = default, string sContactCompany = default, string sContactOccupation = default, string tContactNote = default, bool bContactIsactive = default, ContactinformationsResponseCompound objContactinformations = default)
        {
            ...
            {
                throw new ArgumentNullException("sContactFirstname is a required property for ContactResponse and cannot be null");
            }
            this.SContactFirstname = sContactFirstname;
            // to ensure "sContactLastname" is required (not null)
            if (sContactLastname == null)
            {
                throw new ArgumentNullException("sContactLastname is a required property for ContactResponse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("objContactinformations is a required property for ContactResponse and cannot be null");
            }
