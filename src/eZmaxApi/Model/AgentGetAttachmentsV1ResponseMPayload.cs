...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "agent-getAttachments-v1-Response-mPayload")]
    public partial class AgentGetAttachmentsV1ResponseMPayload : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentGetAttachmentsV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AgentGetAttachmentsV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentGetAttachmentsV1ResponseMPayload" /> class.
        /// </summary>
        /// <param name="aObjAttachmentdocumenttype">aObjAttachmentdocumenttype (required).</param>
        public AgentGetAttachmentsV1ResponseMPayload(List<CustomAttachmentdocumenttypeResponse> aObjAttachmentdocumenttype = default)
        {
            // to ensure "aObjAttachmentdocumenttype" is required (not null)
            if (aObjAttachmentdocumenttype == null)
            {
                throw new ArgumentNullException("aObjAttachmentdocumenttype is a required property for AgentGetAttachmentsV1ResponseMPayload and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AgentGetAttachmentsV1ResponseMPayload {\n");
