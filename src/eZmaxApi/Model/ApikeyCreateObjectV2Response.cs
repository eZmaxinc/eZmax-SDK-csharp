...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApikeyCreateObjectV2Response :  IEquatable<ApikeyCreateObjectV2Response>
    {
        /// <summary>
        ...
        public ApikeyCreateObjectV2Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), ApikeyCreateObjectV2ResponseMPayload mPayload = default(ApikeyCreateObjectV2ResponseMPayload))
        {
            // to ensure "objDebugPayload" is required (not null)
            if (objDebugPayload == null)
            {
                throw new InvalidDataException("objDebugPayload is a required property for ApikeyCreateObjectV2Response and cannot be null");
            }
            else
            {
