...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "apikey-createObject-v2-Response")]
    public partial class ApikeyCreateObjectV2Response : IEquatable<ApikeyCreateObjectV2Response>, IValidatableObject
    {
        ...
        public ApikeyCreateObjectV2Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), ApikeyCreateObjectV2ResponseMPayload mPayload = default(ApikeyCreateObjectV2ResponseMPayload))
        {
            ...
            {
                throw new ArgumentNullException("objDebugPayload is a required property for ApikeyCreateObjectV2Response and cannot be null");
            }
            this.ObjDebugPayload = objDebugPayload;
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new ArgumentNullException("mPayload is a required property for ApikeyCreateObjectV2Response and cannot be null");
            }
