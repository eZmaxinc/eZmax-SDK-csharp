...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfolderRequest : IValidatableObject
    {
        ...
        public EzsignfolderRequest(int pkiEzsignfolderID = default(int), int fkiEzsignfoldertypeID = default(int), int fkiTimezoneID = default(int), int fkiEzsigntsarequirementID = default(int), string sEzsignfolderDescription = default(string), string tEzsignfolderNote = default(string), FieldEEzsignfolderSendreminderfrequency eEzsignfolderSendreminderfrequency = default(FieldEEzsignfolderSendreminderfrequency), string sEzsignfolderExternalid = default(string))
        {
