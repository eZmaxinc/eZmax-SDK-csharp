...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignaturecustomdateResponseV2 : IValidatableObject
    {
        ...
        public EzsignsignaturecustomdateResponseV2(int  = default(int), int  = default(int), int  = default(int), string  = default(string))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignsignaturecustomdateResponseV2 and cannot be null");
            }
