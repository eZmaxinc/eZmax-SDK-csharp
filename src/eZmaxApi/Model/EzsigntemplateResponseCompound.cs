...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplateResponseCompound : IValidatableObject
    {
        ...
        /// <param name="">The filename pattern of the Ezsigntemplate.</param>
        ...
        public EzsigntemplateResponseCompound(int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), string  = default(string), string  = default(string), string  = default(string), string  = default(string), string  = default(string), bool  = default(bool), string  = default(string), CommonAudit  = default(CommonAudit), bool  = default(bool), FieldEEzsigntemplateType?  = default(FieldEEzsigntemplateType?), EzsigntemplatedocumentResponse  = default(EzsigntemplatedocumentResponse), List<EzsigntemplatesignerResponseCompound>  = default(List<EzsigntemplatesignerResponseCompound>))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplateResponseCompound and cannot be null");
            }
            this.SLanguageNameX = ;
            // to ensure "" is required (not null)
            if ( == null)
