...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplateResponseCompound : IValidatableObject
    {
        ...
        public EzsigntemplateResponseCompound(int pkiEzsigntemplateID = default, int fkiEzsigntemplatedocumentID = default, int fkiEzsignfoldertypeID = default, int fkiLanguageID = default, int fkiEzdoctemplatedocumentID = default, string sLanguageNameX = default, string sEzsigntemplateDescription = default, string sEzsigntemplateExternaldescription = default, string tEzsigntemplateComment = default, string sEzsigntemplateFilenamepattern = default, bool bEzsigntemplateAdminonly = default, string sEzsignfoldertypeNameX = default, CommonAudit objAudit = default, bool bEzsigntemplateEditallowed = default, FieldEEzsigntemplateType? eEzsigntemplateType = default, EzsigntemplatedocumentResponse objEzsigntemplatedocument = default, List<EzsigntemplatesignerResponseCompound> aObjEzsigntemplatesigner = default)
        {
