...
namespace eZmaxApi.Model
{
    ...
    public partial class AttemptResponseCompound : IValidatableObject
    {
        ...
        public AttemptResponseCompound(string  = default(string), string  = default(string), int  = default(int))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for AttemptResponseCompound and cannot be null");
            }
            this.DtAttemptStart = ;
            // to ensure "" is required (not null)
            if ( == null)
