...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntsarequirementAutocompleteElementResponse : IValidatableObject
    {
        ...
        public EzsigntsarequirementAutocompleteElementResponse(string sEzsigntsarequirementDescriptionX = default, int pkiEzsigntsarequirementID = default, bool bEzsigntsarequirementIsactive = default, bool bDisabled = default)
        {
