...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsignformfieldgroupGetObjectV1Response :  IEquatable<EzsignformfieldgroupGetObjectV1Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignformfieldgroupGetObjectV1Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsignformfieldgroupGetObjectV1Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignformfieldgroupGetObjectV1Response" /> class.
        /// </summary>
        ...
        public EzsignformfieldgroupGetObjectV1Response(EzsignformfieldgroupGetObjectV1ResponseMPayload mPayload = default(EzsignformfieldgroupGetObjectV1ResponseMPayload), CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug))
        {
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new InvalidDataException("mPayload is a required property for EzsignformfieldgroupGetObjectV1Response and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EzsignformfieldgroupGetObjectV1Response);
        }

        /// <summary>
        /// Returns true if EzsignformfieldgroupGetObjectV1Response instances are equal
        /// </summary>
        /// <param name="input">Instance of EzsignformfieldgroupGetObjectV1Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EzsignformfieldgroupGetObjectV1Response input)
        {
            if (input == null)
                return false;
