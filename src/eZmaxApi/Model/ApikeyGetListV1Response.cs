...
namespace eZmaxApi.Model
{
    ...
    public partial class ApikeyGetListV1Response : IEquatable<ApikeyGetListV1Response>, IValidatableObject
    {
        ...
        public ApikeyGetListV1Response(CommonResponseObjDebugPayloadGetList objDebugPayload = default(CommonResponseObjDebugPayloadGetList), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), ApikeyGetListV1ResponseMPayload mPayload = default(ApikeyGetListV1ResponseMPayload))
        {
            // to ensure "objDebugPayload" is required (not null)
            if (objDebugPayload == null)
            {
                throw new ArgumentNullException("objDebugPayload is a required property for ApikeyGetListV1Response and cannot be null");
            }
            this.ObjDebugPayload = objDebugPayload;
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new ArgumentNullException("mPayload is a required property for ApikeyGetListV1Response and cannot be null");
            }
