...
namespace eZmaxApi.Model
{
    ...
    public partial class UsergroupResponse : IValidatableObject
    {
        ...
        public UsergroupResponse(int pkiUsergroupID = default, MultilingualUsergroupName objUsergroupName = default, string sUsergroupNameX = default, EmailRequest objEmail = default)
        {
