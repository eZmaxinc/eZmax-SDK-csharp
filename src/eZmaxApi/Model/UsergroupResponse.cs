...
*/
    ...
    public partial class UsergroupResponse :  IEquatable<UsergroupResponse>, IValidatableObject
    {
        ...
        public UsergroupResponse(int pkiUsergroupID = default(int), MultilingualUsergroupName objUsergroupName = default(MultilingualUsergroupName))
        {
            ...
            {
                throw new InvalidDataException("pkiUsergroupID is a required property for UsergroupResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("objUsergroupName is a required property for UsergroupResponse and cannot be null");
            }
            else
            {
