...
namespace eZmaxApi.Model
{
    ...
    public partial class InscriptionGetCommunicationCountV1Response : IValidatableObject
    {
        ...
        protected InscriptionGetCommunicationCountV1Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InscriptionGetCommunicationCountV1Response" /> class.
        /// </summary>
        ...
        /// <param name="">.</param>
        /// <param name=""> (required).</param>
        public InscriptionGetCommunicationCountV1Response(CommonResponseObjDebugPayload  = default(CommonResponseObjDebugPayload), CommonResponseObjDebug  = default(CommonResponseObjDebug), InscriptionGetCommunicationCountV1ResponseMPayload  = default(InscriptionGetCommunicationCountV1ResponseMPayload))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for InscriptionGetCommunicationCountV1Response and cannot be null");
            }
