...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignbulksendRequestCompound : IValidatableObject
    {
        ...
        public EzsignbulksendRequestCompound(int  = default(int), int  = default(int), int  = default(int), string  = default(string), string  = default(string), bool  = default(bool), bool  = default(bool))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignbulksendRequestCompound and cannot be null");
            }
