...
namespace eZmaxApi.Model
{
    ...
    public partial class SupplyRequestCompound : IValidatableObject
    {
        ...
        public SupplyRequestCompound(int  = default(int), int  = default(int), int  = default(int), int  = default(int), string  = default(string), MultilingualSupplyDescription  = default(MultilingualSupplyDescription), string  = default(string), bool  = default(bool), bool  = default(bool))
        {
            this.FkiVariableexpenseID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for SupplyRequestCompound and cannot be null");
            }
            this.SSupplyCode = ;
            // to ensure "" is required (not null)
            if ( == null)
