...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplateglobal-getObject-v2-Response-mPayload")]
    public partial class EzsigntemplateglobalGetObjectV2ResponseMPayload : IValidatableObject
    {
        ...
        protected EzsigntemplateglobalGetObjectV2ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplateglobalGetObjectV2ResponseMPayload" /> class.
        /// </summary>
        /// <param name="objEzsigntemplateglobal">objEzsigntemplateglobal (required).</param>
        public EzsigntemplateglobalGetObjectV2ResponseMPayload(EzsigntemplateglobalResponseCompound objEzsigntemplateglobal = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "objEzsigntemplateglobal", IsRequired = true, EmitDefaultValue = true)]
