...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigndocumentGetObjectV1Response : IValidatableObject
    {
        ...
        public EzsigndocumentGetObjectV1Response(CommonResponseObjDebugPayload objDebugPayload = default, CommonResponseObjDebug objDebug = default, EzsigndocumentGetObjectV1ResponseMPayload mPayload = default)
        {
            // to ensure "objDebugPayload" is required (not null)
            if (objDebugPayload == null)
            {
                throw new ArgumentNullException("objDebugPayload is a required property for EzsigndocumentGetObjectV1Response and cannot be null");
            }
            this.ObjDebugPayload = objDebugPayload;
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new ArgumentNullException("mPayload is a required property for EzsigndocumentGetObjectV1Response and cannot be null");
            }
