...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignannotationRequestCompound : IValidatableObject
    {
        ...
        public EzsignannotationRequestCompound(int pkiEzsignannotationID = default, int fkiEzsigndocumentID = default, EnumHorizontalalignment? eEzsignannotationHorizontalalignment = default, EnumVerticalalignment? eEzsignannotationVerticalalignment = default, FieldEEzsignannotationType eEzsignannotationType = default, int iEzsignannotationX = default, int iEzsignannotationY = default, int iEzsignannotationWidth = default, int iEzsignannotationHeight = default, string sEzsignannotationText = default, int iEzsignpagePagenumber = default, TextstylestaticRequestCompound objTextstylestatic = default)
        {
