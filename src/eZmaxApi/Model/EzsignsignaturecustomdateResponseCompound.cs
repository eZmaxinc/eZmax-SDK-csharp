...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignaturecustomdateResponseCompound : IEquatable<EzsignsignaturecustomdateResponseCompound>, IValidatableObject
    {
		...
		/* <example>200</example>*/
        [DataMember(Name = "iEzsignsignaturecustomdateX", IsRequired = true, EmitDefaultValue = true)]
		...
		/* <example>300</example>*/
        [DataMember(Name = "iEzsignsignaturecustomdateY", IsRequired = true, EmitDefaultValue = true)]
