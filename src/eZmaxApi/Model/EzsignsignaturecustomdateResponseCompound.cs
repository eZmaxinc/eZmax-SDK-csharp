...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignaturecustomdateResponseCompound : IValidatableObject
    {
        ...
        public EzsignsignaturecustomdateResponseCompound(int pkiEzsignsignaturecustomdateID = default(int), int iEzsignsignaturecustomdateX = default(int), int iEzsignsignaturecustomdateY = default(int), int iEzsignsignaturecustomdateOffsetx = default(int), int iEzsignsignaturecustomdateOffsety = default(int), string sEzsignsignaturecustomdateFormat = default(string))
        {
            ...
            {
                throw new ArgumentNullException("sEzsignsignaturecustomdateFormat is a required property for EzsignsignaturecustomdateResponseCompound and cannot be null");
            }
