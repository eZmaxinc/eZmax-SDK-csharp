...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignaturecustomdateResponseCompound : IValidatableObject
    {
        ...
        public EzsignsignaturecustomdateResponseCompound(int pkiEzsignsignaturecustomdateID = default, int iEzsignsignaturecustomdateX = default, int iEzsignsignaturecustomdateY = default, int iEzsignsignaturecustomdateOffsetx = default, int iEzsignsignaturecustomdateOffsety = default, string sEzsignsignaturecustomdateFormat = default)
        {
