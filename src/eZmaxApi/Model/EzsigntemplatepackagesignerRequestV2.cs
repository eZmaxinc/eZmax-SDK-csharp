...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplatepackagesigner-RequestV2")]
    public partial class EzsigntemplatepackagesignerRequestV2 : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatepackagesignerRequestV2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplatepackagesignerRequestV2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatepackagesignerRequestV2" /> class.
        /// </summary>
        ...
        public EzsigntemplatepackagesignerRequestV2(int pkiEzsigntemplatepackagesignerID = default, int fkiEzsigntemplatepackageID = default, int fkiEzdoctemplatedocumentID = default, int fkiUserID = default, int fkiUsergroupID = default, FieldEEzsigntemplatepackagesignerRole? eEzsigntemplatepackagesignerRole = default, FieldEEzsigntemplatepackagesignerMapping? eEzsigntemplatepackagesignerMapping = default, string sEzsigntemplatepackagesignerDescription = default)
        {
            ...
            {
                throw new ArgumentNullException("sEzsigntemplatepackagesignerDescription is a required property for EzsigntemplatepackagesignerRequestV2 and cannot be null");
            }
