...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigndocumentApplyEzsigntemplateglobalV1Request : IValidatableObject
    {
        ...
        public EzsigndocumentApplyEzsigntemplateglobalV1Request(int fkiEzsigntemplateglobalID = default, List<string> aSEzsigntemplateglobalsigner = default, List<int> aPkiEzsignfoldersignerassociationID = default)
        {
