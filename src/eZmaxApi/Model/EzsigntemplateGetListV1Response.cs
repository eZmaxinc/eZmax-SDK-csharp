...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplateGetListV1Response : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        /// <param name=""> (required).</param>
        public EzsigntemplateGetListV1Response(CommonResponseObjDebugPayloadGetList  = default(CommonResponseObjDebugPayloadGetList), CommonResponseObjDebug  = default(CommonResponseObjDebug), EzsigntemplateGetListV1ResponseMPayload  = default(EzsigntemplateGetListV1ResponseMPayload))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplateGetListV1Response and cannot be null");
            }
