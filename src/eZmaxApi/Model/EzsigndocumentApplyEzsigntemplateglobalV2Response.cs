...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigndocument-applyEzsigntemplateglobal-v2-Response")]
    public partial class EzsigndocumentApplyEzsigntemplateglobalV2Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigndocumentApplyEzsigntemplateglobalV2Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigndocumentApplyEzsigntemplateglobalV2Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigndocumentApplyEzsigntemplateglobalV2Response" /> class.
        /// </summary>
        ...
        public EzsigndocumentApplyEzsigntemplateglobalV2Response(CommonResponseObjDebugPayload objDebugPayload = default, CommonResponseObjDebug objDebug = default, List<CommonResponseWarning> aObjWarning = default)
        {
            // to ensure "objDebugPayload" is required (not null)
            if (objDebugPayload == null)
            {
                throw new ArgumentNullException("objDebugPayload is a required property for EzsigndocumentApplyEzsigntemplateglobalV2Response and cannot be null");
            }
