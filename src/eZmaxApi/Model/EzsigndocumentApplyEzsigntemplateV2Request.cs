...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigndocumentApplyEzsigntemplateV2Request : IValidatableObject
    {
        ...
        public EzsigndocumentApplyEzsigntemplateV2Request(int fkiEzsigntemplateID = default, List<string> aSEzsigntemplatesigner = default, List<int> aPkiEzsignfoldersignerassociationID = default)
        {
