...
namespace eZmaxApi.Model
{
    ...
    /// A Contact Object
    /// </summary>
    [DataContract(Name = "contact-RequestV2")]
    public partial class ContactRequestV2 : IValidatableObject
    {
        ...
        public ContactRequestV2(int fkiContacttitleID = default, int fkiLanguageID = default, FieldEContactType eContactType = default, string sContactFirstname = default, string sContactLastname = default, string sContactCompany = default, string dtContactBirthdate = default, string sContactOccupation = default, string tContactNote = default, bool bContactIsactive = default, ContactinformationsRequestCompound objContactinformations = default)
        {
            ...
            {
                throw new ArgumentNullException("sContactFirstname is a required property for ContactRequestV2 and cannot be null");
            }
            this.SContactFirstname = sContactFirstname;
            // to ensure "sContactLastname" is required (not null)
            if (sContactLastname == null)
            {
                throw new ArgumentNullException("sContactLastname is a required property for ContactRequestV2 and cannot be null");
            }
            this.SContactLastname = sContactLastname;
            // to ensure "objContactinformations" is required (not null)
            if (objContactinformations == null)
            {
                throw new ArgumentNullException("objContactinformations is a required property for ContactRequestV2 and cannot be null");
            }
        ...
        */
        [DataMember(Name = "bContactIsactive", EmitDefaultValue = true)]
