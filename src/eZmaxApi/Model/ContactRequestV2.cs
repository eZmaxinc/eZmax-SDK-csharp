...
namespace eZmaxApi.Model
{
    ...
    public partial class ContactRequestV2 : IValidatableObject
    {
        ...
        /// <param name="">Whether the contact is active or not.</param>
        /// <param name=""> (required).</param>
        public ContactRequestV2(int  = default(int), int  = default(int), FieldEContactType  = default(FieldEContactType), string  = default(string), string  = default(string), string  = default(string), string  = default(string), string  = default(string), string  = default(string), bool  = default(bool), ContactinformationsRequestCompound  = default(ContactinformationsRequestCompound))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for ContactRequestV2 and cannot be null");
            }
