...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfolderResponseCompound : IValidatableObject
    {
        ...
        public EzsignfolderResponseCompound(int pkiEzsignfolderID = default, int fkiEzsignfoldertypeID = default, CustomEzsignfoldertypeResponse objEzsignfoldertype = default, int fkiTimezoneID = default, FieldEEzsignfolderCompletion eEzsignfolderCompletion = default, string sEzsignfoldertypeNameX = default, int fkiBillingentityinternalID = default, string sBillingentityinternalDescriptionX = default, int fkiEzsigntsarequirementID = default, string sEzsigntsarequirementDescriptionX = default, string sEzsignfolderDescription = default, string tEzsignfolderNote = default, bool bEzsignfolderIsdisposable = default, FieldEEzsignfolderSendreminderfrequency? eEzsignfolderSendreminderfrequency = default, int iEzsignfolderSendreminderfirstdays = default, int iEzsignfolderSendreminderotherdays = default, string dtEzsignfolderDelayedsenddate = default, string dtEzsignfolderDuedate = default, string dtEzsignfolderSentdate = default, string dtEzsignfolderScheduledarchive = default, string dtEzsignfolderScheduleddispose = default, FieldEEzsignfolderStep? eEzsignfolderStep = default, FieldEEzsignfolderMessageorder? eEzsignfolderMessageorder = default, string dtEzsignfolderClose = default, string tEzsignfolderMessage = default, CommonAudit objAudit = default, string sEzsignfolderExternalid = default, CustomTimezoneWithCodeResponse objTimezone = default)
        {
            ...
            {
                throw new ArgumentNullException("sEzsignfolderDescription is a required property for EzsignfolderResponseCompound and cannot be null");
            }
