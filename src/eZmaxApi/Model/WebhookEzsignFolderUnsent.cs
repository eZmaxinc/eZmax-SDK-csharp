...
namespace eZmaxApi.Model
{
    ...
    public partial class WebhookEzsignFolderUnsent : IValidatableObject
    {
        ...
        /// <param name=""> (required).</param>
        public WebhookEzsignFolderUnsent(CustomWebhookResponse  = default(CustomWebhookResponse), List<AttemptResponseCompound>  = default(List<AttemptResponseCompound>), EzsignfolderResponse  = default(EzsignfolderResponse))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for WebhookEzsignFolderUnsent and cannot be null");
            }
            this.ObjWebhook = ;
            // to ensure "" is required (not null)
            if ( == null)
