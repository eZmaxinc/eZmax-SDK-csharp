...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Webhook-Ezsign-FolderUnsent")]
    public partial class WebhookEzsignFolderUnsent : IValidatableObject
    {
        ...
        protected WebhookEzsignFolderUnsent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEzsignFolderUnsent" /> class.
        /// </summary>
        ...
        public WebhookEzsignFolderUnsent(CustomWebhookResponse objWebhook = default(CustomWebhookResponse), List<AttemptResponseCompound> aObjAttempt = default(List<AttemptResponseCompound>), EzsignfolderResponse objEzsignfolder = default(EzsignfolderResponse))
        {
            // to ensure "objWebhook" is required (not null)
            if (objWebhook == null)
            {
                throw new ArgumentNullException("objWebhook is a required property for WebhookEzsignFolderUnsent and cannot be null");
            }
            this.ObjWebhook = objWebhook;
            // to ensure "aObjAttempt" is required (not null)
            if (aObjAttempt == null)
            {
                throw new ArgumentNullException("aObjAttempt is a required property for WebhookEzsignFolderUnsent and cannot be null");
            }
            this.AObjAttempt = aObjAttempt;
            // to ensure "objEzsignfolder" is required (not null)
            if (objEzsignfolder == null)
            {
                throw new ArgumentNullException("objEzsignfolder is a required property for WebhookEzsignFolderUnsent and cannot be null");
            }
