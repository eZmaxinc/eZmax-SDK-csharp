...
namespace eZmaxApi.Model
{
    ...
    public partial class SupplyListElement : IValidatableObject
    {
        ...
        public SupplyListElement(int pkiSupplyID = default, int fkiGlaccountID = default, int fkiGlaccountcontainerID = default, int fkiVariableexpenseID = default, string sSupplyCode = default, string sSupplyDescriptionX = default, string dSupplyUnitprice = default, bool bSupplyIsactive = default, bool bSupplyVariableprice = default, string sGlaccountDescriptionX = default, string sGlaccountcontainerLongdescriptionX = default, string sVariableexpenseDescriptionX = default)
        {
            ...
            if (sSupplyCode == null)
            {
                throw new ArgumentNullException("sSupplyCode is a required property for SupplyListElement and cannot be null");
            }
            this.SSupplyCode = sSupplyCode;
            // to ensure "sSupplyDescriptionX" is required (not null)
            if (sSupplyDescriptionX == null)
            {
                throw new ArgumentNullException("sSupplyDescriptionX is a required property for SupplyListElement and cannot be null");
            }
            this.SSupplyDescriptionX = sSupplyDescriptionX;
            // to ensure "dSupplyUnitprice" is required (not null)
            if (dSupplyUnitprice == null)
            {
                throw new ArgumentNullException("dSupplyUnitprice is a required property for SupplyListElement and cannot be null");
            }
