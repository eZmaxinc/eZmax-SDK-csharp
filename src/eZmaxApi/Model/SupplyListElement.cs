...
namespace eZmaxApi.Model
{
    ...
    public partial class SupplyListElement : IValidatableObject
    {
        ...
        public SupplyListElement(int pkiSupplyID = default(int), int fkiGlaccountID = default(int), int fkiGlaccountcontainerID = default(int), int fkiVariableexpenseID = default(int), string sSupplyCode = default(string), string sSupplyDescriptionX = default(string), string dSupplyUnitprice = default(string), bool bSupplyIsactive = default(bool), bool bSupplyVariableprice = default(bool), string sGlaccountDescriptionX = default(string), string sGlaccountcontainerLongdescriptionX = default(string), string sVariableexpenseDescriptionX = default(string))
        {
