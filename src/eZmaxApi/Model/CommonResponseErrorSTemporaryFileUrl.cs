...
namespace eZmaxApi.Model
{
    ...
    public partial class CommonResponseErrorSTemporaryFileUrl : IValidatableObject
    {
        ...
        public CommonResponseErrorSTemporaryFileUrl(string sErrorMessage = default, FieldEErrorCode eErrorCode = default, List<string> aSErrorMessagedetail = default, string sTemporaryFileUrl = default)
        {
