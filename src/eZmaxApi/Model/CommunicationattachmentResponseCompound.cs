...
namespace eZmaxApi.Model
{
    ...
    public partial class CommunicationattachmentResponseCompound :  IEquatable<CommunicationattachmentResponseCompound>, IValidatableObject
    {
        ...
        public CommunicationattachmentResponseCompound(int pkiCommunicationattachmentID = default(int), int fkiAttachmentID = default(int), int fkiInvoiceID = default(int), int fkiSalarypreparationID = default(int), string sCommunicationattachmentName = default(string))
        {
