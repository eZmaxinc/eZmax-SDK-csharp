...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigndocument-getTemporaryProof-v1-Response-mPayload")]
    public partial class EzsigndocumentGetTemporaryProofV1ResponseMPayload : IValidatableObject
    {
        ...
        public EzsigndocumentGetTemporaryProofV1ResponseMPayload(List<EzsigndocumentlogResponseCompound> aObjEzsigndocumentlog = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "a_objEzsigndocumentlog", IsRequired = true, EmitDefaultValue = true)]
