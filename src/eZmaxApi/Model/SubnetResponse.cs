...
namespace eZmaxApi.Model
{
    ...
    public partial class SubnetResponse :  IEquatable<SubnetResponse>, IValidatableObject
    {
        ...
        public SubnetResponse(int pkiSubnetID = default(int), int fkiUserID = default(int), int fkiApikeyID = default(int), MultilingualSubnetDescription objSubnetDescription = default(MultilingualSubnetDescription), int iSubnetNetwork = default(int), int iSubnetMask = default(int))
        {
