...
namespace eZmaxApi.Model
{
    ...
    public partial class SubnetResponse : IValidatableObject
    {
        ...
        public SubnetResponse(int pkiSubnetID = default, int fkiUserID = default, int fkiApikeyID = default, MultilingualSubnetDescription objSubnetDescription = default, long iSubnetNetwork = default, long iSubnetMask = default)
        {
