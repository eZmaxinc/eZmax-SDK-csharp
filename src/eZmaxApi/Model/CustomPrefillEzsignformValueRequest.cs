...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomPrefillEzsignformValueRequest : IValidatableObject
    {
        ...
        public CustomPrefillEzsignformValueRequest(string sEzsignformfieldgroupLabel = default(string), string sEzsignformfieldLabel = default(string), string sEzsignformfieldEnteredvalue = default(string), bool bEzsignformfieldSelected = default(bool))
        {
