...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignsignergroup-Response")]
    public partial class EzsignsignergroupResponse : IValidatableObject
    {
        ...
        public EzsignsignergroupResponse(int pkiEzsignsignergroupID = default, MultilingualEzsignsignergroupDescription objEzsignsignergroupDescription = default, string sEzsignsignergroupDescriptionX = default)
        {
            ...
            {
                throw new ArgumentNullException("objEzsignsignergroupDescription is a required property for EzsignsignergroupResponse and cannot be null");
            }
