...
namespace eZmaxApi.Model
{
    ...
    public partial class UserCreateEzsignuserV1Request : IValidatableObject
    {
        ...
        public UserCreateEzsignuserV1Request(int fkiLanguageID = default, string sUserFirstname = default, string sUserLastname = default, string sEmailAddress = default, string sPhoneRegion = default, string sPhoneExchange = default, string sPhoneNumber = default, string sPhoneExtension = default)
        {
