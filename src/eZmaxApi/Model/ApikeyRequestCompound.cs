...
namespace eZmaxApi.Model
{
    ...
    public partial class ApikeyRequestCompound : IValidatableObject
    {
        ...
        public ApikeyRequestCompound(int  = default(int), int  = default(int), MultilingualApikeyDescription  = default(MultilingualApikeyDescription), bool  = default(bool), bool  = default(bool))
        {
            this.FkiUserID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for ApikeyRequestCompound and cannot be null");
            }
