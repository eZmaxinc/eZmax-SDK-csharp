...
namespace eZmaxApi.Model
{
    ...
    public partial class ApikeyRequestCompound : IValidatableObject
    {
        ...
        public ApikeyRequestCompound(int pkiApikeyID = default, int fkiUserID = default, MultilingualApikeyDescription objApikeyDescription = default, bool bApikeyIsactive = default, bool bApikeyIssigned = default)
        {
