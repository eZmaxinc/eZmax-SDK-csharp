...
namespace eZmaxApi.Model
{
    ...
    public partial class ApikeyRequestCompound :  IEquatable<ApikeyRequestCompound>, IValidatableObject
    {
        ...
        public ApikeyRequestCompound(int pkiApikeyID = default(int), int fkiUserID = default(int), MultilingualApikeyDescription objApikeyDescription = default(MultilingualApikeyDescription))
        {
