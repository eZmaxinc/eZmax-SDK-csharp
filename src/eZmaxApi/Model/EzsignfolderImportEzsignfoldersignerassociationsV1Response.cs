...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsignfolderImportEzsignfoldersignerassociationsV1Response :  IEquatable<EzsignfolderImportEzsignfoldersignerassociationsV1Response>
    {
        /// <summary>
        ...
        public EzsignfolderImportEzsignfoldersignerassociationsV1Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), EzsignfolderImportEzsignfoldersignerassociationsV1ResponseMPayload mPayload = default(EzsignfolderImportEzsignfoldersignerassociationsV1ResponseMPayload))
        {
            // to ensure "objDebugPayload" is required (not null)
            if (objDebugPayload == null)
            {
                throw new InvalidDataException("objDebugPayload is a required property for EzsignfolderImportEzsignfoldersignerassociationsV1Response and cannot be null");
            }
            else
            {
