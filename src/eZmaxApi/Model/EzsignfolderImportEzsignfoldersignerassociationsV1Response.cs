...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfolderImportEzsignfoldersignerassociationsV1Response : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        /// <param name=""> (required).</param>
        public EzsignfolderImportEzsignfoldersignerassociationsV1Response(CommonResponseObjDebugPayload  = default(CommonResponseObjDebugPayload), CommonResponseObjDebug  = default(CommonResponseObjDebug), EzsignfolderImportEzsignfoldersignerassociationsV1ResponseMPayload  = default(EzsignfolderImportEzsignfoldersignerassociationsV1ResponseMPayload))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignfolderImportEzsignfoldersignerassociationsV1Response and cannot be null");
            }
