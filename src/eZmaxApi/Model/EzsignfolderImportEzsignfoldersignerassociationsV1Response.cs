...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignfolder-importEzsignfoldersignerassociations-v1-Response")]
    public partial class EzsignfolderImportEzsignfoldersignerassociationsV1Response : IEquatable<EzsignfolderImportEzsignfoldersignerassociationsV1Response>, IValidatableObject
    {
        ...
        public EzsignfolderImportEzsignfoldersignerassociationsV1Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), EzsignfolderImportEzsignfoldersignerassociationsV1ResponseMPayload mPayload = default(EzsignfolderImportEzsignfoldersignerassociationsV1ResponseMPayload))
        {
            ...
            {
                throw new ArgumentNullException("objDebugPayload is a required property for EzsignfolderImportEzsignfoldersignerassociationsV1Response and cannot be null");
            }
            this.ObjDebugPayload = objDebugPayload;
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new ArgumentNullException("mPayload is a required property for EzsignfolderImportEzsignfoldersignerassociationsV1Response and cannot be null");
            }
