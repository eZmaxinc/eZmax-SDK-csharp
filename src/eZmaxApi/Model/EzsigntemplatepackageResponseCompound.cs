...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatepackageResponseCompound : IValidatableObject
    {
        ...
        public EzsigntemplatepackageResponseCompound(int pkiEzsigntemplatepackageID = default, int fkiEzsignfoldertypeID = default, int fkiEzdoctemplatedocumentID = default, int fkiLanguageID = default, string sEzdoctemplatedocumentNameX = default, string sLanguageNameX = default, string sEzsigntemplatepackageDescription = default, bool bEzsigntemplatepackageAdminonly = default, bool bEzsigntemplatepackageNeedvalidation = default, bool bEzsigntemplatepackageIsactive = default, string sEzsignfoldertypeNameX = default, bool bEzsigntemplatepackageEditallowed = default, List<EzsigntemplatepackagesignerResponseCompound> aObjEzsigntemplatepackagesigner = default, List<EzsigntemplatepackagemembershipResponseCompound> aObjEzsigntemplatepackagemembership = default)
        {
            ...
            {
                throw new ArgumentNullException("sLanguageNameX is a required property for EzsigntemplatepackageResponseCompound and cannot be null");
            }
            this.SLanguageNameX = sLanguageNameX;
            // to ensure "sEzsigntemplatepackageDescription" is required (not null)
            if (sEzsigntemplatepackageDescription == null)
            {
                throw new ArgumentNullException("sEzsigntemplatepackageDescription is a required property for EzsigntemplatepackageResponseCompound and cannot be null");
            }
