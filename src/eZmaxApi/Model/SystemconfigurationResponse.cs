...
namespace eZmaxApi.Model
{
    ...
    public partial class SystemconfigurationResponse : IValidatableObject
    {
        ...
        public SystemconfigurationResponse(int pkiSystemconfigurationID = default, int fkiSystemconfigurationtypeID = default, int fkiBrandingID = default, int fkiTimezoneIDDefault = default, string sTimezoneNameDefault = default, string sSystemconfigurationtypeDescriptionX = default, FieldESystemconfigurationNewexternaluseraction eSystemconfigurationNewexternaluseraction = default, FieldESystemconfigurationLanguage1 eSystemconfigurationLanguage1 = default, FieldESystemconfigurationLanguage2 eSystemconfigurationLanguage2 = default, FieldESystemconfigurationEzsign? eSystemconfigurationEzsign = default, FieldESystemconfigurationEzsignofficeplan? eSystemconfigurationEzsignofficeplan = default, bool bSystemconfigurationEzsignpaidbyoffice = default, bool bSystemconfigurationEzsignpersonnal = default, bool bSystemconfigurationHascreditcardmerchant = default, bool bSystemconfigurationIsdisposalactive = default, bool bSystemconfigurationAllowcomplexcreditcardsignature = default, bool bSystemconfigurationSspr = default, string dtSystemconfigurationReadonlyexpirationstart = default, string dtSystemconfigurationReadonlyexpirationend = default, CustomBrandingResponse objBranding = default, int iSystemconfigurationEzsignreminderhoursend = default)
        {
            ...
            {
                throw new ArgumentNullException("sTimezoneNameDefault is a required property for SystemconfigurationResponse and cannot be null");
            }
        ...
        */
        ...
        [DataMember(Name = "bSystemconfigurationAllowcomplexcreditcardsignature", EmitDefaultValue = true)]
        public bool BSystemconfigurationAllowcomplexcreditcardsignature { get; set; }
