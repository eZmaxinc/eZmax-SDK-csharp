...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsigntemplatepackagesignermembershipGetObjectV1ResponseMPayload :  IEquatable<EzsigntemplatepackagesignermembershipGetObjectV1ResponseMPayload>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatepackagesignermembershipGetObjectV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplatepackagesignermembershipGetObjectV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatepackagesignermembershipGetObjectV1ResponseMPayload" /> class.
        /// </summary>
        ...
        public EzsigntemplatepackagesignermembershipGetObjectV1ResponseMPayload(int pkiEzsigntemplatepackagesignermembershipID = default(int), int fkiEzsigntemplatepackagemembershipID = default(int), int fkiEzsigntemplatepackagesignerID = default(int), int fkiEzsigntemplatesignerID = default(int), int iEzsigntemplatepackagesignermembershipCopy = default(int))
        {
            ...
            {
                throw new InvalidDataException("pkiEzsigntemplatepackagesignermembershipID is a required property for EzsigntemplatepackagesignermembershipGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("fkiEzsigntemplatepackagemembershipID is a required property for EzsigntemplatepackagesignermembershipGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("fkiEzsigntemplatepackagesignerID is a required property for EzsigntemplatepackagesignermembershipGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("fkiEzsigntemplatesignerID is a required property for EzsigntemplatepackagesignermembershipGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EzsigntemplatepackagesignermembershipGetObjectV1ResponseMPayload);
        }

        /// <summary>
        /// Returns true if EzsigntemplatepackagesignermembershipGetObjectV1ResponseMPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of EzsigntemplatepackagesignermembershipGetObjectV1ResponseMPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EzsigntemplatepackagesignermembershipGetObjectV1ResponseMPayload input)
        {
            if (input == null)
                return false;
