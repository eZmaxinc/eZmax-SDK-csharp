...
namespace eZmaxApi.Model
{
    ...
    public partial class CreditcarddetailRequest : IValidatableObject
    {
        ...
        public CreditcarddetailRequest(int iCreditcarddetailExpirationmonth = default, int iCreditcarddetailExpirationyear = default, string sCreditcarddetailCivic = default, string sCreditcarddetailStreet = default, string sCreditcarddetailZip = default)
        {
