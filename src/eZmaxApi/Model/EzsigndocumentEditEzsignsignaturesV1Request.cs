...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigndocumentEditEzsignsignaturesV1Request : IValidatableObject
    {
        ...
        public EzsigndocumentEditEzsignsignaturesV1Request(List<EzsignsignatureRequestCompound>  = default(List<EzsignsignatureRequestCompound>))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigndocumentEditEzsignsignaturesV1Request and cannot be null");
            }
