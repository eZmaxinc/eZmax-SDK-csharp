...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignbulksendsignermappingResponseCompound : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="EzsignbulksendsignermappingResponseCompound" /> class.
        /// </summary>
        /// <param name="">The unique ID of the Ezsignbulksendsignermapping (required).</param>
        ...
        public EzsignbulksendsignermappingResponseCompound(int  = default(int), int  = default(int), int  = default(int), string  = default(string))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignbulksendsignermappingResponseCompound and cannot be null");
            }
