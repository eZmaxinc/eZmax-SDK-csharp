...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignbulksendsignermappingResponseCompound : IValidatableObject
    {
        ...
        public EzsignbulksendsignermappingResponseCompound(int pkiEzsignbulksendsignermappingID = default, int fkiEzsignbulksendID = default, int fkiUserID = default, bool bEzsignbulksendsignermappingReceivecopy = default, string sEzsignbulksendsignermappingDescription = default)
        {
