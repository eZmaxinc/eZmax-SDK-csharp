...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Custom-EzsigndocumentGetEzsignsignatures-Response")]
    public partial class CustomEzsigndocumentGetEzsignsignaturesResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomEzsigndocumentGetEzsignsignaturesResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CustomEzsigndocumentGetEzsignsignaturesResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomEzsigndocumentGetEzsignsignaturesResponse" /> class.
        /// </summary>
        ...
        public CustomEzsigndocumentGetEzsignsignaturesResponse(int pkiEzsigndocumentID = default, string sEzsigndocumentName = default, List<EzsignsignatureResponseCompound> aObjEzsignsignature = default)
        {
            this.PkiEzsigndocumentID = pkiEzsigndocumentID;
            // to ensure "sEzsigndocumentName" is required (not null)
            if (sEzsigndocumentName == null)
            {
                throw new ArgumentNullException("sEzsigndocumentName is a required property for CustomEzsigndocumentGetEzsignsignaturesResponse and cannot be null");
            }
            this.SEzsigndocumentName = sEzsigndocumentName;
            // to ensure "aObjEzsignsignature" is required (not null)
            if (aObjEzsignsignature == null)
            {
                throw new ArgumentNullException("aObjEzsignsignature is a required property for CustomEzsigndocumentGetEzsignsignaturesResponse and cannot be null");
            }
