...
namespace eZmaxApi.Model
{
    ...
    public partial class FranchisereferalincomeCreateObjectV2ResponseMPayload : IValidatableObject
    {
        ...
        public FranchisereferalincomeCreateObjectV2ResponseMPayload(List<int>  = default(List<int>))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for FranchisereferalincomeCreateObjectV2ResponseMPayload and cannot be null");
            }
            this.APkiFranchisereferalincomeID = ;
        }
