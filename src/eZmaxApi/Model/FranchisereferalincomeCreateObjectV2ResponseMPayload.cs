...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "franchisereferalincome-createObject-v2-Response-mPayload")]
    public partial class FranchisereferalincomeCreateObjectV2ResponseMPayload : IEquatable<FranchisereferalincomeCreateObjectV2ResponseMPayload>, IValidatableObject
    {
        ...
        public FranchisereferalincomeCreateObjectV2ResponseMPayload(List<int> aPkiFranchisereferalincomeID = default(List<int>))
        {
            ...
            {
                throw new ArgumentNullException("aPkiFranchisereferalincomeID is a required property for FranchisereferalincomeCreateObjectV2ResponseMPayload and cannot be null");
            }
        ...
        [DataMember(Name = "a_pkiFranchisereferalincomeID", IsRequired = true, EmitDefaultValue = true)]
