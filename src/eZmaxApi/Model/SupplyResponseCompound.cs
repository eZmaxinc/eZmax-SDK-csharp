...
namespace eZmaxApi.Model
{
    ...
    public partial class SupplyResponseCompound : IValidatableObject
    {
        ...
        public SupplyResponseCompound(int  = default(int), int  = default(int), int  = default(int), int  = default(int), string  = default(string), MultilingualSupplyDescription  = default(MultilingualSupplyDescription), string  = default(string), bool  = default(bool), bool  = default(bool), string  = default(string), string  = default(string), string  = default(string))
        {
            this.PkiSupplyID = ;
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for SupplyResponseCompound and cannot be null");
            }
            this.SSupplyCode = ;
            // to ensure "" is required (not null)
            if ( == null)
