...
namespace eZmaxApi.Model
{
    ...
    public partial class CommonResponseObjDebug : IValidatableObject
    {
        ...
        public CommonResponseObjDebug(string sMemoryUsage = default, string sRunTime = default, int iSQLSelects = default, int iSQLQueries = default, List<CommonResponseObjSQLQuery> aObjSQLQuery = default)
        {
