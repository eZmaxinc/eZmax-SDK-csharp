...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload :  IEquatable<EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload>
    {
        /// <summary>
        ...
        public EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload(List<FieldEEzsignsignatureType> aEEzsignsignatureType = default(List<FieldEEzsignsignatureType>), List<CustomEzsignfolderEzsignsignaturesAutomaticResponse> aObjEzsignfolder = default(List<CustomEzsignfolderEzsignsignaturesAutomaticResponse>))
        {
            ...
            {
                throw new InvalidDataException("aEEzsignsignatureType is a required property for EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("aObjEzsignfolder is a required property for EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload and cannot be null");
            }
            else
            {
