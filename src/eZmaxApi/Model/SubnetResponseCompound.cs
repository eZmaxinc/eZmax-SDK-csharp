...
namespace eZmaxApi.Model
{
    ...
    public partial class SubnetResponseCompound : IValidatableObject
    {
        ...
        public SubnetResponseCompound(int  = default(int), int  = default(int), int  = default(int), MultilingualSubnetDescription  = default(MultilingualSubnetDescription), long  = default(long), long  = default(long))
        {
            this.PkiSubnetID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for SubnetResponseCompound and cannot be null");
            }
