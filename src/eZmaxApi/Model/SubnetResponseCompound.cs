...
namespace eZmaxApi.Model
{
    ...
    public partial class SubnetResponseCompound : IValidatableObject
    {
        ...
        public SubnetResponseCompound(int pkiSubnetID = default, int fkiUserID = default, int fkiApikeyID = default, MultilingualSubnetDescription objSubnetDescription = default, long iSubnetNetwork = default, long iSubnetMask = default)
        {
