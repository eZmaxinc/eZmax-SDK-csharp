...
namespace eZmaxApi.Model
{
    ...
    public partial class AttachmentlogResponseCompound : IValidatableObject
    {
        ...
        public AttachmentlogResponseCompound(int fkiAttachmentID = default, int fkiUserID = default, string dtAttachmentlogDatetime = default, FieldEAttachmentlogType eAttachmentlogType = default, string sAttachmentlogDetail = default)
        {
