...
namespace eZmaxApi.Model
{
    ...
    public partial class AttachmentlogResponseCompound : IValidatableObject
    {
        ...
        public AttachmentlogResponseCompound(int  = default(int), int  = default(int), string  = default(string), FieldEAttachmentlogType  = default(FieldEAttachmentlogType), string  = default(string))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for AttachmentlogResponseCompound and cannot be null");
            }
