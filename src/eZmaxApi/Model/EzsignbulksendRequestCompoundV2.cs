...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignbulksend-RequestCompoundV2")]
    public partial class EzsignbulksendRequestCompoundV2 : IValidatableObject
    {
        ...
        protected EzsignbulksendRequestCompoundV2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignbulksendRequestCompoundV2" /> class.
        /// </summary>
        ...
        public EzsignbulksendRequestCompoundV2(int pkiEzsignbulksendID = default, int fkiEzsignfoldertypeID = default, int fkiLanguageID = default, FieldEEzsignbulksendEzsignformfieldorder eEzsignbulksendEzsignformfieldorder = default, string sEzsignbulksendDescription = default, string tEzsignbulksendNote = default, bool bEzsignbulksendNeedvalidation = default, bool bEzsignbulksendIsactive = default)
        {
            ...
            {
                throw new ArgumentNullException("sEzsignbulksendDescription is a required property for EzsignbulksendRequestCompoundV2 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("tEzsignbulksendNote is a required property for EzsignbulksendRequestCompoundV2 and cannot be null");
            }
