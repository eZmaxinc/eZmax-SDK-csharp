...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfoldersignerassociationResponseCompoundUser : IValidatableObject
    {
        ...
        public EzsignfoldersignerassociationResponseCompoundUser(int pkiUserID = default, int fkiLanguageID = default, string sUserFirstname = default, string sUserLastname = default, string sEmailAddress = default, FieldEUserType eUserType = default)
        {
