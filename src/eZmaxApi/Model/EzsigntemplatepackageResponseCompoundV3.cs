...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplatepackage-ResponseCompoundV3")]
    public partial class EzsigntemplatepackageResponseCompoundV3 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatepackageResponseCompoundV3" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplatepackageResponseCompoundV3() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatepackageResponseCompoundV3" /> class.
        /// </summary>
        ...
        public EzsigntemplatepackageResponseCompoundV3(int pkiEzsigntemplatepackageID = default, int fkiEzsignfoldertypeID = default, int fkiEzdoctemplatedocumentID = default, int fkiLanguageID = default, string sEzdoctemplatedocumentNameX = default, string sLanguageNameX = default, string sEzsigntemplatepackageDescription = default, bool bEzsigntemplatepackageAdminonly = default, bool bEzsigntemplatepackageNeedvalidation = default, bool bEzsigntemplatepackageIsactive = default, string sEzsignfoldertypeNameX = default, bool bEzsigntemplatepackageEditallowed = default, List<EzsigntemplatepackagesignerResponseCompoundV3> aObjEzsigntemplatepackagesigner = default, List<EzsigntemplatepackagemembershipResponseCompoundV3> aObjEzsigntemplatepackagemembership = default)
        {
            ...
            {
                throw new ArgumentNullException("sLanguageNameX is a required property for EzsigntemplatepackageResponseCompoundV3 and cannot be null");
            }
            this.SLanguageNameX = sLanguageNameX;
            // to ensure "sEzsigntemplatepackageDescription" is required (not null)
            if (sEzsigntemplatepackageDescription == null)
            {
                throw new ArgumentNullException("sEzsigntemplatepackageDescription is a required property for EzsigntemplatepackageResponseCompoundV3 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sEzsignfoldertypeNameX is a required property for EzsigntemplatepackageResponseCompoundV3 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("aObjEzsigntemplatepackagesigner is a required property for EzsigntemplatepackageResponseCompoundV3 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("aObjEzsigntemplatepackagemembership is a required property for EzsigntemplatepackageResponseCompoundV3 and cannot be null");
            }
        ...
        */
        ...
        public List<EzsigntemplatepackagesignerResponseCompoundV3> AObjEzsigntemplatepackagesigner { get; set; }
        ...
        public List<EzsigntemplatepackagemembershipResponseCompoundV3> AObjEzsigntemplatepackagemembership { get; set; }
