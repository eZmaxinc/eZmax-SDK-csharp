...
namespace eZmaxApi.Model
{
    ...
    public partial class CommonReportcolumn : IValidatableObject
    {
        ...
        public CommonReportcolumn(CommonReportcellstyle objReportcellstyleDefault = default, int iReportcolumnWidth = default, EnumReportdataType eReportcolumnType = default)
        {
