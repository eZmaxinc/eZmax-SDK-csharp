...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignaturecustomdateResponseCompoundV2 : IValidatableObject
    {
        ...
        public EzsignsignaturecustomdateResponseCompoundV2(int  = default(int), int  = default(int), int  = default(int), string  = default(string))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignsignaturecustomdateResponseCompoundV2 and cannot be null");
            }
