...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignsignaturecustomdate-ResponseCompoundV2")]
    public partial class EzsignsignaturecustomdateResponseCompoundV2 : IValidatableObject
    {
        ...
        protected EzsignsignaturecustomdateResponseCompoundV2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignsignaturecustomdateResponseCompoundV2" /> class.
        /// </summary>
        ...
        public EzsignsignaturecustomdateResponseCompoundV2(int pkiEzsignsignaturecustomdateID = default(int), int iEzsignsignaturecustomdateOffsetx = default(int), int iEzsignsignaturecustomdateOffsety = default(int), string sEzsignsignaturecustomdateFormat = default(string))
        {
            ...
            {
                throw new ArgumentNullException("sEzsignsignaturecustomdateFormat is a required property for EzsignsignaturecustomdateResponseCompoundV2 and cannot be null");
            }
