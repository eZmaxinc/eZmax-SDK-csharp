...
namespace eZmaxApi.Model
{
    ...
    public partial class WebhookRequestCompound : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        public WebhookRequestCompound(int  = default(int), int  = default(int), int  = default(int), string  = default(string), FieldEWebhookModule  = default(FieldEWebhookModule), FieldEWebhookEzsignevent?  = default(FieldEWebhookEzsignevent?), FieldEWebhookManagementevent?  = default(FieldEWebhookManagementevent?), string  = default(string), string  = default(string), bool  = default(bool), bool  = default(bool), bool  = default(bool), List<WebhookheaderRequestCompound>  = default(List<WebhookheaderRequestCompound>))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for WebhookRequestCompound and cannot be null");
            }
