...
namespace eZmaxApi.Model
{
    ...
    public partial class AuthenticationexternalListElement : IValidatableObject
    {
        ...
        public AuthenticationexternalListElement(int pkiAuthenticationexternalID = default, string sAuthenticationexternalDescription = default, FieldEAuthenticationexternalType eAuthenticationexternalType = default, bool bAuthenticationexternalConnected = default)
        {
