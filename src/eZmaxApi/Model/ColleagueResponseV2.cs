...
namespace eZmaxApi.Model
{
    ...
    /// A Colleague Object
    /// </summary>
    [DataContract(Name = "colleague-ResponseV2")]
    public partial class ColleagueResponseV2 : IValidatableObject
    {
        ...
        public ColleagueResponseV2(int pkiColleagueID = default, int fkiUserID = default, int fkiUserIDColleague = default, bool bColleagueEzsignemail = default, bool bColleagueFinancial = default, bool bColleagueUsecloneemail = default, bool bColleagueAttachment = default, bool bColleagueCanafe = default, bool bColleaguePermission = default, bool bColleagueRealestatecompleted = default, string dtColleagueFrom = default, string dtColleagueTo = default, FieldEColleagueEzsign eColleagueEzsign = default, FieldEColleagueRealestateinprogess eColleagueRealestateinprogress = default, CustomUserNameResponse objUserName = default, CommonAudit objAudit = default)
        {
