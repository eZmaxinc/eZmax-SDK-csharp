...
namespace eZmaxApi.Model
{
    ...
    public partial class VersionhistoryResponse : IValidatableObject
    {
        ...
        public VersionhistoryResponse(int pkiVersionhistoryID = default, int fkiModuleID = default, int fkiModulesectionID = default, string sModuleNameX = default, string sModulesectionNameX = default, FieldEVersionhistoryUsertype? eVersionhistoryUsertype = default, MultilingualVersionhistoryDetail objVersionhistoryDetail = default, string dtVersionhistoryDate = default, string dtVersionhistoryDateend = default, FieldEVersionhistoryType eVersionhistoryType = default, bool bVersionhistoryDraft = default)
        {
