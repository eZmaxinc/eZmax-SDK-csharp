...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatesignatureGetObjectV3ResponseMPayload : IValidatableObject
    {
        ...
        public EzsigntemplatesignatureGetObjectV3ResponseMPayload(EzsigntemplatesignatureResponseCompoundV3  = default(EzsigntemplatesignatureResponseCompoundV3))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplatesignatureGetObjectV3ResponseMPayload and cannot be null");
            }
