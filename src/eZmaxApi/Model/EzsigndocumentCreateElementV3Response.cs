...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigndocumentCreateElementV3Response : IValidatableObject
    {
        ...
        public EzsigndocumentCreateElementV3Response(int pkiEzsigndocumentID = default, List<EzsigndocumentMatchingtemplateV3Response> aObjMatchingtemplate = default)
        {
