...
namespace eZmaxApi.Model
{
    ...
    public partial class SignatureResponse : IValidatableObject
    {
        ...
        public SignatureResponse(int pkiSignatureID = default(int), int fkiFontID = default(int), string sSignatureUrl = default(string), string sSignatureUrlinitials = default(string))
        {
