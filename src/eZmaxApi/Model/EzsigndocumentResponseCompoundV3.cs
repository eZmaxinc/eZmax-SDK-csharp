...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigndocument-ResponseCompoundV3")]
    public partial class EzsigndocumentResponseCompoundV3 : IValidatableObject
    {
        ...
        protected EzsigndocumentResponseCompoundV3() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigndocumentResponseCompoundV3" /> class.
        /// </summary>
        ...
        /// <param name="iEzsigndocumentSteptotal">The total number of steps (required).</param>
        /// <param name="iEzsigndocumentStepcurrent">The current step (required).</param>
        ...
        public EzsigndocumentResponseCompoundV3(int pkiEzsigndocumentID = default, int fkiEzsignfolderID = default, int fkiEzsignfoldersignerassociationIDDeclinedtosign = default, string dtEzsigndocumentDuedate = default, string dtEzsignformCompleted = default, int fkiLanguageID = default, string sEzsigndocumentName = default, FieldEEzsigndocumentStep eEzsigndocumentStep = default, string dtEzsigndocumentFirstsend = default, string dtEzsigndocumentLastsend = default, int iEzsigndocumentOrder = default, int iEzsigndocumentPagetotal = default, int iEzsigndocumentSignaturesigned = default, int iEzsigndocumentSignaturetotal = default, int iEzsigndocumentFormfieldtotal = default, string sEzsigndocumentMD5initial = default, string tEzsigndocumentDeclinedtosignreason = default, string sEzsigndocumentMD5signed = default, bool bEzsigndocumentEzsignform = default, bool bEzsigndocumentHassignedsignatures = default, bool bEzsigndocumentSendtoged = default, CommonAudit objAudit = default, string sEzsigndocumentExternalid = default, int iEzsigndocumentEzsignsignatureattachmenttotal = default, int iEzsigndocumentEzsigndiscussiontotal = default, int iEzsigndocumentSteptotal = default, int iEzsigndocumentStepcurrent = default, List<CustomEzsignfoldersignerassociationstatusResponseV3> aObjEzsignfoldersignerassociationstatus = default, List<EzsigndocumentdependencyResponse> aObjEzsigndocumentdependency = default)
        {
            ...
            {
                throw new ArgumentNullException("dtEzsigndocumentDuedate is a required property for EzsigndocumentResponseCompoundV3 and cannot be null");
            }
            this.DtEzsigndocumentDuedate = dtEzsigndocumentDuedate;
            // to ensure "sEzsigndocumentName" is required (not null)
            if (sEzsigndocumentName == null)
            {
                throw new ArgumentNullException("sEzsigndocumentName is a required property for EzsigndocumentResponseCompoundV3 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("aObjEzsignfoldersignerassociationstatus is a required property for EzsigndocumentResponseCompoundV3 and cannot be null");
            }
        ...
        */
        [DataMember(Name = "bEzsigndocumentSendtoged", EmitDefaultValue = true)]
        public bool BEzsigndocumentSendtoged { get; set; }
        ...
        */
        ...
        <example>2</example>
        */
        [DataMember(Name = "iEzsigndocumentSteptotal", IsRequired = true, EmitDefaultValue = true)]
        ...
        <example>1</example>
        */
        [DataMember(Name = "iEzsigndocumentStepcurrent", IsRequired = true, EmitDefaultValue = true)]
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.SEzsigndocumentMD5initial != null) {
                ...
                if (!regexSEzsigndocumentMD5initial.Match(this.SEzsigndocumentMD5initial).Success)
                {
            ...
            if (this.SEzsigndocumentMD5signed != null) {
                ...
                if (!regexSEzsigndocumentMD5signed.Match(this.SEzsigndocumentMD5signed).Success)
                {
