...
namespace eZmaxApi.Model
{
    ...
    public partial class UserResponseCompound :  IEquatable<UserResponseCompound>, IValidatableObject
    {
        ...
        public UserResponseCompound(int pkiUserID = default(int), int fkiLanguageID = default(int), FieldEUserType eUserType = default(FieldEUserType), string sUserFirstname = default(string), string sUserLastname = default(string), string sUserLoginname = default(string), CommonAudit objAudit = default(CommonAudit))
        {
