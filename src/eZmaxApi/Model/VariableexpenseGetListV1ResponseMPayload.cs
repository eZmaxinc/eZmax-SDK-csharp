...
namespace eZmaxApi.Model
{
    ...
    public partial class VariableexpenseGetListV1ResponseMPayload : IValidatableObject
    {
        ...
        public VariableexpenseGetListV1ResponseMPayload(int iRowReturned = default, int iRowFiltered = default, List<VariableexpenseListElement> aObjVariableexpense = default)
        {
