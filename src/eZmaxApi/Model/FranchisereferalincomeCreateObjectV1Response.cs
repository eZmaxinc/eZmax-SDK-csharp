...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "franchisereferalincome-createObject-v1-Response")]
    public partial class FranchisereferalincomeCreateObjectV1Response : IEquatable<FranchisereferalincomeCreateObjectV1Response>, IValidatableObject
    {
        ...
        public FranchisereferalincomeCreateObjectV1Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), FranchisereferalincomeCreateObjectV1ResponseMPayload mPayload = default(FranchisereferalincomeCreateObjectV1ResponseMPayload))
        {
            // to ensure "objDebugPayload" is required (not null)
            if (objDebugPayload == null)
            {
                throw new ArgumentNullException("objDebugPayload is a required property for FranchisereferalincomeCreateObjectV1Response and cannot be null");
            }
            this.ObjDebugPayload = objDebugPayload;
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new ArgumentNullException("mPayload is a required property for FranchisereferalincomeCreateObjectV1Response and cannot be null");
            }
