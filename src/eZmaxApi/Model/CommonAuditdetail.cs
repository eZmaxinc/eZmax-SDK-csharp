...
namespace eZmaxApi.Model
{
    ...
    public partial class CommonAuditdetail : IValidatableObject
    {
        ...
        public CommonAuditdetail(int fkiUserID = default, int fkiApikeyID = default, string sUserLoginname = default, string sUserLastname = default, string sUserFirstname = default, string sApikeyDescriptionX = default, string dtAuditdetailDate = default)
        {
