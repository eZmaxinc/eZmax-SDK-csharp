...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignbulksendtransmissionResponse : IValidatableObject
    {
        ...
        public EzsignbulksendtransmissionResponse(int pkiEzsignbulksendtransmissionID = default, int fkiEzsignbulksendID = default, string sEzsignbulksendtransmissionDescription = default, int iEzsignbulksendtransmissionErrors = default, CommonAudit objAudit = default)
        {
