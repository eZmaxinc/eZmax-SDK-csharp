...
namespace eZmaxApi.Model
{
    ...
    public partial class GlaccountcontainerAutocompleteElementResponse : IValidatableObject
    {
        ...
        public GlaccountcontainerAutocompleteElementResponse(int pkiGlaccountcontainerID = default, string sGlaccountcontainerLongcode = default, string sGlaccountcontainerLongdescriptionX = default, bool bGlaccountcontainerIsactive = default)
        {
