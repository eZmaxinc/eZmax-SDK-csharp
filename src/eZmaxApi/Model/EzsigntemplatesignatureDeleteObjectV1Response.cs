...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatesignatureDeleteObjectV1Response : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        public EzsigntemplatesignatureDeleteObjectV1Response(CommonResponseObjDebugPayload  = default(CommonResponseObjDebugPayload), CommonResponseObjDebug  = default(CommonResponseObjDebug))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplatesignatureDeleteObjectV1Response and cannot be null");
            }
