...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "otherincome-getCommunicationCount-v1-Response-mPayload")]
    public partial class OtherincomeGetCommunicationCountV1ResponseMPayload : IValidatableObject
    {
        ...
        protected OtherincomeGetCommunicationCountV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OtherincomeGetCommunicationCountV1ResponseMPayload" /> class.
        /// </summary>
        /// <param name="iCommunicationCount">The count of Communication. (required).</param>
        public OtherincomeGetCommunicationCountV1ResponseMPayload(int iCommunicationCount = default)
        {
