...
namespace eZmaxApi.Model
{
    ...
    public partial class UsergroupexternalRequestCompound : UsergroupexternalRequest, IValidatableObject
    {
        /// <summary>
        ...
        public UsergroupexternalRequestCompound(int pkiUsergroupexternalID = default(int), string sUsergroupexternalName = default(string), string sUsergroupexternalID = default(string)) : base()
        {
        }
