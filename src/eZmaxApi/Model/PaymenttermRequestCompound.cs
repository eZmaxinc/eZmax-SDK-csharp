...
namespace eZmaxApi.Model
{
    ...
    public partial class PaymenttermRequestCompound :  IEquatable<PaymenttermRequestCompound>, IValidatableObject
    {
        ...
        public PaymenttermRequestCompound(int pkiPaymenttermID = default(int), string sPaymenttermCode = default(string), MultilingualPaymenttermDescription objPaymenttermDescription = default(MultilingualPaymenttermDescription), bool bPaymenttermIsactive = default(bool))
        {
