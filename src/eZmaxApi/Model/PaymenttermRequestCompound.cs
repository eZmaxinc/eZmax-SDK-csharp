...
namespace eZmaxApi.Model
{
    ...
    public partial class PaymenttermRequestCompound : IValidatableObject
    {
        ...
        public PaymenttermRequestCompound(int  = default(int), string  = default(string), FieldEPaymenttermType  = default(FieldEPaymenttermType), int  = default(int), MultilingualPaymenttermDescription  = default(MultilingualPaymenttermDescription), bool  = default(bool))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for PaymenttermRequestCompound and cannot be null");
            }
