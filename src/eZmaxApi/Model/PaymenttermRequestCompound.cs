...
namespace eZmaxApi.Model
{
    ...
    public partial class PaymenttermRequestCompound : IValidatableObject
    {
        ...
        public PaymenttermRequestCompound(int pkiPaymenttermID = default, string sPaymenttermCode = default, FieldEPaymenttermType ePaymenttermType = default, int iPaymenttermDay = default, MultilingualPaymenttermDescription objPaymenttermDescription = default, bool bPaymenttermIsactive = default)
        {
