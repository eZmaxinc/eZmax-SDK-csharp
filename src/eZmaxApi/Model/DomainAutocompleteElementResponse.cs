...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "domain-AutocompleteElement-Response")]
    public partial class DomainAutocompleteElementResponse : IValidatableObject
    {
        ...
        protected DomainAutocompleteElementResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainAutocompleteElementResponse" /> class.
        /// </summary>
        ...
        /// <param name="bDomainIsactive">Whether the Domain is active or not (required).</param>
        public DomainAutocompleteElementResponse(int pkiDomainID = default, string sDomainName = default, bool bDomainIsactive = default)
        {
            this.PkiDomainID = pkiDomainID;
            // to ensure "sDomainName" is required (not null)
            if (sDomainName == null)
            {
                throw new ArgumentNullException("sDomainName is a required property for DomainAutocompleteElementResponse and cannot be null");
            }
        ...
        */
        [DataMember(Name = "bDomainIsactive", IsRequired = true, EmitDefaultValue = true)]
