...
namespace eZmaxApi.Model
{
    ...
    public partial class PermissionResponseCompound : IValidatableObject
    {
        ...
        public PermissionResponseCompound(int pkiPermissionID = default, int fkiUserID = default, int fkiApikeyID = default, int fkiUsergroupID = default, int fkiCompanyID = default, int fkiModulesectionID = default, string sCompanyNameX = default)
        {
