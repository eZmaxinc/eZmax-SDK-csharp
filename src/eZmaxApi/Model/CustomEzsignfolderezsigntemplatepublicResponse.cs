...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomEzsignfolderezsigntemplatepublicResponse : IValidatableObject
    {
        ...
        public CustomEzsignfolderezsigntemplatepublicResponse(int pkiEzsignfolderID = default, string sEzsignfolderDescription = default, FieldEEzsignfolderStep eEzsignfolderStep = default, int iEzsignfolderSignaturetotal = default, int iEzsignfolderFormfieldtotal = default, int iEzsignfolderSignaturesigned = default, List<CustomEzsignfolderezsigntemplatepublicSignerResponse> aObjEzsignfolderezsigntemplatepublicSigner = default)
        {
