...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignergroupmembershipResponse : IValidatableObject
    {
        ...
        public EzsignsignergroupmembershipResponse(int pkiEzsignsignergroupmembershipID = default, int fkiEzsignsignergroupID = default, int fkiEzsignsignerID = default, int fkiUserID = default, int fkiUsergroupID = default)
        {
