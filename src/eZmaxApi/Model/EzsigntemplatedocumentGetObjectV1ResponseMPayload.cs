...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsigntemplatedocumentGetObjectV1ResponseMPayload :  IEquatable<EzsigntemplatedocumentGetObjectV1ResponseMPayload>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatedocumentGetObjectV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplatedocumentGetObjectV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatedocumentGetObjectV1ResponseMPayload" /> class.
        /// </summary>
        ...
        public EzsigntemplatedocumentGetObjectV1ResponseMPayload(int pkiEzsigntemplatedocumentID = default(int), int fkiEzsigntemplateID = default(int), string sEzsigntemplatedocumentName = default(string), int iEzsigntemplatedocumentPagetotal = default(int), int iEzsigntemplatedocumentSignaturetotal = default(int))
        {
            // to ensure "pkiEzsigntemplatedocumentID" is required (not null)
            if (pkiEzsigntemplatedocumentID == null)
            {
                throw new InvalidDataException("pkiEzsigntemplatedocumentID is a required property for EzsigntemplatedocumentGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("fkiEzsigntemplateID is a required property for EzsigntemplatedocumentGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sEzsigntemplatedocumentName is a required property for EzsigntemplatedocumentGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iEzsigntemplatedocumentPagetotal is a required property for EzsigntemplatedocumentGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iEzsigntemplatedocumentSignaturetotal is a required property for EzsigntemplatedocumentGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EzsigntemplatedocumentGetObjectV1ResponseMPayload);
        }

        /// <summary>
        /// Returns true if EzsigntemplatedocumentGetObjectV1ResponseMPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of EzsigntemplatedocumentGetObjectV1ResponseMPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EzsigntemplatedocumentGetObjectV1ResponseMPayload input)
        {
            if (input == null)
                return false;
