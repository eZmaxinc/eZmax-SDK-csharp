...
namespace eZmaxApi.Model
{
    ...
    public partial class CommunicationreferenceRequestCompound : IValidatableObject
    {
        ...
        public CommunicationreferenceRequestCompound(int pkiCommunicationreferenceID = default, int fkiBuyercontractID = default, int fkiEzsignfolderID = default, int fkiInscriptionID = default, int fkiInscriptiontempID = default, int fkiInvoiceID = default, int fkiOtherincomeID = default, int fkiElectronicfundstransferID = default, int fkiRejectedoffertopurchaseID = default)
        {
