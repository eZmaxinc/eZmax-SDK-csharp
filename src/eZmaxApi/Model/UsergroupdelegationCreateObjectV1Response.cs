...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UsergroupdelegationCreateObjectV1Response :  IEquatable<UsergroupdelegationCreateObjectV1Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UsergroupdelegationCreateObjectV1Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UsergroupdelegationCreateObjectV1Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UsergroupdelegationCreateObjectV1Response" /> class.
        /// </summary>
        ...
        public UsergroupdelegationCreateObjectV1Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), UsergroupdelegationCreateObjectV1ResponseMPayload mPayload = default(UsergroupdelegationCreateObjectV1ResponseMPayload))
        {
            ...
            {
                throw new InvalidDataException("objDebugPayload is a required property for UsergroupdelegationCreateObjectV1Response and cannot be null");
            }
            else
            {
            ...
            if (mPayload == null)
            {
                throw new InvalidDataException("mPayload is a required property for UsergroupdelegationCreateObjectV1Response and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as UsergroupdelegationCreateObjectV1Response);
        }

        /// <summary>
        /// Returns true if UsergroupdelegationCreateObjectV1Response instances are equal
        /// </summary>
        /// <param name="input">Instance of UsergroupdelegationCreateObjectV1Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsergroupdelegationCreateObjectV1Response input)
        {
            if (input == null)
                return false;
