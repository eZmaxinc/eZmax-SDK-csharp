...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomEzsignsignatureEzsignsignaturesAutomaticResponse : IValidatableObject
    {
        ...
        public CustomEzsignsignatureEzsignsignaturesAutomaticResponse(int pkiEzsignsignatureID = default, FieldEEzsignsignatureType eEzsignsignatureType = default, int iEzsignpagePagenumber = default)
        {
