...
namespace eZmaxApi.Model
{
    ...
    public partial class SignatureRequestCompound : IValidatableObject
    {
        ...
        public SignatureRequestCompound(int pkiSignatureID = default, int fkiFontID = default, FieldESignaturePreference eSignaturePreference = default, string tSignatureSvg = default, string tSignatureSvginitials = default)
        {
