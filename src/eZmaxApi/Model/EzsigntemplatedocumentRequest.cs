...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatedocumentRequest : IValidatableObject
    {
        ...
        public EzsigntemplatedocumentRequest(int pkiEzsigntemplatedocumentID = default, int fkiEzsigntemplateID = default, int fkiEzsigndocumentID = default, int fkiEzsigntemplatesignerID = default, string sEzsigntemplatedocumentName = default, EEzsigntemplatedocumentSourceEnum eEzsigntemplatedocumentSource = default, EEzsigntemplatedocumentFormatEnum? eEzsigntemplatedocumentFormat = default, byte[] sEzsigntemplatedocumentBase64 = default, string sEzsigntemplatedocumentUrl = default, bool bEzsigntemplatedocumentForcerepair = default, EEzsigntemplatedocumentFormEnum? eEzsigntemplatedocumentForm = default, string sEzsigntemplatedocumentPassword = @"")
        {
