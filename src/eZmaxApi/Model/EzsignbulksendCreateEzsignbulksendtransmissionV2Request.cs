...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignbulksendCreateEzsignbulksendtransmissionV2Request : IValidatableObject
    {
        ...
        public EzsignbulksendCreateEzsignbulksendtransmissionV2Request(int fkiUserlogintypeID = default, int fkiSecretquestionID = default, int fkiEzsigntsarequirementID = default, string sEzsignbulksendtransmissionDescription = default, string dtEzsigndocumentDuedate = default, int iEzsignfolderSendreminderfirstdays = default, int iEzsignfolderSendreminderotherdays = default, string tExtraMessage = default, byte[] sCsvBase64 = default)
        {
