...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfoldertypeGetListV1ResponseMPayload : IValidatableObject
    {
        ...
        public EzsignfoldertypeGetListV1ResponseMPayload(int iRowReturned = default, int iRowFiltered = default, List<EzsignfoldertypeListElement> aObjEzsignfoldertype = default)
        {
