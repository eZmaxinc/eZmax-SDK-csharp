...
dataType                            : Object
datatypeWithEnum                    : 
name                                : userstaged-createUser-v1-Response-mPayload
defaultValue                        : 
...
*/
    ...
    public partial class UserstagedCreateUserV1ResponseMPayload :  IEquatable<UserstagedCreateUserV1ResponseMPayload>, IValidatableObject
    {
        ...
        public UserstagedCreateUserV1ResponseMPayload(int pkiUserID = default(int))
        {
            ...
            if (pkiUserID == null)
            {
                throw new InvalidDataException("pkiUserID is a required property for UserstagedCreateUserV1ResponseMPayload and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as UserstagedCreateUserV1ResponseMPayload);
        }

        /// <summary>
        /// Returns true if UserstagedCreateUserV1ResponseMPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of UserstagedCreateUserV1ResponseMPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserstagedCreateUserV1ResponseMPayload input)
        {
            if (input == null)
                return false;
