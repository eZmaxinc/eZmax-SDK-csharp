...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfolderGetListV1Response : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        /// <param name=""> (required).</param>
        public EzsignfolderGetListV1Response(CommonResponseObjDebugPayloadGetList  = default(CommonResponseObjDebugPayloadGetList), CommonResponseObjDebug  = default(CommonResponseObjDebug), EzsignfolderGetListV1ResponseMPayload  = default(EzsignfolderGetListV1ResponseMPayload))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignfolderGetListV1Response and cannot be null");
            }
