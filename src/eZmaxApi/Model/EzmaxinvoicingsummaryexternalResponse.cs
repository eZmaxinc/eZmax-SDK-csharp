...
namespace eZmaxApi.Model
{
    ...
    public partial class EzmaxinvoicingsummaryexternalResponse : IValidatableObject
    {
        ...
        public EzmaxinvoicingsummaryexternalResponse(int pkiEzmaxinvoicingsummaryexternalID = default, int fkiEzmaxinvoicingID = default, int fkiBillingentityexternalID = default, string sBillingentityexternalDescription = default, string sEzmaxinvoicingsummaryexternalDescription = default)
        {
