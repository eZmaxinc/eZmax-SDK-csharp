...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomDnsrecordResponse : IValidatableObject
    {
        ...
        public CustomDnsrecordResponse(EDnsrecordTypeEnum eDnsrecordType = default, EDnsrecordValidationEnum eDnsrecordValidation = default, string sDnsrecordName = default, string sDnsrecordValue = default, string sDnsrecordExpectedvalue = default, bool bDnsrecordMustMatch = default)
        {
