...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignaturecustomdateRequest :  IEquatable<EzsignsignaturecustomdateRequest>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="EzsignsignaturecustomdateRequest" /> class.
        /// </summary>
        /// <param name="iEzsignsignaturecustomdateX">The X coordinate (Horizontal) where to put the custom date block on the page.  Coordinate is calculated at 100dpi (dot per inch). So for example, if you want to put the custom date block 2 inches from the left border of the page, you would use \&quot;200\&quot; for the X coordinate. (required).</param>
        /// <param name="iEzsignsignaturecustomdateY">The Y coordinate (Vertical) where to put the custom date block on the page.  Coordinate is calculated at 100dpi (dot per inch). So for example, if you want to put the custom date block 3 inches from the top border of the page, you would use \&quot;300\&quot; for the Y coordinate. (required).</param>
        ...
        public EzsignsignaturecustomdateRequest(int iEzsignsignaturecustomdateX = default(int), int iEzsignsignaturecustomdateY = default(int), string sEzsignsignaturecustomdateFormat = default(string))
        {
        ...
        /// </summary>
        /// <value>The X coordinate (Horizontal) where to put the custom date block on the page.  Coordinate is calculated at 100dpi (dot per inch). So for example, if you want to put the custom date block 2 inches from the left border of the page, you would use \&quot;200\&quot; for the X coordinate.</value>
        ...
        /// </summary>
        /// <value>The Y coordinate (Vertical) where to put the custom date block on the page.  Coordinate is calculated at 100dpi (dot per inch). So for example, if you want to put the custom date block 3 inches from the top border of the page, you would use \&quot;300\&quot; for the Y coordinate.</value>
