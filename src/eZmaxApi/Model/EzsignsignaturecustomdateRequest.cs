...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignsignaturecustomdate-Request")]
    public partial class EzsignsignaturecustomdateRequest : IValidatableObject
    {
        ...
        public EzsignsignaturecustomdateRequest(int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), string  = default(string))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignsignaturecustomdateRequest and cannot be null");
            }
