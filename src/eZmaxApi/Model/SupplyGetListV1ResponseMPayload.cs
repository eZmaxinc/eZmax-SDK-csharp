...
namespace eZmaxApi.Model
{
    ...
    public partial class SupplyGetListV1ResponseMPayload : IValidatableObject
    {
        ...
        public SupplyGetListV1ResponseMPayload(int iRowReturned = default(int), int iRowFiltered = default(int), List<SupplyListElement> aObjSupply = default(List<SupplyListElement>))
        {
