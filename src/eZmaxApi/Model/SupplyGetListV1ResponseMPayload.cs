...
namespace eZmaxApi.Model
{
    ...
    public partial class SupplyGetListV1ResponseMPayload : IValidatableObject
    {
        ...
        public SupplyGetListV1ResponseMPayload(int  = default(int), int  = default(int), List<SupplyListElement>  = default(List<SupplyListElement>))
        {
            this.IRowReturned = ;
            this.IRowFiltered = ;
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for SupplyGetListV1ResponseMPayload and cannot be null");
            }
            this.AObjSupply = ;
        }
