...
namespace eZmaxApi.Model
{
    ...
    public partial class TaxassignmentAutocompleteElementResponse : IValidatableObject
    {
        ...
        public TaxassignmentAutocompleteElementResponse(string sTaxassignmentDescriptionX = default, int pkiTaxassignmentID = default, bool bTaxassignmentIsactive = default)
        {
