...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsignsignatureGetObjectV1ResponseMPayload :  IEquatable<EzsignsignatureGetObjectV1ResponseMPayload>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignsignatureGetObjectV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsignsignatureGetObjectV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignsignatureGetObjectV1ResponseMPayload" /> class.
        /// </summary>
        ...
        public EzsignsignatureGetObjectV1ResponseMPayload(int pkiEzsignsignatureID = default(int), int fkiEzsigndocumentID = default(int), int fkiEzsignfoldersignerassociationID = default(int), int iEzsignpagePagenumber = default(int), int iEzsignsignatureX = default(int), int iEzsignsignatureY = default(int), int iEzsignsignatureStep = default(int), FieldEEzsignsignatureType eEzsignsignatureType = default(FieldEEzsignsignatureType), string tEzsignsignatureTooltip = default(string), FieldEEzsignsignatureTooltipposition eEzsignsignatureTooltipposition = default(FieldEEzsignsignatureTooltipposition), FieldEEzsignsignatureFont eEzsignsignatureFont = default(FieldEEzsignsignatureFont), int iEzsignsignatureValidationstep = default(int), string sEzsignsignatureAttachmentdescription = default(string), FieldEEzsignsignatureAttachmentnamesource eEzsignsignatureAttachmentnamesource = default(FieldEEzsignsignatureAttachmentnamesource), bool bEzsignsignatureRequired = default(bool), int fkiUserID = default(int), bool bEzsignsignatureCustomdate = default(bool), List<EzsignsignaturecustomdateResponseCompound> aObjEzsignsignaturecustomdate = default(List<EzsignsignaturecustomdateResponseCompound>))
        {
            ...
            {
                throw new InvalidDataException("fkiEzsigndocumentID is a required property for EzsignsignatureGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("fkiEzsignfoldersignerassociationID is a required property for EzsignsignatureGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iEzsignpagePagenumber is a required property for EzsignsignatureGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iEzsignsignatureX is a required property for EzsignsignatureGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iEzsignsignatureY is a required property for EzsignsignatureGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iEzsignsignatureStep is a required property for EzsignsignatureGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("eEzsignsignatureType is a required property for EzsignsignatureGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EzsignsignatureGetObjectV1ResponseMPayload);
        }

        /// <summary>
        /// Returns true if EzsignsignatureGetObjectV1ResponseMPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of EzsignsignatureGetObjectV1ResponseMPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EzsignsignatureGetObjectV1ResponseMPayload input)
        {
            if (input == null)
                return false;
