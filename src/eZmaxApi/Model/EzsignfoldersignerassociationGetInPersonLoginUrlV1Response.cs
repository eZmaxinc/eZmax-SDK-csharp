...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfoldersignerassociationGetInPersonLoginUrlV1Response : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        /// <param name=""> (required).</param>
        public EzsignfoldersignerassociationGetInPersonLoginUrlV1Response(CommonResponseObjDebugPayload  = default(CommonResponseObjDebugPayload), CommonResponseObjDebug  = default(CommonResponseObjDebug), EzsignfoldersignerassociationGetInPersonLoginUrlV1ResponseMPayload  = default(EzsignfoldersignerassociationGetInPersonLoginUrlV1ResponseMPayload))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignfoldersignerassociationGetInPersonLoginUrlV1Response and cannot be null");
            }
