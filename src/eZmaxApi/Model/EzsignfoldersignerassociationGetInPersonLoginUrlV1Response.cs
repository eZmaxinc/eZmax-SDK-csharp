...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignfoldersignerassociation-getInPersonLoginUrl-v1-Response")]
    public partial class EzsignfoldersignerassociationGetInPersonLoginUrlV1Response : IValidatableObject
    {
        ...
        public EzsignfoldersignerassociationGetInPersonLoginUrlV1Response(CommonResponseObjDebugPayload objDebugPayload = default, CommonResponseObjDebug objDebug = default, EzsignfoldersignerassociationGetInPersonLoginUrlV1ResponseMPayload mPayload = default)
        {
            // to ensure "objDebugPayload" is required (not null)
            if (objDebugPayload == null)
            {
                throw new ArgumentNullException("objDebugPayload is a required property for EzsignfoldersignerassociationGetInPersonLoginUrlV1Response and cannot be null");
            }
            this.ObjDebugPayload = objDebugPayload;
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new ArgumentNullException("mPayload is a required property for EzsignfoldersignerassociationGetInPersonLoginUrlV1Response and cannot be null");
            }
