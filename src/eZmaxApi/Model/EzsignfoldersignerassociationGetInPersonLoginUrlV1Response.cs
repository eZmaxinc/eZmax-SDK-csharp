...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsignfoldersignerassociationGetInPersonLoginUrlV1Response :  IEquatable<EzsignfoldersignerassociationGetInPersonLoginUrlV1Response>
    {
        /// <summary>
        ...
        public EzsignfoldersignerassociationGetInPersonLoginUrlV1Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), EzsignfoldersignerassociationGetInPersonLoginUrlV1ResponseMPayload mPayload = default(EzsignfoldersignerassociationGetInPersonLoginUrlV1ResponseMPayload))
        {
            ...
            {
                throw new InvalidDataException("objDebugPayload is a required property for EzsignfoldersignerassociationGetInPersonLoginUrlV1Response and cannot be null");
            }
            else
            {
