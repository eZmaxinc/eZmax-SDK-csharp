...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignelementdependency-Request")]
    public partial class EzsignelementdependencyRequest : IEquatable<EzsignelementdependencyRequest>, IValidatableObject
    {
        ...
        protected EzsignelementdependencyRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignelementdependencyRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as EzsignelementdependencyRequest);
        }

        /// <summary>
        /// Returns true if EzsignelementdependencyRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of EzsignelementdependencyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EzsignelementdependencyRequest input)
        {
            if (input == null)
            {
                return false;
