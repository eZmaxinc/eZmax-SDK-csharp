...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomFormsDataFolderResponse : IValidatableObject
    {
        ...
        public CustomFormsDataFolderResponse(int pkiEzsignfolderID = default, string sEzsignfolderDescription = default, List<CustomFormDataDocumentResponse> aObjFormDataDocument = default)
        {
