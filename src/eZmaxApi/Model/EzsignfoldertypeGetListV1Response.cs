...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfoldertypeGetListV1Response :  IEquatable<EzsignfoldertypeGetListV1Response>, IValidatableObject
    {
        ...
        public EzsignfoldertypeGetListV1Response(EzsignfoldertypeGetListV1ResponseMPayload mPayload = default(EzsignfoldertypeGetListV1ResponseMPayload), CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug))
        {
