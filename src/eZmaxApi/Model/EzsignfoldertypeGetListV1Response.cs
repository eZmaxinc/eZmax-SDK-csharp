...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsignfoldertypeGetListV1Response :  IEquatable<EzsignfoldertypeGetListV1Response>
    {
        /// <summary>
        ...
        public EzsignfoldertypeGetListV1Response(CommonResponseObjDebugPayloadGetList objDebugPayload = default(CommonResponseObjDebugPayloadGetList), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), EzsignfoldertypeGetListV1ResponseMPayload mPayload = default(EzsignfoldertypeGetListV1ResponseMPayload))
        {
            ...
            {
                throw new InvalidDataException("objDebugPayload is a required property for EzsignfoldertypeGetListV1Response and cannot be null");
            }
            else
            {
