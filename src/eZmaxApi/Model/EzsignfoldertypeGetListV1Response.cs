...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfoldertypeGetListV1Response : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        /// <param name=""> (required).</param>
        public EzsignfoldertypeGetListV1Response(CommonResponseObjDebugPayloadGetList  = default(CommonResponseObjDebugPayloadGetList), CommonResponseObjDebug  = default(CommonResponseObjDebug), EzsignfoldertypeGetListV1ResponseMPayload  = default(EzsignfoldertypeGetListV1ResponseMPayload))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignfoldertypeGetListV1Response and cannot be null");
            }
