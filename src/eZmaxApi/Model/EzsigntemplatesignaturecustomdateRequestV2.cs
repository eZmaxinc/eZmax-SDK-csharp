...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatesignaturecustomdateRequestV2 : IValidatableObject
    {
        ...
        public EzsigntemplatesignaturecustomdateRequestV2(int  = default(int), int  = default(int), int  = default(int), string  = default(string))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplatesignaturecustomdateRequestV2 and cannot be null");
            }
