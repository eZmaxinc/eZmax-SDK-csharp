...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplatesignaturecustomdate-RequestV2")]
    public partial class EzsigntemplatesignaturecustomdateRequestV2 : IValidatableObject
    {
        ...
        protected EzsigntemplatesignaturecustomdateRequestV2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatesignaturecustomdateRequestV2" /> class.
        /// </summary>
        ...
        public EzsigntemplatesignaturecustomdateRequestV2(int pkiEzsigntemplatesignaturecustomdateID = default(int), int iEzsigntemplatesignaturecustomdateOffsetx = default(int), int iEzsigntemplatesignaturecustomdateOffsety = default(int), string sEzsigntemplatesignaturecustomdateFormat = default(string))
        {
            ...
            {
                throw new ArgumentNullException("sEzsigntemplatesignaturecustomdateFormat is a required property for EzsigntemplatesignaturecustomdateRequestV2 and cannot be null");
            }
