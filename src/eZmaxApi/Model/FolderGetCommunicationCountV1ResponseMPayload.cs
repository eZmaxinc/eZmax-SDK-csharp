...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "folder-getCommunicationCount-v1-Response-mPayload")]
    public partial class FolderGetCommunicationCountV1ResponseMPayload : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FolderGetCommunicationCountV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FolderGetCommunicationCountV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FolderGetCommunicationCountV1ResponseMPayload" /> class.
        /// </summary>
        /// <param name="iCommunicationCount">The count of Communication. (required).</param>
        public FolderGetCommunicationCountV1ResponseMPayload(int iCommunicationCount = default)
        {
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FolderGetCommunicationCountV1ResponseMPayload {\n");
