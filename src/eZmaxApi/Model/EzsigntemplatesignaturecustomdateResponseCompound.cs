...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatesignaturecustomdateResponseCompound : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="EzsigntemplatesignaturecustomdateResponseCompound" /> class.
        /// </summary>
        /// <param name="">The unique ID of the Ezsigntemplatesignaturecustomdate (required).</param>
        ...
        /// <param name="">The Y coordinate (Vertical) where to put the Ezsigntemplatesignaturecustomdate on the page.  Coordinate is calculated at 100dpi (dot per inch). So for example, if you want to put the Ezsigntemplatesignaturecustomdate 3 inches from the top border of the page, you would use \&quot;300\&quot; for the Y coordinate..</param>
        ...
        public EzsigntemplatesignaturecustomdateResponseCompound(int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), string  = default(string))
        {
            this.PkiEzsigntemplatesignaturecustomdateID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplatesignaturecustomdateResponseCompound and cannot be null");
            }
            this.SEzsigntemplatesignaturecustomdateFormat = ;
