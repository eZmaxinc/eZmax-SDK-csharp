...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatesignaturecustomdateResponseCompound : IValidatableObject
    {
        ...
        public EzsigntemplatesignaturecustomdateResponseCompound(int pkiEzsigntemplatesignaturecustomdateID = default, int iEzsigntemplatesignaturecustomdateX = default, int iEzsigntemplatesignaturecustomdateY = default, int iEzsigntemplatesignaturecustomdateOffsetx = default, int iEzsigntemplatesignaturecustomdateOffsety = default, string sEzsigntemplatesignaturecustomdateFormat = default)
        {
