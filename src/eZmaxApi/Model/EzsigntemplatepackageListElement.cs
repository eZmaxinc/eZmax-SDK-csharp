...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatepackageListElement : IValidatableObject
    {
        ...
        public EzsigntemplatepackageListElement(int pkiEzsigntemplatepackageID = default, int fkiEzsignfoldertypeID = default, int fkiLanguageID = default, string sEzsigntemplatepackageDescription = default, bool bEzsigntemplatepackageNeedvalidation = default, int iEzsigntemplatepackagemembership = default, string sEzsignfoldertypeNameX = default, bool bEzsigntemplatepackageIsactive = default)
        {
