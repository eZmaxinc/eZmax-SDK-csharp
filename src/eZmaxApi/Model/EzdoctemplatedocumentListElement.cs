...
namespace eZmaxApi.Model
{
    ...
    public partial class EzdoctemplatedocumentListElement : IValidatableObject
    {
        ...
        public EzdoctemplatedocumentListElement(int pkiEzdoctemplatedocumentID = default, int fkiLanguageID = default, int fkiEzsignfoldertypeID = default, int fkiEzdoctemplatetypeID = default, int fkiEzdoctemplatefieldtypecategoryID = default, string sEzsignfoldertypeNameX = default, string sEzdoctemplatetypeDescriptionX = default, string sEzdoctemplatefieldtypecategoryDescriptionX = default, FieldEEzdoctemplatedocumentPrivacylevel? eEzdoctemplatedocumentPrivacylevel = default, bool bEzdoctemplatedocumentIsactive = default, string sEzdoctemplatedocumentNameX = default)
        {
