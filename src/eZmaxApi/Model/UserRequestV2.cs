...
namespace eZmaxApi.Model
{
    ...
    public partial class UserRequestV2 : IValidatableObject
    {
        ...
        public UserRequestV2(int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), EmailRequestCompound  = default(EmailRequestCompound), int  = default(int), PhoneRequestCompoundV2  = default(PhoneRequestCompoundV2), PhoneRequestCompoundV2  = default(PhoneRequestCompoundV2), int  = default(int), string  = default(string), int  = default(int), FieldEUserType  = default(FieldEUserType), FieldEUserLogintype  = default(FieldEUserLogintype), string  = default(string), string  = default(string), string  = default(string), string  = default(string), FieldEUserEzsignaccess  = default(FieldEUserEzsignaccess), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for UserRequestV2 and cannot be null");
            }
            this.ObjEmail = ;
