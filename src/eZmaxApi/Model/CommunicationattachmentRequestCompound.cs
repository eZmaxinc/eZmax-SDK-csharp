...
namespace eZmaxApi.Model
{
    ...
    public partial class CommunicationattachmentRequestCompound : IValidatableObject
    {
        ...
        public CommunicationattachmentRequestCompound(int pkiCommunicationattachmentID = default, int fkiAttachmentID = default, int fkiInvoiceID = default, int fkiSalarypreparationID = default)
        {
