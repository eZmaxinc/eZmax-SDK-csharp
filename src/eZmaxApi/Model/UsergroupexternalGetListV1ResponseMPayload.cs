...
namespace eZmaxApi.Model
{
    ...
    public partial class UsergroupexternalGetListV1ResponseMPayload : IValidatableObject
    {
        ...
        public UsergroupexternalGetListV1ResponseMPayload(int iRowReturned = default, int iRowFiltered = default, List<UsergroupexternalListElement> aObjUsergroupexternal = default)
        {
