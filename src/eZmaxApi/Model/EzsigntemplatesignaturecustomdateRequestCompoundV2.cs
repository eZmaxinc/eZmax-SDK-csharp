...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatesignaturecustomdateRequestCompoundV2 : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="EzsigntemplatesignaturecustomdateRequestCompoundV2" /> class.
        /// </summary>
        /// <param name="">The unique ID of the Ezsigntemplatesignaturecustomdate.</param>
        ...
        public EzsigntemplatesignaturecustomdateRequestCompoundV2(int  = default(int), int  = default(int), int  = default(int), string  = default(string))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplatesignaturecustomdateRequestCompoundV2 and cannot be null");
            }
