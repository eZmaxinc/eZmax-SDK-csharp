...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplatesignaturecustomdate-RequestCompoundV2")]
    public partial class EzsigntemplatesignaturecustomdateRequestCompoundV2 : IValidatableObject
    {
        ...
        protected EzsigntemplatesignaturecustomdateRequestCompoundV2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatesignaturecustomdateRequestCompoundV2" /> class.
        /// </summary>
        ...
        public EzsigntemplatesignaturecustomdateRequestCompoundV2(int pkiEzsigntemplatesignaturecustomdateID = default(int), int iEzsigntemplatesignaturecustomdateOffsetx = default(int), int iEzsigntemplatesignaturecustomdateOffsety = default(int), string sEzsigntemplatesignaturecustomdateFormat = default(string))
        {
            ...
            {
                throw new ArgumentNullException("sEzsigntemplatesignaturecustomdateFormat is a required property for EzsigntemplatesignaturecustomdateRequestCompoundV2 and cannot be null");
            }
