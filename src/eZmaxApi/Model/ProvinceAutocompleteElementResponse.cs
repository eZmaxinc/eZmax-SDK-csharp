...
namespace eZmaxApi.Model
{
    ...
    public partial class ProvinceAutocompleteElementResponse : IValidatableObject
    {
        ...
        /// <param name="">The shortname of the Province (required).</param>
        /// <param name="">Whether the Province is active or not (required).</param>
        public ProvinceAutocompleteElementResponse(int  = default(int), int  = default(int), string  = default(string), string  = default(string), bool  = default(bool))
        {
            this.PkiProvinceID = ;
            this.FkiCountryID = ;
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for ProvinceAutocompleteElementResponse and cannot be null");
            }
            this.SProvinceNameX = ;
            // to ensure "" is required (not null)
            if ( == null)
            ...
            this.SProvinceShortname = ;
            this.BProvinceIsactive = ;
        }
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PkiProvinceID, must be a value greater than or equal to 0.", new [] { "PkiProvinceID" });
            }
