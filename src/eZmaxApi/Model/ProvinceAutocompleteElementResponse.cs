...
namespace eZmaxApi.Model
{
    ...
    public partial class ProvinceAutocompleteElementResponse : IValidatableObject
    {
        ...
        public ProvinceAutocompleteElementResponse(int pkiProvinceID = default, int fkiCountryID = default, string sProvinceNameX = default, string sProvinceShortname = default, bool bProvinceIsactive = default)
        {
