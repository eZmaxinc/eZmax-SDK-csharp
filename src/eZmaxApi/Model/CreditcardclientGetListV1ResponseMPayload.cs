...
namespace eZmaxApi.Model
{
    ...
    public partial class CreditcardclientGetListV1ResponseMPayload : IValidatableObject
    {
        ...
        public CreditcardclientGetListV1ResponseMPayload(int iRowReturned = default, int iRowFiltered = default, List<CreditcardclientListElement> aObjCreditcardclient = default)
        {
