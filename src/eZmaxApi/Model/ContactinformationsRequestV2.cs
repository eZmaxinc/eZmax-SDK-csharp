...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "contactinformations-RequestV2")]
    public partial class ContactinformationsRequestV2 : IValidatableObject
    {
        ...
        protected ContactinformationsRequestV2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactinformationsRequestV2" /> class.
        /// </summary>
        ...
        public ContactinformationsRequestV2(FieldEContactinformationsType eContactinformationsType = default(FieldEContactinformationsType), int iAddressDefault = default(int), int iPhoneDefault = default(int), int iEmailDefault = default(int), int iWebsiteDefault = default(int))
        {
