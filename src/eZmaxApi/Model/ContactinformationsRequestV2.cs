...
namespace eZmaxApi.Model
{
    ...
    public partial class ContactinformationsRequestV2 : IValidatableObject
    {
        ...
        public ContactinformationsRequestV2(FieldEContactinformationsType  = default(FieldEContactinformationsType), int  = default(int), int  = default(int), int  = default(int), int  = default(int))
        {
