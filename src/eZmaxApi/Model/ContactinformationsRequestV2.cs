...
namespace eZmaxApi.Model
{
    ...
    public partial class ContactinformationsRequestV2 : IValidatableObject
    {
        ...
        public ContactinformationsRequestV2(FieldEContactinformationsType eContactinformationsType = default, int iAddressDefault = default, int iPhoneDefault = default, int iEmailDefault = default, int iWebsiteDefault = default)
        {
