...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomCommunicationrecipientsrecipientResponse : IValidatableObject
    {
        ...
        public CustomCommunicationrecipientsrecipientResponse(int fkiAgentID = default, int fkiBrokerID = default, int fkiContactID = default, int fkiCustomerID = default, int fkiEmployeeID = default, int fkiEzsignsignerID = default, int fkiFranchiseofficeID = default, int fkiUserID = default, int fkiAgentincorporationID = default, int fkiAssistantID = default, int fkiExternalbrokerID = default, int fkiEzcomagentID = default, int fkiNotaryID = default, int fkiRewardmemberID = default, int fkiSupplierID = default, ECommunicationrecipientsrecipientObjecttypeEnum eCommunicationrecipientsrecipientObjecttype = default, CustomContactNameResponse objContactName = default, EmailResponseCompound objEmail = default, PhoneResponseCompound objPhoneFax = default, PhoneResponseCompound objPhoneSMS = default)
        {
