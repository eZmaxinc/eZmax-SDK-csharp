...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomEzmaxpricingResponse : IValidatableObject
    {
        ...
        public CustomEzmaxpricingResponse(int pkiEzmaxpricingID = default, string dEzmaxpricingRebateezsignallagents = default, string dtEzmaxpricingStart = default, string dtEzmaxpricingEnd = default)
        {
