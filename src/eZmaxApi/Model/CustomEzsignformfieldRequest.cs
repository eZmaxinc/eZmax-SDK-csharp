...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomEzsignformfieldRequest : IValidatableObject
    {
        ...
        public CustomEzsignformfieldRequest(int pkiEzsignformfieldID = default, string sEzsignformfieldLabel = default, bool bEzsignformfieldSelected = default, string sEzsignformfieldEnteredvalue = default)
        {
