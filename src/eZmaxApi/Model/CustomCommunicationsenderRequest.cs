...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomCommunicationsenderRequest : IValidatableObject
    {
        ...
        public CustomCommunicationsenderRequest(int fkiAgentID = default, int fkiBrokerID = default, int fkiMailboxsharedID = default, int fkiPhonelinesharedID = default, int fkiUserID = default)
        {
