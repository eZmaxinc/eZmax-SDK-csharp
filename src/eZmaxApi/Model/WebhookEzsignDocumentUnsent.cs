...
namespace eZmaxApi.Model
{
    ...
    public partial class WebhookEzsignDocumentUnsent : IValidatableObject
    {
        ...
        public WebhookEzsignDocumentUnsent(CustomWebhookResponse objWebhook = default, List<AttemptResponseCompound> aObjAttempt = default, EzsigndocumentResponse objEzsigndocument = default)
        {
