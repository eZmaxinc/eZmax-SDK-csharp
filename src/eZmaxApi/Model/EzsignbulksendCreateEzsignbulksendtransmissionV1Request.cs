...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignbulksend-createEzsignbulksendtransmission-v1-Request")]
    public partial class EzsignbulksendCreateEzsignbulksendtransmissionV1Request : IValidatableObject
    {
        ...
        public EzsignbulksendCreateEzsignbulksendtransmissionV1Request(int fkiUserlogintypeID = default(int), int fkiEzsigntsarequirementID = default(int), string sEzsignbulksendtransmissionDescription = default(string), string dtEzsigndocumentDuedate = default(string), FieldEEzsignfolderSendreminderfrequency eEzsignfolderSendreminderfrequency = default(FieldEEzsignfolderSendreminderfrequency), string tExtraMessage = default(string), byte[] sCsvBase64 = default(byte[]))
        {
            ...
            {
                throw new ArgumentNullException("sEzsignbulksendtransmissionDescription is a required property for EzsignbulksendCreateEzsignbulksendtransmissionV1Request and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("dtEzsigndocumentDuedate is a required property for EzsignbulksendCreateEzsignbulksendtransmissionV1Request and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("tExtraMessage is a required property for EzsignbulksendCreateEzsignbulksendtransmissionV1Request and cannot be null");
            }
            this.TExtraMessage = tExtraMessage;
            // to ensure "sCsvBase64" is required (not null)
            if (sCsvBase64 == null)
            {
                throw new ArgumentNullException("sCsvBase64 is a required property for EzsignbulksendCreateEzsignbulksendtransmissionV1Request and cannot be null");
            }
