...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "branding-getList-v1-Response")]
    public partial class BrandingGetListV1Response : IValidatableObject
    {
        ...
        public BrandingGetListV1Response(CommonResponseObjDebugPayloadGetList objDebugPayload = default(CommonResponseObjDebugPayloadGetList), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), BrandingGetListV1ResponseMPayload mPayload = default(BrandingGetListV1ResponseMPayload))
        {
            ...
            {
                throw new ArgumentNullException("objDebugPayload is a required property for BrandingGetListV1Response and cannot be null");
            }
            this.ObjDebugPayload = objDebugPayload;
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new ArgumentNullException("mPayload is a required property for BrandingGetListV1Response and cannot be null");
            }
