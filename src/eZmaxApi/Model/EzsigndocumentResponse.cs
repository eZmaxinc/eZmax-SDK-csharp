...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigndocumentResponse : IValidatableObject
    {
        ...
        public EzsigndocumentResponse(int pkiEzsigndocumentID = default, int fkiEzsignfolderID = default, int fkiEzsignfoldersignerassociationIDDeclinedtosign = default, string dtEzsigndocumentDuedate = default, string dtEzsignformCompleted = default, int fkiLanguageID = default, string sEzsigndocumentName = default, FieldEEzsigndocumentStep eEzsigndocumentStep = default, string dtEzsigndocumentFirstsend = default, string dtEzsigndocumentLastsend = default, int iEzsigndocumentOrder = default, int iEzsigndocumentPagetotal = default, int iEzsigndocumentSignaturesigned = default, int iEzsigndocumentSignaturetotal = default, int iEzsigndocumentFormfieldtotal = default, string sEzsigndocumentMD5initial = default, string tEzsigndocumentDeclinedtosignreason = default, string sEzsigndocumentMD5signed = default, bool bEzsigndocumentEzsignform = default, bool bEzsigndocumentHassignedsignatures = default, bool bEzsigndocumentSendtoged = default, CommonAudit objAudit = default, string sEzsigndocumentExternalid = default, int iEzsigndocumentEzsignsignatureattachmenttotal = default, int iEzsigndocumentEzsigndiscussiontotal = default)
        {
            ...
            {
                throw new ArgumentNullException("dtEzsigndocumentDuedate is a required property for EzsigndocumentResponse and cannot be null");
            }
            this.DtEzsigndocumentDuedate = dtEzsigndocumentDuedate;
            // to ensure "sEzsigndocumentName" is required (not null)
            if (sEzsigndocumentName == null)
            {
                throw new ArgumentNullException("sEzsigndocumentName is a required property for EzsigndocumentResponse and cannot be null");
            }
