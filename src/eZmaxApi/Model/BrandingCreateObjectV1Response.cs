...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "branding-createObject-v1-Response")]
    public partial class BrandingCreateObjectV1Response : IEquatable<BrandingCreateObjectV1Response>, IValidatableObject
    {
        ...
        public BrandingCreateObjectV1Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), BrandingCreateObjectV1ResponseMPayload mPayload = default(BrandingCreateObjectV1ResponseMPayload))
        {
            // to ensure "objDebugPayload" is required (not null)
            if (objDebugPayload == null)
            {
                throw new ArgumentNullException("objDebugPayload is a required property for BrandingCreateObjectV1Response and cannot be null");
            }
            this.ObjDebugPayload = objDebugPayload;
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new ArgumentNullException("mPayload is a required property for BrandingCreateObjectV1Response and cannot be null");
            }
