...
namespace eZmaxApi.Model
{
    ...
    public partial class CommonResponseGetList : IValidatableObject
    {
        ...
        public CommonResponseGetList(CommonResponseObjDebugPayloadGetList objDebugPayload = default, CommonResponseObjDebug objDebug = default)
        {
            // to ensure "objDebugPayload" is required (not null)
            if (objDebugPayload == null)
            {
                throw new ArgumentNullException("objDebugPayload is a required property for CommonResponseGetList and cannot be null");
            }
