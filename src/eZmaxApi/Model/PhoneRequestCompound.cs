...
namespace eZmaxApi.Model
{
    ...
    public partial class PhoneRequestCompound : IValidatableObject
    {
        ...
        public PhoneRequestCompound(int  = default(int), int  = default(int), FieldEPhoneType?  = default(FieldEPhoneType?), string  = default(string), string  = default(string), string  = default(string), string  = default(string), string  = default(string), string  = default(string))
        {
            this.FkiPhonetypeID = ;
            this.PkiPhoneID = ;
            this.EPhoneType = ;
