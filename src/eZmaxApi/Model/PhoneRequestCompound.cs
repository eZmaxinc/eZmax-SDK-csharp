...
namespace eZmaxApi.Model
{
    ...
    public partial class PhoneRequestCompound : IValidatableObject
    {
        ...
        public PhoneRequestCompound(int pkiPhoneID = default, int fkiPhonetypeID = default, FieldEPhoneType? ePhoneType = default, string sPhoneRegion = default, string sPhoneExchange = default, string sPhoneNumber = default, string sPhoneInternational = default, string sPhoneExtension = default, string sPhoneE164 = default)
        {
