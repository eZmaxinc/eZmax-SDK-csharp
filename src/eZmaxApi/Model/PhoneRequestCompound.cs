...
namespace eZmaxApi.Model
{
    ...
    public partial class PhoneRequestCompound :  IEquatable<PhoneRequestCompound>, IValidatableObject
    {
        ...
        public PhoneRequestCompound(int fkiPhonetypeID = default(int), FieldEPhoneType ePhoneType = default(FieldEPhoneType), string sPhoneRegion = default(string), string sPhoneExchange = default(string), string sPhoneNumber = default(string), string sPhoneInternational = default(string), string sPhoneExtension = default(string))
        {
            ...
            if (ePhoneType == null)
            {
                throw new InvalidDataException("ePhoneType is a required property for PhoneRequestCompound and cannot be null");
            }
            else
            {
