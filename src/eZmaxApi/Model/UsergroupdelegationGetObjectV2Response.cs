...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "usergroupdelegation-getObject-v2-Response")]
    public partial class UsergroupdelegationGetObjectV2Response : IEquatable<UsergroupdelegationGetObjectV2Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UsergroupdelegationGetObjectV2Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UsergroupdelegationGetObjectV2Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UsergroupdelegationGetObjectV2Response" /> class.
        /// </summary>
        ...
        public UsergroupdelegationGetObjectV2Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), UsergroupdelegationGetObjectV2ResponseMPayload mPayload = default(UsergroupdelegationGetObjectV2ResponseMPayload))
        {
            // to ensure "objDebugPayload" is required (not null)
            if (objDebugPayload == null)
            {
                throw new ArgumentNullException("objDebugPayload is a required property for UsergroupdelegationGetObjectV2Response and cannot be null");
            }
            this.ObjDebugPayload = objDebugPayload;
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new ArgumentNullException("mPayload is a required property for UsergroupdelegationGetObjectV2Response and cannot be null");
            }
        ...
        {
            return this.Equals(input as UsergroupdelegationGetObjectV2Response);
        }

        /// <summary>
        /// Returns true if UsergroupdelegationGetObjectV2Response instances are equal
        /// </summary>
        /// <param name="input">Instance of UsergroupdelegationGetObjectV2Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsergroupdelegationGetObjectV2Response input)
        {
            if (input == null)
            {
                return false;
