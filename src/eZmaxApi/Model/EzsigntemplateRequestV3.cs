...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplate-RequestV3")]
    public partial class EzsigntemplateRequestV3 : IValidatableObject
    {
        ...
        protected EzsigntemplateRequestV3() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplateRequestV3" /> class.
        /// </summary>
        ...
        public EzsigntemplateRequestV3(int pkiEzsigntemplateID = default, int fkiEzsignfoldertypeID = default, int fkiLanguageID = default, int fkiEzdoctemplatedocumentID = default, string sEzsigntemplateDescription = default, string sEzsigntemplateExternaldescription = default, string tEzsigntemplateComment = default, FieldEEzsigntemplateRecognition? eEzsigntemplateRecognition = default, string sEzsigntemplateFilenameregexp = default, bool bEzsigntemplateAdminonly = default, FieldEEzsigntemplateType eEzsigntemplateType = default)
        {
