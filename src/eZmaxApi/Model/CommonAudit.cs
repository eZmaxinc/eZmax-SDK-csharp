...
namespace eZmaxApi.Model
{
    ...
    public partial class CommonAudit : IValidatableObject
    {
        ...
        public CommonAudit(CommonAuditdetail objAuditdetailCreated = default, CommonAuditdetail objAuditdetailModified = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "objAuditdetailCreated", IsRequired = true, EmitDefaultValue = true)]
