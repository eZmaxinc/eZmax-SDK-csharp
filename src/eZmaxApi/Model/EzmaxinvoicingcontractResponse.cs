...
namespace eZmaxApi.Model
{
    ...
    public partial class EzmaxinvoicingcontractResponse : IValidatableObject
    {
        ...
        public EzmaxinvoicingcontractResponse(int pkiEzmaxinvoicingcontractID = default, FieldEEzmaxinvoicingcontractPaymenttype eEzmaxinvoicingcontractPaymenttype = default, int iEzmaxinvoicingcontractLength = default, string dtEzmaxinvoicingcontractStart = default, string dtEzmaxinvoicingcontractEnd = default, string dEzmaxinvoicingcontractLicense = default, string dEzmaxinvoicingcontract121qa = default, bool bEzmaxinvoicingcontractEzsignallagents = default, CommonAudit objAudit = default)
        {
