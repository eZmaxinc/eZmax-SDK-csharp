...
namespace eZmaxApi.Model
{
    ...
    public partial class PaymenttermResponseCompound :  IEquatable<PaymenttermResponseCompound>, IValidatableObject
    {
        ...
        public PaymenttermResponseCompound(int pkiPaymenttermID = default(int), string sPaymenttermCode = default(string), MultilingualPaymenttermDescription objPaymenttermDescription = default(MultilingualPaymenttermDescription), bool bPaymenttermIsactive = default(bool), CommonAudit objAudit = default(CommonAudit))
        {
