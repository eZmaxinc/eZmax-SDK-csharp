...
namespace eZmaxApi.Model
{
    ...
    public partial class PaymenttermResponseCompound : IValidatableObject
    {
        ...
        /// <param name=""> (required).</param>
        public PaymenttermResponseCompound(int  = default(int), string  = default(string), FieldEPaymenttermType  = default(FieldEPaymenttermType), int  = default(int), MultilingualPaymenttermDescription  = default(MultilingualPaymenttermDescription), bool  = default(bool), CommonAudit  = default(CommonAudit))
        {
            this.PkiPaymenttermID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for PaymenttermResponseCompound and cannot be null");
            }
