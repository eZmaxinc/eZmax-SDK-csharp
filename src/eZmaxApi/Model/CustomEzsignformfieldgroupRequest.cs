...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomEzsignformfieldgroupRequest : IValidatableObject
    {
        ...
        public CustomEzsignformfieldgroupRequest(int pkiEzsignformfieldgroupID = default, string sEzsignformfieldgroupLabel = default, List<CustomEzsignformfieldRequest> aObjEzsignformfield = default)
        {
