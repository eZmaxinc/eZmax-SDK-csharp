...
namespace eZmaxApi.Model
{
    ...
    public partial class CommonResponseErrorWrongFranchiseoffice : IValidatableObject
    {
        ...
        public CommonResponseErrorWrongFranchiseoffice(string sErrorMessage = default, FieldEErrorCode eErrorCode = default, List<string> aSErrorMessagedetail = default, int fkiFranchiseagenceID = default, string sFranchiseagenceName = default, int fkiFranchiseofficeID = default, string iFranchiseofficeCode = default)
        {
