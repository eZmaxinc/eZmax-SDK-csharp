...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigndocumentEndPrematurelyV1Response : IValidatableObject
    {
        ...
        public EzsigndocumentEndPrematurelyV1Response(CommonResponseObjDebugPayload objDebugPayload = default, CommonResponseObjDebug objDebug = default)
        {
            // to ensure "objDebugPayload" is required (not null)
            if (objDebugPayload == null)
            {
                throw new ArgumentNullException("objDebugPayload is a required property for EzsigndocumentEndPrematurelyV1Response and cannot be null");
            }
