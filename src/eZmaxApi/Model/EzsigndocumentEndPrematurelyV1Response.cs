...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigndocument-endPrematurely-v1-Response")]
    public partial class EzsigndocumentEndPrematurelyV1Response : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        public EzsigndocumentEndPrematurelyV1Response(CommonResponseObjDebugPayload  = default(CommonResponseObjDebugPayload), CommonResponseObjDebug  = default(CommonResponseObjDebug))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigndocumentEndPrematurelyV1Response and cannot be null");
            }
