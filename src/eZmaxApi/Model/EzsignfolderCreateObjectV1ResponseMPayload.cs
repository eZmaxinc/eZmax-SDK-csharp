...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfolderCreateObjectV1ResponseMPayload : IValidatableObject
    {
        ...
        public EzsignfolderCreateObjectV1ResponseMPayload(List<int> aPkiEzsignfolderID = default)
        {
            // to ensure "aPkiEzsignfolderID" is required (not null)
            if (aPkiEzsignfolderID == null)
            {
                throw new ArgumentNullException("aPkiEzsignfolderID is a required property for EzsignfolderCreateObjectV1ResponseMPayload and cannot be null");
            }
