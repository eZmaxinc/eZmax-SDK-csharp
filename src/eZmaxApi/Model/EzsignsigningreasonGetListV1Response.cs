...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsigningreasonGetListV1Response : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        /// <param name=""> (required).</param>
        public EzsignsigningreasonGetListV1Response(CommonResponseObjDebugPayloadGetList  = default(CommonResponseObjDebugPayloadGetList), CommonResponseObjDebug  = default(CommonResponseObjDebug), EzsignsigningreasonGetListV1ResponseMPayload  = default(EzsignsigningreasonGetListV1ResponseMPayload))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignsigningreasonGetListV1Response and cannot be null");
            }
