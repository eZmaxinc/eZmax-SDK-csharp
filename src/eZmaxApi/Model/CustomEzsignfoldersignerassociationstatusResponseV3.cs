...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Custom-Ezsignfoldersignerassociationstatus-ResponseV3")]
    public partial class CustomEzsignfoldersignerassociationstatusResponseV3 : IValidatableObject
    {
        ...
        protected CustomEzsignfoldersignerassociationstatusResponseV3() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomEzsignfoldersignerassociationstatusResponseV3" /> class.
        /// </summary>
        ...
        public CustomEzsignfoldersignerassociationstatusResponseV3(int fkiEzsignfoldersignerassociationID = default, string sEzsignfoldersignerassociationstatusLastname = default, string sEzsignfoldersignerassociationstatusFirstname = default, string sEzsignfoldersignerassociationstatusDescriptionX = default, List<CustomEzsignsignaturestatusResponse> aObjEzsignsignaturestatus = default)
        {
            this.FkiEzsignfoldersignerassociationID = fkiEzsignfoldersignerassociationID;
            // to ensure "aObjEzsignsignaturestatus" is required (not null)
            if (aObjEzsignsignaturestatus == null)
            {
                throw new ArgumentNullException("aObjEzsignsignaturestatus is a required property for CustomEzsignfoldersignerassociationstatusResponseV3 and cannot be null");
            }
