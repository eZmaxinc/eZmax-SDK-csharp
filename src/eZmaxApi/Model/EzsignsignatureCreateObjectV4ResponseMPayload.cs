...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignsignature-createObject-v4-Response-mPayload")]
    public partial class EzsignsignatureCreateObjectV4ResponseMPayload : IValidatableObject
    {
        ...
        protected EzsignsignatureCreateObjectV4ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignsignatureCreateObjectV4ResponseMPayload" /> class.
        /// </summary>
        ...
        public EzsignsignatureCreateObjectV4ResponseMPayload(List<int> aPkiEzsignsignatureID = default)
        {
            // to ensure "aPkiEzsignsignatureID" is required (not null)
            if (aPkiEzsignsignatureID == null)
            {
                throw new ArgumentNullException("aPkiEzsignsignatureID is a required property for EzsignsignatureCreateObjectV4ResponseMPayload and cannot be null");
            }
