...
namespace eZmaxApi.Model
{
    ...
    public partial class EzmaxinvoicingsummaryexternaldetailResponse : IValidatableObject
    {
        ...
        public EzmaxinvoicingsummaryexternaldetailResponse(int pkiEzmaxinvoicingsummaryexternaldetailID = default, int fkiEzmaxinvoicingsummaryexternalID = default, int fkiEzmaxproductID = default, string sEzmaxproductDescriptionX = default, string dEzmaxinvoicingsummaryexternaldetailCountreal = default, string dEzmaxinvoicingsummaryexternaldetailSubtotal = default, string dEzmaxinvoicingsummaryexternaldetailRebate = default, string dEzmaxinvoicingsummaryexternaldetailTotal = default, bool bEzmaxinvoicingsummaryexternaldetailAdjustment = default, string tEzmaxproductHelpX = default)
        {
