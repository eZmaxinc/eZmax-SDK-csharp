...
namespace eZmaxApi.Model
{
    ...
    public partial class EzmaxinvoicingsummaryexternaldetailResponse : IValidatableObject
    {
        ...
        public EzmaxinvoicingsummaryexternaldetailResponse(int  = default(int), int  = default(int), int  = default(int), string  = default(string), string  = default(string), string  = default(string), string  = default(string), string  = default(string), bool  = default(bool), string  = default(string))
        {
            this.FkiEzmaxproductID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzmaxinvoicingsummaryexternaldetailResponse and cannot be null");
            }
