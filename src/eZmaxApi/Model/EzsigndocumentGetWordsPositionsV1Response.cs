...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigndocumentGetWordsPositionsV1Response : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        /// <param name="">Payload for POST /1/object/ezsigndocument/{pkiEzsigndocumentID}/getWordsPositions (required).</param>
        public EzsigndocumentGetWordsPositionsV1Response(CommonResponseObjDebugPayload  = default(CommonResponseObjDebugPayload), CommonResponseObjDebug  = default(CommonResponseObjDebug), List<CustomWordPositionWordResponse>  = default(List<CustomWordPositionWordResponse>))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigndocumentGetWordsPositionsV1Response and cannot be null");
            }
