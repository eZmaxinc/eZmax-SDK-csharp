...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignbulksendsignermappingRequest : IValidatableObject
    {
        ...
        public EzsignbulksendsignermappingRequest(int pkiEzsignbulksendsignermappingID = default, int fkiEzsignbulksendID = default, int fkiUserID = default, bool bEzsignbulksendsignermappingReceivecopy = default, string sEzsignbulksendsignermappingDescription = default)
        {
