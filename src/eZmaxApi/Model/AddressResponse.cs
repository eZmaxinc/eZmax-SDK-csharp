...
namespace eZmaxApi.Model
{
    ...
    public partial class AddressResponse : IValidatableObject
    {
        ...
        public AddressResponse(int pkiAddressID = default, int fkiAddresstypeID = default, string sAddressCivic = default, string sAddressStreet = default, string sAddressSuite = default, string sAddressCity = default, int fkiProvinceID = default, string sProvinceNameX = default, int fkiCountryID = default, string sCountryNameX = default, string sAddressZip = default, string fAddressLongitude = default, string fAddressLatitude = default)
        {
            ...
            {
                throw new ArgumentNullException("sAddressCivic is a required property for AddressResponse and cannot be null");
            }
            this.SAddressCivic = sAddressCivic;
            // to ensure "sAddressStreet" is required (not null)
            if (sAddressStreet == null)
            {
                throw new ArgumentNullException("sAddressStreet is a required property for AddressResponse and cannot be null");
            }
            this.SAddressStreet = sAddressStreet;
            // to ensure "sAddressCity" is required (not null)
            if (sAddressCity == null)
            {
                throw new ArgumentNullException("sAddressCity is a required property for AddressResponse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sProvinceNameX is a required property for AddressResponse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sCountryNameX is a required property for AddressResponse and cannot be null");
            }
            this.SCountryNameX = sCountryNameX;
            // to ensure "sAddressZip" is required (not null)
            if (sAddressZip == null)
            {
                throw new ArgumentNullException("sAddressZip is a required property for AddressResponse and cannot be null");
            }
