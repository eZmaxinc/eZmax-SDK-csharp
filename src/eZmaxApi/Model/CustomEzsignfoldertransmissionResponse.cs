...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomEzsignfoldertransmissionResponse : IValidatableObject
    {
        ...
        public CustomEzsignfoldertransmissionResponse(int pkiEzsignfolderID = default, string sEzsignfolderDescription = default, FieldEEzsignfolderStep eEzsignfolderStep = default, int iEzsignfolderSignaturetotal = default, int iEzsignfolderFormfieldtotal = default, int iEzsignfolderSignaturesigned = default, List<CustomEzsignfoldertransmissionSignerResponse> aObjEzsignfoldertransmissionSigner = default)
        {
