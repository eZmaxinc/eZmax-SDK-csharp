...
namespace eZmaxApi.Model
{
    ...
    /// A Discussion Object
    /// </summary>
    [DataContract(Name = "discussion-Response")]
    public partial class DiscussionResponse : IValidatableObject
    {
        ...
        public DiscussionResponse(int pkiDiscussionID = default, string sDiscussionDescription = default, bool bDiscussionClosed = default, string dtDiscussionLastread = default, int iDiscussionmessageCount = default, int iDiscussionmessageCountunread = default, CustomDiscussionconfigurationResponse objDiscussionconfiguration = default)
        {
