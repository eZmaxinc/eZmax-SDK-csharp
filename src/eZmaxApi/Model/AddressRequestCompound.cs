...
namespace eZmaxApi.Model
{
    ...
    public partial class AddressRequestCompound : IValidatableObject
    {
        ...
        public AddressRequestCompound(int pkiAddressID = default, int fkiAddresstypeID = default, string sAddressCivic = default, string sAddressStreet = default, string sAddressSuite = default, string sAddressCity = default, int fkiProvinceID = default, int fkiCountryID = default, string sAddressZip = default, string fAddressLongitude = default, string fAddressLatitude = default)
        {
