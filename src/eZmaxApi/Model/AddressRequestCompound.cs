...
namespace eZmaxApi.Model
{
    ...
    public partial class AddressRequestCompound : IValidatableObject
    {
        ...
        public AddressRequestCompound(int fkiAddresstypeID = default(int), string sAddressCivic = default(string), string sAddressStreet = default(string), string sAddressSuite = default(string), string sAddressCity = default(string), int fkiProvinceID = default(int), int fkiCountryID = default(int), string sAddressZip = default(string), string fAddressLongitude = default(string), string fAddressLatitude = default(string))
        {
            this.FkiAddresstypeID = fkiAddresstypeID;
            // to ensure "sAddressCivic" is required (not null)
            if (sAddressCivic == null)
            {
                throw new ArgumentNullException("sAddressCivic is a required property for AddressRequestCompound and cannot be null");
            }
            this.SAddressCivic = sAddressCivic;
            // to ensure "sAddressStreet" is required (not null)
            if (sAddressStreet == null)
            {
                throw new ArgumentNullException("sAddressStreet is a required property for AddressRequestCompound and cannot be null");
            }
            this.SAddressStreet = sAddressStreet;
            // to ensure "sAddressSuite" is required (not null)
            if (sAddressSuite == null)
            {
                throw new ArgumentNullException("sAddressSuite is a required property for AddressRequestCompound and cannot be null");
            }
            this.SAddressSuite = sAddressSuite;
            // to ensure "sAddressCity" is required (not null)
            if (sAddressCity == null)
            {
                throw new ArgumentNullException("sAddressCity is a required property for AddressRequestCompound and cannot be null");
            }
            ...
            if (sAddressZip == null)
            {
                throw new ArgumentNullException("sAddressZip is a required property for AddressRequestCompound and cannot be null");
            }
        ...
        /* <example>610</example>*/
        [DataMember(Name = "sAddressSuite", IsRequired = true, EmitDefaultValue = true)]
