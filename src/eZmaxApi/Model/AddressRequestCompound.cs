...
namespace eZmaxApi.Model
{
    ...
    public partial class AddressRequestCompound : IValidatableObject
    {
        ...
        public AddressRequestCompound(int  = default(int), int  = default(int), string  = default(string), string  = default(string), string  = default(string), string  = default(string), int  = default(int), int  = default(int), string  = default(string), string  = default(string), string  = default(string))
        {
            this.FkiAddresstypeID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for AddressRequestCompound and cannot be null");
            }
            this.SAddressCivic = ;
            // to ensure "" is required (not null)
            if ( == null)
        ...
        /* <example>142</example>*/
        [DataMember(Name = "pkiAddressID", EmitDefaultValue = false)]
