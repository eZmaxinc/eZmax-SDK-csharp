...
namespace eZmaxApi.Model
{
    ...
    public partial class BillingentityinternalproductRequest : IValidatableObject
    {
        ...
        public BillingentityinternalproductRequest(int pkiBillingentityinternalproductID = default, int fkiEzmaxproductID = default, int fkiBillingentityexternalID = default)
        {
