...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "attachment-Response")]
    public partial class AttachmentResponse : IValidatableObject
    {
        ...
        /// <param name="">The unique ID of the User.</param>
        /// <param name="">.</param>
        public AttachmentResponse(int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), FieldEAttachmentDocumenttype  = default(FieldEAttachmentDocumenttype), string  = default(string), FieldEAttachmentPrivacy  = default(FieldEAttachmentPrivacy), int  = default(int), FieldEAttachmentType  = default(FieldEAttachmentType), int  = default(int), int  = default(int), string  = default(string), bool  = default(bool), bool  = default(bool), FieldEAttachmentVerified  = default(FieldEAttachmentVerified), string  = default(string), int  = default(int), CommonAudit  = default(CommonAudit))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for AttachmentResponse and cannot be null");
            }
