...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignatureSignV1Response : IValidatableObject
    {
        ...
        public EzsignsignatureSignV1Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), EzsignsignatureSignV1ResponseMPayload mPayload = default(EzsignsignatureSignV1ResponseMPayload))
        {
