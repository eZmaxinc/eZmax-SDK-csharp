...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignatureSignV1Response :  IEquatable<EzsignsignatureSignV1Response>, IValidatableObject
    {
        ...
        protected EzsignsignatureSignV1Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignsignatureSignV1Response" /> class.
        /// </summary>
        /// <param name="mPayload">Payload for POST /1/object/ezsignsignature/{pkiEzsignsignatureID}/sign (required).</param>
        /// <param name="objDebugPayload">objDebugPayload.</param>
        /// <param name="objDebug">objDebug.</param>
        public EzsignsignatureSignV1Response(Object mPayload = default(Object), CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug))
        {
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new InvalidDataException("mPayload is a required property for EzsignsignatureSignV1Response and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Payload for POST /1/object/ezsignsignature/{pkiEzsignsignatureID}/sign</value>
