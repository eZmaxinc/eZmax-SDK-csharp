...
namespace eZmaxApi.Model
{
    ...
    public partial class CommunicationRequestCompound : IValidatableObject
    {
        ...
        public CommunicationRequestCompound(int pkiCommunicationID = default, FieldECommunicationImportance? eCommunicationImportance = default, FieldECommunicationType eCommunicationType = default, CustomCommunicationsenderRequest objCommunicationsender = default, string sCommunicationSubject = default, string tCommunicationBody = default, bool bCommunicationPrivate = default, ECommunicationAttachmenttypeEnum? eCommunicationAttachmenttype = default, int iCommunicationAttachmentlinkexpiration = default, bool bCommunicationReadreceipt = default, List<CustomCommunicationattachmentRequest> aObjCommunicationattachment = default, List<CommunicationrecipientRequestCompound> aObjCommunicationrecipient = default, List<CommunicationreferenceRequestCompound> aObjCommunicationreference = default, List<CommunicationexternalrecipientRequestCompound> aObjCommunicationexternalrecipient = default)
        {
