...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "billingentityexternal-generateFederationToken-v1-Request")]
    public partial class BillingentityexternalGenerateFederationTokenV1Request : IValidatableObject
    {
        ...
        protected BillingentityexternalGenerateFederationTokenV1Request() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BillingentityexternalGenerateFederationTokenV1Request" /> class.
        /// </summary>
        /// <param name="fksEzmaxcustomerCode">The Ezmaxcustomer code (required).</param>
        public BillingentityexternalGenerateFederationTokenV1Request(string fksEzmaxcustomerCode = default(string))
        {
            // to ensure "fksEzmaxcustomerCode" is required (not null)
            if (fksEzmaxcustomerCode == null)
            {
                throw new ArgumentNullException("fksEzmaxcustomerCode is a required property for BillingentityexternalGenerateFederationTokenV1Request and cannot be null");
            }
