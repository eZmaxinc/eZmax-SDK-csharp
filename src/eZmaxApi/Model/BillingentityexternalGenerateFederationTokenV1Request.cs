...
namespace eZmaxApi.Model
{
    ...
    public partial class BillingentityexternalGenerateFederationTokenV1Request : IValidatableObject
    {
        ...
        public BillingentityexternalGenerateFederationTokenV1Request(string  = default(string))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for BillingentityexternalGenerateFederationTokenV1Request and cannot be null");
            }
