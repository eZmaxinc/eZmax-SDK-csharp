...
namespace eZmaxApi.Model
{
    ...
    public partial class InscriptionnotauthenticatedListElement : IValidatableObject
    {
        ...
        /// <param name="bInscriptionnotauthenticatedDraft">Whether the Inscriptionnotauthenticated is a draft or not.</param>
        ...
        public InscriptionnotauthenticatedListElement(int pkiInscriptionID = default, int pkiInscriptionnotauthenticatedID = default, int fkiInscriptiontypeID = default, string sInscriptiontypeNameX = default, int fkiInscriptionbuildingtypeID = default, string sInscriptionbuildingtypeNameX = default, int fkiInscriptioncategoryID = default, string sInscriptioncategoryNameX = default, int fkiBuyercontractID = default, string sBuyercontractContract = default, FieldEInscriptionStep eInscriptionStep = default, FieldEInscriptionType eInscriptionType = default, string sInscriptionCivicend = default, string sInscriptionMLS = default, string sInscriptionContract = default, string dInscriptionSaleprice = default, string dInscriptionRentprice = default, string dtInscriptionDate = default, string dtInscriptionExpirationdate = default, string dtInscriptionNotarydate = default, bool bInscriptionInspection = default, bool bInscriptionIsactive = default, bool bInscriptionArchived = default, string dtInscriptionnotauthenticatedNotaryscheduledate = default, string dtInscriptionnotauthenticatedTransactiondate = default, string dtInscriptionnotauthenticatedTransactiondateReal = default, bool bInscriptionnotauthenticatedConditional = default, bool bInscriptionnotauthenticatedIsactive = default, bool bInscriptionnotauthenticatedDraft = default, string sAddressCivic = default, string sAddressStreet = default, string sAddressSuite = default, string sAddressCity = default, string sAddressZip = default, int fkiProvinceID = default, string sProvinceNameX = default, int fkiCountryID = default, string sCountryNameX = default, string sInscriptionnotauthenticatedOffertopurchasenumber = default, int iInscriptionUnit = default)
        {
            ...
            {
                throw new ArgumentNullException("sInscriptionbuildingtypeNameX is a required property for InscriptionnotauthenticatedListElement and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sInscriptioncategoryNameX is a required property for InscriptionnotauthenticatedListElement and cannot be null");
            }
        ...
        */
        ...
        <example>true</example>
        */
        [DataMember(Name = "bInscriptionnotauthenticatedDraft", EmitDefaultValue = true)]
