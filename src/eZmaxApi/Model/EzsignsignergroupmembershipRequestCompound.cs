...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignergroupmembershipRequestCompound : IValidatableObject
    {
        ...
        public EzsignsignergroupmembershipRequestCompound(int pkiEzsignsignergroupmembershipID = default, int fkiEzsignsignergroupID = default, int fkiEzsignsignerID = default, int fkiUserID = default, int fkiUsergroupID = default)
        {
