...
namespace eZmaxApi.Model
{
    ...
    public partial class CreditcardtypeAutocompleteElementResponse : IValidatableObject
    {
        ...
        public CreditcardtypeAutocompleteElementResponse(string sCreditcardtypeName = default, int pkiCreditcardtypeID = default, FieldECreditcardtypeCodename eCreditcardtypeCodename = default)
        {
