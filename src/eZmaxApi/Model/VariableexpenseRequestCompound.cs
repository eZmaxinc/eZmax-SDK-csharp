...
namespace eZmaxApi.Model
{
    ...
    public partial class VariableexpenseRequestCompound : IValidatableObject
    {
        ...
        public VariableexpenseRequestCompound(int pkiVariableexpenseID = default, string sVariableexpenseCode = default, MultilingualVariableexpenseDescription objVariableexpenseDescription = default, FieldEVariableexpenseTaxable eVariableexpenseTaxable = default, bool bVariableexpenseIsactive = default)
        {
