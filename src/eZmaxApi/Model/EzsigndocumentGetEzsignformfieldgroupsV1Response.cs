...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsigndocumentGetEzsignformfieldgroupsV1Response :  IEquatable<EzsigndocumentGetEzsignformfieldgroupsV1Response>
    {
        /// <summary>
        ...
        public EzsigndocumentGetEzsignformfieldgroupsV1Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), EzsigndocumentGetEzsignformfieldgroupsV1ResponseMPayload mPayload = default(EzsigndocumentGetEzsignformfieldgroupsV1ResponseMPayload))
        {
            // to ensure "objDebugPayload" is required (not null)
            if (objDebugPayload == null)
            {
                throw new InvalidDataException("objDebugPayload is a required property for EzsigndocumentGetEzsignformfieldgroupsV1Response and cannot be null");
            }
            else
            {
