...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigndocument-getEzsignformfieldgroups-v1-Response")]
    public partial class EzsigndocumentGetEzsignformfieldgroupsV1Response : IEquatable<EzsigndocumentGetEzsignformfieldgroupsV1Response>, IValidatableObject
    {
        ...
        public EzsigndocumentGetEzsignformfieldgroupsV1Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), EzsigndocumentGetEzsignformfieldgroupsV1ResponseMPayload mPayload = default(EzsigndocumentGetEzsignformfieldgroupsV1ResponseMPayload))
        {
            ...
            {
                throw new ArgumentNullException("objDebugPayload is a required property for EzsigndocumentGetEzsignformfieldgroupsV1Response and cannot be null");
            }
            this.ObjDebugPayload = objDebugPayload;
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new ArgumentNullException("mPayload is a required property for EzsigndocumentGetEzsignformfieldgroupsV1Response and cannot be null");
            }
