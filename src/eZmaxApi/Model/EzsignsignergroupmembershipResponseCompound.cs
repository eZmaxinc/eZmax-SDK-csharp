...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignergroupmembershipResponseCompound : IValidatableObject
    {
        ...
        public EzsignsignergroupmembershipResponseCompound(int pkiEzsignsignergroupmembershipID = default, int fkiEzsignsignergroupID = default, int fkiEzsignsignerID = default, int fkiUserID = default, int fkiUsergroupID = default)
        {
