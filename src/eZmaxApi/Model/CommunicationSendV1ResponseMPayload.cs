...
namespace eZmaxApi.Model
{
    ...
    public partial class CommunicationSendV1ResponseMPayload : IValidatableObject
    {
        ...
        public CommunicationSendV1ResponseMPayload(List<int>  = default(List<int>))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for CommunicationSendV1ResponseMPayload and cannot be null");
            }
            this.APkiCommunicationID = ;
        }
