...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfolderRequestV3 : IValidatableObject
    {
        ...
        public EzsignfolderRequestV3(int  = default(int), int  = default(int), int  = default(int), int  = default(int), FieldEEzsignfolderDocumentdependency?  = default(FieldEEzsignfolderDocumentdependency?), string  = default(string), string  = default(string), string  = default(string), int  = default(int), int  = default(int), string  = default(string))
        {
            this.FkiEzsignfoldertypeID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignfolderRequestV3 and cannot be null");
            }
