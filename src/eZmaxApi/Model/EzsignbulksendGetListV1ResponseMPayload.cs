...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignbulksendGetListV1ResponseMPayload : IValidatableObject
    {
        ...
        public EzsignbulksendGetListV1ResponseMPayload(int iRowReturned = default, int iRowFiltered = default, List<EzsignbulksendListElement> aObjEzsignbulksend = default)
        {
