...
namespace eZmaxApi.Model
{
    ...
    public partial class EzmaxinvoicinguserResponseCompound : IValidatableObject
    {
        ...
        public EzmaxinvoicinguserResponseCompound(int pkiEzmaxinvoicinguserID = default, int fkiEzmaxinvoicingID = default, int fkiBillingentityinternalID = default, string sBillingentityinternalDescriptionX = default, int fkiUserID = default, int iEzmaxinvoicinguserEzsigndocument = default, bool bEzmaxinvoicinguserEzsignaccount = default, bool bEzmaxinvoicinguserBillableezsign = default, FieldEEzmaxinvoicinguserVariationezsign eEzmaxinvoicinguserVariationezsign = default, CustomContactNameResponse objContactName = default)
        {
