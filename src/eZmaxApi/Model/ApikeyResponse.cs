...
namespace eZmaxApi.Model
{
    ...
    public partial class ApikeyResponse :  IEquatable<ApikeyResponse>, IValidatableObject
    {
        ...
        public ApikeyResponse(int pkiApikeyID = default(int), int fkiUserID = default(int), MultilingualApikeyDescription objApikeyDescription = default(MultilingualApikeyDescription), string sComputedToken = default(string), bool bApikeyIsactive = default(bool), CommonAudit objAudit = default(CommonAudit))
        {
