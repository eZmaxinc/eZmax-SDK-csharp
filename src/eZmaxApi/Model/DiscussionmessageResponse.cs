...
namespace eZmaxApi.Model
{
    ...
    public partial class DiscussionmessageResponse : IValidatableObject
    {
        ...
        /// <param name=""> (required).</param>
        public DiscussionmessageResponse(int  = default(int), int  = default(int), int  = default(int), int  = default(int), FieldEDiscussionmessageStatus  = default(FieldEDiscussionmessageStatus), string  = default(string), string  = default(string), string  = default(string), CommonAudit  = default(CommonAudit))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for DiscussionmessageResponse and cannot be null");
            }
