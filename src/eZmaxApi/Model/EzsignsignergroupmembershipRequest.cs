...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignergroupmembershipRequest : IValidatableObject
    {
        ...
        public EzsignsignergroupmembershipRequest(int pkiEzsignsignergroupmembershipID = default, int fkiEzsignsignergroupID = default, int fkiEzsignsignerID = default, int fkiUserID = default, int fkiUsergroupID = default)
        {
