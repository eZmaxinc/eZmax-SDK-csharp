...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatepublicResponseCompound : IValidatableObject
    {
        ...
        public EzsigntemplatepublicResponseCompound(int  = default(int), int  = default(int), string  = default(string), int  = default(int), string  = default(string), int  = default(int), int  = default(int), string  = default(string), string  = default(string), bool  = default(bool), string  = default(string), FieldEEzsigntemplatepublicLimittype  = default(FieldEEzsigntemplatepublicLimittype), int  = default(int), int  = default(int), string  = default(string), string  = default(string), string  = default(string), CommonAudit  = default(CommonAudit), List<CustomEzsignfolderezsigntemplatepublicResponse>  = default(List<CustomEzsignfolderezsigntemplatepublicResponse>))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplatepublicResponseCompound and cannot be null");
            }
            ...
            this.AObjEzsignfolderezsigntemplatepublic = ;
