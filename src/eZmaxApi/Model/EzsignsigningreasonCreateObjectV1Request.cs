...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignsigningreason-createObject-v1-Request")]
    public partial class EzsignsigningreasonCreateObjectV1Request : IValidatableObject
    {
        ...
        protected EzsignsigningreasonCreateObjectV1Request() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignsigningreasonCreateObjectV1Request" /> class.
        /// </summary>
        /// <param name="aObjEzsignsigningreason">aObjEzsignsigningreason (required).</param>
        public EzsignsigningreasonCreateObjectV1Request(List<EzsignsigningreasonRequestCompound> aObjEzsignsigningreason = default)
        {
