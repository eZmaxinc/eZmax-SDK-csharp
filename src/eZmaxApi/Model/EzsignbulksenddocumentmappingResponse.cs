...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignbulksenddocumentmappingResponse : IValidatableObject
    {
        ...
        public EzsignbulksenddocumentmappingResponse(int pkiEzsignbulksenddocumentmappingID = default, int fkiEzsignbulksendID = default, int fkiEzsigntemplatepackageID = default, int fkiEzsigntemplateID = default, int iEzsignbulksenddocumentmappingOrder = default)
        {
