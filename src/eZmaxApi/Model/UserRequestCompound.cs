...
namespace eZmaxApi.Model
{
    ...
    public partial class UserRequestCompound : IValidatableObject
    {
        ...
        public UserRequestCompound(int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), EmailRequestCompound  = default(EmailRequestCompound), int  = default(int), PhoneRequestCompound  = default(PhoneRequestCompound), PhoneRequestCompound  = default(PhoneRequestCompound), int  = default(int), string  = default(string), int  = default(int), FieldEUserType  = default(FieldEUserType), FieldEUserLogintype  = default(FieldEUserLogintype), string  = default(string), string  = default(string), string  = default(string), string  = default(string), FieldEUserEzsignaccess  = default(FieldEUserEzsignaccess), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for UserRequestCompound and cannot be null");
            }
            this.ObjEmail = ;
