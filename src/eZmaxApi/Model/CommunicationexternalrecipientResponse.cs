...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "communicationexternalrecipient-Response")]
    public partial class CommunicationexternalrecipientResponse : IEquatable<CommunicationexternalrecipientResponse>, IValidatableObject
    {
        ...
        public CommunicationexternalrecipientResponse(int pkiCommunicationexternalrecipientID = default(int), FieldECommunicationexternalrecipientType eCommunicationexternalrecipientType = default(FieldECommunicationexternalrecipientType), DescriptionstaticResponseCompound objDescriptionstatic = default(DescriptionstaticResponseCompound), EmailstaticResponseCompound objEmailstatic = default(EmailstaticResponseCompound), PhonestaticResponseCompound objPhonestatic = default(PhonestaticResponseCompound))
        {
            ...
            {
                throw new ArgumentNullException("objDescriptionstatic is a required property for CommunicationexternalrecipientResponse and cannot be null");
            }
