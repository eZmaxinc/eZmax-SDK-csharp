...
namespace eZmaxApi.Model
{
    ...
    public partial class CommunicationexternalrecipientResponse :  IEquatable<CommunicationexternalrecipientResponse>, IValidatableObject
    {
        ...
        public CommunicationexternalrecipientResponse(int pkiCommunicationexternalrecipientID = default(int), string sEmailAddress = default(string), PhoneResponseCompound objPhoneSms = default(PhoneResponseCompound), FieldECommunicationexternalrecipientType eCommunicationexternalrecipientType = default(FieldECommunicationexternalrecipientType), string sCommunicationexternalrecipientName = default(string))
        {
            ...
            {
                throw new InvalidDataException("sCommunicationexternalrecipientName is a required property for CommunicationexternalrecipientResponse and cannot be null");
            }
            else
            {
