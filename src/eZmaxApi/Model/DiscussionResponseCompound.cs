...
namespace eZmaxApi.Model
{
    ...
    public partial class DiscussionResponseCompound : IValidatableObject
    {
        ...
        public DiscussionResponseCompound(int pkiDiscussionID = default, string sDiscussionDescription = default, bool bDiscussionClosed = default, string dtDiscussionLastread = default, int iDiscussionmessageCount = default, int iDiscussionmessageCountunread = default, CustomDiscussionconfigurationResponse objDiscussionconfiguration = default, List<DiscussionmembershipResponseCompound> aObjDiscussionmembership = default, List<DiscussionmessageResponseCompound> aObjDiscussionmessage = default)
        {
