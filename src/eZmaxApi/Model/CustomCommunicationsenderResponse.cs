...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomCommunicationsenderResponse : IValidatableObject
    {
        ...
        public CustomCommunicationsenderResponse(int fkiAgentID = default, int fkiBrokerID = default, int fkiUserID = default, int fkiMailboxsharedID = default, int fkiPhonelinesharedID = default, ECommunicationsenderObjecttypeEnum eCommunicationsenderObjecttype = default, CustomContactNameResponse objContactName = default, EmailResponseCompound objEmail = default, PhoneResponseCompound objPhoneFax = default, PhoneResponseCompound objPhoneSMS = default)
        {
