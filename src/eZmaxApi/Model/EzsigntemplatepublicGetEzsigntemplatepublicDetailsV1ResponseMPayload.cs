...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatepublicGetEzsigntemplatepublicDetailsV1ResponseMPayload : IValidatableObject
    {
        ...
        public EzsigntemplatepublicGetEzsigntemplatepublicDetailsV1ResponseMPayload(Object objBranding = default(Object), int fkiUserlogintypeID = default(int), List<string> aSEzsigntemplatesignerDescription = default(List<string>))
        {
