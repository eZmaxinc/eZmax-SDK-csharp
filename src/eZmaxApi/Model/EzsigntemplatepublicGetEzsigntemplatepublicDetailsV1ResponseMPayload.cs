...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatepublicGetEzsigntemplatepublicDetailsV1ResponseMPayload : IValidatableObject
    {
        ...
        public EzsigntemplatepublicGetEzsigntemplatepublicDetailsV1ResponseMPayload(CustomBrandingResponse  = default(CustomBrandingResponse), int  = default(int), List<string>  = default(List<string>))
        {
            this.FkiUserlogintypeID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplatepublicGetEzsigntemplatepublicDetailsV1ResponseMPayload and cannot be null");
            }
