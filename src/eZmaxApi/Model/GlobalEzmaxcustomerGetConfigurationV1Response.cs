...
namespace eZmaxApi.Model
{
    ...
    public partial class GlobalEzmaxcustomerGetConfigurationV1Response : IValidatableObject
    {
        ...
        public GlobalEzmaxcustomerGetConfigurationV1Response(string sInfrastructureregionCode = default, string sInfrastructureregionCodeWeb = default, string sInfrastructureenvironmenttypeDescription = default, string sCognitoClientIDExternal = default, string sCognitoClientIDEzmaxpublic = default)
        {
