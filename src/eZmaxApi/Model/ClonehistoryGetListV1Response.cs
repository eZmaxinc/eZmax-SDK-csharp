...
namespace eZmaxApi.Model
{
    ...
    public partial class ClonehistoryGetListV1Response : IEquatable<ClonehistoryGetListV1Response>, IValidatableObject
    {
        ...
        public ClonehistoryGetListV1Response(CommonResponseObjDebugPayloadGetList objDebugPayload = default(CommonResponseObjDebugPayloadGetList), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), ClonehistoryGetListV1ResponseMPayload mPayload = default(ClonehistoryGetListV1ResponseMPayload))
        {
            ...
            {
                throw new ArgumentNullException("objDebugPayload is a required property for ClonehistoryGetListV1Response and cannot be null");
            }
            this.ObjDebugPayload = objDebugPayload;
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new ArgumentNullException("mPayload is a required property for ClonehistoryGetListV1Response and cannot be null");
            }
