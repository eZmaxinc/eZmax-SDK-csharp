...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "usergroupexternal-editObject-v1-Request")]
    public partial class UsergroupexternalEditObjectV1Request : IValidatableObject
    {
        ...
        protected UsergroupexternalEditObjectV1Request() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UsergroupexternalEditObjectV1Request" /> class.
        /// </summary>
        /// <param name="objUsergroupexternal">objUsergroupexternal (required).</param>
        public UsergroupexternalEditObjectV1Request(UsergroupexternalRequestCompound objUsergroupexternal = default)
        {
