...
namespace eZmaxApi.Model
{
    ...
    public partial class CreditcardmerchantAutocompleteElementResponse : IValidatableObject
    {
        ...
        public CreditcardmerchantAutocompleteElementResponse(int pkiCreditcardmerchantID = default, string sCreditcardmerchantDescription = default, bool bCreditcardmerchantIsactive = default)
        {
