...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "contactinformations-Response")]
    public partial class ContactinformationsResponse : IValidatableObject
    {
        ...
        protected ContactinformationsResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactinformationsResponse" /> class.
        /// </summary>
        ...
        public ContactinformationsResponse(int pkiContactinformationsID = default, int fkiAddressIDDefault = default, int fkiPhoneIDDefault = default, int fkiEmailIDDefault = default, int fkiWebsiteIDDefault = default, FieldEContactinformationsType eContactinformationsType = default, string sContactinformationsUrl = default, AddressResponseCompound objAddressDefault = default, PhoneResponseCompound objPhoneDefault = default, EmailResponseCompound objEmailDefault = default, WebsiteResponseCompound objWebsiteDefault = default)
        {
