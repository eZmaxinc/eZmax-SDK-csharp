...
namespace eZmaxApi.Model
{
    ...
    public partial class PermissionRequest : IValidatableObject
    {
        ...
        public PermissionRequest(int pkiPermissionID = default, int fkiUserID = default, int fkiApikeyID = default, int fkiUsergroupID = default, int fkiCompanyID = default, int fkiModulesectionID = default)
        {
