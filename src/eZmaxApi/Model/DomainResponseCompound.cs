...
namespace eZmaxApi.Model
{
    ...
    public partial class DomainResponseCompound : IValidatableObject
    {
        ...
        public DomainResponseCompound(int pkiDomainID = default, string sDomainName = default, bool bDomainValiddkim = default, bool bDomainValidmailfrom = default, bool bDomainValidcustomer = default, CommonAudit objAudit = default, List<CustomDnsrecordResponse> aObjDnsrecord = default)
        {
