...
namespace eZmaxApi.Model
{
    ...
    public partial class SsprUnlockAccountV1Request :  IEquatable<SsprUnlockAccountV1Request>, IValidatableObject
    {
        ...
        public SsprUnlockAccountV1Request(string pksCustomerCode = default(string), int fkiLanguageID = default(int), FieldEUserTypeSSPR eUserTypeSSPR = default(FieldEUserTypeSSPR), string sEmailAddress = default(string), string sUserLoginname = default(string), string binUserSSPRtoken = default(string))
        {
            ...
            {
                throw new InvalidDataException("pksCustomerCode is a required property for SsprUnlockAccountV1Request and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("fkiLanguageID is a required property for SsprUnlockAccountV1Request and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("eUserTypeSSPR is a required property for SsprUnlockAccountV1Request and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("binUserSSPRtoken is a required property for SsprUnlockAccountV1Request and cannot be null");
            }
            else
            {
