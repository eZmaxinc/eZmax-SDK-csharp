...
namespace eZmaxApi.Model
{
    ...
    public partial class ContactinformationsRequestCompoundV2 : ContactinformationsRequestV2, IValidatableObject
    {
        /// <summary>
        ...
        public ContactinformationsRequestCompoundV2(List<AddressRequestCompound> aObjAddress = default(List<AddressRequestCompound>), List<PhoneRequestCompound> aObjPhone = default(List<PhoneRequestCompound>), List<EmailRequestCompound> aObjEmail = default(List<EmailRequestCompound>), List<WebsiteRequestCompound> aObjWebsite = default(List<WebsiteRequestCompound>), FieldEContactinformationsType eContactinformationsType = default(FieldEContactinformationsType), int iAddressDefault = default(int), int iPhoneDefault = default(int), int iEmailDefault = default(int), int iWebsiteDefault = default(int)) : base()
        {
            // to ensure "aObjAddress" is required (not null)
            if (aObjAddress == null)
            {
                throw new ArgumentNullException("aObjAddress is a required property for ContactinformationsRequestCompoundV2 and cannot be null");
            }
            this.AObjAddress = aObjAddress;
            // to ensure "aObjPhone" is required (not null)
            if (aObjPhone == null)
            {
                throw new ArgumentNullException("aObjPhone is a required property for ContactinformationsRequestCompoundV2 and cannot be null");
            }
            this.AObjPhone = aObjPhone;
            // to ensure "aObjEmail" is required (not null)
            if (aObjEmail == null)
            {
                throw new ArgumentNullException("aObjEmail is a required property for ContactinformationsRequestCompoundV2 and cannot be null");
            }
            this.AObjEmail = aObjEmail;
            // to ensure "aObjWebsite" is required (not null)
            if (aObjWebsite == null)
            {
                throw new ArgumentNullException("aObjWebsite is a required property for ContactinformationsRequestCompoundV2 and cannot be null");
            }
