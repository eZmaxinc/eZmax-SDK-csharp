...
namespace eZmaxApi.Model
{
    ...
    public partial class ContactinformationsRequestCompoundV2 : IValidatableObject
    {
        ...
        public ContactinformationsRequestCompoundV2(FieldEContactinformationsType eContactinformationsType = default, int iAddressDefault = default, int iPhoneDefault = default, int iEmailDefault = default, int iWebsiteDefault = default, List<AddressRequestCompound> aObjAddress = default, List<PhoneRequestCompound> aObjPhone = default, List<EmailRequestCompound> aObjEmail = default, List<WebsiteRequestCompound> aObjWebsite = default)
        {
