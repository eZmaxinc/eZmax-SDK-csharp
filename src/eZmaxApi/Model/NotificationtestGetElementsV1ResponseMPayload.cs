...
namespace eZmaxApi.Model
{
    ...
    public partial class NotificationtestGetElementsV1ResponseMPayload : IValidatableObject
    {
        ...
        public NotificationtestGetElementsV1ResponseMPayload(int pkiNotificationtestID = default, string sNotificationtestFunction = default, List<string> aSVariableobjectProperty = default, List<Dictionary<string, Object>> aObjVariableobject = default)
        {
