...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignbulksendsignermappingRequestCompound : IValidatableObject
    {
        ...
        public EzsignbulksendsignermappingRequestCompound(int  = default(int), int  = default(int), int  = default(int), string  = default(string))
        {
            this.FkiEzsignbulksendID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignbulksendsignermappingRequestCompound and cannot be null");
            }
