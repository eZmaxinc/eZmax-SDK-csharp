...
dataType                            : Object
datatypeWithEnum                    : 
name                                : ezsigndocument-getWordsPositions-v1-Request
defaultValue                        : 
...
*/
    ...
    public partial class EzsigndocumentGetWordsPositionsV1Request :  IEquatable<EzsigndocumentGetWordsPositionsV1Request>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as EzsigndocumentGetWordsPositionsV1Request);
        }

        /// <summary>
        /// Returns true if EzsigndocumentGetWordsPositionsV1Request instances are equal
        /// </summary>
        /// <param name="input">Instance of EzsigndocumentGetWordsPositionsV1Request to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EzsigndocumentGetWordsPositionsV1Request input)
        {
            if (input == null)
                return false;
