...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfoldersignerassociationDeleteObjectV1Response : IValidatableObject
    {
        ...
        protected EzsignfoldersignerassociationDeleteObjectV1Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignfoldersignerassociationDeleteObjectV1Response" /> class.
        /// </summary>
        /// <param name=""> (required).</param>
        /// <param name="">.</param>
        public EzsignfoldersignerassociationDeleteObjectV1Response(CommonResponseObjDebugPayload  = default(CommonResponseObjDebugPayload), CommonResponseObjDebug  = default(CommonResponseObjDebug))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignfoldersignerassociationDeleteObjectV1Response and cannot be null");
            }
