...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsignfoldersignerassociationDeleteObjectV1Response :  IEquatable<EzsignfoldersignerassociationDeleteObjectV1Response>
    {
        /// <summary>
        ...
        public EzsignfoldersignerassociationDeleteObjectV1Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug))
        {
            ...
            {
                throw new InvalidDataException("objDebugPayload is a required property for EzsignfoldersignerassociationDeleteObjectV1Response and cannot be null");
            }
            else
            {
