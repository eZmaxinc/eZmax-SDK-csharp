...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfoldersignerassociationDeleteObjectV1Response : IValidatableObject
    {
        ...
        public EzsignfoldersignerassociationDeleteObjectV1Response(CommonResponseObjDebugPayload objDebugPayload = default, CommonResponseObjDebug objDebug = default)
        {
            // to ensure "objDebugPayload" is required (not null)
            if (objDebugPayload == null)
            {
                throw new ArgumentNullException("objDebugPayload is a required property for EzsignfoldersignerassociationDeleteObjectV1Response and cannot be null");
            }
