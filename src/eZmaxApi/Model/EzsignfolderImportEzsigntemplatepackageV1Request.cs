...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfolderImportEzsigntemplatepackageV1Request : IValidatableObject
    {
        ...
        public EzsignfolderImportEzsigntemplatepackageV1Request(int fkiEzsigntemplatepackageID = default, string dtEzsigndocumentDuedate = default, List<CustomImportEzsigntemplatepackageRelationRequest> aObjImportEzsigntemplatepackageRelation = default)
        {
