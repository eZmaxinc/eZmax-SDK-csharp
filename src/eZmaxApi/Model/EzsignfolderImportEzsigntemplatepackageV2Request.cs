...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignfolder-importEzsigntemplatepackage-v2-Request")]
    public partial class EzsignfolderImportEzsigntemplatepackageV2Request : IValidatableObject
    {
        ...
        protected EzsignfolderImportEzsigntemplatepackageV2Request() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignfolderImportEzsigntemplatepackageV2Request" /> class.
        /// </summary>
        ...
        public EzsignfolderImportEzsigntemplatepackageV2Request(int fkiEzsigntemplatepackageID = default, string dtEzsigndocumentDuedate = default, List<CustomImportEzsigntemplatepackageRelationRequest> aObjImportEzsigntemplatepackageRelation = default)
        {
            this.FkiEzsigntemplatepackageID = fkiEzsigntemplatepackageID;
            // to ensure "dtEzsigndocumentDuedate" is required (not null)
            if (dtEzsigndocumentDuedate == null)
            {
                throw new ArgumentNullException("dtEzsigndocumentDuedate is a required property for EzsignfolderImportEzsigntemplatepackageV2Request and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("aObjImportEzsigntemplatepackageRelation is a required property for EzsignfolderImportEzsigntemplatepackageV2Request and cannot be null");
            }
