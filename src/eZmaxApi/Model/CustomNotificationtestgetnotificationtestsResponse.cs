...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomNotificationtestgetnotificationtestsResponse : IValidatableObject
    {
        ...
        public CustomNotificationtestgetnotificationtestsResponse(int pkiNotificationtestID = default, MultilingualNotificationtestName objNotificationtestName = default, int fkiNotificationsubsectionID = default, string sNotificationtestFunction = default, string sNotificationtestNameX = default, FieldENotificationpreferenceStatus eNotificationpreferenceStatus = default, int iNotificationtest = default)
        {
