...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignfoldersignerassociation-RequestCompoundV2")]
    public partial class EzsignfoldersignerassociationRequestCompoundV2 : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignfoldersignerassociationRequestCompoundV2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsignfoldersignerassociationRequestCompoundV2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignfoldersignerassociationRequestCompoundV2" /> class.
        /// </summary>
        ...
        public EzsignfoldersignerassociationRequestCompoundV2(int pkiEzsignfoldersignerassociationID = default, int fkiUserID = default, int fkiEzsignsignergroupID = default, int fkiEzsignfolderID = default, FieldEEzsignfoldersignerassociationRole eEzsignfoldersignerassociationRole = default, string tEzsignfoldersignerassociationMessage = default, EzsignsignerRequestCompound objEzsignsigner = default)
        {
