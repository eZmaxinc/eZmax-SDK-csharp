...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignbulksendRequest : IValidatableObject
    {
        ...
        public EzsignbulksendRequest(int pkiEzsignbulksendID = default, int fkiEzsignfoldertypeID = default, int fkiLanguageID = default, string sEzsignbulksendDescription = default, string tEzsignbulksendNote = default, bool bEzsignbulksendNeedvalidation = default, bool bEzsignbulksendIsactive = default)
        {
