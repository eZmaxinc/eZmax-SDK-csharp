...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignsignaturecustomdate-RequestCompound")]
    public partial class EzsignsignaturecustomdateRequestCompound : IValidatableObject
    {
        ...
        protected EzsignsignaturecustomdateRequestCompound() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignsignaturecustomdateRequestCompound" /> class.
        /// </summary>
        ...
        public EzsignsignaturecustomdateRequestCompound(int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), string  = default(string))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignsignaturecustomdateRequestCompound and cannot be null");
            }
