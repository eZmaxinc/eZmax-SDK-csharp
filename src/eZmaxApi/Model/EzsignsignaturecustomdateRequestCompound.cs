...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsignsignaturecustomdateRequestCompound :  IEquatable<EzsignsignaturecustomdateRequestCompound>, IValidatableObject
    {
        /// <summary>
...
getter                              : 
setter                              : 
dataType                            : EzsignsignaturecustomdateRequest
datatypeWithEnum                    : 
name                                : ezsignsignaturecustomdate-RequestCompound
defaultValue                        : 
...
datatype                            : 
*/
        public EzsignsignaturecustomdateRequestCompound(int pkiEzsignsignaturecustomdateID = default(int), int iEzsignsignaturecustomdateX = default(int), int iEzsignsignaturecustomdateY = default(int), string sEzsignsignaturecustomdateFormat = default(string))
        {
            // to ensure "iEzsignsignaturecustomdateX" is required (not null)
            if (iEzsignsignaturecustomdateX == null)
            {
                throw new InvalidDataException("iEzsignsignaturecustomdateX is a required property for EzsignsignaturecustomdateRequestCompound and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iEzsignsignaturecustomdateY is a required property for EzsignsignaturecustomdateRequestCompound and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sEzsignsignaturecustomdateFormat is a required property for EzsignsignaturecustomdateRequestCompound and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EzsignsignaturecustomdateRequestCompound);
        }

        /// <summary>
        /// Returns true if EzsignsignaturecustomdateRequestCompound instances are equal
        /// </summary>
        /// <param name="input">Instance of EzsignsignaturecustomdateRequestCompound to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EzsignsignaturecustomdateRequestCompound input)
        {
            if (input == null)
                return false;
