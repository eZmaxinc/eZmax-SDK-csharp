...
namespace eZmaxApi.Model
{
    ...
    public partial class AuthenticationexternalResponse : IValidatableObject
    {
        ...
        public AuthenticationexternalResponse(int pkiAuthenticationexternalID = default(int), string sAuthenticationexternalDescription = default(string), FieldEAuthenticationexternalType eAuthenticationexternalType = default(FieldEAuthenticationexternalType), bool bAuthenticationexternalConnected = default(bool), string sAuthenticationexternalAuthorizationurl = default(string), CommonAudit objAudit = default(CommonAudit))
        {
