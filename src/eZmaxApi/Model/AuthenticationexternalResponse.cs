...
namespace eZmaxApi.Model
{
    ...
    public partial class AuthenticationexternalResponse : IValidatableObject
    {
        ...
        public AuthenticationexternalResponse(int pkiAuthenticationexternalID = default, string sAuthenticationexternalDescription = default, FieldEAuthenticationexternalType eAuthenticationexternalType = default, bool bAuthenticationexternalConnected = default, string sAuthenticationexternalAuthorizationurl = default, CommonAudit objAudit = default)
        {
            ...
            {
                throw new ArgumentNullException("sAuthenticationexternalDescription is a required property for AuthenticationexternalResponse and cannot be null");
            }
            ...
            if (objAudit == null)
            {
                throw new ArgumentNullException("objAudit is a required property for AuthenticationexternalResponse and cannot be null");
            }
