...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomCreateEzsignelementsPositionedByWordRequest : IValidatableObject
    {
        ...
        public CustomCreateEzsignelementsPositionedByWordRequest(string sCreateezsignelementspositionedbywordPattern = default, int iCreateezsignelementspositionedbywordOffsetx = default, int iCreateezsignelementspositionedbywordOffsety = default, ECreateezsignelementspositionedbywordOccuranceEnum eCreateezsignelementspositionedbywordOccurance = default)
        {
