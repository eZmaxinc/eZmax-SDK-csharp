...
namespace eZmaxApi.Model
{
    ...
    public partial class SsprSendUsernamesV1Request :  IEquatable<SsprSendUsernamesV1Request>, IValidatableObject
    {
        ...
        public SsprSendUsernamesV1Request(string pksCustomerCode = default(string), int fkiLanguageID = default(int), FieldEUserTypeSSPR eUserTypeSSPR = default(FieldEUserTypeSSPR), string sEmailAddress = default(string))
        {
            ...
            {
                throw new InvalidDataException("pksCustomerCode is a required property for SsprSendUsernamesV1Request and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("fkiLanguageID is a required property for SsprSendUsernamesV1Request and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("eUserTypeSSPR is a required property for SsprSendUsernamesV1Request and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sEmailAddress is a required property for SsprSendUsernamesV1Request and cannot be null");
            }
            else
            {
