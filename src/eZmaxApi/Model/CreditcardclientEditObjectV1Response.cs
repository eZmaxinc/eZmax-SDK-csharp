...
namespace eZmaxApi.Model
{
    ...
    public partial class CreditcardclientEditObjectV1Response : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        public CreditcardclientEditObjectV1Response(CommonResponseObjDebugPayload  = default(CommonResponseObjDebugPayload), CommonResponseObjDebug  = default(CommonResponseObjDebug))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for CreditcardclientEditObjectV1Response and cannot be null");
            }
