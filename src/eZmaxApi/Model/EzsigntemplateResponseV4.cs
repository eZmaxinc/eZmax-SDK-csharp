...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplate-ResponseV4")]
    public partial class EzsigntemplateResponseV4 : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplateResponseV4" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplateResponseV4() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplateResponseV4" /> class.
        /// </summary>
        ...
        public EzsigntemplateResponseV4(int pkiEzsigntemplateID = default, int fkiEzsigntemplatedocumentID = default, int fkiEzsignfoldertypeID = default, CustomEzsignfoldertypeTemplateResponse objEzsignfoldertype = default, int fkiLanguageID = default, int fkiEzdoctemplatedocumentID = default, string sEzdoctemplatedocumentNameX = default, string sLanguageNameX = default, string sEzsigntemplateDescription = default, string sEzsigntemplateExternaldescription = default, string tEzsigntemplateComment = default, FieldEEzsigntemplateRecognition? eEzsigntemplateRecognition = default, string sEzsigntemplateFilenameregexp = default, bool bEzsigntemplateAdminonly = default, string sEzsignfoldertypeNameX = default, CommonAudit objAudit = default, bool bEzsigntemplateEditallowed = default, FieldEEzsigntemplateType? eEzsigntemplateType = default)
        {
            ...
            {
                throw new ArgumentNullException("sLanguageNameX is a required property for EzsigntemplateResponseV4 and cannot be null");
            }
            this.SLanguageNameX = sLanguageNameX;
            // to ensure "sEzsigntemplateDescription" is required (not null)
            if (sEzsigntemplateDescription == null)
            {
                throw new ArgumentNullException("sEzsigntemplateDescription is a required property for EzsigntemplateResponseV4 and cannot be null");
            }
            ...
            if (objAudit == null)
            {
                throw new ArgumentNullException("objAudit is a required property for EzsigntemplateResponseV4 and cannot be null");
            }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EzsigntemplateResponseV4 {\n");
