...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplateelementdependencyResponseCompound : IValidatableObject
    {
        ...
        public EzsigntemplateelementdependencyResponseCompound(int pkiEzsigntemplateelementdependencyID = default, int fkiEzsigntemplateformfieldID = default, int fkiEzsigntemplatesignatureID = default, int fkiEzsigntemplateformfieldIDValidation = default, int fkiEzsigntemplateformfieldgroupIDValidation = default, FieldEEzsigntemplateelementdependencyValidation eEzsigntemplateelementdependencyValidation = default, bool bEzsigntemplateelementdependencySelected = default, FieldEEzsigntemplateelementdependencyOperator? eEzsigntemplateelementdependencyOperator = default, string sEzsigntemplateelementdependencyValue = default)
        {
