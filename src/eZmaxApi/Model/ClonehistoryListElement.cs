...
namespace eZmaxApi.Model
{
    ...
    public partial class ClonehistoryListElement : IValidatableObject
    {
        ...
        public ClonehistoryListElement(int pkiClonehistoryID = default, int fkiUserIDCloning = default, int fkiUserIDCloned = default, string dtClonehistoryFirsthit = default, string dtClonehistoryLasthit = default, string sUserLoginnameCloning = default, string sUserFirstnameCloning = default, string sUserLastnameCloning = default, string sUserLoginnameCloned = default, string sUserFirstnameCloned = default, string sUserLastnameCloned = default)
        {
