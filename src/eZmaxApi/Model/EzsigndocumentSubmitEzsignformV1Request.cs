...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigndocumentSubmitEzsignformV1Request : IValidatableObject
    {
        ...
        public EzsigndocumentSubmitEzsignformV1Request(bool bEzsignformIsdraft = default, List<CustomEzsignformfieldgroupRequest> aObjEzsignformfieldgroup = default)
        {
        ...
        [DataMember(Name = "bEzsignformIsdraft", IsRequired = true, EmitDefaultValue = true)]
