...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomCommunicationListElementResponse : IValidatableObject
    {
        ...
        public CustomCommunicationListElementResponse(int pkiCommunicationID = default, string dtCreatedDate = default, ComputedECommunicationDirection eCommunicationDirection = default, FieldECommunicationImportance eCommunicationImportance = default, FieldECommunicationType eCommunicationType = default, int iCommunicationrecipientCount = default, string sCommunicationSubject = default, string sCommunicationSender = default, string sCommunicationRecipient = default)
        {
