...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomDropdownElementResponseCompound : IValidatableObject
    {
        ...
        public CustomDropdownElementResponseCompound(string  = default(string), string  = default(string))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for CustomDropdownElementResponseCompound and cannot be null");
            }
            this.SLabel = ;
            // to ensure "" is required (not null)
            if ( == null)
