...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignelementdependencyRequestCompound : IValidatableObject
    {
        ...
        public EzsignelementdependencyRequestCompound(int pkiEzsignelementdependencyID = default, int fkiEzsignformfieldIDValidation = default, int fkiEzsignformfieldgroupIDValidation = default, string sEzsignelementdependencyEzsignformfieldgrouplabel = default, string sEzsignelementdependencyEzsignformfieldlabel = default, FieldEEzsignelementdependencyValidation eEzsignelementdependencyValidation = default, bool bEzsignelementdependencySelected = default, FieldEEzsignelementdependencyOperator? eEzsignelementdependencyOperator = default, string sEzsignelementdependencyValue = default)
        {
