...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "userstaged-ListElement")]
    public partial class UserstagedListElement : IValidatableObject
    {
        ...
        public UserstagedListElement(int pkiUserstagedID = default, string sEmailAddress = default, string sUserstagedFirstname = default, string sUserstagedLastname = default, string sUserstagedExternalid = default)
        {
