...
namespace eZmaxApi.Model
{
    ...
    public partial class CommonReportsection :  IEquatable<CommonReportsection>, IValidatableObject
    {
        ...
        public CommonReportsection(List<CommonReportsubsection> aObjReportsubsection = default(List<CommonReportsubsection>), List<CommonReportcolumn> aObjReportcolumn = default(List<CommonReportcolumn>), EnumHorizontalalignment eReportsectionHorizontalalignment = default(EnumHorizontalalignment), int iReportsectionColumncount = default(int), int iReportsectionWidth = default(int))
        {
            ...
            {
                throw new InvalidDataException("aObjReportsubsection is a required property for CommonReportsection and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("aObjReportcolumn is a required property for CommonReportsection and cannot be null");
            }
            else
            {
            ...
            // to ensure "eReportsectionHorizontalalignment" is required (not null)
            if (eReportsectionHorizontalalignment == null)
            {
                throw new InvalidDataException("eReportsectionHorizontalalignment is a required property for CommonReportsection and cannot be null");
            }
            else
            {
            ...
            // to ensure "iReportsectionColumncount" is required (not null)
            if (iReportsectionColumncount == null)
            {
                throw new InvalidDataException("iReportsectionColumncount is a required property for CommonReportsection and cannot be null");
            }
            else
            {
            ...
            // to ensure "iReportsectionWidth" is required (not null)
            if (iReportsectionWidth == null)
            {
                throw new InvalidDataException("iReportsectionWidth is a required property for CommonReportsection and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="a_objReportsubsection", EmitDefaultValue=true)]
        public List<CommonReportsubsection> AObjReportsubsection { get; set; }

        /// <summary>
        /// Gets or Sets AObjReportcolumn
        /// </summary>
        [DataMember(Name="a_objReportcolumn", EmitDefaultValue=true)]
        ...
        [DataMember(Name="iReportsectionColumncount", EmitDefaultValue=true)]
        ...
        [DataMember(Name="iReportsectionWidth", EmitDefaultValue=true)]
        ...
        public bool Equals(CommonReportsection input)
        {
            ...
            return 
                ...
                (
                    ...
                    (this.EReportsectionHorizontalalignment != null &&
