...
namespace eZmaxApi.Model
{
    ...
    public partial class WebhookheaderResponseCompound : IValidatableObject
    {
        ...
        public WebhookheaderResponseCompound(int pkiWebhookheaderID = default, int fkiWebhookID = default, string sWebhookheaderName = default, string sWebhookheaderValue = default)
        {
