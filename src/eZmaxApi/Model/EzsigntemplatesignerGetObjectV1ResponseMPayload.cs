...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsigntemplatesignerGetObjectV1ResponseMPayload :  IEquatable<EzsigntemplatesignerGetObjectV1ResponseMPayload>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatesignerGetObjectV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplatesignerGetObjectV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatesignerGetObjectV1ResponseMPayload" /> class.
        /// </summary>
        ...
        public EzsigntemplatesignerGetObjectV1ResponseMPayload(int pkiEzsigntemplatesignerID = default(int), int fkiEzsigntemplateID = default(int), string sEzsigntemplatesignerDescription = default(string))
        {
            // to ensure "pkiEzsigntemplatesignerID" is required (not null)
            if (pkiEzsigntemplatesignerID == null)
            {
                throw new InvalidDataException("pkiEzsigntemplatesignerID is a required property for EzsigntemplatesignerGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("fkiEzsigntemplateID is a required property for EzsigntemplatesignerGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sEzsigntemplatesignerDescription is a required property for EzsigntemplatesignerGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EzsigntemplatesignerGetObjectV1ResponseMPayload);
        }

        /// <summary>
        /// Returns true if EzsigntemplatesignerGetObjectV1ResponseMPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of EzsigntemplatesignerGetObjectV1ResponseMPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EzsigntemplatesignerGetObjectV1ResponseMPayload input)
        {
            if (input == null)
                return false;
