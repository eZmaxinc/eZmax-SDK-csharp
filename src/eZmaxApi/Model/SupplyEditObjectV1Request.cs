...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "supply-editObject-v1-Request")]
    public partial class SupplyEditObjectV1Request : IValidatableObject
    {
        ...
        protected SupplyEditObjectV1Request() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SupplyEditObjectV1Request" /> class.
        /// </summary>
        /// <param name="objSupply">objSupply (required).</param>
        public SupplyEditObjectV1Request(SupplyRequestCompound objSupply = default)
        {
