...
namespace eZmaxApi.Model
{
    ...
    /// A Permission Object
    /// </summary>
    [DataContract(Name = "permission-Response")]
    public partial class PermissionResponse : IValidatableObject
    {
        ...
        public PermissionResponse(int pkiPermissionID = default, int fkiUserID = default, int fkiApikeyID = default, int fkiUsergroupID = default, int fkiCompanyID = default, int fkiModulesectionID = default, string sCompanyNameX = default)
        {
