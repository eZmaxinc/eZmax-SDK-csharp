...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignerResponseCompound : IValidatableObject
    {
        ...
        public EzsignsignerResponseCompound(int pkiEzsignsignerID = default, int fkiTaxassignmentID = default, int fkiSecretquestionID = default, int fkiUserlogintypeID = default, string sUserlogintypeDescriptionX = default, EzsignsignerResponseCompoundContact objContact = default)
        {
