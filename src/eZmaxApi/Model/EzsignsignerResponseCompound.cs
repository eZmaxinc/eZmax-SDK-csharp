...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignerResponseCompound : IValidatableObject
    {
        ...
        public EzsignsignerResponseCompound(int  = default(int), int  = default(int), int  = default(int), int  = default(int), string  = default(string), EzsignsignerResponseCompoundContact  = default(EzsignsignerResponseCompoundContact))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignsignerResponseCompound and cannot be null");
            }
