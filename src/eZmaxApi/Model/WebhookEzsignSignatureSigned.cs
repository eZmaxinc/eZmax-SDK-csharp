...
namespace eZmaxApi.Model
{
    ...
    public partial class WebhookEzsignSignatureSigned : IValidatableObject
    {
        ...
        public WebhookEzsignSignatureSigned(CustomWebhookResponse objWebhook = default, List<AttemptResponseCompound> aObjAttempt = default, EzsignsignatureResponse objEzsignsignature = default)
        {
