...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatepackagesignermembershipRequestCompound : IValidatableObject
    {
        ...
        public EzsigntemplatepackagesignermembershipRequestCompound(int pkiEzsigntemplatepackagesignermembershipID = default, int fkiEzsigntemplatepackagemembershipID = default, int fkiEzsigntemplatepackagesignerID = default, int fkiEzsigntemplatesignerID = default, int iEzsigntemplatepackagesignermembershipCopy = default)
        {
