...
namespace eZmaxApi.Model
{
    ...
    public partial class CommonResponseObjDebugPayloadGetList : IValidatableObject
    {
        ...
        public CommonResponseObjDebugPayloadGetList(int iVersionMin = default, int iVersionMax = default, List<int> aRequiredPermission = default, bool bVersionDeprecated = default, string dtResponseDate = default, CommonResponseFilter aFilter = default, Dictionary<string, string> aOrderBy = default, int iRowMax = default, int iRowOffset = 0)
        {
