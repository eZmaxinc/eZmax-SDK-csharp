...
namespace eZmaxApi.Model
{
    ...
    public partial class CommonResponseObjDebugPayloadGetList :  IEquatable<CommonResponseObjDebugPayloadGetList>, IValidatableObject
    {
        ...
        public CommonResponseObjDebugPayloadGetList(int iVersionMin = default(int), int iVersionMax = default(int), List<int> aRequiredPermission = default(List<int>), bool bVersionDeprecated = default(bool), CommonResponseFilter aFilter = default(CommonResponseFilter), Dictionary<string, string> aOrderBy = default(Dictionary<string, string>), int iRowMax = 10000, int iRowOffset = 0)
        {
            ...
            // to ensure "iRowMax" is required (not null)
            if (iRowMax == null)
            {
                throw new InvalidDataException("iRowMax is a required property for CommonResponseObjDebugPayloadGetList and cannot be null");
            }
            else
            {
            ...
            // to ensure "iRowOffset" is required (not null)
            if (iRowOffset == null)
            {
                throw new InvalidDataException("iRowOffset is a required property for CommonResponseObjDebugPayloadGetList and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="iRowMax", EmitDefaultValue=true)]
        ...
        [DataMember(Name="iRowOffset", EmitDefaultValue=true)]
