...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatedocumentGetWordsPositionsV1Response : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        /// <param name="">Payload for POST /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/getWordsPositions (required).</param>
        public EzsigntemplatedocumentGetWordsPositionsV1Response(CommonResponseObjDebugPayload  = default(CommonResponseObjDebugPayload), CommonResponseObjDebug  = default(CommonResponseObjDebug), List<CustomWordPositionWordResponse>  = default(List<CustomWordPositionWordResponse>))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplatedocumentGetWordsPositionsV1Response and cannot be null");
            }
