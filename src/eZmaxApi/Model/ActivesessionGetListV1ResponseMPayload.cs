...
namespace eZmaxApi.Model
{
    ...
    public partial class ActivesessionGetListV1ResponseMPayload : IValidatableObject
    {
        ...
        public ActivesessionGetListV1ResponseMPayload(int iRowReturned = default, int iRowFiltered = default, List<ActivesessionListElement> aObjActivesession = default)
        {
