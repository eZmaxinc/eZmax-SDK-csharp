...
namespace eZmaxApi.Model
{
    ...
    public partial class PaymenttermRequest :  IEquatable<PaymenttermRequest>, IValidatableObject
    {
        ...
        public PaymenttermRequest(int pkiPaymenttermID = default(int), string sPaymenttermCode = default(string), MultilingualPaymenttermDescription objPaymenttermDescription = default(MultilingualPaymenttermDescription), bool bPaymenttermIsactive = default(bool))
        {
