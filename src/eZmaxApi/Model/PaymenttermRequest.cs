...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "paymentterm-Request")]
    public partial class PaymenttermRequest : IValidatableObject
    {
        ...
        public PaymenttermRequest(int pkiPaymenttermID = default, string sPaymenttermCode = default, FieldEPaymenttermType ePaymenttermType = default, int iPaymenttermDay = default, MultilingualPaymenttermDescription objPaymenttermDescription = default, bool bPaymenttermIsactive = default)
        {
