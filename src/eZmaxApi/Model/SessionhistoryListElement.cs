...
namespace eZmaxApi.Model
{
    ...
    public partial class SessionhistoryListElement : IValidatableObject
    {
        ...
        public SessionhistoryListElement(int pkiSessionhistoryID = default, int fkiComputerID = default, int fkiUserID = default, string dtSessionhistoryFirsthit = default, string dtSessionhistoryLasthit = default, FieldESessionhistoryEndby eSessionhistoryEndby = default, string sComputerDescription = default, string sSessionhistoryDuration = default, string sSessionhistoryIP = default, string sUserLoginname = default)
        {
