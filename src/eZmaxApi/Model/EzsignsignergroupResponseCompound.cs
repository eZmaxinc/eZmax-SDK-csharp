...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignergroupResponseCompound : IValidatableObject
    {
        ...
        public EzsignsignergroupResponseCompound(int pkiEzsignsignergroupID = default, MultilingualEzsignsignergroupDescription objEzsignsignergroupDescription = default, string sEzsignsignergroupDescriptionX = default)
        {
