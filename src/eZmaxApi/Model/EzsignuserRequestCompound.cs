...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignuserRequestCompound : IValidatableObject
    {
        ...
        public EzsignuserRequestCompound(int  = default(int), int  = default(int), ContactRequestCompoundV2  = default(ContactRequestCompoundV2))
        {
            this.FkiContactID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignuserRequestCompound and cannot be null");
            }
            this.ObjContact = ;
