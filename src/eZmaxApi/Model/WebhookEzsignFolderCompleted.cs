...
namespace eZmaxApi.Model
{
    ...
    public partial class WebhookEzsignFolderCompleted : IValidatableObject
    {
        ...
        public WebhookEzsignFolderCompleted(CustomWebhookResponse objWebhook = default, List<AttemptResponseCompound> aObjAttempt = default, EzsignfolderResponse objEzsignfolder = default)
        {
            // to ensure "objWebhook" is required (not null)
            if (objWebhook == null)
            {
                throw new ArgumentNullException("objWebhook is a required property for WebhookEzsignFolderCompleted and cannot be null");
            }
            this.ObjWebhook = objWebhook;
            // to ensure "aObjAttempt" is required (not null)
            if (aObjAttempt == null)
            {
                throw new ArgumentNullException("aObjAttempt is a required property for WebhookEzsignFolderCompleted and cannot be null");
            }
            this.AObjAttempt = aObjAttempt;
            // to ensure "objEzsignfolder" is required (not null)
            if (objEzsignfolder == null)
            {
                throw new ArgumentNullException("objEzsignfolder is a required property for WebhookEzsignFolderCompleted and cannot be null");
            }
