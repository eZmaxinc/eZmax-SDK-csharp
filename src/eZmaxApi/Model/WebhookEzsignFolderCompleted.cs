...
namespace eZmaxApi.Model
{
    ...
    public partial class WebhookEzsignFolderCompleted : IValidatableObject
    {
        ...
        /// <param name=""> (required).</param>
        public WebhookEzsignFolderCompleted(CustomWebhookResponse  = default(CustomWebhookResponse), List<AttemptResponseCompound>  = default(List<AttemptResponseCompound>), EzsignfolderResponse  = default(EzsignfolderResponse))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for WebhookEzsignFolderCompleted and cannot be null");
            }
            this.ObjWebhook = ;
            // to ensure "" is required (not null)
            if ( == null)
