...
namespace eZmaxApi.Model
{
    ...
    public partial class WebhookEzsignFolderCompleted :  IEquatable<WebhookEzsignFolderCompleted>, IValidatableObject
    {
        ...
        public WebhookEzsignFolderCompleted(EzsignfolderResponse objEzsignfolder = default(EzsignfolderResponse), WebhookResponse objWebhook = default(WebhookResponse), List<AttemptResponseCompound> aObjAttempt = default(List<AttemptResponseCompound>))
        {
