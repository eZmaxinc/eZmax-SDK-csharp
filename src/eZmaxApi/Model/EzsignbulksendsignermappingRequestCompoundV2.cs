...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignbulksendsignermapping-RequestCompoundV2")]
    public partial class EzsignbulksendsignermappingRequestCompoundV2 : IValidatableObject
    {

        /// <summary>
        /// Gets or Sets EEzsignbulksendsignermappingRole
        /// </summary>
        [DataMember(Name = "eEzsignbulksendsignermappingRole", EmitDefaultValue = false)]
        public FieldEEzsignbulksendsignermappingRole? EEzsignbulksendsignermappingRole { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignbulksendsignermappingRequestCompoundV2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsignbulksendsignermappingRequestCompoundV2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignbulksendsignermappingRequestCompoundV2" /> class.
        /// </summary>
        ...
        /// <param name="eEzsignbulksendsignermappingRole">eEzsignbulksendsignermappingRole.</param>
        /// <param name="sEzsignbulksendsignermappingDescription">The description of the Ezsignbulksendsignermapping (required).</param>
        public EzsignbulksendsignermappingRequestCompoundV2(int pkiEzsignbulksendsignermappingID = default, int fkiEzsignbulksendID = default, int fkiUserID = default, FieldEEzsignbulksendsignermappingRole? eEzsignbulksendsignermappingRole = default, string sEzsignbulksendsignermappingDescription = default)
        {
            ...
            {
                throw new ArgumentNullException("sEzsignbulksendsignermappingDescription is a required property for EzsignbulksendsignermappingRequestCompoundV2 and cannot be null");
            }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EzsignbulksendsignermappingRequestCompoundV2 {\n");
