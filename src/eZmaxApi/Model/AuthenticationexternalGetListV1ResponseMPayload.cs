...
namespace eZmaxApi.Model
{
    ...
    public partial class AuthenticationexternalGetListV1ResponseMPayload : IValidatableObject
    {
        ...
        public AuthenticationexternalGetListV1ResponseMPayload(int iRowReturned = default, int iRowFiltered = default, List<AuthenticationexternalListElement> aObjAuthenticationexternal = default)
        {
