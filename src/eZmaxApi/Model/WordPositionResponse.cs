...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WordPositionResponse :  IEquatable<WordPositionResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WordPositionResponse" /> class.
        /// </summary>
        ...
        public WordPositionResponse(int iPage = default(int), int iX = default(int), int iY = default(int))
        {
            this.IPage = iPage;
            this.IX = iX;
            this.IY = iY;
        ...
        {
            return this.Equals(input as WordPositionResponse);
        }

        /// <summary>
        /// Returns true if WordPositionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of WordPositionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WordPositionResponse input)
        {
            if (input == null)
                return false;
