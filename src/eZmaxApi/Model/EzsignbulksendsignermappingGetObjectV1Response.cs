...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsignbulksendsignermappingGetObjectV1Response :  IEquatable<EzsignbulksendsignermappingGetObjectV1Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignbulksendsignermappingGetObjectV1Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsignbulksendsignermappingGetObjectV1Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignbulksendsignermappingGetObjectV1Response" /> class.
        /// </summary>
        ...
        public EzsignbulksendsignermappingGetObjectV1Response(EzsignbulksendsignermappingGetObjectV1ResponseMPayload mPayload = default(EzsignbulksendsignermappingGetObjectV1ResponseMPayload), CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug))
        {
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new InvalidDataException("mPayload is a required property for EzsignbulksendsignermappingGetObjectV1Response and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EzsignbulksendsignermappingGetObjectV1Response);
        }

        /// <summary>
        /// Returns true if EzsignbulksendsignermappingGetObjectV1Response instances are equal
        /// </summary>
        /// <param name="input">Instance of EzsignbulksendsignermappingGetObjectV1Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EzsignbulksendsignermappingGetObjectV1Response input)
        {
            if (input == null)
                return false;
