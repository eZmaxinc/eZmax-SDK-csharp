...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "broker-getCommunicationCount-v1-Response-mPayload")]
    public partial class BrokerGetCommunicationCountV1ResponseMPayload : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BrokerGetCommunicationCountV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BrokerGetCommunicationCountV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BrokerGetCommunicationCountV1ResponseMPayload" /> class.
        /// </summary>
        /// <param name="iCommunicationCount">The count of Communication. (required).</param>
        public BrokerGetCommunicationCountV1ResponseMPayload(int iCommunicationCount = default)
        {
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BrokerGetCommunicationCountV1ResponseMPayload {\n");
