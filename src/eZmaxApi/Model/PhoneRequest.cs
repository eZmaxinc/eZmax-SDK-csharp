...
namespace eZmaxApi.Model
{
    ...
    public partial class PhoneRequest : IValidatableObject
    {
        ...
        public PhoneRequest(int pkiPhoneID = default, int fkiPhonetypeID = default, FieldEPhoneType? ePhoneType = default, string sPhoneRegion = default, string sPhoneExchange = default, string sPhoneNumber = default, string sPhoneInternational = default, string sPhoneExtension = default, string sPhoneE164 = default)
        {
