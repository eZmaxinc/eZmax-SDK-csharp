...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigndocumentEditEzsignformfieldgroupsV1Response : IEquatable<EzsigndocumentEditEzsignformfieldgroupsV1Response>, IValidatableObject
    {
        ...
        public EzsigndocumentEditEzsignformfieldgroupsV1Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), EzsigndocumentEditEzsignformfieldgroupsV1ResponseMPayload mPayload = default(EzsigndocumentEditEzsignformfieldgroupsV1ResponseMPayload))
        {
            // to ensure "objDebugPayload" is required (not null)
            if (objDebugPayload == null)
            {
                throw new ArgumentNullException("objDebugPayload is a required property for EzsigndocumentEditEzsignformfieldgroupsV1Response and cannot be null");
            }
            this.ObjDebugPayload = objDebugPayload;
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new ArgumentNullException("mPayload is a required property for EzsigndocumentEditEzsignformfieldgroupsV1Response and cannot be null");
            }
