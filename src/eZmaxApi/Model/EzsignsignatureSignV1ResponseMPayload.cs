...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignatureSignV1ResponseMPayload : IValidatableObject
    {
        ...
        public EzsignsignatureSignV1ResponseMPayload(string dtEzsignsignatureDateInFolderTimezone = default, CustomTimezoneWithCodeResponse objTimezone = default, CustomCreditcardtransactionResponse objCreditcardtransaction = default)
        {
