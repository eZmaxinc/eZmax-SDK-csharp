...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomFormDataSignerResponse : IValidatableObject
    {
        ...
        public CustomFormDataSignerResponse(int fkiEzsignfoldersignerassociationID = default, int fkiUserID = default, string sContactFirstname = default, string sContactLastname = default, List<CustomFormDataEzsignformfieldgroupResponse> aObjEzsignformfieldgroup = default)
        {
