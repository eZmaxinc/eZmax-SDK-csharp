...
namespace eZmaxApi.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommunicationGetCountV1Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CommunicationGetCountV1Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CommunicationGetCountV1Response" /> class.
        /// </summary>
        ...
        public CommunicationGetCountV1Response(CommunicationGetCountV1ResponseMPayload mPayload = default(CommunicationGetCountV1ResponseMPayload), CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug))
        {
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new InvalidDataException("mPayload is a required property for CommunicationGetCountV1Response and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CommunicationGetCountV1Response {\n");
        ...
        {
            return this.Equals(input as CommunicationGetCountV1Response);
        }

        /// <summary>
        /// Returns true if CommunicationGetCountV1Response instances are equal
        /// </summary>
        /// <param name="input">Instance of CommunicationGetCountV1Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommunicationGetCountV1Response input)
        {
            if (input == null)
                return false;
