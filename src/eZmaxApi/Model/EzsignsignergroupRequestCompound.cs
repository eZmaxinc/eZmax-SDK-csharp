...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignergroupRequestCompound : IValidatableObject
    {
        ...
        public EzsignsignergroupRequestCompound(int pkiEzsignsignergroupID = default, int fkiEzsignfolderID = default, MultilingualEzsignsignergroupDescription objEzsignsignergroupDescription = default)
        {
