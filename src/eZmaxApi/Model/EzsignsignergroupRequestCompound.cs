...
getter                              : 
setter                              : 
dataType                            : EzsignsignergroupRequest
datatypeWithEnum                    : 
name                                : ezsignsignergroup-RequestCompound
defaultValue                        : 
...
*/
        public EzsignsignergroupRequestCompound(int pkiEzsignsignergroupID = default(int), int fkiEzsignfolderID = default(int), MultilingualEzsignsignergroupDescription objEzsignsignergroupDescription = default(MultilingualEzsignsignergroupDescription))
        {
            ...
            {
                throw new InvalidDataException("fkiEzsignfolderID is a required property for EzsignsignergroupRequestCompound and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("objEzsignsignergroupDescription is a required property for EzsignsignergroupRequestCompound and cannot be null");
            }
            else
            {
