...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignergroupRequestCompound : IValidatableObject
    {
        ...
        public EzsignsignergroupRequestCompound(int  = default(int), int  = default(int), MultilingualEzsignsignergroupDescription  = default(MultilingualEzsignsignergroupDescription))
        {
            this.FkiEzsignfolderID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignsignergroupRequestCompound and cannot be null");
            }
