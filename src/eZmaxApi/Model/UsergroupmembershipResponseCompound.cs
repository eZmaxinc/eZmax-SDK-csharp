...
namespace eZmaxApi.Model
{
    ...
    public partial class UsergroupmembershipResponseCompound : IValidatableObject
    {
        ...
        public UsergroupmembershipResponseCompound(int  = default(int), int  = default(int), int  = default(int), int  = default(int), string  = default(string), string  = default(string), string  = default(string), string  = default(string), string  = default(string), string  = default(string))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for UsergroupmembershipResponseCompound and cannot be null");
            }
