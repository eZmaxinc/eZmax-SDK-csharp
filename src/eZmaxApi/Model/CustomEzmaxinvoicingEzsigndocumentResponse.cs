...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomEzmaxinvoicingEzsigndocumentResponse : IValidatableObject
    {
        ...
        public CustomEzmaxinvoicingEzsigndocumentResponse(int fkiEzsignfolderID = default, int fkiBillingentityinternalID = default, string sName = default, string sEzsignfolderDescription = default, string sEzsigndocumentName = default, bool bEzsignfolderAllowed = default)
        {
