...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomImportEzsigntemplatepackageRelationRequest : IValidatableObject
    {
        ...
        public CustomImportEzsigntemplatepackageRelationRequest(int fkiEzsigntemplatepackagesignerID = default, int fkiEzsignfoldersignerassociationID = default, string sEzsigntemplatepackagesignerDescription = default)
        {
