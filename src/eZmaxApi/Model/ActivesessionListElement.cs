...
namespace eZmaxApi.Model
{
    ...
    public partial class ActivesessionListElement : IValidatableObject
    {
        ...
        public ActivesessionListElement(int pkiActivesessionID = default, int fkiUserID = default, int fkiComputerID = default, int fkiCompanyID = default, int fkiDepartmentID = default, string sCompanyNameX = default, string sDepartmentNameX = default, string sActivesessionLoginname = default, string sComputerDescription = default, string dtActivesessionFirsthit = default, string dtActivesessionLasthit = default, string sActivesessionIP = default)
        {
