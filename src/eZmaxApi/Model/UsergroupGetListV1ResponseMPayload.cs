...
namespace eZmaxApi.Model
{
    ...
    public partial class UsergroupGetListV1ResponseMPayload : IValidatableObject
    {
        ...
        public UsergroupGetListV1ResponseMPayload(int  = default(int), int  = default(int), List<UsergroupListElement>  = default(List<UsergroupListElement>))
        {
            this.IRowReturned = ;
            this.IRowFiltered = ;
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for UsergroupGetListV1ResponseMPayload and cannot be null");
            }
            this.AObjUsergroup = ;
        }
