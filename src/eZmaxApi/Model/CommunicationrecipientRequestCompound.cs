...
namespace eZmaxApi.Model
{
    ...
    public partial class CommunicationrecipientRequestCompound : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        public CommunicationrecipientRequestCompound(int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), FieldECommunicationrecipientType?  = default(FieldECommunicationrecipientType?))
        {
