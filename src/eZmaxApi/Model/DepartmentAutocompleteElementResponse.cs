...
namespace eZmaxApi.Model
{
    ...
    public partial class DepartmentAutocompleteElementResponse : IValidatableObject
    {
        ...
        public DepartmentAutocompleteElementResponse(string sCompanyNameX = default, string sDepartmentNameX = default, int pkiDepartmentID = default, bool bDepartmentIsactive = default)
        {
