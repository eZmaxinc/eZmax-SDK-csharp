...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "usergroupexternal-Response")]
    public partial class UsergroupexternalResponse : IValidatableObject
    {
        ...
        protected UsergroupexternalResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UsergroupexternalResponse" /> class.
        /// </summary>
        ...
        public UsergroupexternalResponse(int pkiUsergroupexternalID = default(int), string sUsergroupexternalName = default(string), string sUsergroupexternalID = default(string))
        {
            ...
            {
                throw new ArgumentNullException("sUsergroupexternalName is a required property for UsergroupexternalResponse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sUsergroupexternalID is a required property for UsergroupexternalResponse and cannot be null");
            }
