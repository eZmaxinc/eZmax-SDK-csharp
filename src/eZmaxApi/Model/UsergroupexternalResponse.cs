...
namespace eZmaxApi.Model
{
    ...
    public partial class UsergroupexternalResponse : IValidatableObject
    {
        ...
        public UsergroupexternalResponse(int  = default(int), string  = default(string), string  = default(string))
        {
            this.PkiUsergroupexternalID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for UsergroupexternalResponse and cannot be null");
            }
