...
namespace eZmaxApi.Model
{
    ...
    public partial class BillingentityinternalAutocompleteElementResponse : IValidatableObject
    {
        ...
        public BillingentityinternalAutocompleteElementResponse(int pkiBillingentityinternalID = default, string sBillingentityinternalDescriptionX = default, bool bBillingentityinternalIsactive = default)
        {
