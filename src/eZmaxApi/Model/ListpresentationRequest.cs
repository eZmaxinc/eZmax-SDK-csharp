...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ListpresentationRequest :  IEquatable<ListpresentationRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListpresentationRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListpresentationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListpresentationRequest" /> class.
        /// </summary>
        ...
        public ListpresentationRequest(string sListpresentationDescription = default(string), string sListpresentationFilter = default(string), string sListpresentationOrderby = default(string), List<string> aSColumnName = default(List<string>), int iListpresentationRowMax = default(int), int iListpresentationRowOffset = default(int), bool bListpresentationDefault = default(bool))
        {
            ...
            {
                throw new InvalidDataException("sListpresentationDescription is a required property for ListpresentationRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sListpresentationFilter is a required property for ListpresentationRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sListpresentationOrderby is a required property for ListpresentationRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("aSColumnName is a required property for ListpresentationRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iListpresentationRowMax is a required property for ListpresentationRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iListpresentationRowOffset is a required property for ListpresentationRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ListpresentationRequest);
        }

        /// <summary>
        /// Returns true if ListpresentationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ListpresentationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListpresentationRequest input)
        {
            if (input == null)
                return false;
