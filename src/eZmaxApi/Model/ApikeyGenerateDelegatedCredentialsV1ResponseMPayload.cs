...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "apikey-generateDelegatedCredentials-v1-Response-mPayload")]
    public partial class ApikeyGenerateDelegatedCredentialsV1ResponseMPayload : IValidatableObject
    {
        ...
        protected ApikeyGenerateDelegatedCredentialsV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ApikeyGenerateDelegatedCredentialsV1ResponseMPayload" /> class.
        /// </summary>
        /// <param name="objApikey">objApikey (required).</param>
        public ApikeyGenerateDelegatedCredentialsV1ResponseMPayload(CustomApikey objApikey = default)
        {
