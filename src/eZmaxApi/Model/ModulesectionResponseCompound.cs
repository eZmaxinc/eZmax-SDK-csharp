...
namespace eZmaxApi.Model
{
    ...
    public partial class ModulesectionResponseCompound : IValidatableObject
    {
        ...
        public ModulesectionResponseCompound(int pkiModulesectionID = default, int fkiModuleID = default, string sModulesectionInternalname = default, string sModulesectionNameX = default, List<PermissionResponseCompound> aObjPermission = default)
        {
