...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1ResponseMPayload : IValidatableObject
    {
        ...
        public EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1ResponseMPayload(List<FieldEEzsignsignatureType>  = default(List<FieldEEzsignsignatureType>), List<CustomEzsignfolderEzsignsignaturesAutomaticResponse>  = default(List<CustomEzsignfolderEzsignsignaturesAutomaticResponse>))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1ResponseMPayload and cannot be null");
            }
