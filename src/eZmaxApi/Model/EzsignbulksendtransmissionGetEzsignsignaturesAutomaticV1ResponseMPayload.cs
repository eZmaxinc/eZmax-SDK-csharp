...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignbulksendtransmission-getEzsignsignaturesAutomatic-v1-Response-mPayload")]
    public partial class EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1ResponseMPayload : IEquatable<EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1ResponseMPayload>, IValidatableObject
    {
        ...
        public EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1ResponseMPayload(List<FieldEEzsignsignatureType> aEEzsignsignatureType = default(List<FieldEEzsignsignatureType>), List<CustomEzsignfolderEzsignsignaturesAutomaticResponse> aObjEzsignfolder = default(List<CustomEzsignfolderEzsignsignaturesAutomaticResponse>))
        {
            ...
            {
                throw new ArgumentNullException("aEEzsignsignatureType is a required property for EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1ResponseMPayload and cannot be null");
            }
            this.AEEzsignsignatureType = aEEzsignsignatureType;
            // to ensure "aObjEzsignfolder" is required (not null)
            if (aObjEzsignfolder == null)
            {
                throw new ArgumentNullException("aObjEzsignfolder is a required property for EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1ResponseMPayload and cannot be null");
            }
