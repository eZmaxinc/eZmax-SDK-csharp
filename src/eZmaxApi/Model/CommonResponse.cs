...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CommonResponse :  IEquatable<CommonResponse>
    {
        /// <summary>
        ...
        public CommonResponse(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug))
        {
            ...
            {
                throw new InvalidDataException("objDebugPayload is a required property for CommonResponse and cannot be null");
            }
            else
            {
