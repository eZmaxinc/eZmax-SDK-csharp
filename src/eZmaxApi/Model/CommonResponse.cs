...
namespace eZmaxApi.Model
{
    ...
    public partial class CommonResponse : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        public CommonResponse(CommonResponseObjDebugPayload  = default(CommonResponseObjDebugPayload), CommonResponseObjDebug  = default(CommonResponseObjDebug))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for CommonResponse and cannot be null");
            }
