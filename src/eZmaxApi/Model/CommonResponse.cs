...
namespace eZmaxApi.Model
{
    ...
    public partial class CommonResponse : IValidatableObject
    {
        ...
        public CommonResponse(CommonResponseObjDebugPayload objDebugPayload = default, CommonResponseObjDebug objDebug = default)
        {
            // to ensure "objDebugPayload" is required (not null)
            if (objDebugPayload == null)
            {
                throw new ArgumentNullException("objDebugPayload is a required property for CommonResponse and cannot be null");
            }
