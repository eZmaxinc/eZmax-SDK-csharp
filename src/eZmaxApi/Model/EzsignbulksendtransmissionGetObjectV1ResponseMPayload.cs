...
namespace eZmaxApi.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignbulksendtransmissionGetObjectV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsignbulksendtransmissionGetObjectV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignbulksendtransmissionGetObjectV1ResponseMPayload" /> class.
        /// </summary>
        ...
        public EzsignbulksendtransmissionGetObjectV1ResponseMPayload(int pkiEzsignbulksendtransmissionID = default(int), int fkiEzsignbulksendID = default(int), string sEzsignbulksendtransmissionDescription = default(string), int iEzsignbulksendtransmissionErrors = default(int), CommonAudit objAudit = default(CommonAudit), List<CustomEzsignfoldertransmissionResponse> aObjEzsignfoldertransmission = default(List<CustomEzsignfoldertransmissionResponse>))
        {
            ...
            {
                throw new InvalidDataException("pkiEzsignbulksendtransmissionID is a required property for EzsignbulksendtransmissionGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("fkiEzsignbulksendID is a required property for EzsignbulksendtransmissionGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sEzsignbulksendtransmissionDescription is a required property for EzsignbulksendtransmissionGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iEzsignbulksendtransmissionErrors is a required property for EzsignbulksendtransmissionGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            if (objAudit == null)
            {
                throw new InvalidDataException("objAudit is a required property for EzsignbulksendtransmissionGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EzsignbulksendtransmissionGetObjectV1ResponseMPayload);
        }

        /// <summary>
        /// Returns true if EzsignbulksendtransmissionGetObjectV1ResponseMPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of EzsignbulksendtransmissionGetObjectV1ResponseMPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EzsignbulksendtransmissionGetObjectV1ResponseMPayload input)
        {
            if (input == null)
                return false;
