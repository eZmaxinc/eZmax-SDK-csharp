...
namespace eZmaxApi.Model
{
    ...
    public partial class ModuleResponseCompound : IValidatableObject
    {
        ...
        public ModuleResponseCompound(int pkiModuleID = default, int fkiModulegroupID = default, string eModuleInternalname = default, string sModuleNameX = default, bool bModuleRegistered = default, bool bModuleRegisteredapi = default, List<ModulesectionResponseCompound> aObjModulesection = default)
        {
