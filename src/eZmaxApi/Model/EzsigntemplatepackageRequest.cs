...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplatepackage-Request")]
    public partial class EzsigntemplatepackageRequest : IValidatableObject
    {
        ...
        public EzsigntemplatepackageRequest(int pkiEzsigntemplatepackageID = default, int fkiEzsignfoldertypeID = default, int fkiEzdoctemplatedocumentID = default, int fkiLanguageID = default, string sEzsigntemplatepackageDescription = default, bool bEzsigntemplatepackageAdminonly = default, bool bEzsigntemplatepackageIsactive = default)
        {
            ...
            {
                throw new ArgumentNullException("sEzsigntemplatepackageDescription is a required property for EzsigntemplatepackageRequest and cannot be null");
            }
