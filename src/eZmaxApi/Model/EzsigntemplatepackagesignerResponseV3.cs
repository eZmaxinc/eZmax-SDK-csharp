...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplatepackagesigner-ResponseV3")]
    public partial class EzsigntemplatepackagesignerResponseV3 : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatepackagesignerResponseV3" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplatepackagesignerResponseV3() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatepackagesignerResponseV3" /> class.
        /// </summary>
        ...
        public EzsigntemplatepackagesignerResponseV3(int pkiEzsigntemplatepackagesignerID = default, int fkiEzsigntemplatepackageID = default, int fkiEzdoctemplatedocumentID = default, int fkiUserID = default, int fkiUsergroupID = default, string sEzdoctemplatedocumentNameX = default, FieldEEzsigntemplatepackagesignerRole? eEzsigntemplatepackagesignerRole = default, FieldEEzsigntemplatepackagesignerMapping? eEzsigntemplatepackagesignerMapping = default, string sEzsigntemplatepackagesignerDescription = default, string sUserName = default, string sUsergroupNameX = default)
        {
            ...
            {
                throw new ArgumentNullException("sEzsigntemplatepackagesignerDescription is a required property for EzsigntemplatepackagesignerResponseV3 and cannot be null");
            }
