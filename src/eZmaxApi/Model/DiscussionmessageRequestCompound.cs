...
namespace eZmaxApi.Model
{
    ...
    public partial class DiscussionmessageRequestCompound : IValidatableObject
    {
        ...
        public DiscussionmessageRequestCompound(int  = default(int), int  = default(int), int  = default(int), string  = default(string))
        {
            this.FkiDiscussionID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for DiscussionmessageRequestCompound and cannot be null");
            }
