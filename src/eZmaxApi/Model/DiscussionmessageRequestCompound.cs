...
namespace eZmaxApi.Model
{
    ...
    public partial class DiscussionmessageRequestCompound : IValidatableObject
    {
        ...
        public DiscussionmessageRequestCompound(int pkiDiscussionmessageID = default, int fkiDiscussionID = default, int fkiDiscussionmembershipIDActionrequired = default, string tDiscussionmessageContent = default)
        {
