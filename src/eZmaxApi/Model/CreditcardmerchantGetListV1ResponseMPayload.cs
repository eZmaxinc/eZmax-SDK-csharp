...
namespace eZmaxApi.Model
{
    ...
    public partial class CreditcardmerchantGetListV1ResponseMPayload : IValidatableObject
    {
        ...
        public CreditcardmerchantGetListV1ResponseMPayload(int iRowReturned = default, int iRowFiltered = default, List<CreditcardmerchantListElement> aObjCreditcardmerchant = default)
        {
