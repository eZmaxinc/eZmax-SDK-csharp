...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomEzsignfoldertransmissionSignerResponse : IValidatableObject
    {
        ...
        public CustomEzsignfoldertransmissionSignerResponse(int fkiUserID = default, string sContactFirstname = default, string sContactLastname = default, string sEzsignsignergroupDescriptionX = default)
        {
