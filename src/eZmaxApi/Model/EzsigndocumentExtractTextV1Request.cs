...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigndocument-extractText-v1-Request")]
    public partial class EzsigndocumentExtractTextV1Request : IValidatableObject
    {
        ...
        protected EzsigndocumentExtractTextV1Request() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigndocumentExtractTextV1Request" /> class.
        /// </summary>
        ...
        public EzsigndocumentExtractTextV1Request(int iPage = default, ESectionEnum? eSection = default, int iX = default, int iY = default, int iWidth = default, int iHeight = default)
        {
            this.IPage = iPage;
