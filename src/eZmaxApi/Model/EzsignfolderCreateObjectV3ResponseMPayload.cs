...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfolderCreateObjectV3ResponseMPayload : IValidatableObject
    {
        ...
        public EzsignfolderCreateObjectV3ResponseMPayload(List<int>  = default(List<int>))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignfolderCreateObjectV3ResponseMPayload and cannot be null");
            }
