...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignfolder-createObject-v3-Response-mPayload")]
    public partial class EzsignfolderCreateObjectV3ResponseMPayload : IValidatableObject
    {
        ...
        protected EzsignfolderCreateObjectV3ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignfolderCreateObjectV3ResponseMPayload" /> class.
        /// </summary>
        ...
        public EzsignfolderCreateObjectV3ResponseMPayload(List<int> aPkiEzsignfolderID = default(List<int>))
        {
            // to ensure "aPkiEzsignfolderID" is required (not null)
            if (aPkiEzsignfolderID == null)
            {
                throw new ArgumentNullException("aPkiEzsignfolderID is a required property for EzsignfolderCreateObjectV3ResponseMPayload and cannot be null");
            }
