...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignbulksend-createEzsignbulksendtransmission-v1-Response")]
    public partial class EzsignbulksendCreateEzsignbulksendtransmissionV1Response : IEquatable<EzsignbulksendCreateEzsignbulksendtransmissionV1Response>, IValidatableObject
    {
        ...
        public EzsignbulksendCreateEzsignbulksendtransmissionV1Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), EzsignbulksendCreateEzsignbulksendtransmissionV1ResponseMPayload mPayload = default(EzsignbulksendCreateEzsignbulksendtransmissionV1ResponseMPayload))
        {
            ...
            {
                throw new ArgumentNullException("objDebugPayload is a required property for EzsignbulksendCreateEzsignbulksendtransmissionV1Response and cannot be null");
            }
            this.ObjDebugPayload = objDebugPayload;
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new ArgumentNullException("mPayload is a required property for EzsignbulksendCreateEzsignbulksendtransmissionV1Response and cannot be null");
            }
