...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfoldersignerassociationRequest : IValidatableObject
    {
        ...
        public EzsignfoldersignerassociationRequest(int pkiEzsignfoldersignerassociationID = default, int fkiUserID = default, int fkiEzsignsignergroupID = default, int fkiEzsignfolderID = default, bool bEzsignfoldersignerassociationReceivecopy = default, string tEzsignfoldersignerassociationMessage = default)
        {
