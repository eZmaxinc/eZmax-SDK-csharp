...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "employee-getCommunicationCount-v1-Response-mPayload")]
    public partial class EmployeeGetCommunicationCountV1ResponseMPayload : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmployeeGetCommunicationCountV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EmployeeGetCommunicationCountV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EmployeeGetCommunicationCountV1ResponseMPayload" /> class.
        /// </summary>
        /// <param name="iCommunicationCount">The count of Communication. (required).</param>
        public EmployeeGetCommunicationCountV1ResponseMPayload(int iCommunicationCount = default)
        {
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmployeeGetCommunicationCountV1ResponseMPayload {\n");
