...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignerResponseCompoundContact : IValidatableObject
    {
        ...
        public EzsignsignerResponseCompoundContact(int pkiContactID = default, string sContactFirstname = default, string sContactLastname = default, int fkiLanguageID = default, string sEmailAddress = default, string sPhoneE164 = default, string sPhoneExtension = default, string sPhoneE164Cell = default)
        {
