...
namespace eZmaxApi.Model
{
    ...
    public partial class UsergroupexternalmembershipResponse : IValidatableObject
    {
        ...
        public UsergroupexternalmembershipResponse(int pkiUsergroupexternalmembershipID = default, int fkiUsergroupexternalID = default, int fkiUserID = default, string sUserFirstname = default, string sUserLastname = default, string sUserLoginname = default, string sEmailAddress = default, string sUsergroupexternalName = default)
        {
