...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignerRequest : IValidatableObject
    {
        ...
        public EzsignsignerRequest(int fkiUserlogintypeID = default, int fkiTaxassignmentID = default, int fkiSecretquestionID = default, EEzsignsignerLogintypeEnum? eEzsignsignerLogintype = default, string sEzsignsignerSecretanswer = default)
        {
