...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignerRequest : IValidatableObject
    {
        ...
        public EzsignsignerRequest(int  = default(int), int  = default(int), int  = default(int), EEzsignsignerLogintypeEnum?  = default(EEzsignsignerLogintypeEnum?), string  = default(string))
        {
