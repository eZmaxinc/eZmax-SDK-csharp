...
namespace eZmaxApi.Model
{
    ...
    public partial class EzmaxproductAutocompleteElementResponse : IValidatableObject
    {
        ...
        public EzmaxproductAutocompleteElementResponse(int pkiEzmaxproductID = default, string sEzmaxproductDescriptionX = default, bool bEzmaxproductIsactive = default)
        {
