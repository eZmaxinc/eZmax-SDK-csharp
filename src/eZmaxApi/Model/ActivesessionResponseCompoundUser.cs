...
namespace eZmaxApi.Model
{
    ...
    public partial class ActivesessionResponseCompoundUser : IValidatableObject
    {
        ...
        /// <param name="bUserAddmeinezsignfolder">Whether if I want to automatically add myself during the creation of Ezsignfolder of which I am the owner (required).</param>
        ...
        /// <param name="iUserFrontendgoal">Goals save as bit wise (one bit per goal) (required).</param>
        public ActivesessionResponseCompoundUser(int pkiUserID = default, int fkiTimezoneID = default, string sAvatarUrl = default, string sUserFirstname = default, string sUserLastname = default, string sEmailAddress = default, bool bUserAddmeinezsignfolder = default, FieldEUserEzsignsendreminderfrequency eUserEzsignsendreminderfrequency = default, int iUserInterfacecolor = default, bool bUserInterfacedark = default, int iUserListresult = default, int iUserFrontendgoal = default)
        {
        ...
        */
        [DataMember(Name = "bUserAddmeinezsignfolder", IsRequired = true, EmitDefaultValue = true)]
        ...
        */
        ...
        <example>256</example>
        */
        [DataMember(Name = "iUserFrontendgoal", IsRequired = true, EmitDefaultValue = true)]
