...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignfolder-getAttachmentCount-v1-Response-mPayload")]
    public partial class EzsignfolderGetAttachmentCountV1ResponseMPayload : IValidatableObject
    {
        ...
        protected EzsignfolderGetAttachmentCountV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignfolderGetAttachmentCountV1ResponseMPayload" /> class.
        /// </summary>
        /// <param name="iAttachmentCount">The count of Attachment. (required).</param>
        public EzsignfolderGetAttachmentCountV1ResponseMPayload(int iAttachmentCount = default)
        {
        ...
        <example>4</example>
        */
        [DataMember(Name = "iAttachmentCount", IsRequired = true, EmitDefaultValue = true)]
