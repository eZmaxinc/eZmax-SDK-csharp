...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "usergroupexternal-ListElement")]
    public partial class UsergroupexternalListElement : IValidatableObject
    {
        ...
        protected UsergroupexternalListElement() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UsergroupexternalListElement" /> class.
        /// </summary>
        ...
        public UsergroupexternalListElement(int pkiUsergroupexternalID = default(int), string sUsergroupexternalName = default(string), string sUsergroupexternalID = default(string))
        {
            ...
            {
                throw new ArgumentNullException("sUsergroupexternalName is a required property for UsergroupexternalListElement and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sUsergroupexternalID is a required property for UsergroupexternalListElement and cannot be null");
            }
