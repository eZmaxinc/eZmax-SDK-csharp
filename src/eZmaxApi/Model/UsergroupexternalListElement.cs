...
namespace eZmaxApi.Model
{
    ...
    public partial class UsergroupexternalListElement : IValidatableObject
    {
        ...
        public UsergroupexternalListElement(int  = default(int), string  = default(string), string  = default(string))
        {
            this.PkiUsergroupexternalID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for UsergroupexternalListElement and cannot be null");
            }
