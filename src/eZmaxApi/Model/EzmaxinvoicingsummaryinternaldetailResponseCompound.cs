...
namespace eZmaxApi.Model
{
    ...
    public partial class EzmaxinvoicingsummaryinternaldetailResponseCompound : IValidatableObject
    {
        ...
        public EzmaxinvoicingsummaryinternaldetailResponseCompound(int pkiEzmaxinvoicingsummaryinternaldetailID = default, int fkiEzmaxinvoicingsummaryinternalID = default, int fkiEzmaxproductID = default, string sEzmaxproductDescriptionX = default, int fkiBillingentityexternalID = default, string sBillingentityexternalDescription = default, string dEzmaxinvoicingsummaryinternaldetailCountreal = default, string dEzmaxinvoicingsummaryinternaldetailSubtotal = default, string dEzmaxinvoicingsummaryinternaldetailRebate = default, string dEzmaxinvoicingsummaryinternaldetailTotal = default, bool bEzmaxinvoicingsummaryinternaldetailAdjustment = default, string tEzmaxproductHelpX = default)
        {
