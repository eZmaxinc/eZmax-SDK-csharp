...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplateListElement : IValidatableObject
    {
        ...
        public EzsigntemplateListElement(int pkiEzsigntemplateID = default, int fkiEzsignfoldertypeID = default, int fkiLanguageID = default, string sEzsigntemplateDescription = default, int iEzsigntemplatedocumentPagetotal = default, int iEzsigntemplateSignaturetotal = default, int iEzsigntemplateFormfieldtotal = default, bool bEzsigntemplateIncomplete = default, string sEzsignfoldertypeNameX = default, FieldEEzsigntemplateType eEzsigntemplateType = default)
        {
