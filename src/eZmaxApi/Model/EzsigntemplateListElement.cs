...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplateListElement :  IEquatable<EzsigntemplateListElement>, IValidatableObject
    {
        ...
        /// <param name="iEzsigntemplateSignaturetotal">The number of total signatures in the Ezsigntemplate. (required).</param>
        ...
        public EzsigntemplateListElement(int pkiEzsigntemplateID = default(int), int fkiEzsignfoldertypeID = default(int), int fkiLanguageID = default(int), string sEzsigntemplateDescription = default(string), int iEzsigntemplatedocumentPagetotal = default(int), int iEzsigntemplateSignaturetotal = default(int), bool bEzsigntemplateIncomplete = default(bool), string sEzsignfoldertypeNameX = default(string))
        {
            ...
            {
                throw new InvalidDataException("iEzsigntemplatedocumentPagetotal is a required property for EzsigntemplateListElement and cannot be null");
            }
            else
            {
            ...
            // to ensure "iEzsigntemplateSignaturetotal" is required (not null)
            if (iEzsigntemplateSignaturetotal == null)
            {
                throw new InvalidDataException("iEzsigntemplateSignaturetotal is a required property for EzsigntemplateListElement and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="iEzsigntemplateSignaturetotal", EmitDefaultValue=true)]
