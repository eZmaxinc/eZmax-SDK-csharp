...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignbulksend-ResponseCompoundV4")]
    public partial class EzsignbulksendResponseCompoundV4 : IValidatableObject
    {

        /// <summary>
        /// Gets or Sets EEzsignbulksendEzsignformfieldorder
        /// </summary>
        [DataMember(Name = "eEzsignbulksendEzsignformfieldorder", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignbulksendResponseCompoundV4" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsignbulksendResponseCompoundV4() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignbulksendResponseCompoundV4" /> class.
        /// </summary>
        ...
        /// <param name="eEzsignbulksendEzsignformfieldorder">eEzsignbulksendEzsignformfieldorder (required).</param>
        ...
        public EzsignbulksendResponseCompoundV4(int pkiEzsignbulksendID = default, int fkiEzsignfoldertypeID = default, int fkiLanguageID = default, string sLanguageNameX = default, FieldEEzsignbulksendEzsignformfieldorder eEzsignbulksendEzsignformfieldorder = default, FieldEEzsignfoldertypePrivacylevel eEzsignfoldertypePrivacylevel = default, string sEzsignfoldertypeNameX = default, string sEzsignbulksendDescription = default, string tEzsignbulksendNote = default, bool bEzsignbulksendNeedvalidation = default, bool bEzsignbulksendIsactive = default, CommonAudit objAudit = default, List<EzsignbulksenddocumentmappingResponseCompoundV3> aObjEzsignbulksenddocumentmapping = default, List<EzsignbulksendsignermappingResponseV3> aObjEzsignbulksendsignermapping = default)
        {
            ...
            {
                throw new ArgumentNullException("sLanguageNameX is a required property for EzsignbulksendResponseCompoundV4 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sEzsignfoldertypeNameX is a required property for EzsignbulksendResponseCompoundV4 and cannot be null");
            }
            this.SEzsignfoldertypeNameX = sEzsignfoldertypeNameX;
            // to ensure "sEzsignbulksendDescription" is required (not null)
            if (sEzsignbulksendDescription == null)
            {
                throw new ArgumentNullException("sEzsignbulksendDescription is a required property for EzsignbulksendResponseCompoundV4 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("tEzsignbulksendNote is a required property for EzsignbulksendResponseCompoundV4 and cannot be null");
            }
            ...
            if (objAudit == null)
            {
                throw new ArgumentNullException("objAudit is a required property for EzsignbulksendResponseCompoundV4 and cannot be null");
            }
            this.ObjAudit = objAudit;
            // to ensure "aObjEzsignbulksenddocumentmapping" is required (not null)
            if (aObjEzsignbulksenddocumentmapping == null)
            {
                throw new ArgumentNullException("aObjEzsignbulksenddocumentmapping is a required property for EzsignbulksendResponseCompoundV4 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("aObjEzsignbulksendsignermapping is a required property for EzsignbulksendResponseCompoundV4 and cannot be null");
            }
        ...
        */
        ...
        public List<EzsignbulksenddocumentmappingResponseCompoundV3> AObjEzsignbulksenddocumentmapping { get; set; }
        ...
        public List<EzsignbulksendsignermappingResponseV3> AObjEzsignbulksendsignermapping { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EzsignbulksendResponseCompoundV4 {\n");
