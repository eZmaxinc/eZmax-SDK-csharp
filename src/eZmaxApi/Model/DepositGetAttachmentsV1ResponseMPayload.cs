...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "deposit-getAttachments-v1-Response-mPayload")]
    public partial class DepositGetAttachmentsV1ResponseMPayload : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DepositGetAttachmentsV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DepositGetAttachmentsV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DepositGetAttachmentsV1ResponseMPayload" /> class.
        /// </summary>
        /// <param name="aObjAttachmentdocumenttype">aObjAttachmentdocumenttype (required).</param>
        public DepositGetAttachmentsV1ResponseMPayload(List<CustomAttachmentdocumenttypeResponse> aObjAttachmentdocumenttype = default)
        {
            // to ensure "aObjAttachmentdocumenttype" is required (not null)
            if (aObjAttachmentdocumenttype == null)
            {
                throw new ArgumentNullException("aObjAttachmentdocumenttype is a required property for DepositGetAttachmentsV1ResponseMPayload and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DepositGetAttachmentsV1ResponseMPayload {\n");
