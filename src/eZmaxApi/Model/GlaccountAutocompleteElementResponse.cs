...
namespace eZmaxApi.Model
{
    ...
    public partial class GlaccountAutocompleteElementResponse : IValidatableObject
    {
        ...
        public GlaccountAutocompleteElementResponse(int pkiGlaccountID = default, int iGlaccountCode = default, string sGlaccountDescriptionX = default, bool bGlaccountIsactive = default)
        {
