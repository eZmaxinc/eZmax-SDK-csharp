...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatesignerResponseCompound : IValidatableObject
    {
        ...
        public EzsigntemplatesignerResponseCompound(int pkiEzsigntemplatesignerID = default, int fkiEzsigntemplateID = default, int fkiUserID = default, int fkiUsergroupID = default, int fkiEzdoctemplatedocumentID = default, bool bEzsigntemplatesignerReceivecopy = default, FieldEEzsigntemplatesignerMapping? eEzsigntemplatesignerMapping = default, string sEzsigntemplatesignerDescription = default, string sUserName = default, string sUsergroupNameX = default)
        {
