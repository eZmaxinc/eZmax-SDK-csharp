...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CommunicationimageResponseCompound :  IEquatable<CommunicationimageResponseCompound>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommunicationimageResponseCompound" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CommunicationimageResponseCompound() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CommunicationimageResponseCompound" /> class.
        /// </summary>
        ...
        public CommunicationimageResponseCompound(int pkiCommunicationimageID = default(int), int fkiImageID = default(int), string sCommunicationimageName = default(string))
        {
            // to ensure "pkiCommunicationimageID" is required (not null)
            if (pkiCommunicationimageID == null)
            {
                throw new InvalidDataException("pkiCommunicationimageID is a required property for CommunicationimageResponseCompound and cannot be null");
            }
            else
            {
            ...
            if (fkiImageID == null)
            {
                throw new InvalidDataException("fkiImageID is a required property for CommunicationimageResponseCompound and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CommunicationimageResponseCompound);
        }

        /// <summary>
        /// Returns true if CommunicationimageResponseCompound instances are equal
        /// </summary>
        /// <param name="input">Instance of CommunicationimageResponseCompound to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommunicationimageResponseCompound input)
        {
            if (input == null)
                return false;
