...
namespace eZmaxApi.Model
{
    ...
    public partial class CommonResponseErrorEzsignformValidation : IValidatableObject
    {
        ...
        public CommonResponseErrorEzsignformValidation(string sErrorMessage = default, FieldEErrorCode eErrorCode = default, List<string> aSErrorMessagedetail = default, List<CustomEzsignformfielderrorResponse> aObjEzsignformfielderror = default)
        {
