...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatedocumentpagerecognitionResponseCompound : IValidatableObject
    {
        ...
        public EzsigntemplatedocumentpagerecognitionResponseCompound(int  = default(int), int  = default(int), FieldEEzsigntemplatedocumentpagerecognitionOperator  = default(FieldEEzsigntemplatedocumentpagerecognitionOperator), FieldEEzsigntemplatedocumentpagerecognitionSection  = default(FieldEEzsigntemplatedocumentpagerecognitionSection), int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), string  = default(string))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplatedocumentpagerecognitionResponseCompound and cannot be null");
            }
