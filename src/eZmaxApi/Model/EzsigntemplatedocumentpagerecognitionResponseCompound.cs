...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatedocumentpagerecognitionResponseCompound : IValidatableObject
    {
        ...
        public EzsigntemplatedocumentpagerecognitionResponseCompound(int pkiEzsigntemplatedocumentpagerecognitionID = default, int fkiEzsigntemplatedocumentpageID = default, FieldEEzsigntemplatedocumentpagerecognitionOperator eEzsigntemplatedocumentpagerecognitionOperator = default, FieldEEzsigntemplatedocumentpagerecognitionSection eEzsigntemplatedocumentpagerecognitionSection = default, int iEzsigntemplatedocumentpagerecognitionSimilarpercentage = default, int iEzsigntemplatedocumentpagerecognitionX = default, int iEzsigntemplatedocumentpagerecognitionY = default, int iEzsigntemplatedocumentpagerecognitionWidth = default, int iEzsigntemplatedocumentpagerecognitionHeight = default, string tEzsigntemplatedocumentpagerecognitionText = default)
        {
            ...
            {
                throw new ArgumentNullException("tEzsigntemplatedocumentpagerecognitionText is a required property for EzsigntemplatedocumentpagerecognitionResponseCompound and cannot be null");
            }
