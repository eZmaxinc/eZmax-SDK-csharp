...
namespace eZmaxApi.Model
{
    ...
    public partial class ContactResponseCompound : IValidatableObject
    {
        ...
        public ContactResponseCompound(int pkiContactID = default, int fkiLanguageID = default, int fkiContacttitleID = default, int fkiContactinformationsID = default, string dtContactBirthdate = default, FieldEContactType eContactType = default, string sContactFirstname = default, string sContactLastname = default, string sContactCompany = default, string sContactOccupation = default, string tContactNote = default, bool bContactIsactive = default, ContactinformationsResponseCompound objContactinformations = default)
        {
