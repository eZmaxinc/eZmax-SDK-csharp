...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignformfieldgroupCreateObjectV1ResponseMPayload : IValidatableObject
    {
        ...
        public EzsignformfieldgroupCreateObjectV1ResponseMPayload(List<int>  = default(List<int>))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignformfieldgroupCreateObjectV1ResponseMPayload and cannot be null");
            }
