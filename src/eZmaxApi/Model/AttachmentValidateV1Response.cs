...
namespace eZmaxApi.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AttachmentValidateV1Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AttachmentValidateV1Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AttachmentValidateV1Response" /> class.
        /// </summary>
        ...
        public AttachmentValidateV1Response(CommonResponseObjDebugPayload objDebugPayload = default, CommonResponseObjDebug objDebug = default, AttachmentValidateV1ResponseMPayload mPayload = default)
        {
            // to ensure "objDebugPayload" is required (not null)
            if (objDebugPayload == null)
            {
                throw new ArgumentNullException("objDebugPayload is a required property for AttachmentValidateV1Response and cannot be null");
            }
            this.ObjDebugPayload = objDebugPayload;
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new ArgumentNullException("mPayload is a required property for AttachmentValidateV1Response and cannot be null");
            }
        ...
        public AttachmentValidateV1ResponseMPayload MPayload { get; set; }
