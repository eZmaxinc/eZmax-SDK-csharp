...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplateGetListV1ResponseMPayload : IValidatableObject
    {
        ...
        public EzsigntemplateGetListV1ResponseMPayload(int iRowReturned = default, int iRowFiltered = default, List<EzsigntemplateListElement> aObjEzsigntemplate = default)
        {
