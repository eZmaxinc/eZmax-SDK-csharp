...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigndocumentGetCompletedElementsV1ResponseMPayload :  IEquatable<EzsigndocumentGetCompletedElementsV1ResponseMPayload>, IValidatableObject
    {
        ...
        public EzsigndocumentGetCompletedElementsV1ResponseMPayload(List<EzsignsignatureResponseCompound> aObjEzsignsignature = default(List<EzsignsignatureResponseCompound>), List<EzsignformfieldgroupResponseCompound> aObjEzsignformfieldgroup = default(List<EzsignformfieldgroupResponseCompound>))
        {
            ...
            {
                throw new InvalidDataException("aObjEzsignsignature is a required property for EzsigndocumentGetCompletedElementsV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("aObjEzsignformfieldgroup is a required property for EzsigndocumentGetCompletedElementsV1ResponseMPayload and cannot be null");
            }
            else
            {
