...
namespace eZmaxApi.Model
{
    ...
    public partial class BillingentityinternalproductRequestCompound : IValidatableObject
    {
        ...
        public BillingentityinternalproductRequestCompound(int pkiBillingentityinternalproductID = default, int fkiEzmaxproductID = default, int fkiBillingentityexternalID = default)
        {
