...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignbulksendtransmissionResponseCompound : IValidatableObject
    {
        ...
        public EzsignbulksendtransmissionResponseCompound(int pkiEzsignbulksendtransmissionID = default, int fkiEzsignbulksendID = default, string sEzsignbulksendtransmissionDescription = default, int iEzsignbulksendtransmissionErrors = default, CommonAudit objAudit = default, List<CustomEzsignfoldertransmissionResponse> aObjEzsignfoldertransmission = default)
        {
