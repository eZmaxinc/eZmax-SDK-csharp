...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignpageResponse :  IEquatable<EzsignpageResponse>, IValidatableObject
    {
        ...
        public EzsignpageResponse(int pkiEzsignpageID = default(int), int iEzsignpageWidthimage = default(int), int iEzsignpageHeightimage = default(int), int iEzsignpageWidthpdf = default(int), int iEzsignpageHeightpdf = default(int), int iEzsignpagePagenumber = default(int), string sImageUrl = default(string))
        {
            ...
            if (sImageUrl == null)
            {
                throw new InvalidDataException("sImageUrl is a required property for EzsignpageResponse and cannot be null");
            }
            else
            {
