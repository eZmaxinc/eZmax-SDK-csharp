...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignpageResponse : IValidatableObject
    {
        ...
        public EzsignpageResponse(int pkiEzsignpageID = default, int iEzsignpageWidthimage = default, int iEzsignpageHeightimage = default, int iEzsignpageWidthpdf = default, int iEzsignpageHeightpdf = default, int iEzsignpagePagenumber = default, string sComputedImageurl = default)
        {
