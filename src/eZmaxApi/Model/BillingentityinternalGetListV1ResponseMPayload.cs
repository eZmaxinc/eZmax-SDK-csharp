...
namespace eZmaxApi.Model
{
    ...
    public partial class BillingentityinternalGetListV1ResponseMPayload : IValidatableObject
    {
        ...
        public BillingentityinternalGetListV1ResponseMPayload(int iRowReturned = default, int iRowFiltered = default, List<BillingentityinternalListElement> aObjBillingentityinternal = default)
        {
