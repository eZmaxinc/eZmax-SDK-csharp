...
namespace eZmaxApi.Model
{
    ...
    /// A Customer Object
    /// </summary>
    [DataContract(Name = "customer-Response")]
    public partial class CustomerResponse : IValidatableObject
    {
        ...
        public CustomerResponse(int pkiCustomerID = default, int fkiCompanyID = default, int fkiCustomergroupID = default, string sCustomerName = default, string sCustomerNote = default, int fkiContactinformationsID = default, int fkiContactcontainerID = default, int fkiImageID = default, int fkiGlaccountcontainerID = default, int fkiLanguageID = default, int fkiDepartmentID = default, int fkiPaymentmethodID = default, int fkiElectronicfundstransferbankaccountID = default, int fkiElectronicfundstransferbankaccountIDDirectdebit = default, int fkiSendingmethodID = default, int fkiTaxassignmentID = default, int fkiAttendancestatusID = default, int fkiAgentIDVariableexpensechargeto = default, int fkiBrokerIDVariableexpensechargeto = default, int fkiCustomerIDVariableexpensechargeto = default, int fkiGlaccountcontainerIDVariableexpensechargeto = default, int fkiAgentIDSupplychargechargeto = default, int fkiBrokerIDSupplychargechargeto = default, int fkiCustomerIDSupplychargechargeto = default, int fkiGlaccountcontainerIDSupplychargechargeto = default, int fkiInvoicealternatelogoID = default, int fkiSynchronizationlinkserverID = default, int efkiUserID = default, string efksCustomerCode = default, string sCustomerCode = default, string dCustomerFulltimeequivalent = default, int iCustomerPhotocopiercode = default, int iCustomerLongdistancecode = default, int iCustomerTimewindowstart = default, int iCustomerTimewindowend = default, string dCustomerMinimumchargeableinterests = default, string dtCustomerBirthdate = default, string dtCustomerTransfer = default, string dtCustomerTransferappointment = default, string dtCustomerTransfersurvey = default, bool bCustomerIsactive = default, bool bCustomerVariableexpensefinanced = default, bool bCustomerVariableexpensefinancedtaxes = default, bool bCustomerSupplychargefinanced = default, bool bCustomerSupplychargefinancedtaxes = default, bool bCustomerAttendance = default, FieldECustomerType eCustomerType = default, FieldECustomerMarketingcorrespondence eCustomerMarketingcorrespondence = default, bool bCustomerBlackcopycarbon = default, bool bCustomerUnsubscribeinfo = default, string tCustomerComment = default, string iMPORTID = default)
        {
            ...
            {
                throw new ArgumentNullException("sCustomerName is a required property for CustomerResponse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sCustomerCode is a required property for CustomerResponse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("dCustomerFulltimeequivalent is a required property for CustomerResponse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("dCustomerMinimumchargeableinterests is a required property for CustomerResponse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("dtCustomerBirthdate is a required property for CustomerResponse and cannot be null");
            }
            this.DtCustomerBirthdate = dtCustomerBirthdate;
            // to ensure "dtCustomerTransfer" is required (not null)
            if (dtCustomerTransfer == null)
            {
                throw new ArgumentNullException("dtCustomerTransfer is a required property for CustomerResponse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("dtCustomerTransferappointment is a required property for CustomerResponse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("dtCustomerTransfersurvey is a required property for CustomerResponse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("tCustomerComment is a required property for CustomerResponse and cannot be null");
            }
