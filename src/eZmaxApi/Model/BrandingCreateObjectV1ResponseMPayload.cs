...
namespace eZmaxApi.Model
{
    ...
    public partial class BrandingCreateObjectV1ResponseMPayload : IEquatable<BrandingCreateObjectV1ResponseMPayload>, IValidatableObject
    {
        ...
        public BrandingCreateObjectV1ResponseMPayload(List<int> aPkiBrandingID = default(List<int>))
        {
            ...
            {
                throw new ArgumentNullException("aPkiBrandingID is a required property for BrandingCreateObjectV1ResponseMPayload and cannot be null");
            }
        ...
        [DataMember(Name = "a_pkiBrandingID", IsRequired = true, EmitDefaultValue = true)]
