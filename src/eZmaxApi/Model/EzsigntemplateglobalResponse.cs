...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplateglobalResponse : IValidatableObject
    {
        ...
        public EzsigntemplateglobalResponse(int pkiEzsigntemplateglobalID = default, int fkiEzsigntemplateglobaldocumentID = default, int fkiModuleID = default, string sModuleNameX = default, int fkiLanguageID = default, string sLanguageNameX = default, FieldEEzsigntemplateglobalModule eEzsigntemplateglobalModule = default, FieldEEzsigntemplateglobalSupplier eEzsigntemplateglobalSupplier = default, string sEzsigntemplateglobalCode = default, string sEzsigntemplateglobalDescription = default)
        {
