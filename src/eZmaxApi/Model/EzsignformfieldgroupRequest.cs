...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignformfieldgroup-Request")]
    public partial class EzsignformfieldgroupRequest : IValidatableObject
    {
        ...
        public EzsignformfieldgroupRequest(int pkiEzsignformfieldgroupID = default, int fkiEzsigndocumentID = default, FieldEEzsignformfieldgroupType eEzsignformfieldgroupType = default, FieldEEzsignformfieldgroupSignerrequirement? eEzsignformfieldgroupSignerrequirement = default, string sEzsignformfieldgroupLabel = default, int iEzsignformfieldgroupStep = default, string sEzsignformfieldgroupDefaultvalue = default, int iEzsignformfieldgroupFilledmin = default, int iEzsignformfieldgroupFilledmax = default, bool bEzsignformfieldgroupReadonly = default, int iEzsignformfieldgroupMaxlength = default, bool bEzsignformfieldgroupEncrypted = default, string sEzsignformfieldgroupRegexp = default, string sEzsignformfieldgroupTextvalidationcustommessage = default, string tEzsignformfieldgroupTooltip = default, FieldEEzsignformfieldgroupTooltipposition? eEzsignformfieldgroupTooltipposition = default, EnumTextvalidation? eEzsignformfieldgroupTextvalidation = default)
        {
            ...
            {
                throw new ArgumentNullException("sEzsignformfieldgroupLabel is a required property for EzsignformfieldgroupRequest and cannot be null");
            }
