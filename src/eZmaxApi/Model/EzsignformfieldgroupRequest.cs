...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignformfieldgroupRequest : IValidatableObject
    {
        ...
        public EzsignformfieldgroupRequest(int  = default(int), int  = default(int), FieldEEzsignformfieldgroupType  = default(FieldEEzsignformfieldgroupType), FieldEEzsignformfieldgroupSignerrequirement?  = default(FieldEEzsignformfieldgroupSignerrequirement?), string  = default(string), int  = default(int), string  = default(string), int  = default(int), int  = default(int), bool  = default(bool), int  = default(int), bool  = default(bool), string  = default(string), string  = default(string), string  = default(string), FieldEEzsignformfieldgroupTooltipposition?  = default(FieldEEzsignformfieldgroupTooltipposition?), EnumTextvalidation?  = default(EnumTextvalidation?))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignformfieldgroupRequest and cannot be null");
            }
