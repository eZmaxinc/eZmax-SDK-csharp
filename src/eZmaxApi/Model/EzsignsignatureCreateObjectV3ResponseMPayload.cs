...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignatureCreateObjectV3ResponseMPayload : IValidatableObject
    {
        ...
        public EzsignsignatureCreateObjectV3ResponseMPayload(List<int>  = default(List<int>))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignsignatureCreateObjectV3ResponseMPayload and cannot be null");
            }
