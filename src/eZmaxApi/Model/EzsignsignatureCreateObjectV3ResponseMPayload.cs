...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignsignature-createObject-v3-Response-mPayload")]
    public partial class EzsignsignatureCreateObjectV3ResponseMPayload : IValidatableObject
    {
        ...
        protected EzsignsignatureCreateObjectV3ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignsignatureCreateObjectV3ResponseMPayload" /> class.
        /// </summary>
        ...
        public EzsignsignatureCreateObjectV3ResponseMPayload(List<int> aPkiEzsignsignatureID = default(List<int>))
        {
            // to ensure "aPkiEzsignsignatureID" is required (not null)
            if (aPkiEzsignsignatureID == null)
            {
                throw new ArgumentNullException("aPkiEzsignsignatureID is a required property for EzsignsignatureCreateObjectV3ResponseMPayload and cannot be null");
            }
