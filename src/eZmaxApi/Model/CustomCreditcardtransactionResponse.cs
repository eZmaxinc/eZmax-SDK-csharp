...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomCreditcardtransactionResponse :  IEquatable<CustomCreditcardtransactionResponse>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="CustomCreditcardtransactionResponse" /> class.
        /// </summary>
        /// <param name="sCreditcardtypeCodename">The codename of the Creditcardtype (required).</param>
        ...
        public CustomCreditcardtransactionResponse(string sCreditcardtypeCodename = default(string), string dCreditcardtransactionAmount = default(string), string sCreditcardtransactionPartiallydecryptednumber = default(string), string sCreditcardtransactionReferencenumber = default(string))
        {
            // to ensure "sCreditcardtypeCodename" is required (not null)
            if (sCreditcardtypeCodename == null)
            {
                throw new InvalidDataException("sCreditcardtypeCodename is a required property for CustomCreditcardtransactionResponse and cannot be null");
            }
            else
            {
                this.SCreditcardtypeCodename = sCreditcardtypeCodename;
            }
        ...
        [DataMember(Name="sCreditcardtypeCodename", EmitDefaultValue=true)]
        public string SCreditcardtypeCodename { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SCreditcardtypeCodename: ").Append(SCreditcardtypeCodename).Append("\n");
        ...
        public bool Equals(CustomCreditcardtransactionResponse input)
        {
            ...
            return 
                (
                    this.SCreditcardtypeCodename == input.SCreditcardtypeCodename ||
                    (this.SCreditcardtypeCodename != null &&
                    this.SCreditcardtypeCodename.Equals(input.SCreditcardtypeCodename))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.SCreditcardtypeCodename != null)
                    hashCode = hashCode * 59 + this.SCreditcardtypeCodename.GetHashCode();
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // SCreditcardtypeCodename (string) pattern
            Regex regexSCreditcardtypeCodename = new Regex(@"^[a-zA-Z ]{0,15}$", RegexOptions.CultureInvariant);
            if (false == regexSCreditcardtypeCodename.Match(this.SCreditcardtypeCodename).Success)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SCreditcardtypeCodename, must match a pattern of " + regexSCreditcardtypeCodename, new [] { "SCreditcardtypeCodename" });
            }
