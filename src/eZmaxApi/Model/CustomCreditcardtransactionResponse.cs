...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomCreditcardtransactionResponse : IValidatableObject
    {
        ...
        public CustomCreditcardtransactionResponse(FieldECreditcardtypeCodename eCreditcardtypeCodename = default, string dCreditcardtransactionAmount = default, string sCreditcardtransactionPartiallydecryptednumber = default, string sCreditcardtransactionReferencenumber = default)
        {
