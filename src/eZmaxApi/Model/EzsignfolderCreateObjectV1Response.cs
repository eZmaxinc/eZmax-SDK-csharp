...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfolderCreateObjectV1Response : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        /// <param name=""> (required).</param>
        public EzsignfolderCreateObjectV1Response(CommonResponseObjDebugPayload  = default(CommonResponseObjDebugPayload), CommonResponseObjDebug  = default(CommonResponseObjDebug), EzsignfolderCreateObjectV1ResponseMPayload  = default(EzsignfolderCreateObjectV1ResponseMPayload))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignfolderCreateObjectV1Response and cannot be null");
            }
