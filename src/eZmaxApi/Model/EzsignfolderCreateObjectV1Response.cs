...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsignfolderCreateObjectV1Response :  IEquatable<EzsignfolderCreateObjectV1Response>
    {
        /// <summary>
        ...
        public EzsignfolderCreateObjectV1Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), EzsignfolderCreateObjectV1ResponseMPayload mPayload = default(EzsignfolderCreateObjectV1ResponseMPayload))
        {
            // to ensure "objDebugPayload" is required (not null)
            if (objDebugPayload == null)
            {
                throw new InvalidDataException("objDebugPayload is a required property for EzsignfolderCreateObjectV1Response and cannot be null");
            }
            else
            {
