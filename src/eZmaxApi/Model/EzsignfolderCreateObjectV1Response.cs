...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfolderCreateObjectV1Response : IValidatableObject
    {
        ...
        public EzsignfolderCreateObjectV1Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), EzsignfolderCreateObjectV1ResponseMPayload mPayload = default(EzsignfolderCreateObjectV1ResponseMPayload))
        {
            ...
            {
                throw new ArgumentNullException("objDebugPayload is a required property for EzsignfolderCreateObjectV1Response and cannot be null");
            }
            this.ObjDebugPayload = objDebugPayload;
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new ArgumentNullException("mPayload is a required property for EzsignfolderCreateObjectV1Response and cannot be null");
            }
