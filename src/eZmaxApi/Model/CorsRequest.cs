...
namespace eZmaxApi.Model
{
    ...
    public partial class CorsRequest : IValidatableObject
    {
        ...
        public CorsRequest(int  = default(int), int  = default(int), string  = default(string))
        {
            this.FkiApikeyID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for CorsRequest and cannot be null");
            }
            this.SCorsEntryurl = ;
            this.PkiCorsID = ;
        }
