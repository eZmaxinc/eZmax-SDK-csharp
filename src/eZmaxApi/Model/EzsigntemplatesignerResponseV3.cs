...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplatesigner-ResponseV3")]
    public partial class EzsigntemplatesignerResponseV3 : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatesignerResponseV3" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplatesignerResponseV3() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatesignerResponseV3" /> class.
        /// </summary>
        ...
        public EzsigntemplatesignerResponseV3(int pkiEzsigntemplatesignerID = default, int fkiEzsigntemplateID = default, int fkiUserID = default, int fkiUsergroupID = default, int fkiEzdoctemplatedocumentID = default, FieldEEzsigntemplatesignerRole? eEzsigntemplatesignerRole = default, FieldEEzsigntemplatesignerMapping? eEzsigntemplatesignerMapping = default, string sEzsigntemplatesignerDescription = default, string sUserName = default, string sUsergroupNameX = default)
        {
            ...
            {
                throw new ArgumentNullException("sEzsigntemplatesignerDescription is a required property for EzsigntemplatesignerResponseV3 and cannot be null");
            }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EzsigntemplatesignerResponseV3 {\n");
