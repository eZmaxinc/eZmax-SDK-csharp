...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload : IEquatable<EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload>, IValidatableObject
    {
        ...
        public EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload(List<FieldEEzsignsignatureType> aEEzsignsignatureType = default(List<FieldEEzsignsignatureType>), List<CustomEzsignfolderEzsignsignaturesAutomaticResponse> aObjEzsignfolder = default(List<CustomEzsignfolderEzsignsignaturesAutomaticResponse>))
        {
            // to ensure "aEEzsignsignatureType" is required (not null)
            if (aEEzsignsignatureType == null)
            {
                throw new ArgumentNullException("aEEzsignsignatureType is a required property for EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload and cannot be null");
            }
            this.AEEzsignsignatureType = aEEzsignsignatureType;
            // to ensure "aObjEzsignfolder" is required (not null)
            if (aObjEzsignfolder == null)
            {
                throw new ArgumentNullException("aObjEzsignfolder is a required property for EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload and cannot be null");
            }
        ...
        {
            return this.Equals(input as EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload);
        }

        /// <summary>
        /// Returns true if EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload input)
        {
            if (input == null)
            {
                return false;
