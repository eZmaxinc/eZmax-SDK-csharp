...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatesignerResponse : IValidatableObject
    {
        ...
        public EzsigntemplatesignerResponse(int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), bool  = default(bool), FieldEEzsigntemplatesignerMapping?  = default(FieldEEzsigntemplatesignerMapping?), string  = default(string), string  = default(string), string  = default(string))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplatesignerResponse and cannot be null");
            }
