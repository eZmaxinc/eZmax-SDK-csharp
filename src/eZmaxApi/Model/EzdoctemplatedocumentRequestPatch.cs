...
namespace eZmaxApi.Model
{
    ...
    public partial class EzdoctemplatedocumentRequestPatch : IValidatableObject
    {
        ...
        public EzdoctemplatedocumentRequestPatch(EEzdoctemplatedocumentFormatEnum? eEzdoctemplatedocumentFormat = default, string sEzdoctemplatedocumentFields = default, byte[] sEzdoctemplatedocumentBase64 = default)
        {
