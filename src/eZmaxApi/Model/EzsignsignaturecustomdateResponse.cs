...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignaturecustomdateResponse : IValidatableObject
    {
        ...
        public EzsignsignaturecustomdateResponse(int pkiEzsignsignaturecustomdateID = default(int), int iEzsignsignaturecustomdateX = default(int), int iEzsignsignaturecustomdateY = default(int), int iEzsignsignaturecustomdateOffsetx = default(int), int iEzsignsignaturecustomdateOffsety = default(int), string sEzsignsignaturecustomdateFormat = default(string))
        {
            ...
            {
                throw new ArgumentNullException("sEzsignsignaturecustomdateFormat is a required property for EzsignsignaturecustomdateResponse and cannot be null");
            }
