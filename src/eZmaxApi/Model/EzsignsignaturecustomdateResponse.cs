...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignaturecustomdateResponse :  IEquatable<EzsignsignaturecustomdateResponse>, IValidatableObject
    {
        ...
        public EzsignsignaturecustomdateResponse(int pkiEzsignsignaturecustomdateID = default(int), int iEzsignsignaturecustomdateX = default(int), int iEzsignsignaturecustomdateY = default(int), string sEzsignsignaturecustomdateFormat = default(string))
        {
            // to ensure "pkiEzsignsignaturecustomdateID" is required (not null)
            if (pkiEzsignsignaturecustomdateID == null)
            {
                throw new InvalidDataException("pkiEzsignsignaturecustomdateID is a required property for EzsignsignaturecustomdateResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iEzsignsignaturecustomdateX is a required property for EzsignsignaturecustomdateResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iEzsignsignaturecustomdateY is a required property for EzsignsignaturecustomdateResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sEzsignsignaturecustomdateFormat is a required property for EzsignsignaturecustomdateResponse and cannot be null");
            }
            else
            {
