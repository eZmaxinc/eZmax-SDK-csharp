...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignaturecustomdateResponse : IValidatableObject
    {
        ...
        protected EzsignsignaturecustomdateResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignsignaturecustomdateResponse" /> class.
        /// </summary>
        ...
        public EzsignsignaturecustomdateResponse(int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), string  = default(string))
        {
            this.PkiEzsignsignaturecustomdateID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignsignaturecustomdateResponse and cannot be null");
            }
