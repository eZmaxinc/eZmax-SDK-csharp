...
namespace eZmaxApi.Model
{
    ...
    public partial class PhoneResponseCompound : IValidatableObject
    {
        ...
        public PhoneResponseCompound(int pkiPhoneID = default, int fkiPhonetypeID = default, FieldEPhoneType? ePhoneType = default, string sPhoneE164 = default, string sPhoneExtension = default, bool bPhoneInternational = default)
        {
