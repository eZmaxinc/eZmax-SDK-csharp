...
namespace eZmaxApi.Model
{
    ...
    public partial class BillingentityexternalGenerateFederationTokenV1ResponseMPayload : IValidatableObject
    {
        ...
        public BillingentityexternalGenerateFederationTokenV1ResponseMPayload(CustomApikeyfederation objApikeyfederation = default, string sEzmaxcustomercodeUrl = default)
        {
