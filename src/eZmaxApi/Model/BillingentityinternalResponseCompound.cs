...
namespace eZmaxApi.Model
{
    ...
    public partial class BillingentityinternalResponseCompound : IValidatableObject
    {
        ...
        public BillingentityinternalResponseCompound(int pkiBillingentityinternalID = default, MultilingualBillingentityinternalDescription objBillingentityinternalDescription = default, List<BillingentityinternalproductResponseCompound> aObjBillingentityinternalproduct = default)
        {
