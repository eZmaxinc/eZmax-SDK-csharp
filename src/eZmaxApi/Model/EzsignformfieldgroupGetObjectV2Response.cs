...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignformfieldgroupGetObjectV2Response : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        /// <param name=""> (required).</param>
        public EzsignformfieldgroupGetObjectV2Response(CommonResponseObjDebugPayload  = default(CommonResponseObjDebugPayload), CommonResponseObjDebug  = default(CommonResponseObjDebug), EzsignformfieldgroupGetObjectV2ResponseMPayload  = default(EzsignformfieldgroupGetObjectV2ResponseMPayload))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignformfieldgroupGetObjectV2Response and cannot be null");
            }
