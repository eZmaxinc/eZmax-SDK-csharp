...
namespace eZmaxApi.Model
{
    ...
    public partial class ContactRequestCompoundV2 : IValidatableObject
    {
        ...
        /// <param name=""> (required).</param>
        public ContactRequestCompoundV2(int  = default(int), int  = default(int), FieldEContactType  = default(FieldEContactType), string  = default(string), string  = default(string), string  = default(string), string  = default(string), string  = default(string), string  = default(string), bool  = default(bool), ContactinformationsRequestCompoundV2  = default(ContactinformationsRequestCompoundV2))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for ContactRequestCompoundV2 and cannot be null");
            }
