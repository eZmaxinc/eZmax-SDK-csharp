...
namespace eZmaxApi.Model
{
    ...
    public partial class ContactRequestCompoundV2 : IValidatableObject
    {
        ...
        public ContactRequestCompoundV2(int fkiContacttitleID = default, int fkiLanguageID = default, FieldEContactType eContactType = default, string sContactFirstname = default, string sContactLastname = default, string sContactCompany = default, string dtContactBirthdate = default, string sContactOccupation = default, string tContactNote = default, bool bContactIsactive = default, ContactinformationsRequestCompoundV2 objContactinformations = default)
        {
            ...
            {
                throw new ArgumentNullException("sContactFirstname is a required property for ContactRequestCompoundV2 and cannot be null");
            }
            this.SContactFirstname = sContactFirstname;
            // to ensure "sContactLastname" is required (not null)
            if (sContactLastname == null)
            {
                throw new ArgumentNullException("sContactLastname is a required property for ContactRequestCompoundV2 and cannot be null");
            }
