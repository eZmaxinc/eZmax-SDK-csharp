...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplatepackagemembership-ResponseCompoundV3")]
    public partial class EzsigntemplatepackagemembershipResponseCompoundV3 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatepackagemembershipResponseCompoundV3" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplatepackagemembershipResponseCompoundV3() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatepackagemembershipResponseCompoundV3" /> class.
        /// </summary>
        ...
        public EzsigntemplatepackagemembershipResponseCompoundV3(int pkiEzsigntemplatepackagemembershipID = default, int fkiEzsigntemplatepackageID = default, int fkiEzsigntemplateID = default, int iEzsigntemplatepackagemembershipOrder = default, EzsigntemplateResponseCompoundV4 objEzsigntemplate = default, List<EzsigntemplatepackagesignermembershipResponseCompound> aObjEzsigntemplatepackagesignermembership = default)
        {
            ...
            {
                throw new ArgumentNullException("objEzsigntemplate is a required property for EzsigntemplatepackagemembershipResponseCompoundV3 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("aObjEzsigntemplatepackagesignermembership is a required property for EzsigntemplatepackagemembershipResponseCompoundV3 and cannot be null");
            }
