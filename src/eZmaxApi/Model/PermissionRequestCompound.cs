...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "permission-RequestCompound")]
    public partial class PermissionRequestCompound : IValidatableObject
    {
        ...
        public PermissionRequestCompound(int pkiPermissionID = default, int fkiUserID = default, int fkiApikeyID = default, int fkiUsergroupID = default, int fkiCompanyID = default, int fkiModulesectionID = default)
        {
