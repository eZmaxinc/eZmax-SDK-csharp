...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "attachment-restore-v1-Response-mPayload")]
    public partial class AttachmentRestoreV1ResponseMPayload : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AttachmentRestoreV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AttachmentRestoreV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AttachmentRestoreV1ResponseMPayload" /> class.
        /// </summary>
        /// <param name="pkiAttachmentID">The unique ID of the Attachment. (required).</param>
        public AttachmentRestoreV1ResponseMPayload(int pkiAttachmentID = default)
        {
