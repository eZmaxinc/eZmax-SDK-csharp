...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatesignerRequestCompound : IValidatableObject
    {
        ...
        public EzsigntemplatesignerRequestCompound(int pkiEzsigntemplatesignerID = default, int fkiEzsigntemplateID = default, int fkiUserID = default, int fkiUsergroupID = default, int fkiEzdoctemplatedocumentID = default, bool bEzsigntemplatesignerReceivecopy = default, FieldEEzsigntemplatesignerMapping? eEzsigntemplatesignerMapping = default, string sEzsigntemplatesignerDescription = default)
        {
