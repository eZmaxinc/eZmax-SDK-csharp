...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatesignerRequestCompound : EzsigntemplatesignerRequest, IValidatableObject
    {
        /// <summary>
        ...
        public EzsigntemplatesignerRequestCompound(int pkiEzsigntemplatesignerID = default(int), int fkiEzsigntemplateID = default(int), int fkiUserID = default(int), int fkiUsergroupID = default(int), int fkiEzdoctemplatedocumentID = default(int), bool bEzsigntemplatesignerReceivecopy = default(bool), FieldEEzsigntemplatesignerMapping? eEzsigntemplatesignerMapping = default(FieldEEzsigntemplatesignerMapping?), string sEzsigntemplatesignerDescription = default(string)) : base()
        {
        }
