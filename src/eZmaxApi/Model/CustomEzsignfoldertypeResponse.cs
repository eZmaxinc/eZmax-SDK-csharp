...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomEzsignfoldertypeResponse : IValidatableObject
    {
        ...
        public CustomEzsignfoldertypeResponse(int pkiEzsignfoldertypeID = default, int fkiFontIDAnnotation = default, int fkiFontIDFormfield = default, int fkiFontIDSignature = default, string sEzsignfoldertypeNameX = default, bool bEzsignfoldertypeSendproofezsignsigner = default, bool bEzsignfoldertypeAllowdownloadattachmentezsignsigner = default, bool bEzsignfoldertypeAllowdownloadproofezsignsigner = default, bool bEzsignfoldertypeAutomaticsignature = default, bool bEzsignfoldertypeDelegate = default, bool bEzsignfoldertypeDiscussion = default, bool bEzsignfoldertypeReassignezsignsigner = default, bool bEzsignfoldertypeReassignuser = default, bool bEzsignfoldertypeReassigngroup = default, int iEzsignfoldertypeDeadlinedays = default, int iEzsignfoldertypeFontsizeannotation = default, int iEzsignfoldertypeFontsizeformfield = default, FieldEEzsignfoldertypeDocumentmerge? eEzsignfoldertypeDocumentmerge = default)
        {
