...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomEzsignfoldertypeResponse :  IEquatable<CustomEzsignfoldertypeResponse>, IValidatableObject
    {
        ...
        public CustomEzsignfoldertypeResponse(int pkiEzsignfoldertypeID = default(int), string sEzsignfoldertypeNameX = default(string), bool bEzsignfoldertypeIncludeproofsigner = default(bool), bool bEzsignfoldertypeIncludeproofuser = default(bool), bool bEzsignfoldertypeDelegate = default(bool), bool bEzsignfoldertypeReassign = default(bool))
        {
            ...
            {
                throw new InvalidDataException("pkiEzsignfoldertypeID is a required property for CustomEzsignfoldertypeResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sEzsignfoldertypeNameX is a required property for CustomEzsignfoldertypeResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("bEzsignfoldertypeIncludeproofsigner is a required property for CustomEzsignfoldertypeResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("bEzsignfoldertypeIncludeproofuser is a required property for CustomEzsignfoldertypeResponse and cannot be null");
            }
            else
            {
