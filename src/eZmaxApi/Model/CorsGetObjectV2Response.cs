...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "cors-getObject-v2-Response")]
    public partial class CorsGetObjectV2Response : IEquatable<CorsGetObjectV2Response>, IValidatableObject
    {
        ...
        public CorsGetObjectV2Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), CorsGetObjectV2ResponseMPayload mPayload = default(CorsGetObjectV2ResponseMPayload))
        {
            // to ensure "objDebugPayload" is required (not null)
            if (objDebugPayload == null)
            {
                throw new ArgumentNullException("objDebugPayload is a required property for CorsGetObjectV2Response and cannot be null");
            }
            this.ObjDebugPayload = objDebugPayload;
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new ArgumentNullException("mPayload is a required property for CorsGetObjectV2Response and cannot be null");
            }
