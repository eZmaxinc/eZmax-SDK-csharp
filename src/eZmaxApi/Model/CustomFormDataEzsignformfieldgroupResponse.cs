...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomFormDataEzsignformfieldgroupResponse : IValidatableObject
    {
        ...
        public CustomFormDataEzsignformfieldgroupResponse(string sEzsignformfieldgroupLabel = default, List<CustomFormDataEzsignformfieldResponse> aObjEzsignformfield = default)
        {
