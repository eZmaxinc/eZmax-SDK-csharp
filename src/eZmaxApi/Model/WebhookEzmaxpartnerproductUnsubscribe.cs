...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Webhook-Ezmaxpartnerproduct-Unsubscribe")]
    public partial class WebhookEzmaxpartnerproductUnsubscribe : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEzmaxpartnerproductUnsubscribe" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WebhookEzmaxpartnerproductUnsubscribe() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEzmaxpartnerproductUnsubscribe" /> class.
        /// </summary>
        ...
        public WebhookEzmaxpartnerproductUnsubscribe(CustomWebhookResponse objWebhook = default, List<AttemptResponseCompound> aObjAttempt = default, CustomEzmaxpartnerproductSubscribe objEzmaxpartnerproduct = default, string sExternalID = default)
        {
            ...
            if (objWebhook == null)
            {
                throw new ArgumentNullException("objWebhook is a required property for WebhookEzmaxpartnerproductUnsubscribe and cannot be null");
            }
            this.ObjWebhook = objWebhook;
            // to ensure "aObjAttempt" is required (not null)
            if (aObjAttempt == null)
            {
                throw new ArgumentNullException("aObjAttempt is a required property for WebhookEzmaxpartnerproductUnsubscribe and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WebhookEzmaxpartnerproductUnsubscribe {\n");
