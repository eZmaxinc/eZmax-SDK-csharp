...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigndiscussionRequestCompound : IValidatableObject
    {
        ...
        public EzsigndiscussionRequestCompound(int pkiEzsigndiscussionID = default, int fkiEzsigndocumentID = default, int iEzsigndiscussionPagenumber = default, int iEzsigndiscussionX = default, int iEzsigndiscussionY = default, DiscussionRequest objDiscussion = default)
        {
