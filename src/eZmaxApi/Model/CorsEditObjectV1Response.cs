...
namespace eZmaxApi.Model
{
    ...
    public partial class CorsEditObjectV1Response : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        public CorsEditObjectV1Response(CommonResponseObjDebugPayload  = default(CommonResponseObjDebugPayload), CommonResponseObjDebug  = default(CommonResponseObjDebug))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for CorsEditObjectV1Response and cannot be null");
            }
