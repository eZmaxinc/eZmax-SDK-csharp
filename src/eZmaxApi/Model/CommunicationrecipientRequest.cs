...
namespace eZmaxApi.Model
{
    ...
    public partial class CommunicationrecipientRequest : IValidatableObject
    {
        ...
        public CommunicationrecipientRequest(int pkiCommunicationrecipientID = default, int fkiAgentID = default, int fkiBrokerID = default, int fkiContactID = default, int fkiCustomerID = default, int fkiEmployeeID = default, int fkiAssistantID = default, int fkiExternalbrokerID = default, int fkiEzsignsignerID = default, int fkiNotaryID = default, int fkiSupplierID = default, int fkiUserID = default, int fkiMailboxsharedID = default, int fkiPhonelinesharedID = default, FieldECommunicationrecipientType? eCommunicationrecipientType = default)
        {
