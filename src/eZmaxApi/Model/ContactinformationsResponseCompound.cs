...
namespace eZmaxApi.Model
{
    ...
    public partial class ContactinformationsResponseCompound : IValidatableObject
    {
        ...
        public ContactinformationsResponseCompound(int pkiContactinformationsID = default, int fkiAddressIDDefault = default, int fkiPhoneIDDefault = default, int fkiEmailIDDefault = default, int fkiWebsiteIDDefault = default, FieldEContactinformationsType eContactinformationsType = default, string sContactinformationsUrl = default, AddressResponseCompound objAddressDefault = default, PhoneResponseCompound objPhoneDefault = default, EmailResponseCompound objEmailDefault = default, WebsiteResponseCompound objWebsiteDefault = default, List<AddressResponseCompound> aObjAddress = default, List<PhoneResponseCompound> aObjPhone = default, List<EmailResponseCompound> aObjEmail = default, List<WebsiteResponseCompound> aObjWebsite = default)
        {
