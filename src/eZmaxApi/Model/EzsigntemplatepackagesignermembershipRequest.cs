...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatepackagesignermembershipRequest : IValidatableObject
    {
        ...
        public EzsigntemplatepackagesignermembershipRequest(int pkiEzsigntemplatepackagesignermembershipID = default, int fkiEzsigntemplatepackagemembershipID = default, int fkiEzsigntemplatepackagesignerID = default, int fkiEzsigntemplatesignerID = default, int iEzsigntemplatepackagesignermembershipCopy = default)
        {
