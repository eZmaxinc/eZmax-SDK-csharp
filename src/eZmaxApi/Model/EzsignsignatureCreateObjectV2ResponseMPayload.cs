...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignatureCreateObjectV2ResponseMPayload : IValidatableObject
    {
        ...
        public EzsignsignatureCreateObjectV2ResponseMPayload(List<int>  = default(List<int>))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignsignatureCreateObjectV2ResponseMPayload and cannot be null");
            }
