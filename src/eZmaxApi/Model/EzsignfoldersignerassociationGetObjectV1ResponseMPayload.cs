...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfoldersignerassociationGetObjectV1ResponseMPayload : IValidatableObject
    {
        ...
        public EzsignfoldersignerassociationGetObjectV1ResponseMPayload(int  = default(int), int  = default(int), bool  = default(bool), bool  = default(bool), string  = default(string), bool  = default(bool), EzsignsignergroupResponseCompound  = default(EzsignsignergroupResponseCompound), EzsignfoldersignerassociationResponseCompoundUser  = default(EzsignfoldersignerassociationResponseCompoundUser), EzsignsignerResponseCompound  = default(EzsignsignerResponseCompound))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignfoldersignerassociationGetObjectV1ResponseMPayload and cannot be null");
            }
