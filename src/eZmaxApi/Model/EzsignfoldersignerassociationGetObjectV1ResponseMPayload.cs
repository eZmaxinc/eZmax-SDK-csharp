...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfoldersignerassociationGetObjectV1ResponseMPayload : IValidatableObject
    {
        ...
        public EzsignfoldersignerassociationGetObjectV1ResponseMPayload(int pkiEzsignfoldersignerassociationID = default, int fkiEzsignfolderID = default, bool bEzsignfoldersignerassociationDelayedsend = default, bool bEzsignfoldersignerassociationReceivecopy = default, string tEzsignfoldersignerassociationMessage = default, bool bEzsignfoldersignerassociationAllowsigninginperson = default, EzsignsignergroupResponseCompound objEzsignsignergroup = default, EzsignfoldersignerassociationResponseCompoundUser objUser = default, EzsignsignerResponseCompound objEzsignsigner = default)
        {
