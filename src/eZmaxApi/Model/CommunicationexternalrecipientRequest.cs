...
namespace eZmaxApi.Model
{
    ...
    public partial class CommunicationexternalrecipientRequest : IValidatableObject
    {
        ...
        public CommunicationexternalrecipientRequest(int pkiCommunicationexternalrecipientID = default, string sEmailAddress = default, string sPhoneE164 = default, FieldECommunicationexternalrecipientType? eCommunicationexternalrecipientType = default, string sCommunicationexternalrecipientName = default)
        {
