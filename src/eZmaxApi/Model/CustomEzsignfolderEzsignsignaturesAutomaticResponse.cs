...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomEzsignfolderEzsignsignaturesAutomaticResponse : IValidatableObject
    {
        ...
        public CustomEzsignfolderEzsignsignaturesAutomaticResponse(int pkiEzsignfolderID = default, string sEzsignfolderDescription = default, List<CustomEzsigndocumentEzsignsignaturesAutomaticResponse> aObjEzsigndocument = default)
        {
