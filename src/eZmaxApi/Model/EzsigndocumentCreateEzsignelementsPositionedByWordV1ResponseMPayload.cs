...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigndocumentCreateEzsignelementsPositionedByWordV1ResponseMPayload : IValidatableObject
    {
        ...
        public EzsigndocumentCreateEzsignelementsPositionedByWordV1ResponseMPayload(List<int> aPkiEzsignsignatureID = default, List<int> aPkiEzsignformfieldgroupID = default)
        {
