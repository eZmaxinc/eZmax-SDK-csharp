...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigndiscussion-Response")]
    public partial class EzsigndiscussionResponse : IValidatableObject
    {
        ...
        protected EzsigndiscussionResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigndiscussionResponse" /> class.
        /// </summary>
        ...
        public EzsigndiscussionResponse(int pkiEzsigndiscussionID = default, int fkiEzsignpageID = default, int fkiDiscussionID = default, int iEzsigndiscussionX = default, int iEzsigndiscussionY = default, int iEzsigndiscussionPagenumber = default, DiscussionResponseCompound objDiscussion = default)
        {
