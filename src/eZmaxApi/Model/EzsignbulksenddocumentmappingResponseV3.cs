...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignbulksenddocumentmapping-ResponseV3")]
    public partial class EzsignbulksenddocumentmappingResponseV3 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignbulksenddocumentmappingResponseV3" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsignbulksenddocumentmappingResponseV3() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignbulksenddocumentmappingResponseV3" /> class.
        /// </summary>
        ...
        public EzsignbulksenddocumentmappingResponseV3(int pkiEzsignbulksenddocumentmappingID = default, int fkiEzsignbulksendID = default, int fkiEzsigntemplatepackageID = default, int fkiEzsigntemplateID = default, int iEzsignbulksenddocumentmappingOrder = default)
        {
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EzsignbulksenddocumentmappingResponseV3 {\n");
