...
namespace eZmaxApi.Model
{
    ...
    public partial class EzdoctemplatedocumentRequest : IValidatableObject
    {
        ...
        public EzdoctemplatedocumentRequest(int pkiEzdoctemplatedocumentID = default, int fkiLanguageID = default, int fkiEzsignfoldertypeID = default, int fkiEzdoctemplatetypeID = default, int fkiEzdoctemplatefieldtypecategoryID = default, FieldEEzdoctemplatedocumentPrivacylevel? eEzdoctemplatedocumentPrivacylevel = default, bool bEzdoctemplatedocumentIsactive = default, MultilingualEzdoctemplatedocumentName objEzdoctemplatedocumentName = default)
        {
