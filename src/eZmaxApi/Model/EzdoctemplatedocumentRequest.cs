...
namespace eZmaxApi.Model
{
    ...
    public partial class EzdoctemplatedocumentRequest : IValidatableObject
    {
        ...
        public EzdoctemplatedocumentRequest(int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), FieldEEzdoctemplatedocumentPrivacylevel?  = default(FieldEEzdoctemplatedocumentPrivacylevel?), bool  = default(bool), MultilingualEzdoctemplatedocumentName  = default(MultilingualEzdoctemplatedocumentName))
        {
            this.FkiLanguageID = ;
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzdoctemplatedocumentRequest and cannot be null");
            }
