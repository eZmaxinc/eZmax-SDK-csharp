...
namespace eZmaxApi.Model
{
    ...
    public partial class EzdoctemplatefieldtypecategoryAutocompleteElementResponse : IValidatableObject
    {
        ...
        public EzdoctemplatefieldtypecategoryAutocompleteElementResponse(int pkiEzdoctemplatefieldtypecategoryID = default, int fkiEzdoctemplatetypeID = default, string sEzdoctemplatefieldtypecategoryDescriptionX = default, bool bEzdoctemplatefieldtypecategoryIsactive = default)
        {
