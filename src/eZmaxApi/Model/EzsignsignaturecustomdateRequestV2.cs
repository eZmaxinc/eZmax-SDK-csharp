...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignaturecustomdateRequestV2 : IValidatableObject
    {
        ...
        public EzsignsignaturecustomdateRequestV2(int pkiEzsignsignaturecustomdateID = default(int), int iEzsignsignaturecustomdateOffsetx = default(int), int iEzsignsignaturecustomdateOffsety = default(int), string sEzsignsignaturecustomdateFormat = default(string))
        {
            ...
            {
                throw new ArgumentNullException("sEzsignsignaturecustomdateFormat is a required property for EzsignsignaturecustomdateRequestV2 and cannot be null");
            }
