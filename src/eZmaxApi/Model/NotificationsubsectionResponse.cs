...
namespace eZmaxApi.Model
{
    ...
    public partial class NotificationsubsectionResponse : IValidatableObject
    {
        ...
        public NotificationsubsectionResponse(int pkiNotificationsubsectionID = default, int fkiNotificationsectionID = default, MultilingualNotificationsubsectionName objNotificationsubsectionName = default, string sNotificationsectionNameX = default, string sNotificationsubsectionNameX = default)
        {
