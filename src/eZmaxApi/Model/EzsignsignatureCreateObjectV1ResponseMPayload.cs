...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignatureCreateObjectV1ResponseMPayload : IValidatableObject
    {
        ...
        public EzsignsignatureCreateObjectV1ResponseMPayload(List<int>  = default(List<int>))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignsignatureCreateObjectV1ResponseMPayload and cannot be null");
            }
