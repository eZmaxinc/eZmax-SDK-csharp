...
dataType                            : Object
datatypeWithEnum                    : 
name                                : ezsignsignature-createObject-v1-Response-mPayload
defaultValue                        : 
...
*/
    ...
    public partial class EzsignsignatureCreateObjectV1ResponseMPayload :  IEquatable<EzsignsignatureCreateObjectV1ResponseMPayload>, IValidatableObject
    {
        ...
        public EzsignsignatureCreateObjectV1ResponseMPayload(List<int> aPkiEzsignsignatureID = default(List<int>))
        {
            ...
            {
                throw new InvalidDataException("aPkiEzsignsignatureID is a required property for EzsignsignatureCreateObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
