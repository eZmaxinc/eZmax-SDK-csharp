...
namespace eZmaxApi.Model
{
    ...
    public partial class CommonResponseErrorCreditcardValidation : IValidatableObject
    {
        ...
        protected CommonResponseErrorCreditcardValidation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonResponseErrorCreditcardValidation" /> class.
        /// </summary>
        ...
        /// <param name="">.</param>
        public CommonResponseErrorCreditcardValidation(string  = default(string), FieldEErrorCode  = default(FieldEErrorCode), List<string>  = default(List<string>), CustomCreditcardtransactionresponseResponse  = default(CustomCreditcardtransactionresponseResponse))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for CommonResponseErrorCreditcardValidation and cannot be null");
            }
            this.SErrorMessage = ;
            this.EErrorCode = ;
        ...
        /// </summary>
        [DataMember(Name = "objCreditcardtransactionresponse", EmitDefaultValue = false)]
        public CustomCreditcardtransactionresponseResponse ObjCreditcardtransactionresponse { get; set; }
