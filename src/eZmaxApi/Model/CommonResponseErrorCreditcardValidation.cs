...
namespace eZmaxApi.Model
{
    ...
    public partial class CommonResponseErrorCreditcardValidation : IValidatableObject
    {
        ...
        public CommonResponseErrorCreditcardValidation(string sErrorMessage = default, FieldEErrorCode eErrorCode = default, List<string> aSErrorMessagedetail = default, CustomCreditcardtransactionresponseResponse objCreditcardtransactionresponse = default)
        {
