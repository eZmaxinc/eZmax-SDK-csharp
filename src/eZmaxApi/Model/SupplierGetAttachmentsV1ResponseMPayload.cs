...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "supplier-getAttachments-v1-Response-mPayload")]
    public partial class SupplierGetAttachmentsV1ResponseMPayload : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SupplierGetAttachmentsV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SupplierGetAttachmentsV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SupplierGetAttachmentsV1ResponseMPayload" /> class.
        /// </summary>
        /// <param name="aObjAttachmentdocumenttype">aObjAttachmentdocumenttype (required).</param>
        public SupplierGetAttachmentsV1ResponseMPayload(List<CustomAttachmentdocumenttypeResponse> aObjAttachmentdocumenttype = default)
        {
            // to ensure "aObjAttachmentdocumenttype" is required (not null)
            if (aObjAttachmentdocumenttype == null)
            {
                throw new ArgumentNullException("aObjAttachmentdocumenttype is a required property for SupplierGetAttachmentsV1ResponseMPayload and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SupplierGetAttachmentsV1ResponseMPayload {\n");
