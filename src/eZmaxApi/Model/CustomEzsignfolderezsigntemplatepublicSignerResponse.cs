...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomEzsignfolderezsigntemplatepublicSignerResponse : IValidatableObject
    {
        ...
        public CustomEzsignfolderezsigntemplatepublicSignerResponse(int fkiUserID = default, int fkiEzsignsignergroupID = default, string sContactFirstname = default, string sContactLastname = default, string sEzsignsignergroupDescriptionX = default)
        {
