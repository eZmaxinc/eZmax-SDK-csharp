...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplateRequestCompoundV3 : IValidatableObject
    {
        ...
        public EzsigntemplateRequestCompoundV3(int pkiEzsigntemplateID = default, int fkiEzsignfoldertypeID = default, int fkiLanguageID = default, int fkiEzdoctemplatedocumentID = default, string sEzsigntemplateDescription = default, string sEzsigntemplateExternaldescription = default, string tEzsigntemplateComment = default, FieldEEzsigntemplateRecognition? eEzsigntemplateRecognition = default, string sEzsigntemplateFilenameregexp = default, bool bEzsigntemplateAdminonly = default, FieldEEzsigntemplateType eEzsigntemplateType = default)
        {
            this.FkiLanguageID = fkiLanguageID;
            // to ensure "sEzsigntemplateDescription" is required (not null)
            if (sEzsigntemplateDescription == null)
            {
                throw new ArgumentNullException("sEzsigntemplateDescription is a required property for EzsigntemplateRequestCompoundV3 and cannot be null");
            }
