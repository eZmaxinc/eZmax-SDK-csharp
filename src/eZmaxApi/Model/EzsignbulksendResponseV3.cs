...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignbulksend-ResponseV3")]
    public partial class EzsignbulksendResponseV3 : IValidatableObject
    {
        ...
        protected EzsignbulksendResponseV3() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignbulksendResponseV3" /> class.
        /// </summary>
        ...
        public EzsignbulksendResponseV3(int pkiEzsignbulksendID = default, int fkiEzsignfoldertypeID = default, int fkiLanguageID = default, string sLanguageNameX = default, FieldEEzsignbulksendEzsignformfieldorder eEzsignbulksendEzsignformfieldorder = default, FieldEEzsignfoldertypePrivacylevel eEzsignfoldertypePrivacylevel = default, string sEzsignfoldertypeNameX = default, string sEzsignbulksendDescription = default, string tEzsignbulksendNote = default, bool bEzsignbulksendNeedvalidation = default, bool bEzsignbulksendIsactive = default, CommonAudit objAudit = default)
        {
            ...
            {
                throw new ArgumentNullException("sLanguageNameX is a required property for EzsignbulksendResponseV3 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sEzsignfoldertypeNameX is a required property for EzsignbulksendResponseV3 and cannot be null");
            }
            this.SEzsignfoldertypeNameX = sEzsignfoldertypeNameX;
            // to ensure "sEzsignbulksendDescription" is required (not null)
            if (sEzsignbulksendDescription == null)
            {
                throw new ArgumentNullException("sEzsignbulksendDescription is a required property for EzsignbulksendResponseV3 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("tEzsignbulksendNote is a required property for EzsignbulksendResponseV3 and cannot be null");
            }
            ...
            if (objAudit == null)
            {
                throw new ArgumentNullException("objAudit is a required property for EzsignbulksendResponseV3 and cannot be null");
            }
