...
namespace eZmaxApi.Model
{
    ...
    public partial class SubnetRequestCompound : IValidatableObject
    {
        ...
        public SubnetRequestCompound(int pkiSubnetID = default, int fkiUserID = default, int fkiApikeyID = default, MultilingualSubnetDescription objSubnetDescription = default, long iSubnetNetwork = default, long iSubnetMask = default)
        {
