...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "subnet-RequestCompound")]
    public partial class SubnetRequestCompound : SubnetRequest, IValidatableObject
    {
        /// <summary>
        ...
        public SubnetRequestCompound(int pkiSubnetID = default(int), int fkiUserID = default(int), int fkiApikeyID = default(int), MultilingualSubnetDescription objSubnetDescription = default(MultilingualSubnetDescription), long iSubnetNetwork = default(long), long iSubnetMask = default(long)) : base()
        {
        }
