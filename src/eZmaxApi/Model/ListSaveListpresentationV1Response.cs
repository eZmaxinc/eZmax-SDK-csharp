...
namespace eZmaxApi.Model
{
    ...
    public partial class ListSaveListpresentationV1Response :  IEquatable<ListSaveListpresentationV1Response>, IValidatableObject
    {
        ...
        protected ListSaveListpresentationV1Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListSaveListpresentationV1Response" /> class.
        /// </summary>
        ...
        public ListSaveListpresentationV1Response(ListSaveListpresentationV1ResponseMPayload mPayload = default(ListSaveListpresentationV1ResponseMPayload), CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug))
        {
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new InvalidDataException("mPayload is a required property for ListSaveListpresentationV1Response and cannot be null");
            }
            else
            {
