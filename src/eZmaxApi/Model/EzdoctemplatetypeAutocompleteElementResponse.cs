...
namespace eZmaxApi.Model
{
    ...
    public partial class EzdoctemplatetypeAutocompleteElementResponse : IValidatableObject
    {
        ...
        public EzdoctemplatetypeAutocompleteElementResponse(int pkiEzdoctemplatetypeID = default, string sEzdoctemplatetypeDescriptionX = default, bool bEzdoctemplatetypeIsactive = default)
        {
