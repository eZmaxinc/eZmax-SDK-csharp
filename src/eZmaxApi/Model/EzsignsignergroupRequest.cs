...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignergroupRequest : IValidatableObject
    {
        ...
        public EzsignsignergroupRequest(int pkiEzsignsignergroupID = default, int fkiEzsignfolderID = default, MultilingualEzsignsignergroupDescription objEzsignsignergroupDescription = default)
        {
