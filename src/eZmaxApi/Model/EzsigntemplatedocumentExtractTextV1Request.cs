...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatedocumentExtractTextV1Request : IValidatableObject
    {
        ...
        public EzsigntemplatedocumentExtractTextV1Request(int iPage = default, ESectionEnum? eSection = default, int iX = default, int iY = default, int iWidth = default, int iHeight = default)
        {
            this.IPage = iPage;
