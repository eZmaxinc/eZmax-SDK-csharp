...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BrandingGetObjectV1ResponseMPayload :  IEquatable<BrandingGetObjectV1ResponseMPayload>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BrandingGetObjectV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BrandingGetObjectV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BrandingGetObjectV1ResponseMPayload" /> class.
        /// </summary>
        ...
        public BrandingGetObjectV1ResponseMPayload(int pkiBrandingID = default(int), MultilingualBrandingDescription objBrandingDescription = default(MultilingualBrandingDescription), string sBrandingDescriptionX = default(string), FieldEBrandingLogo eBrandingLogo = default(FieldEBrandingLogo), int iBrandingColortext = default(int), int iBrandingColortextlinkbox = default(int), int iBrandingColortextbutton = default(int), int iBrandingColorbackground = default(int), int iBrandingColorbackgroundbutton = default(int), int iBrandingColorbackgroundsmallbox = default(int), bool bBrandingIsactive = default(bool), string sBrandingLogourl = default(string))
        {
            ...
            {
                throw new InvalidDataException("objBrandingDescription is a required property for BrandingGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sBrandingDescriptionX is a required property for BrandingGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("eBrandingLogo is a required property for BrandingGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iBrandingColortext is a required property for BrandingGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iBrandingColortextlinkbox is a required property for BrandingGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iBrandingColortextbutton is a required property for BrandingGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iBrandingColorbackground is a required property for BrandingGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iBrandingColorbackgroundbutton is a required property for BrandingGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iBrandingColorbackgroundsmallbox is a required property for BrandingGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("bBrandingIsactive is a required property for BrandingGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as BrandingGetObjectV1ResponseMPayload);
        }

        /// <summary>
        /// Returns true if BrandingGetObjectV1ResponseMPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of BrandingGetObjectV1ResponseMPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BrandingGetObjectV1ResponseMPayload input)
        {
            if (input == null)
                return false;
