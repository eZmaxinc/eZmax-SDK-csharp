...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsigningreasonResponse : IValidatableObject
    {
        ...
        public EzsignsigningreasonResponse(int  = default(int), MultilingualEzsignsigningreasonDescription  = default(MultilingualEzsignsigningreasonDescription), bool  = default(bool))
        {
            this.PkiEzsignsigningreasonID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignsigningreasonResponse and cannot be null");
            }
