...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignsigningreason-Response")]
    public partial class EzsignsigningreasonResponse : IValidatableObject
    {
        ...
        protected EzsignsigningreasonResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignsigningreasonResponse" /> class.
        /// </summary>
        ...
        public EzsignsigningreasonResponse(int pkiEzsignsigningreasonID = default(int), MultilingualEzsignsigningreasonDescription objEzsignsigningreasonDescription = default(MultilingualEzsignsigningreasonDescription), bool bEzsignsigningreasonIsactive = default(bool))
        {
            ...
            {
                throw new ArgumentNullException("objEzsignsigningreasonDescription is a required property for EzsignsigningreasonResponse and cannot be null");
            }
