...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignformfieldgroupResponse : IValidatableObject
    {
        ...
        public EzsignformfieldgroupResponse(int  = default(int), int  = default(int), FieldEEzsignformfieldgroupType  = default(FieldEEzsignformfieldgroupType), FieldEEzsignformfieldgroupSignerrequirement?  = default(FieldEEzsignformfieldgroupSignerrequirement?), string  = default(string), int  = default(int), string  = default(string), int  = default(int), int  = default(int), bool  = default(bool), int  = default(int), bool  = default(bool), EnumTextvalidation?  = default(EnumTextvalidation?), string  = default(string), string  = default(string), string  = default(string), FieldEEzsignformfieldgroupTooltipposition?  = default(FieldEEzsignformfieldgroupTooltipposition?))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignformfieldgroupResponse and cannot be null");
            }
