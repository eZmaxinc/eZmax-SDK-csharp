...
namespace eZmaxApi.Model
{
    ...
    public partial class CreditcarddetailResponse : IValidatableObject
    {
        ...
        public CreditcarddetailResponse(int pkiCreditcarddetailID = default(int), int fkiCreditcardtypeID = default(int), int iCreditcarddetailLastdigits = default(int), int iCreditcarddetailExpirationmonth = default(int), int iCreditcarddetailExpirationyear = default(int), string sCreditcarddetailCivic = default(string), string sCreditcarddetailStreet = default(string), string sCreditcarddetailZip = default(string))
        {
