...
namespace eZmaxApi.Model
{
    ...
    public partial class CreditcarddetailResponse : IValidatableObject
    {
        ...
        public CreditcarddetailResponse(int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), string  = default(string), string  = default(string), string  = default(string))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for CreditcarddetailResponse and cannot be null");
            }
