...
namespace eZmaxApi.Model
{
    ...
    public partial class CreditcarddetailResponse : IValidatableObject
    {
        ...
        public CreditcarddetailResponse(int pkiCreditcarddetailID = default, int fkiCreditcardtypeID = default, int iCreditcarddetailLastdigits = default, int iCreditcarddetailExpirationmonth = default, int iCreditcarddetailExpirationyear = default, string sCreditcarddetailCivic = default, string sCreditcarddetailStreet = default, string sCreditcarddetailZip = default)
        {
