...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ListpresentationResponseCompound :  IEquatable<ListpresentationResponseCompound>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListpresentationResponseCompound" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListpresentationResponseCompound() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListpresentationResponseCompound" /> class.
        /// </summary>
        ...
        public ListpresentationResponseCompound(string sListpresentationDescription = default(string), string sListpresentationFilter = default(string), string sListpresentationOrderby = default(string), List<string> aSColumnName = default(List<string>), int iListpresentationRowMax = default(int), int iListpresentationRowOffset = default(int), bool bListpresentationDefault = default(bool))
        {
            ...
            {
                throw new InvalidDataException("sListpresentationFilter is a required property for ListpresentationResponseCompound and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sListpresentationOrderby is a required property for ListpresentationResponseCompound and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("aSColumnName is a required property for ListpresentationResponseCompound and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iListpresentationRowMax is a required property for ListpresentationResponseCompound and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iListpresentationRowOffset is a required property for ListpresentationResponseCompound and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("bListpresentationDefault is a required property for ListpresentationResponseCompound and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ListpresentationResponseCompound);
        }

        /// <summary>
        /// Returns true if ListpresentationResponseCompound instances are equal
        /// </summary>
        /// <param name="input">Instance of ListpresentationResponseCompound to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListpresentationResponseCompound input)
        {
            if (input == null)
                return false;
