...
namespace eZmaxApi.Model
{
    ...
    public partial class MultilingualPaymenttermDescription : IValidatableObject
    {
        ...
        public MultilingualPaymenttermDescription(string sPaymenttermDescription1 = default, string sPaymenttermDescription2 = default)
        {
        ...
        */
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            if (this.SPaymenttermDescription1 != null) {
                ...
                if (!regexSPaymenttermDescription1.Match(this.SPaymenttermDescription1).Success)
                {
            ...
            if (this.SPaymenttermDescription2 != null) {
                ...
                if (!regexSPaymenttermDescription2.Match(this.SPaymenttermDescription2).Success)
                {
