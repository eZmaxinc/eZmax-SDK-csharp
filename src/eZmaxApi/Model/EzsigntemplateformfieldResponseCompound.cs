...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplateformfieldResponseCompound :  IEquatable<EzsigntemplateformfieldResponseCompound>, IValidatableObject
    {
        ...
        /// <param name="sEzsigntemplateformfieldValue">The value for the Ezsigntemplateformfield  This can only be set if eEzsigntemplateformfieldgroupType is Checkbox or Radio.</param>
