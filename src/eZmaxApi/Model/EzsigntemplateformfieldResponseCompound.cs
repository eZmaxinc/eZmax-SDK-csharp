...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplateformfieldResponseCompound : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="EzsigntemplateformfieldResponseCompound" /> class.
        /// </summary>
        /// <param name="">The unique ID of the Ezsigntemplateformfield (required).</param>
        /// <param name="">.</param>
        ...
        public EzsigntemplateformfieldResponseCompound(int  = default(int), FieldEEzsigntemplateformfieldPositioning?  = default(FieldEEzsigntemplateformfieldPositioning?), int  = default(int), string  = default(string), string  = default(string), int  = default(int), int  = default(int), int  = default(int), int  = default(int), bool  = default(bool), bool  = default(bool), FieldEEzsigntemplateformfieldDependencyrequirement?  = default(FieldEEzsigntemplateformfieldDependencyrequirement?), string  = default(string), int  = default(int), int  = default(int), FieldEEzsigntemplateformfieldPositioningoccurence?  = default(FieldEEzsigntemplateformfieldPositioningoccurence?), EnumHorizontalalignment?  = default(EnumHorizontalalignment?), TextstylestaticResponseCompound  = default(TextstylestaticResponseCompound), List<EzsigntemplateelementdependencyResponseCompound>  = default(List<EzsigntemplateelementdependencyResponseCompound>))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplateformfieldResponseCompound and cannot be null");
            }
