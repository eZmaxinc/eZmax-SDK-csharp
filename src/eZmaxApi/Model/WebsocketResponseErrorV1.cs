...
namespace eZmaxApi.Model
{
    ...
    public partial class WebsocketResponseErrorV1 : IValidatableObject
    {
        ...
        public WebsocketResponseErrorV1(EWebsocketMessagetypeEnum  = default(EWebsocketMessagetypeEnum), string  = default(string), WebsocketResponseErrorV1MPayload  = default(WebsocketResponseErrorV1MPayload))
        {
            this.EWebsocketMessagetype = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for WebsocketResponseErrorV1 and cannot be null");
            }
