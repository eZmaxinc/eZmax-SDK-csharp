...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfolderGetActionableElementsV1ResponseMPayload : IValidatableObject
    {
        ...
        /// <param name=""> (required).</param>
        public EzsignfolderGetActionableElementsV1ResponseMPayload(List<EzsignsignatureResponseCompound>  = default(List<EzsignsignatureResponseCompound>), List<EzsignformfieldgroupResponseCompound>  = default(List<EzsignformfieldgroupResponseCompound>))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignfolderGetActionableElementsV1ResponseMPayload and cannot be null");
            }
