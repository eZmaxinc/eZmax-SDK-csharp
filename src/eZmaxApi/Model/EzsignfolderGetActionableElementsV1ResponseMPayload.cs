...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfolderGetActionableElementsV1ResponseMPayload : IValidatableObject
    {
        ...
        public EzsignfolderGetActionableElementsV1ResponseMPayload(List<EzsignsignatureResponseCompound> aObjEzsignsignature = default(List<EzsignsignatureResponseCompound>), List<EzsignformfieldgroupResponseCompound> aObjEzsignformfieldgroup = default(List<EzsignformfieldgroupResponseCompound>))
        {
            ...
            {
                throw new ArgumentNullException("aObjEzsignsignature is a required property for EzsignfolderGetActionableElementsV1ResponseMPayload and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("aObjEzsignformfieldgroup is a required property for EzsignfolderGetActionableElementsV1ResponseMPayload and cannot be null");
            }
