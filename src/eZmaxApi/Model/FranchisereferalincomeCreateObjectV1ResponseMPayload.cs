...
namespace eZmaxApi.Model
{
    ...
    public partial class FranchisereferalincomeCreateObjectV1ResponseMPayload : IValidatableObject
    {
        ...
        public FranchisereferalincomeCreateObjectV1ResponseMPayload(List<int> aPkiFranchisereferalincomeID = default(List<int>))
        {
            ...
            {
                throw new ArgumentNullException("aPkiFranchisereferalincomeID is a required property for FranchisereferalincomeCreateObjectV1ResponseMPayload and cannot be null");
            }
