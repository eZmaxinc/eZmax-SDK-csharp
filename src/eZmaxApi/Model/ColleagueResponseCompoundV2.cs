...
namespace eZmaxApi.Model
{
    ...
    public partial class ColleagueResponseCompoundV2 : IValidatableObject
    {
        ...
        public ColleagueResponseCompoundV2(int  = default(int), int  = default(int), int  = default(int), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), bool  = default(bool), string  = default(string), string  = default(string), FieldEColleagueEzsign  = default(FieldEColleagueEzsign), FieldEColleagueRealestateinprogess  = default(FieldEColleagueRealestateinprogess), CustomUserNameResponse  = default(CustomUserNameResponse), CommonAudit  = default(CommonAudit))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for ColleagueResponseCompoundV2 and cannot be null");
            }
            this.ObjUserName = ;
            // to ensure "" is required (not null)
            if ( == null)
