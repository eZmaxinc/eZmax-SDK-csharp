...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignformfieldgroupResponseCompound :  IEquatable<EzsignformfieldgroupResponseCompound>, IValidatableObject
    {
        ...
        public EzsignformfieldgroupResponseCompound(string sEzsignformfieldgroupLabel = default(string), List<EzsignformfieldResponse> aObjEzsignformfield = default(List<EzsignformfieldResponse>))
        {
