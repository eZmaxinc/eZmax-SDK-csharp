...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignformfieldgroupResponseCompound : IValidatableObject
    {
        ...
        /// <param name="dtEzsignformfieldgroupCompleted">The date the Ezsignformfieldgroup was completed..</param>
        ...
        public EzsignformfieldgroupResponseCompound(int pkiEzsignformfieldgroupID = default, int fkiEzsigndocumentID = default, FieldEEzsignformfieldgroupType eEzsignformfieldgroupType = default, FieldEEzsignformfieldgroupSignerrequirement? eEzsignformfieldgroupSignerrequirement = default, string sEzsignformfieldgroupLabel = default, int iEzsignformfieldgroupStep = default, string sEzsignformfieldgroupDefaultvalue = default, int iEzsignformfieldgroupFilledmin = default, int iEzsignformfieldgroupFilledmax = default, bool bEzsignformfieldgroupReadonly = default, int iEzsignformfieldgroupMaxlength = default, bool bEzsignformfieldgroupEncrypted = default, EnumTextvalidation? eEzsignformfieldgroupTextvalidation = default, string sEzsignformfieldgroupRegexp = default, string sEzsignformfieldgroupTextvalidationcustommessage = default, string tEzsignformfieldgroupTooltip = default, FieldEEzsignformfieldgroupTooltipposition? eEzsignformfieldgroupTooltipposition = default, string dtEzsignformfieldgroupCompleted = default, List<EzsignformfieldResponseCompound> aObjEzsignformfield = default, List<CustomDropdownElementResponseCompound> aObjDropdownElement = default, List<EzsignformfieldgroupsignerResponseCompound> aObjEzsignformfieldgroupsigner = default)
        {
            ...
            this.DtEzsignformfieldgroupCompleted = dtEzsignformfieldgroupCompleted;
        ...
        */
        ...
        /// </summary>
        /// <value>The date the Ezsignformfieldgroup was completed.</value>
        /*
        <example>2020-12-31 23:59:59</example>
        */
        [DataMember(Name = "dtEzsignformfieldgroupCompleted", EmitDefaultValue = false)]
        public string DtEzsignformfieldgroupCompleted { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DtEzsignformfieldgroupCompleted: ").Append(DtEzsignformfieldgroupCompleted).Append("\n");
