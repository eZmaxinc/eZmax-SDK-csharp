...
namespace eZmaxApi.Model
{
    ...
    public partial class ContactRequest : IValidatableObject
    {
        ...
        public ContactRequest(int fkiContacttitleID = default, int fkiLanguageID = default, string sContactFirstname = default, string sContactLastname = default, string sContactCompany = default, string dtContactBirthdate = default)
        {
