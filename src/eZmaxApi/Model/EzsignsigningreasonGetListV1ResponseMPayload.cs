...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsigningreasonGetListV1ResponseMPayload : IValidatableObject
    {
        ...
        public EzsignsigningreasonGetListV1ResponseMPayload(int iRowReturned = default, int iRowFiltered = default, List<EzsignsigningreasonListElement> aObjEzsignsigningreason = default)
        {
