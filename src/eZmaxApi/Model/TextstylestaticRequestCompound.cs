...
namespace eZmaxApi.Model
{
    ...
    public partial class TextstylestaticRequestCompound : IValidatableObject
    {
        ...
        public TextstylestaticRequestCompound(int fkiFontID = default, bool bTextstylestaticBold = default, bool bTextstylestaticUnderline = default, bool bTextstylestaticItalic = default, bool bTextstylestaticStrikethrough = default, int iTextstylestaticFontcolor = default, int iTextstylestaticSize = default)
        {
