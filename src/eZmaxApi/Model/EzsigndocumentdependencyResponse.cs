...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigndocumentdependencyResponse : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="EzsigndocumentdependencyResponse" /> class.
        /// </summary>
        /// <param name="pkiEzsigndocumentdependencyID">The unique ID of the Ezsigndocumentdependency (required).</param>
        /// <param name="fkiEzsigndocumentIDdependency">The unique ID of the Ezsigndocument (required).</param>
        public EzsigndocumentdependencyResponse(int pkiEzsigndocumentdependencyID = default(int), int fkiEzsigndocumentIDdependency = default(int))
        {
