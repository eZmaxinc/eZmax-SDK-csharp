...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "webhook-regenerateApikey-v1-Response-mPayload")]
    public partial class WebhookRegenerateApikeyV1ResponseMPayload : IValidatableObject
    {
        ...
        protected WebhookRegenerateApikeyV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookRegenerateApikeyV1ResponseMPayload" /> class.
        /// </summary>
        /// <param name="objWebhook">objWebhook (required).</param>
        public WebhookRegenerateApikeyV1ResponseMPayload(WebhookResponseCompound objWebhook = default)
        {
