...
namespace eZmaxApi.Model
{
    ...
    public partial class CommunicationexternalrecipientRequestCompound : IValidatableObject
    {
        ...
        public CommunicationexternalrecipientRequestCompound(int  = default(int), string  = default(string), string  = default(string), FieldECommunicationexternalrecipientType?  = default(FieldECommunicationexternalrecipientType?), string  = default(string))
        {
