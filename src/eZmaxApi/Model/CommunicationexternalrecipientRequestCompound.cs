...
namespace eZmaxApi.Model
{
    ...
    public partial class CommunicationexternalrecipientRequestCompound : IValidatableObject
    {
        ...
        public CommunicationexternalrecipientRequestCompound(int pkiCommunicationexternalrecipientID = default, string sEmailAddress = default, string sPhoneE164 = default, FieldECommunicationexternalrecipientType? eCommunicationexternalrecipientType = default, string sCommunicationexternalrecipientName = default)
        {
