...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload :  IEquatable<EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload" /> class.
        /// </summary>
        ...
        public EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload(List<FieldEEzsignsignatureType> aEEzsignsignatureType = default(List<FieldEEzsignsignatureType>), List<CustomEzsignfolderEzsignsignaturesAutomaticResponse> aObjEzsignfolder = default(List<CustomEzsignfolderEzsignsignaturesAutomaticResponse>))
        {
            ...
            {
                throw new InvalidDataException("aEEzsignsignatureType is a required property for EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("aObjEzsignfolder is a required property for EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload);
        }

        /// <summary>
        /// Returns true if EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload input)
        {
            if (input == null)
                return false;
