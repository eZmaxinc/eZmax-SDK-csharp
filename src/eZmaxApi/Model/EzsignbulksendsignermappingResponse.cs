...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignbulksendsignermappingResponse : IValidatableObject
    {
        ...
        public EzsignbulksendsignermappingResponse(int pkiEzsignbulksendsignermappingID = default, int fkiEzsignbulksendID = default, int fkiUserID = default, bool bEzsignbulksendsignermappingReceivecopy = default, string sEzsignbulksendsignermappingDescription = default)
        {
