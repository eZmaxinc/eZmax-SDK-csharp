...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignbulksendsignermappingResponse : IValidatableObject
    {
        ...
        public EzsignbulksendsignermappingResponse(int  = default(int), int  = default(int), int  = default(int), string  = default(string))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignbulksendsignermappingResponse and cannot be null");
            }
