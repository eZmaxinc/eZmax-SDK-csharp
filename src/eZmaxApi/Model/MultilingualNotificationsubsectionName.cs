...
namespace eZmaxApi.Model
{
    ...
    public partial class MultilingualNotificationsubsectionName : IValidatableObject
    {
        ...
        public MultilingualNotificationsubsectionName(string sNotificationsubsectionName1 = default, string sNotificationsubsectionName2 = default)
        {
        ...
        /*
        <example>Signature ̩lectronique</example>
        */
