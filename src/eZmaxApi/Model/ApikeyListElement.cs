...
namespace eZmaxApi.Model
{
    ...
    public partial class ApikeyListElement : IValidatableObject
    {
        ...
        public ApikeyListElement(int pkiApikeyID = default, string sApikeyDescriptionX = default, string sUserFirstname = default, string sUserLastname = default, bool bApikeyIsactive = default, bool bApikeyIssigned = default)
        {
