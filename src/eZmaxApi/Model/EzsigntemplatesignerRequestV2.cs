...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplatesigner-RequestV2")]
    public partial class EzsigntemplatesignerRequestV2 : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatesignerRequestV2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplatesignerRequestV2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatesignerRequestV2" /> class.
        /// </summary>
        ...
        public EzsigntemplatesignerRequestV2(int pkiEzsigntemplatesignerID = default, int fkiEzsigntemplateID = default, int fkiUserID = default, int fkiUsergroupID = default, int fkiEzdoctemplatedocumentID = default, FieldEEzsigntemplatesignerRole? eEzsigntemplatesignerRole = default, FieldEEzsigntemplatesignerMapping? eEzsigntemplatesignerMapping = default, string sEzsigntemplatesignerDescription = default)
        {
            ...
            {
                throw new ArgumentNullException("sEzsigntemplatesignerDescription is a required property for EzsigntemplatesignerRequestV2 and cannot be null");
            }
