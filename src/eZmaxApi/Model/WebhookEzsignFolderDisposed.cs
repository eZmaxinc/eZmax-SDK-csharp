...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Webhook-Ezsign-FolderDisposed")]
    public partial class WebhookEzsignFolderDisposed : CommonWebhook, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEzsignFolderDisposed" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WebhookEzsignFolderDisposed() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEzsignFolderDisposed" /> class.
        /// </summary>
        ...
        public WebhookEzsignFolderDisposed(EzsignfolderResponse objEzsignfolder = default(EzsignfolderResponse), CustomWebhookResponse objWebhook = default(CustomWebhookResponse), List<AttemptResponseCompound> aObjAttempt = default(List<AttemptResponseCompound>)) : base()
        {
