...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignsignaturecustomdate-RequestCompoundV2")]
    public partial class EzsignsignaturecustomdateRequestCompoundV2 : IValidatableObject
    {
        ...
        protected EzsignsignaturecustomdateRequestCompoundV2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignsignaturecustomdateRequestCompoundV2" /> class.
        /// </summary>
        ...
        public EzsignsignaturecustomdateRequestCompoundV2(int pkiEzsignsignaturecustomdateID = default(int), int iEzsignsignaturecustomdateOffsetx = default(int), int iEzsignsignaturecustomdateOffsety = default(int), string sEzsignsignaturecustomdateFormat = default(string))
        {
            ...
            {
                throw new ArgumentNullException("sEzsignsignaturecustomdateFormat is a required property for EzsignsignaturecustomdateRequestCompoundV2 and cannot be null");
            }
