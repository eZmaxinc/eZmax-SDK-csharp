...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignaturecustomdateRequestCompoundV2 : IValidatableObject
    {
        ...
        public EzsignsignaturecustomdateRequestCompoundV2(int  = default(int), int  = default(int), int  = default(int), string  = default(string))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignsignaturecustomdateRequestCompoundV2 and cannot be null");
            }
