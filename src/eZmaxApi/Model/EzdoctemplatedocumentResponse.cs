...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezdoctemplatedocument-Response")]
    public partial class EzdoctemplatedocumentResponse : IValidatableObject
    {
        ...
        protected EzdoctemplatedocumentResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzdoctemplatedocumentResponse" /> class.
        /// </summary>
        ...
        public EzdoctemplatedocumentResponse(int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), FieldEEzdoctemplatedocumentPrivacylevel?  = default(FieldEEzdoctemplatedocumentPrivacylevel?), bool  = default(bool), MultilingualEzdoctemplatedocumentName  = default(MultilingualEzdoctemplatedocumentName), string  = default(string), string  = default(string), string  = default(string), string  = default(string))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzdoctemplatedocumentResponse and cannot be null");
            }
