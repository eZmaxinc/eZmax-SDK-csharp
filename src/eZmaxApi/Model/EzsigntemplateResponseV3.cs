...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplateResponseV3 : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        public EzsigntemplateResponseV3(int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), string  = default(string), string  = default(string), string  = default(string), string  = default(string), string  = default(string), FieldEEzsigntemplateRecognition?  = default(FieldEEzsigntemplateRecognition?), string  = default(string), bool  = default(bool), string  = default(string), CommonAudit  = default(CommonAudit), bool  = default(bool), FieldEEzsigntemplateType?  = default(FieldEEzsigntemplateType?))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplateResponseV3 and cannot be null");
            }
            this.SLanguageNameX = ;
            // to ensure "" is required (not null)
            if ( == null)
