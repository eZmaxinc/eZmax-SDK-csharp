...
namespace eZmaxApi.Model
{
    ...
    public partial class CreditcardmerchantRequestCompound : IValidatableObject
    {
        ...
        public CreditcardmerchantRequestCompound(int pkiCreditcardmerchantID = default, int fkiBankaccountID = default, int fkiLanguageID = default, int fkiCurrencyID = default, bool bCreditcardmerchantDenyvisa = default, bool bCreditcardmerchantDenymastercard = default, bool bCreditcardmerchantDenyamex = default, bool bCreditcardmerchantIsactive = default, string sCreditcardmerchantApitoken = default, string sCreditcardmerchantDescription = default, string sCreditcardmerchantStoreid = default)
        {
