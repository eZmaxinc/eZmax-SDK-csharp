...
namespace eZmaxApi.Model
{
    ...
    public partial class CommonReportsubsectionpart : IValidatableObject
    {
        ...
        public CommonReportsubsectionpart(EReportsubsectionpartTypeEnum eReportsubsectionpartType = default, List<CommonReportrow> aObjReportrow = default, List<string> aSVariableobjectProperty = default)
        {
