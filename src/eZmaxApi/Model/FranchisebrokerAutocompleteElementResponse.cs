...
namespace eZmaxApi.Model
{
    ...
    public partial class FranchisebrokerAutocompleteElementResponse : IValidatableObject
    {
        ...
        public FranchisebrokerAutocompleteElementResponse(string sFranchisebrokerName = default, int pkiFranchisebrokerID = default, bool bFranchisebrokerIsactive = default)
        {
