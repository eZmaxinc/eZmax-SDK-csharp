...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfoldertypeResponseCompound : IValidatableObject
    {
        ...
        public EzsignfoldertypeResponseCompound(int pkiEzsignfoldertypeID = default, MultilingualEzsignfoldertypeName objEzsignfoldertypeName = default, int fkiBrandingID = default, int fkiBillingentityinternalID = default, int fkiUsergroupID = default, int fkiUsergroupIDRestricted = default, int fkiEzsigntsarequirementID = default, string sBrandingDescriptionX = default, string sBillingentityinternalDescriptionX = default, string sEzsigntsarequirementDescriptionX = default, string sEmailAddressSigned = default, string sEmailAddressSummary = default, string sUsergroupNameX = default, string sUsergroupNameXRestricted = default, FieldEEzsignfoldertypePrivacylevel eEzsignfoldertypePrivacylevel = default, FieldEEzsignfoldertypeSendreminderfrequency? eEzsignfoldertypeSendreminderfrequency = default, int iEzsignfoldertypeArchivaldays = default, FieldEEzsignfoldertypeDisposal eEzsignfoldertypeDisposal = default, FieldEEzsignfoldertypeCompletion eEzsignfoldertypeCompletion = default, int iEzsignfoldertypeDisposaldays = default, int iEzsignfoldertypeDeadlinedays = default, bool bEzsignfoldertypeAutomaticsignature = default, bool bEzsignfoldertypeDelegate = default, bool bEzsignfoldertypeDiscussion = default, bool bEzsignfoldertypeReassignezsignsigner = default, bool bEzsignfoldertypeReassignuser = default, bool bEzsignfoldertypeReassigngroup = default, bool bEzsignfoldertypeSendsignedtoezsignsigner = default, bool bEzsignfoldertypeSendsignedtouser = default, bool bEzsignfoldertypeSendattachmentezsignsigner = default, bool bEzsignfoldertypeSendproofezsignsigner = default, bool bEzsignfoldertypeSendattachmentuser = default, bool bEzsignfoldertypeSendproofuser = default, bool bEzsignfoldertypeSendproofemail = default, bool bEzsignfoldertypeAllowdownloadattachmentezsignsigner = default, bool bEzsignfoldertypeAllowdownloadproofezsignsigner = default, bool bEzsignfoldertypeSendproofreceivealldocument = default, bool bEzsignfoldertypeSendsignedtodocumentowner = default, bool bEzsignfoldertypeSendsignedtofolderowner = default, bool bEzsignfoldertypeSendsignedtofullgroup = default, bool bEzsignfoldertypeSendsignedtolimitedgroup = default, bool bEzsignfoldertypeSendsignedtocolleague = default, bool bEzsignfoldertypeSendsummarytodocumentowner = default, bool bEzsignfoldertypeSendsummarytofolderowner = default, bool bEzsignfoldertypeSendsummarytofullgroup = default, bool bEzsignfoldertypeSendsummarytolimitedgroup = default, bool bEzsignfoldertypeSendsummarytocolleague = default, bool bEzsignfoldertypeIsactive = default, List<UserlogintypeResponse> aObjUserlogintype = default, List<int> aFkiUserIDSigned = default, List<int> aFkiUserIDSummary = default)
        {
            ...
            {
                throw new ArgumentNullException("objEzsignfoldertypeName is a required property for EzsignfoldertypeResponseCompound and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sBrandingDescriptionX is a required property for EzsignfoldertypeResponseCompound and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("aObjUserlogintype is a required property for EzsignfoldertypeResponseCompound and cannot be null");
            }
        ...
        */
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.SUsergroupNameXRestricted != null) {
                ...
                if (!regexSUsergroupNameXRestricted.Match(this.SUsergroupNameXRestricted).Success)
                {
