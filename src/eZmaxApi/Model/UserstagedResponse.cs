...
namespace eZmaxApi.Model
{
    ...
    public partial class UserstagedResponse : IValidatableObject
    {
        ...
        public UserstagedResponse(int pkiUserstagedID = default(int), int fkiEmailID = default(int), string sEmailAddress = default(string), string sUserstagedFirstname = default(string), string sUserstagedLastname = default(string), string sUserstagedExternalid = default(string))
        {
            ...
            {
                throw new ArgumentNullException("sEmailAddress is a required property for UserstagedResponse and cannot be null");
            }
            this.SEmailAddress = sEmailAddress;
            // to ensure "sUserstagedFirstname" is required (not null)
            if (sUserstagedFirstname == null)
            {
                throw new ArgumentNullException("sUserstagedFirstname is a required property for UserstagedResponse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sUserstagedLastname is a required property for UserstagedResponse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sUserstagedExternalid is a required property for UserstagedResponse and cannot be null");
            }
