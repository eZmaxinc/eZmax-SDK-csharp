...
namespace eZmaxApi.Model
{
    ...
    public partial class UserstagedResponse : IValidatableObject
    {
        ...
        public UserstagedResponse(int  = default(int), int  = default(int), string  = default(string), string  = default(string), string  = default(string), string  = default(string))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for UserstagedResponse and cannot be null");
            }
            this.SEmailAddress = ;
            // to ensure "" is required (not null)
            if ( == null)
