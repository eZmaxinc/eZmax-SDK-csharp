...
namespace eZmaxApi.Model
{
    ...
    public partial class UserstagedResponse :  IEquatable<UserstagedResponse>, IValidatableObject
    {
        ...
        public UserstagedResponse(int pkiUserstagedID = default(int), int fkiEmailID = default(int), string sUserstagedFirstname = default(string), string sUserstagedLastname = default(string), string sUserstagedExternalid = default(string))
        {
