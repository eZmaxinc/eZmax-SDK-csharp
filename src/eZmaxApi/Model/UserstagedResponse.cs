...
namespace eZmaxApi.Model
{
    ...
    public partial class UserstagedResponse : IValidatableObject
    {
        ...
        public UserstagedResponse(int pkiUserstagedID = default, int fkiEmailID = default, string sEmailAddress = default, string sUserstagedFirstname = default, string sUserstagedLastname = default, string sUserstagedExternalid = default)
        {
