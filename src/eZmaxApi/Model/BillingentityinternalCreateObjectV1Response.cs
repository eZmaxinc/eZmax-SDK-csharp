...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BillingentityinternalCreateObjectV1Response :  IEquatable<BillingentityinternalCreateObjectV1Response>
    {
        /// <summary>
        ...
        public BillingentityinternalCreateObjectV1Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), BillingentityinternalCreateObjectV1ResponseMPayload mPayload = default(BillingentityinternalCreateObjectV1ResponseMPayload))
        {
            // to ensure "objDebugPayload" is required (not null)
            if (objDebugPayload == null)
            {
                throw new InvalidDataException("objDebugPayload is a required property for BillingentityinternalCreateObjectV1Response and cannot be null");
            }
            else
            {
