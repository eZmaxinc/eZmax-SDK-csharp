...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "billingentityinternal-createObject-v1-Response")]
    public partial class BillingentityinternalCreateObjectV1Response : IEquatable<BillingentityinternalCreateObjectV1Response>, IValidatableObject
    {
        ...
        public BillingentityinternalCreateObjectV1Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), BillingentityinternalCreateObjectV1ResponseMPayload mPayload = default(BillingentityinternalCreateObjectV1ResponseMPayload))
        {
            ...
            {
                throw new ArgumentNullException("objDebugPayload is a required property for BillingentityinternalCreateObjectV1Response and cannot be null");
            }
            this.ObjDebugPayload = objDebugPayload;
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new ArgumentNullException("mPayload is a required property for BillingentityinternalCreateObjectV1Response and cannot be null");
            }
