...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfolderSendV3Request : IValidatableObject
    {
        ...
        public EzsignfolderSendV3Request(string tEzsignfolderMessage = default, FieldEEzsignfolderMessageorder? eEzsignfolderMessageorder = default, string dtEzsignfolderDelayedsenddate = default, List<int> aFkiEzsignfoldersignerassociationID = default)
        {
