...
namespace eZmaxApi.Model
{
    ...
    public partial class WebhookEzsignEzsignsignerAcceptclause : IValidatableObject
    {
        ...
        public WebhookEzsignEzsignsignerAcceptclause(CustomWebhookResponse objWebhook = default, List<AttemptResponseCompound> aObjAttempt = default, EzsignfolderResponse objEzsignfolder = default, EzsignfoldersignerassociationResponseCompound objEzsignfoldersignerassociation = default)
        {
