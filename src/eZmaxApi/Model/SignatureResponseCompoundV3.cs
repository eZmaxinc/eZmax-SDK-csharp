...
namespace eZmaxApi.Model
{
    ...
    public partial class SignatureResponseCompoundV3 : IValidatableObject
    {
        ...
        public SignatureResponseCompoundV3(int pkiSignatureID = default, int fkiFontID = default, FieldESignaturePreference eSignaturePreference = default, bool bSignatureSvg = default, bool bSignatureSvginitials = default)
        {
