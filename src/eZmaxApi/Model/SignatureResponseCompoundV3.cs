...
namespace eZmaxApi.Model
{
    ...
    public partial class SignatureResponseCompoundV3 : IValidatableObject
    {
        ...
        public SignatureResponseCompoundV3(int  = default(int), int  = default(int), FieldESignaturePreference  = default(FieldESignaturePreference), bool  = default(bool), bool  = default(bool))
        {
            this.PkiSignatureID = ;
            this.FkiFontID = ;
