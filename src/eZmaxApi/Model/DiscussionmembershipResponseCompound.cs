...
namespace eZmaxApi.Model
{
    ...
    public partial class DiscussionmembershipResponseCompound : IValidatableObject
    {
        ...
        public DiscussionmembershipResponseCompound(int pkiDiscussionmembershipID = default, int fkiDiscussionID = default, int fkiUserID = default, int fkiUsergroupID = default, int fkiModulesectionID = default, string sDiscussionmembershipDescription = default, string dtDiscussionmembershipJoined = default)
        {
        ...
        <example>165</example>
        */
        [DataMember(Name = "pkiDiscussionmembershipID", IsRequired = true, EmitDefaultValue = true)]
        ...
        */
        [DataMember(Name = "sDiscussionmembershipDescription", IsRequired = true, EmitDefaultValue = true)]
