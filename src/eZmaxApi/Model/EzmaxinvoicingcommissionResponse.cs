...
namespace eZmaxApi.Model
{
    ...
    public partial class EzmaxinvoicingcommissionResponse : IValidatableObject
    {
        ...
        public EzmaxinvoicingcommissionResponse(int pkiEzmaxinvoicingcommissionID = default, int fkiEzmaxinvoicingsummaryglobalID = default, int fkiEzmaxpartnerID = default, int fkiEzmaxrepresentativeID = default, string dtEzmaxinvoicingcommissionStart = default, string dtEzmaxinvoicingcommissionEnd = default, int iEzmaxinvoicingcommissionDays = default, string dEzmaxinvoicingcommissionAmount = default)
        {
