...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplatepackagesigner-ResponseCompoundV3")]
    public partial class EzsigntemplatepackagesignerResponseCompoundV3 : IValidatableObject
    {

        /// <summary>
        /// Gets or Sets EEzsigntemplatepackagesignerRole
        /// </summary>
        [DataMember(Name = "eEzsigntemplatepackagesignerRole", EmitDefaultValue = false)]
        public FieldEEzsigntemplatepackagesignerRole? EEzsigntemplatepackagesignerRole { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatepackagesignerResponseCompoundV3" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplatepackagesignerResponseCompoundV3() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatepackagesignerResponseCompoundV3" /> class.
        /// </summary>
        ...
        /// <param name="eEzsigntemplatepackagesignerRole">eEzsigntemplatepackagesignerRole.</param>
        ...
        public EzsigntemplatepackagesignerResponseCompoundV3(int pkiEzsigntemplatepackagesignerID = default, int fkiEzsigntemplatepackageID = default, int fkiEzdoctemplatedocumentID = default, int fkiUserID = default, int fkiUsergroupID = default, string sEzdoctemplatedocumentNameX = default, FieldEEzsigntemplatepackagesignerRole? eEzsigntemplatepackagesignerRole = default, FieldEEzsigntemplatepackagesignerMapping? eEzsigntemplatepackagesignerMapping = default, string sEzsigntemplatepackagesignerDescription = default, string sUserName = default, string sUsergroupNameX = default)
        {
            ...
            {
                throw new ArgumentNullException("sEzsigntemplatepackagesignerDescription is a required property for EzsigntemplatepackagesignerResponseCompoundV3 and cannot be null");
            }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EzsigntemplatepackagesignerResponseCompoundV3 {\n");
