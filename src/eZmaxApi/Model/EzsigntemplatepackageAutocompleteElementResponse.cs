...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatepackageAutocompleteElementResponse : IValidatableObject
    {
        ...
        public EzsigntemplatepackageAutocompleteElementResponse(FieldEEzsignfoldertypePrivacylevel eEzsignfoldertypePrivacylevel = default, string sEzsigntemplatepackageDescription = default, int pkiEzsigntemplatepackageID = default, bool bEzsigntemplatepackageIsactive = default, bool bDisabled = default)
        {
