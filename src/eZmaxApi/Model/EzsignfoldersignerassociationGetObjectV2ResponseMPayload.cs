...
dataType                            : Object
datatypeWithEnum                    : 
name                                : ezsignfoldersignerassociation-getObject-v2-Response-mPayload
defaultValue                        : 
...
*/
        public EzsignfoldersignerassociationGetObjectV2ResponseMPayload(EzsignfoldersignerassociationResponseCompound objEzsignfoldersignerassociation = default(EzsignfoldersignerassociationResponseCompound))
        {
            ...
            {
                throw new InvalidDataException("objEzsignfoldersignerassociation is a required property for EzsignfoldersignerassociationGetObjectV2ResponseMPayload and cannot be null");
            }
            else
            {
