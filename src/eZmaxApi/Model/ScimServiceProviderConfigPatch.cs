...
dataType                            : Object
datatypeWithEnum                    : 
name                                : Scim_ServiceProviderConfig_patch
defaultValue                        : 
...
*/
    ...
    public partial class ScimServiceProviderConfigPatch :  IEquatable<ScimServiceProviderConfigPatch>, IValidatableObject
    {
        ...
        public ScimServiceProviderConfigPatch(bool supported = default(bool))
        {
            ...
            if (supported == null)
            {
                throw new InvalidDataException("supported is a required property for ScimServiceProviderConfigPatch and cannot be null");
            }
            else
            {
