...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignbulksend-RequestV2")]
    public partial class EzsignbulksendRequestV2 : IValidatableObject
    {
        ...
        protected EzsignbulksendRequestV2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignbulksendRequestV2" /> class.
        /// </summary>
        ...
        public EzsignbulksendRequestV2(int pkiEzsignbulksendID = default, int fkiEzsignfoldertypeID = default, int fkiLanguageID = default, FieldEEzsignbulksendEzsignformfieldorder eEzsignbulksendEzsignformfieldorder = default, string sEzsignbulksendDescription = default, string tEzsignbulksendNote = default, bool bEzsignbulksendNeedvalidation = default, bool bEzsignbulksendIsactive = default)
        {
            ...
            {
                throw new ArgumentNullException("sEzsignbulksendDescription is a required property for EzsignbulksendRequestV2 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("tEzsignbulksendNote is a required property for EzsignbulksendRequestV2 and cannot be null");
            }
