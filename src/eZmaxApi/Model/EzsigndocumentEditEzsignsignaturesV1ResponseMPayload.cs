...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigndocumentEditEzsignsignaturesV1ResponseMPayload : IValidatableObject
    {
        ...
        public EzsigndocumentEditEzsignsignaturesV1ResponseMPayload(List<int>  = default(List<int>))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigndocumentEditEzsignsignaturesV1ResponseMPayload and cannot be null");
            }
