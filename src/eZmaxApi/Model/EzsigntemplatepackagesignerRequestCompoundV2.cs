...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplatepackagesigner-RequestCompoundV2")]
    public partial class EzsigntemplatepackagesignerRequestCompoundV2 : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatepackagesignerRequestCompoundV2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplatepackagesignerRequestCompoundV2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatepackagesignerRequestCompoundV2" /> class.
        /// </summary>
        ...
        public EzsigntemplatepackagesignerRequestCompoundV2(int pkiEzsigntemplatepackagesignerID = default, int fkiEzsigntemplatepackageID = default, int fkiEzdoctemplatedocumentID = default, int fkiUserID = default, int fkiUsergroupID = default, FieldEEzsigntemplatepackagesignerRole? eEzsigntemplatepackagesignerRole = default, FieldEEzsigntemplatepackagesignerMapping? eEzsigntemplatepackagesignerMapping = default, string sEzsigntemplatepackagesignerDescription = default)
        {
            ...
            {
                throw new ArgumentNullException("sEzsigntemplatepackagesignerDescription is a required property for EzsigntemplatepackagesignerRequestCompoundV2 and cannot be null");
            }
