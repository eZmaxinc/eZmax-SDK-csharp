...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignpageResponseCompound : IValidatableObject
    {
        ...
        public EzsignpageResponseCompound(int pkiEzsignpageID = default, int iEzsignpageWidthimage = default, int iEzsignpageHeightimage = default, int iEzsignpageWidthpdf = default, int iEzsignpageHeightpdf = default, int iEzsignpagePagenumber = default, string sComputedImageurl = default)
        {
