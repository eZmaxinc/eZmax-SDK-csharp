...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignpageResponseCompound :  IEquatable<EzsignpageResponseCompound>, IValidatableObject
    {
        ...
        /// <param name="sImageUrl">The Url to the Ezsignpage&#39;s rasterized image.  Url will expire after 5 minutes. (required).</param>
        public EzsignpageResponseCompound(int pkiEzsignpageID = default(int), int iEzsignpageWidthimage = default(int), int iEzsignpageHeightimage = default(int), int iEzsignpageWidthpdf = default(int), int iEzsignpageHeightpdf = default(int), int iEzsignpagePagenumber = default(int), string sImageUrl = default(string))
        {
            ...
            if (sImageUrl == null)
            {
                throw new InvalidDataException("sImageUrl is a required property for EzsignpageResponseCompound and cannot be null");
            }
            else
            {
