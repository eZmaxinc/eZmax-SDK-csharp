...
namespace eZmaxApi.Model
{
    ...
    public partial class UsergroupmembershipCreateObjectV1Response : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        /// <param name=""> (required).</param>
        public UsergroupmembershipCreateObjectV1Response(CommonResponseObjDebugPayload  = default(CommonResponseObjDebugPayload), CommonResponseObjDebug  = default(CommonResponseObjDebug), UsergroupmembershipCreateObjectV1ResponseMPayload  = default(UsergroupmembershipCreateObjectV1ResponseMPayload))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for UsergroupmembershipCreateObjectV1Response and cannot be null");
            }
