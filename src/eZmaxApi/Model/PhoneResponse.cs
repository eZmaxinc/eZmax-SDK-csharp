...
namespace eZmaxApi.Model
{
    ...
    public partial class PhoneResponse : IValidatableObject
    {
        ...
        public PhoneResponse(int pkiPhoneID = default, int fkiPhonetypeID = default, FieldEPhoneType? ePhoneType = default, string sPhoneE164 = default, string sPhoneExtension = default)
        {
