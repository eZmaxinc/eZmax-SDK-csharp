...
namespace eZmaxApi.Model
{
    ...
    /// A Supply Object
    /// </summary>
    [DataContract(Name = "supply-Response")]
    public partial class SupplyResponse : IValidatableObject
    {
        ...
        public SupplyResponse(int pkiSupplyID = default, int fkiGlaccountID = default, int fkiGlaccountcontainerID = default, int fkiVariableexpenseID = default, string sSupplyCode = default, MultilingualSupplyDescription objSupplyDescription = default, string dSupplyUnitprice = default, bool bSupplyIsactive = default, bool bSupplyVariableprice = default, string sGlaccountDescriptionX = default, string sGlaccountcontainerLongdescriptionX = default, string sVariableexpenseDescriptionX = default)
        {
            ...
            if (sSupplyCode == null)
            {
                throw new ArgumentNullException("sSupplyCode is a required property for SupplyResponse and cannot be null");
            }
            this.SSupplyCode = sSupplyCode;
            // to ensure "objSupplyDescription" is required (not null)
            if (objSupplyDescription == null)
            {
                throw new ArgumentNullException("objSupplyDescription is a required property for SupplyResponse and cannot be null");
            }
            this.ObjSupplyDescription = objSupplyDescription;
            // to ensure "dSupplyUnitprice" is required (not null)
            if (dSupplyUnitprice == null)
            {
                throw new ArgumentNullException("dSupplyUnitprice is a required property for SupplyResponse and cannot be null");
            }
