...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "discussionmessage-Request")]
    public partial class DiscussionmessageRequest : IValidatableObject
    {
        ...
        protected DiscussionmessageRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DiscussionmessageRequest" /> class.
        /// </summary>
        ...
        public DiscussionmessageRequest(int pkiDiscussionmessageID = default, int fkiDiscussionID = default, int fkiDiscussionmembershipIDActionrequired = default, string tDiscussionmessageContent = default)
        {
