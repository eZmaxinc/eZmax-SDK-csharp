...
namespace eZmaxApi.Model
{
    ...
    public partial class EzmaxinvoicingcontractResponseCompound : IValidatableObject
    {
        ...
        public EzmaxinvoicingcontractResponseCompound(int pkiEzmaxinvoicingcontractID = default, FieldEEzmaxinvoicingcontractPaymenttype eEzmaxinvoicingcontractPaymenttype = default, int iEzmaxinvoicingcontractLength = default, string dtEzmaxinvoicingcontractStart = default, string dtEzmaxinvoicingcontractEnd = default, string dEzmaxinvoicingcontractLicense = default, string dEzmaxinvoicingcontract121qa = default, bool bEzmaxinvoicingcontractEzsignallagents = default, CommonAudit objAudit = default)
        {
