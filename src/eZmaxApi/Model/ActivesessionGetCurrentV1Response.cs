...
namespace eZmaxApi.Model
{
    ...
    public partial class ActivesessionGetCurrentV1Response : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        /// <param name=""> (required).</param>
        public ActivesessionGetCurrentV1Response(CommonResponseObjDebugPayload  = default(CommonResponseObjDebugPayload), CommonResponseObjDebug  = default(CommonResponseObjDebug), ActivesessionGetCurrentV1ResponseMPayload  = default(ActivesessionGetCurrentV1ResponseMPayload))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for ActivesessionGetCurrentV1Response and cannot be null");
            }
