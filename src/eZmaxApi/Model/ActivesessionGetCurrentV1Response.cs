...
namespace eZmaxApi.Model
{
    ...
    public partial class ActivesessionGetCurrentV1Response : IValidatableObject
    {
        ...
        public ActivesessionGetCurrentV1Response(CommonResponseObjDebugPayload objDebugPayload = default, CommonResponseObjDebug objDebug = default, ActivesessionGetCurrentV1ResponseMPayload mPayload = default)
        {
            // to ensure "objDebugPayload" is required (not null)
            if (objDebugPayload == null)
            {
                throw new ArgumentNullException("objDebugPayload is a required property for ActivesessionGetCurrentV1Response and cannot be null");
            }
