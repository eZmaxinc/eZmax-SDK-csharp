...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "attachment-documentType-v1-Response-mPayload")]
    public partial class AttachmentDocumentTypeV1ResponseMPayload : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AttachmentDocumentTypeV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AttachmentDocumentTypeV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AttachmentDocumentTypeV1ResponseMPayload" /> class.
        /// </summary>
        /// <param name="pkiAttachmentID">The unique ID of the Attachment. (required).</param>
        public AttachmentDocumentTypeV1ResponseMPayload(int pkiAttachmentID = default)
        {
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AttachmentDocumentTypeV1ResponseMPayload {\n");
