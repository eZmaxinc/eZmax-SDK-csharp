...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignbulksendListElement : IValidatableObject
    {
        ...
        public EzsignbulksendListElement(int pkiEzsignbulksendID = default, int fkiEzsignfoldertypeID = default, string sEzsignbulksendDescription = default, string sEzsignfoldertypeNameX = default, bool bEzsignbulksendNeedvalidation = default, int iEzsignbulksendtransmission = default, int iEzsignfolder = default, int iEzsigndocument = default, int iEzsignsignature = default, int iEzsignsignatureSigned = default, bool bEzsignbulksendIsactive = default)
        {
