...
namespace eZmaxApi.Model
{
    ...
    public partial class SignatureCreateObjectV1ResponseMPayload : IValidatableObject
    {
        ...
        public SignatureCreateObjectV1ResponseMPayload(List<int>  = default(List<int>))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for SignatureCreateObjectV1ResponseMPayload and cannot be null");
            }
            this.APkiSignatureID = ;
        }
