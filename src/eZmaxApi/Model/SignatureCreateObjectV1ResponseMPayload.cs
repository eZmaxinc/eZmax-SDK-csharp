...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "signature-createObject-v1-Response-mPayload")]
    public partial class SignatureCreateObjectV1ResponseMPayload : IValidatableObject
    {
        ...
        public SignatureCreateObjectV1ResponseMPayload(List<int> aPkiSignatureID = default)
        {
            // to ensure "aPkiSignatureID" is required (not null)
            if (aPkiSignatureID == null)
            {
                throw new ArgumentNullException("aPkiSignatureID is a required property for SignatureCreateObjectV1ResponseMPayload and cannot be null");
            }
        ...
        [DataMember(Name = "a_pkiSignatureID", IsRequired = true, EmitDefaultValue = true)]
