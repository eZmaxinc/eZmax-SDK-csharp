...
namespace eZmaxApi.Model
{
    ...
    /// A Website Object
    /// </summary>
    [DataContract(Name = "website-Response")]
    public partial class WebsiteResponse : IValidatableObject
    {
        ...
        public WebsiteResponse(int pkiWebsiteID = default(int), int fkiWebsitetypeID = default(int), string sWebsiteAddress = default(string))
        {
            ...
            {
                throw new ArgumentNullException("sWebsiteAddress is a required property for WebsiteResponse and cannot be null");
            }
