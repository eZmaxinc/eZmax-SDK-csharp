...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsigntemplatesignerGetObjectV1Response :  IEquatable<EzsigntemplatesignerGetObjectV1Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatesignerGetObjectV1Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplatesignerGetObjectV1Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatesignerGetObjectV1Response" /> class.
        /// </summary>
        ...
        public EzsigntemplatesignerGetObjectV1Response(EzsigntemplatesignerGetObjectV1ResponseMPayload mPayload = default(EzsigntemplatesignerGetObjectV1ResponseMPayload), CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug))
        {
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new InvalidDataException("mPayload is a required property for EzsigntemplatesignerGetObjectV1Response and cannot be null");
            }
            else
            {
        ...
        public EzsigntemplatesignerGetObjectV1ResponseMPayload MPayload { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EzsigntemplatesignerGetObjectV1Response {\n");
        ...
        {
            return this.Equals(input as EzsigntemplatesignerGetObjectV1Response);
        }

        /// <summary>
        /// Returns true if EzsigntemplatesignerGetObjectV1Response instances are equal
        /// </summary>
        /// <param name="input">Instance of EzsigntemplatesignerGetObjectV1Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EzsigntemplatesignerGetObjectV1Response input)
        {
            if (input == null)
                return false;
