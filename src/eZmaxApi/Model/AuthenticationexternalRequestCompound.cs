...
namespace eZmaxApi.Model
{
    ...
    public partial class AuthenticationexternalRequestCompound : IValidatableObject
    {
        ...
        public AuthenticationexternalRequestCompound(int  = default(int), string  = default(string), FieldEAuthenticationexternalType  = default(FieldEAuthenticationexternalType))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for AuthenticationexternalRequestCompound and cannot be null");
            }
