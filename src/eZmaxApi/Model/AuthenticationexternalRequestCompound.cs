...
namespace eZmaxApi.Model
{
    ...
    public partial class AuthenticationexternalRequestCompound : IValidatableObject
    {
        ...
        public AuthenticationexternalRequestCompound(int pkiAuthenticationexternalID = default, string sAuthenticationexternalDescription = default, FieldEAuthenticationexternalType eAuthenticationexternalType = default)
        {
