...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomEzmaxinvoicingEzsignfolderResponse : IValidatableObject
    {
        ...
        public CustomEzmaxinvoicingEzsignfolderResponse(int fkiEzsignfolderID = default, int fkiBillingentityinternalID = default, string sEzsignfolderDescription = default, bool bEzsigntsarequirementBillable = default, bool bEzsignfolderMfaused = default, bool bEzsignfolderAllowed = default)
        {
