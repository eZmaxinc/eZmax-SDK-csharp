...
namespace eZmaxApi.Model
{
    ...
    public partial class AddressResponseCompound : IValidatableObject
    {
        ...
        public AddressResponseCompound(int  = default(int), int  = default(int), string  = default(string), string  = default(string), string  = default(string), string  = default(string), int  = default(int), string  = default(string), int  = default(int), string  = default(string), string  = default(string), string  = default(string), string  = default(string))
        {
            this.PkiAddressID = ;
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for AddressResponseCompound and cannot be null");
            }
            this.SAddressCivic = ;
            // to ensure "" is required (not null)
            if ( == null)
