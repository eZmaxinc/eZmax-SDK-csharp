...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplateformfieldResponse : IValidatableObject
    {
        ...
        public EzsigntemplateformfieldResponse(int  = default(int), FieldEEzsigntemplateformfieldPositioning?  = default(FieldEEzsigntemplateformfieldPositioning?), int  = default(int), string  = default(string), string  = default(string), int  = default(int), int  = default(int), int  = default(int), int  = default(int), bool  = default(bool), bool  = default(bool), FieldEEzsigntemplateformfieldDependencyrequirement?  = default(FieldEEzsigntemplateformfieldDependencyrequirement?), string  = default(string), int  = default(int), int  = default(int), FieldEEzsigntemplateformfieldPositioningoccurence?  = default(FieldEEzsigntemplateformfieldPositioningoccurence?), EnumHorizontalalignment?  = default(EnumHorizontalalignment?), TextstylestaticResponseCompound  = default(TextstylestaticResponseCompound))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplateformfieldResponse and cannot be null");
            }
