...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsigndocumentGetDownloadUrlV1Response :  IEquatable<EzsigndocumentGetDownloadUrlV1Response>
    {
        /// <summary>
        ...
        public EzsigndocumentGetDownloadUrlV1Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), EzsigndocumentGetDownloadUrlV1ResponseMPayload mPayload = default(EzsigndocumentGetDownloadUrlV1ResponseMPayload))
        {
            ...
            {
                throw new InvalidDataException("objDebugPayload is a required property for EzsigndocumentGetDownloadUrlV1Response and cannot be null");
            }
            else
            {
