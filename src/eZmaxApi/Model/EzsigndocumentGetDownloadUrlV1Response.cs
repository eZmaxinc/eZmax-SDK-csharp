...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigndocumentGetDownloadUrlV1Response : IValidatableObject
    {
        ...
        /// <param name="">.</param>
        /// <param name=""> (required).</param>
        public EzsigndocumentGetDownloadUrlV1Response(CommonResponseObjDebugPayload  = default(CommonResponseObjDebugPayload), CommonResponseObjDebug  = default(CommonResponseObjDebug), EzsigndocumentGetDownloadUrlV1ResponseMPayload  = default(EzsigndocumentGetDownloadUrlV1ResponseMPayload))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigndocumentGetDownloadUrlV1Response and cannot be null");
            }
