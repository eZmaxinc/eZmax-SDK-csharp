...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigndocumentGetDownloadUrlV1Response : IValidatableObject
    {
        ...
        public EzsigndocumentGetDownloadUrlV1Response(CommonResponseObjDebugPayload objDebugPayload = default, CommonResponseObjDebug objDebug = default, EzsigndocumentGetDownloadUrlV1ResponseMPayload mPayload = default)
        {
            // to ensure "objDebugPayload" is required (not null)
            if (objDebugPayload == null)
            {
                throw new ArgumentNullException("objDebugPayload is a required property for EzsigndocumentGetDownloadUrlV1Response and cannot be null");
            }
            this.ObjDebugPayload = objDebugPayload;
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new ArgumentNullException("mPayload is a required property for EzsigndocumentGetDownloadUrlV1Response and cannot be null");
            }
