...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatesignaturecustomdateResponse : IValidatableObject
    {
        ...
        public EzsigntemplatesignaturecustomdateResponse(int pkiEzsigntemplatesignaturecustomdateID = default(int), int iEzsigntemplatesignaturecustomdateX = default(int), int iEzsigntemplatesignaturecustomdateY = default(int), int iEzsigntemplatesignaturecustomdateOffsetx = default(int), int iEzsigntemplatesignaturecustomdateOffsety = default(int), string sEzsigntemplatesignaturecustomdateFormat = default(string))
        {
