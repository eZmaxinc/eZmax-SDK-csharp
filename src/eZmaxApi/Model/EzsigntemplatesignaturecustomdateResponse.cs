...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatesignaturecustomdateResponse : IValidatableObject
    {
        ...
        public EzsigntemplatesignaturecustomdateResponse(int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), string  = default(string))
        {
            this.PkiEzsigntemplatesignaturecustomdateID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplatesignaturecustomdateResponse and cannot be null");
            }
