...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplatesignaturecustomdate-Response")]
    public partial class EzsigntemplatesignaturecustomdateResponse : IValidatableObject
    {
        ...
        public EzsigntemplatesignaturecustomdateResponse(int pkiEzsigntemplatesignaturecustomdateID = default, int iEzsigntemplatesignaturecustomdateX = default, int iEzsigntemplatesignaturecustomdateY = default, int iEzsigntemplatesignaturecustomdateOffsetx = default, int iEzsigntemplatesignaturecustomdateOffsety = default, string sEzsigntemplatesignaturecustomdateFormat = default)
        {
            ...
            {
                throw new ArgumentNullException("sEzsigntemplatesignaturecustomdateFormat is a required property for EzsigntemplatesignaturecustomdateResponse and cannot be null");
            }
