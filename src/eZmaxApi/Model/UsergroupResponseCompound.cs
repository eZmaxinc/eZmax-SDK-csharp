...
namespace eZmaxApi.Model
{
    ...
    public partial class UsergroupResponseCompound : IValidatableObject
    {
        ...
        public UsergroupResponseCompound(int pkiUsergroupID = default, MultilingualUsergroupName objUsergroupName = default, string sUsergroupNameX = default, EmailRequest objEmail = default)
        {
