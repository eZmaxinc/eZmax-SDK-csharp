...
namespace eZmaxApi.Model
{
    ...
    public partial class UsergroupdelegationResponseCompound : IValidatableObject
    {
        ...
        public UsergroupdelegationResponseCompound(int  = default(int), int  = default(int), int  = default(int), string  = default(string), string  = default(string), string  = default(string), string  = default(string), string  = default(string))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for UsergroupdelegationResponseCompound and cannot be null");
            }
            this.SUserFirstname = ;
            // to ensure "" is required (not null)
            if ( == null)
