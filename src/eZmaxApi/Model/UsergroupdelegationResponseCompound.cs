...
namespace eZmaxApi.Model
{
    ...
    public partial class UsergroupdelegationResponseCompound : IValidatableObject
    {
        ...
        public UsergroupdelegationResponseCompound(int pkiUsergroupdelegationID = default, int fkiUsergroupID = default, int fkiUserID = default, string sUserFirstname = default, string sUserLastname = default, string sUserLoginname = default, string sEmailAddress = default, string sUsergroupNameX = default)
        {
