...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UsergroupdelegationResponseCompound :  IEquatable<UsergroupdelegationResponseCompound>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UsergroupdelegationResponseCompound" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UsergroupdelegationResponseCompound() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UsergroupdelegationResponseCompound" /> class.
        /// </summary>
        ...
        public UsergroupdelegationResponseCompound(int pkiUsergroupdelegationID = default(int), int fkiUsergroupID = default(int), int fkiUserID = default(int), string sUserFirstname = default(string), string sUserLastname = default(string), string sUserLoginname = default(string), string sEmailAddress = default(string), string sUsergroupNameX = default(string))
        {
            ...
            {
                throw new InvalidDataException("pkiUsergroupdelegationID is a required property for UsergroupdelegationResponseCompound and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("fkiUsergroupID is a required property for UsergroupdelegationResponseCompound and cannot be null");
            }
            else
            {
            ...
            if (fkiUserID == null)
            {
                throw new InvalidDataException("fkiUserID is a required property for UsergroupdelegationResponseCompound and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sUserFirstname is a required property for UsergroupdelegationResponseCompound and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sUserLastname is a required property for UsergroupdelegationResponseCompound and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sUserLoginname is a required property for UsergroupdelegationResponseCompound and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sUsergroupNameX is a required property for UsergroupdelegationResponseCompound and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as UsergroupdelegationResponseCompound);
        }

        /// <summary>
        /// Returns true if UsergroupdelegationResponseCompound instances are equal
        /// </summary>
        /// <param name="input">Instance of UsergroupdelegationResponseCompound to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsergroupdelegationResponseCompound input)
        {
            if (input == null)
                return false;
