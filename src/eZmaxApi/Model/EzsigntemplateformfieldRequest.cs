...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplateformfieldRequest : IValidatableObject
    {
        ...
        public EzsigntemplateformfieldRequest(int pkiEzsigntemplateformfieldID = default, FieldEEzsigntemplateformfieldPositioning? eEzsigntemplateformfieldPositioning = default, int iEzsigntemplatedocumentpagePagenumber = default, string sEzsigntemplateformfieldLabel = default, string sEzsigntemplateformfieldValue = default, int iEzsigntemplateformfieldX = default, int iEzsigntemplateformfieldY = default, int iEzsigntemplateformfieldWidth = default, int iEzsigntemplateformfieldHeight = default, bool bEzsigntemplateformfieldAutocomplete = default, bool bEzsigntemplateformfieldSelected = default, FieldEEzsigntemplateformfieldDependencyrequirement? eEzsigntemplateformfieldDependencyrequirement = default, string sEzsigntemplateformfieldPositioningpattern = default, int iEzsigntemplateformfieldPositioningoffsetx = default, int iEzsigntemplateformfieldPositioningoffsety = default, FieldEEzsigntemplateformfieldPositioningoccurence? eEzsigntemplateformfieldPositioningoccurence = default, EnumHorizontalalignment? eEzsigntemplateformfieldHorizontalalignment = default, TextstylestaticRequestCompound objTextstylestatic = default)
        {
            ...
            {
                throw new ArgumentNullException("sEzsigntemplateformfieldLabel is a required property for EzsigntemplateformfieldRequest and cannot be null");
            }
