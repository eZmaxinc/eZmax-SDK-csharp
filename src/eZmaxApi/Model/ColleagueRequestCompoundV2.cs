...
namespace eZmaxApi.Model
{
    ...
    public partial class ColleagueRequestCompoundV2 : IValidatableObject
    {
        ...
        public ColleagueRequestCompoundV2(int pkiColleagueID = default, int fkiUserID = default, int fkiUserIDColleague = default, bool bColleagueEzsignemail = default, bool bColleagueFinancial = default, bool bColleagueUsecloneemail = default, bool bColleagueAttachment = default, bool bColleagueCanafe = default, bool bColleaguePermission = default, bool bColleagueRealestatecompleted = default, string dtColleagueFrom = default, string dtColleagueTo = default, FieldEColleagueEzsign eColleagueEzsign = default, FieldEColleagueRealestateinprogess eColleagueRealestateinprogress = default)
        {
