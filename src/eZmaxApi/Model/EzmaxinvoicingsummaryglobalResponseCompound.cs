...
namespace eZmaxApi.Model
{
    ...
    public partial class EzmaxinvoicingsummaryglobalResponseCompound : IValidatableObject
    {
        ...
        public EzmaxinvoicingsummaryglobalResponseCompound(int pkiEzmaxinvoicingsummaryglobalID = default, int fkiEzmaxinvoicingID = default, int fkiEzmaxproductID = default, string sEzmaxproductDescriptionX = default, string dtEzmaxinvoicingsummaryglobalStart = default, string dtEzmaxinvoicingsummaryglobalEnd = default, int iEzmaxinvoicingsummaryglobalDays = default, string dEzmaxinvoicingsummaryglobalCountreal = default, string dEzmaxinvoicingsummaryglobalCountbilled = default, string dEzmaxinvoicingsummaryglobalSubtotal = default, string dEzmaxinvoicingsummaryglobalRebateamount = default, string dEzmaxinvoicingsummaryglobalRebatepercent = default, string dEzmaxinvoicingsummaryglobalRebatetotal = default, string dEzmaxinvoicingsummaryglobalTotal = default, string dEzmaxinvoicingsummaryglobalRepresentative = default, string dEzmaxinvoicingsummaryglobalPartner = default, string dEzmaxinvoicingsummaryglobalNet = default, bool bEzmaxinvoicingsummaryglobalAdjustment = default, string tEzmaxproductHelpX = default, List<EzmaxinvoicingcommissionResponseCompound> aObjEzmaxinvoicingcommission = default)
        {
