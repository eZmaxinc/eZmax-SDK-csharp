...
namespace eZmaxApi.Model
{
    ...
    public partial class PaymenttermListElement : IValidatableObject
    {
        ...
        public PaymenttermListElement(int pkiPaymenttermID = default, string sPaymenttermCode = default, FieldEPaymenttermType ePaymenttermType = default, int iPaymenttermDay = default, string sPaymenttermDescriptionX = default, bool bPaymenttermIsactive = default)
        {
