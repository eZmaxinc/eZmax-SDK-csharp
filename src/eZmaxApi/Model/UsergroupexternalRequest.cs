...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "usergroupexternal-Request")]
    public partial class UsergroupexternalRequest : IValidatableObject
    {
        ...
        protected UsergroupexternalRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UsergroupexternalRequest" /> class.
        /// </summary>
        ...
        public UsergroupexternalRequest(int pkiUsergroupexternalID = default(int), string sUsergroupexternalName = default(string), string sUsergroupexternalID = default(string))
        {
            // to ensure "sUsergroupexternalName" is required (not null)
            if (sUsergroupexternalName == null)
            {
                throw new ArgumentNullException("sUsergroupexternalName is a required property for UsergroupexternalRequest and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sUsergroupexternalID is a required property for UsergroupexternalRequest and cannot be null");
            }
