...
namespace eZmaxApi.Model
{
    ...
    public partial class UsergroupexternalRequest : IValidatableObject
    {
        ...
        public UsergroupexternalRequest(int  = default(int), string  = default(string), string  = default(string))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for UsergroupexternalRequest and cannot be null");
            }
