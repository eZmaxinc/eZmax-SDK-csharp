...
namespace eZmaxApi.Model
{
    ...
    public partial class NotificationtestResponse : IValidatableObject
    {
        ...
        public NotificationtestResponse(int pkiNotificationtestID = default, MultilingualNotificationtestName objNotificationtestName = default, int fkiNotificationsubsectionID = default, string sNotificationtestFunction = default, string sNotificationtestNameX = default)
        {
