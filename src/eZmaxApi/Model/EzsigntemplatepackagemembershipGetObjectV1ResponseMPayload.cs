...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsigntemplatepackagemembershipGetObjectV1ResponseMPayload :  IEquatable<EzsigntemplatepackagemembershipGetObjectV1ResponseMPayload>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatepackagemembershipGetObjectV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplatepackagemembershipGetObjectV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatepackagemembershipGetObjectV1ResponseMPayload" /> class.
        /// </summary>
        ...
        public EzsigntemplatepackagemembershipGetObjectV1ResponseMPayload(int pkiEzsigntemplatepackagemembershipID = default(int), int fkiEzsigntemplatepackageID = default(int), int fkiEzsigntemplateID = default(int), int iEzsigntemplatepackagemembershipOrder = default(int), EzsigntemplateResponseCompound objEzsigntemplate = default(EzsigntemplateResponseCompound), List<EzsigntemplatepackagesignermembershipResponseCompound> aObjEzsigntemplatepackagesignermembership = default(List<EzsigntemplatepackagesignermembershipResponseCompound>))
        {
            ...
            {
                throw new InvalidDataException("fkiEzsigntemplatepackageID is a required property for EzsigntemplatepackagemembershipGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("fkiEzsigntemplateID is a required property for EzsigntemplatepackagemembershipGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iEzsigntemplatepackagemembershipOrder is a required property for EzsigntemplatepackagemembershipGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("objEzsigntemplate is a required property for EzsigntemplatepackagemembershipGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("aObjEzsigntemplatepackagesignermembership is a required property for EzsigntemplatepackagemembershipGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EzsigntemplatepackagemembershipGetObjectV1ResponseMPayload);
        }

        /// <summary>
        /// Returns true if EzsigntemplatepackagemembershipGetObjectV1ResponseMPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of EzsigntemplatepackagemembershipGetObjectV1ResponseMPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EzsigntemplatepackagemembershipGetObjectV1ResponseMPayload input)
        {
            if (input == null)
                return false;
