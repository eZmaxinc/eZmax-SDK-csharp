...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomEzsignsignaturestatusResponse : IValidatableObject
    {
        ...
        public CustomEzsignsignaturestatusResponse(EEzsignsignaturestatusSteptypeEnum eEzsignsignaturestatusSteptype = default, int iEzsignsignaturestatusStep = default, int iEzsignsignaturestatusTotal = default, int iEzsignsignaturestatusSigned = default, int iEzsignsignaturestatusConditional = default)
        {
