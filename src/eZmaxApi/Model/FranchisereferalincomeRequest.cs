...
namespace eZmaxApi.Model
{
    ...
    public partial class FranchisereferalincomeRequest :  IEquatable<FranchisereferalincomeRequest>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // DFranchisereferalincomeLoan (string) pattern
            Regex regexDFranchisereferalincomeLoan = new Regex(@"^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$", RegexOptions.CultureInvariant);
            if (false == regexDFranchisereferalincomeLoan.Match(this.DFranchisereferalincomeLoan).Success)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DFranchisereferalincomeLoan, must match a pattern of " + regexDFranchisereferalincomeLoan, new [] { "DFranchisereferalincomeLoan" });
            }



            // DFranchisereferalincomeFranchiseamount (string) pattern
            Regex regexDFranchisereferalincomeFranchiseamount = new Regex(@"^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$", RegexOptions.CultureInvariant);
            if (false == regexDFranchisereferalincomeFranchiseamount.Match(this.DFranchisereferalincomeFranchiseamount).Success)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DFranchisereferalincomeFranchiseamount, must match a pattern of " + regexDFranchisereferalincomeFranchiseamount, new [] { "DFranchisereferalincomeFranchiseamount" });
            }



            // DFranchisereferalincomeFranchisoramount (string) pattern
            Regex regexDFranchisereferalincomeFranchisoramount = new Regex(@"^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$", RegexOptions.CultureInvariant);
            if (false == regexDFranchisereferalincomeFranchisoramount.Match(this.DFranchisereferalincomeFranchisoramount).Success)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DFranchisereferalincomeFranchisoramount, must match a pattern of " + regexDFranchisereferalincomeFranchisoramount, new [] { "DFranchisereferalincomeFranchisoramount" });
            }



            // DFranchisereferalincomeAgentamount (string) pattern
            Regex regexDFranchisereferalincomeAgentamount = new Regex(@"^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$", RegexOptions.CultureInvariant);
            if (false == regexDFranchisereferalincomeAgentamount.Match(this.DFranchisereferalincomeAgentamount).Success)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DFranchisereferalincomeAgentamount, must match a pattern of " + regexDFranchisereferalincomeAgentamount, new [] { "DFranchisereferalincomeAgentamount" });
            }
