...
namespace eZmaxApi.Model
{
    ...
    public partial class ModulesectionResponse : IValidatableObject
    {
        ...
        public ModulesectionResponse(int pkiModulesectionID = default, int fkiModuleID = default, string sModulesectionInternalname = default, string sModulesectionNameX = default)
        {
