...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignerRequestCompound : IValidatableObject
    {
        ...
        public EzsignsignerRequestCompound(int fkiUserlogintypeID = default, int fkiTaxassignmentID = default, int fkiSecretquestionID = default, EEzsignsignerLogintypeEnum? eEzsignsignerLogintype = default, string sEzsignsignerSecretanswer = default, EzsignsignerRequestCompoundContact objContact = default)
        {
            this.FkiTaxassignmentID = fkiTaxassignmentID;
            // to ensure "objContact" is required (not null)
            if (objContact == null)
            {
                throw new ArgumentNullException("objContact is a required property for EzsignsignerRequestCompound and cannot be null");
            }
