...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignsignerRequestCompound : IValidatableObject
    {
        ...
        /// <param name="">The method the Ezsignsigner will authenticate to the signing platform.  1. **Password** means the Ezsignsigner will receive a secure link by email. 2. **PasswordPhone** means the Ezsignsigner will receive a secure link by email and will need to authenticate using SMS or Phone call. **Additional fee applies**. 3. **PasswordQuestion** means the Ezsignsigner will receive a secure link by email and will need to authenticate using a predefined question and answer. 4. **InPersonPhone** means the Ezsignsigner will only be able to sign \&quot;In-Person\&quot; and will need to authenticate using SMS or Phone call. No email will be sent for invitation to sign. **Additional fee applies**. 5. **InPerson** means the Ezsignsigner will only be able to sign \&quot;In-Person\&quot; and there won&#39;t be any authentication. No email will be sent for invitation to sign. Make sure you evaluate the risk of signature denial and at minimum, we recommend you use a handwritten signature type..</param>
        /// <param name="">The predefined answer to the secret question the Ezsignsigner will need to provide to successfully authenticate..</param>
        /// <param name=""> (required).</param>
        public EzsignsignerRequestCompound(int  = default(int), int  = default(int), int  = default(int), EEzsignsignerLogintypeEnum?  = default(EEzsignsignerLogintypeEnum?), string  = default(string), EzsignsignerRequestCompoundContact  = default(EzsignsignerRequestCompoundContact))
        {
            this.FkiTaxassignmentID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignsignerRequestCompound and cannot be null");
            }
            this.ObjContact = ;
