...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfoldersignerassociationCreateObjectV2ResponseMPayload : IValidatableObject
    {
        ...
        public EzsignfoldersignerassociationCreateObjectV2ResponseMPayload(List<int>  = default(List<int>))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsignfoldersignerassociationCreateObjectV2ResponseMPayload and cannot be null");
            }
