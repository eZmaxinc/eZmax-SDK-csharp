...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignfoldersignerassociation-createObject-v2-Response-mPayload")]
    public partial class EzsignfoldersignerassociationCreateObjectV2ResponseMPayload : IValidatableObject
    {
        ...
        public EzsignfoldersignerassociationCreateObjectV2ResponseMPayload(List<int> aPkiEzsignfoldersignerassociationID = default)
        {
            // to ensure "aPkiEzsignfoldersignerassociationID" is required (not null)
            if (aPkiEzsignfoldersignerassociationID == null)
            {
                throw new ArgumentNullException("aPkiEzsignfoldersignerassociationID is a required property for EzsignfoldersignerassociationCreateObjectV2ResponseMPayload and cannot be null");
            }
