...
namespace eZmaxApi.Model
{
    ...
    public partial class CorsResponse : IValidatableObject
    {
        ...
        public CorsResponse(int  = default(int), int  = default(int), string  = default(string))
        {
            this.PkiCorsID = ;
            this.FkiApikeyID = ;
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for CorsResponse and cannot be null");
            }
            this.SCorsEntryurl = ;
        }
