...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatesignerRequest : IValidatableObject
    {
        ...
        public EzsigntemplatesignerRequest(int  = default(int), int  = default(int), int  = default(int), int  = default(int), int  = default(int), bool  = default(bool), FieldEEzsigntemplatesignerMapping?  = default(FieldEEzsigntemplatesignerMapping?), string  = default(string))
        {
            this.FkiEzsigntemplateID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplatesignerRequest and cannot be null");
            }
