...
namespace eZmaxApi.Model
{
    ...
    /// A Branding Object
    /// </summary>
    [DataContract(Name = "branding-ResponseV3")]
    public partial class BrandingResponseV3 : IValidatableObject
    {
        ...
        public BrandingResponseV3(int pkiBrandingID = default, int fkiDomainID = default, string sDomainName = default, int fkiEmailID = default, MultilingualBrandingDescription objBrandingDescription = default, string sBrandingDescriptionX = default, string sBrandingName = default, string sEmailAddress = default, FieldEBrandingLogo eBrandingLogo = default, FieldEBrandingAlignlogo eBrandingAlignlogo = default, int iBrandingColor = default, bool bBrandingIsactive = default)
        {
        ...
        */
        ...
        <example>96</example>
        */
        [DataMember(Name = "fkiDomainID", EmitDefaultValue = false)]
        public int FkiDomainID { get; set; }
        ...
        */
        [DataMember(Name = "sDomainName", EmitDefaultValue = false)]
