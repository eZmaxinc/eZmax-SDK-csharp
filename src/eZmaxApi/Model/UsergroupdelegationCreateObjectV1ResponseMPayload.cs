...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "usergroupdelegation-createObject-v1-Response-mPayload")]
    public partial class UsergroupdelegationCreateObjectV1ResponseMPayload : IValidatableObject
    {
        ...
        public UsergroupdelegationCreateObjectV1ResponseMPayload(List<int> aPkiUsergroupdelegationID = default)
        {
            // to ensure "aPkiUsergroupdelegationID" is required (not null)
            if (aPkiUsergroupdelegationID == null)
            {
                throw new ArgumentNullException("aPkiUsergroupdelegationID is a required property for UsergroupdelegationCreateObjectV1ResponseMPayload and cannot be null");
            }
