...
namespace eZmaxApi.Model
{
    ...
    public partial class UsergroupdelegationCreateObjectV1ResponseMPayload : IValidatableObject
    {
        ...
        public UsergroupdelegationCreateObjectV1ResponseMPayload(List<int>  = default(List<int>))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for UsergroupdelegationCreateObjectV1ResponseMPayload and cannot be null");
            }
