...
namespace eZmaxApi.Model
{
    ...
    public partial class EzmaxinvoicingcommissionResponseCompound : IValidatableObject
    {
        ...
        public EzmaxinvoicingcommissionResponseCompound(int pkiEzmaxinvoicingcommissionID = default, int fkiEzmaxinvoicingsummaryglobalID = default, int fkiEzmaxpartnerID = default, int fkiEzmaxrepresentativeID = default, string dtEzmaxinvoicingcommissionStart = default, string dtEzmaxinvoicingcommissionEnd = default, int iEzmaxinvoicingcommissionDays = default, string dEzmaxinvoicingcommissionAmount = default, CustomContactNameResponse objContactName = default)
        {
