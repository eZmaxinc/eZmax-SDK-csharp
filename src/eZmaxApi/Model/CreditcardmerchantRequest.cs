...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "creditcardmerchant-Request")]
    public partial class CreditcardmerchantRequest : IValidatableObject
    {
        ...
        protected CreditcardmerchantRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreditcardmerchantRequest" /> class.
        /// </summary>
        ...
        public CreditcardmerchantRequest(int pkiCreditcardmerchantID = default, int fkiBankaccountID = default, int fkiLanguageID = default, int fkiCurrencyID = default, bool bCreditcardmerchantDenyvisa = default, bool bCreditcardmerchantDenymastercard = default, bool bCreditcardmerchantDenyamex = default, bool bCreditcardmerchantIsactive = default, string sCreditcardmerchantApitoken = default, string sCreditcardmerchantDescription = default, string sCreditcardmerchantStoreid = default)
        {
            ...
            {
                throw new ArgumentNullException("sCreditcardmerchantDescription is a required property for CreditcardmerchantRequest and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sCreditcardmerchantStoreid is a required property for CreditcardmerchantRequest and cannot be null");
            }
