...
namespace eZmaxApi.Model
{
    ...
    public partial class CreditcardmerchantRequest : IValidatableObject
    {
        ...
        public CreditcardmerchantRequest(int pkiCreditcardmerchantID = default(int), int fkiBankaccountID = default(int), int fkiLanguageID = default(int), bool bCreditcardmerchantDenyvisa = default(bool), bool bCreditcardmerchantDenymastercard = default(bool), bool bCreditcardmerchantDenyamex = default(bool), bool bCreditcardmerchantIsactive = default(bool), string sCreditcardmerchantApitoken = default(string), string sCreditcardmerchantDescription = default(string), string sCreditcardmerchantStoreid = default(string))
        {
