...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "lead-getCommunicationCount-v1-Response-mPayload")]
    public partial class LeadGetCommunicationCountV1ResponseMPayload : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LeadGetCommunicationCountV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LeadGetCommunicationCountV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LeadGetCommunicationCountV1ResponseMPayload" /> class.
        /// </summary>
        /// <param name="iCommunicationCount">The count of Communication. (required).</param>
        public LeadGetCommunicationCountV1ResponseMPayload(int iCommunicationCount = default)
        {
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LeadGetCommunicationCountV1ResponseMPayload {\n");
