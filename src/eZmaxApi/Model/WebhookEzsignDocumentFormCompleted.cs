...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Webhook-Ezsign-DocumentFormCompleted")]
    public partial class WebhookEzsignDocumentFormCompleted : IValidatableObject
    {
        ...
        protected WebhookEzsignDocumentFormCompleted() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEzsignDocumentFormCompleted" /> class.
        /// </summary>
        ...
        public WebhookEzsignDocumentFormCompleted(CustomWebhookResponse objWebhook = default(CustomWebhookResponse), List<AttemptResponseCompound> aObjAttempt = default(List<AttemptResponseCompound>), EzsigndocumentResponse objEzsigndocument = default(EzsigndocumentResponse))
        {
            // to ensure "objWebhook" is required (not null)
            if (objWebhook == null)
            {
                throw new ArgumentNullException("objWebhook is a required property for WebhookEzsignDocumentFormCompleted and cannot be null");
            }
            this.ObjWebhook = objWebhook;
            // to ensure "aObjAttempt" is required (not null)
            if (aObjAttempt == null)
            {
                throw new ArgumentNullException("aObjAttempt is a required property for WebhookEzsignDocumentFormCompleted and cannot be null");
            }
            this.AObjAttempt = aObjAttempt;
            // to ensure "objEzsigndocument" is required (not null)
            if (objEzsigndocument == null)
            {
                throw new ArgumentNullException("objEzsigndocument is a required property for WebhookEzsignDocumentFormCompleted and cannot be null");
            }
