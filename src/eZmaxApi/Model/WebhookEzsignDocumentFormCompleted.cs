...
namespace eZmaxApi.Model
{
    ...
    public partial class WebhookEzsignDocumentFormCompleted : IValidatableObject
    {
        ...
        /// <param name=""> (required).</param>
        public WebhookEzsignDocumentFormCompleted(CustomWebhookResponse  = default(CustomWebhookResponse), List<AttemptResponseCompound>  = default(List<AttemptResponseCompound>), EzsigndocumentResponse  = default(EzsigndocumentResponse))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for WebhookEzsignDocumentFormCompleted and cannot be null");
            }
            this.ObjWebhook = ;
            // to ensure "" is required (not null)
            if ( == null)
