...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplatesigner-ResponseCompoundV3")]
    public partial class EzsigntemplatesignerResponseCompoundV3 : IValidatableObject
    {

        /// <summary>
        /// Gets or Sets EEzsigntemplatesignerRole
        /// </summary>
        [DataMember(Name = "eEzsigntemplatesignerRole", EmitDefaultValue = false)]
        public FieldEEzsigntemplatesignerRole? EEzsigntemplatesignerRole { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatesignerResponseCompoundV3" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplatesignerResponseCompoundV3() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatesignerResponseCompoundV3" /> class.
        /// </summary>
        ...
        /// <param name="eEzsigntemplatesignerRole">eEzsigntemplatesignerRole.</param>
        ...
        public EzsigntemplatesignerResponseCompoundV3(int pkiEzsigntemplatesignerID = default, int fkiEzsigntemplateID = default, int fkiUserID = default, int fkiUsergroupID = default, int fkiEzdoctemplatedocumentID = default, FieldEEzsigntemplatesignerRole? eEzsigntemplatesignerRole = default, FieldEEzsigntemplatesignerMapping? eEzsigntemplatesignerMapping = default, string sEzsigntemplatesignerDescription = default, string sUserName = default, string sUsergroupNameX = default)
        {
            ...
            {
                throw new ArgumentNullException("sEzsigntemplatesignerDescription is a required property for EzsigntemplatesignerResponseCompoundV3 and cannot be null");
            }
