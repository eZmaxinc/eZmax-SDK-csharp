...
namespace eZmaxApi.Model
{
    ...
    public partial class UserGetColleaguesV2ResponseMPayload : IValidatableObject
    {
        ...
        public UserGetColleaguesV2ResponseMPayload(List<ColleagueResponseCompoundV2> aObjColleague = default, List<ColleagueResponseCompoundV2> aObjColleagueClonable = default)
        {
