...
namespace eZmaxApi.Model
{
    ...
    public partial class WebsiteRequest : IValidatableObject
    {
        ...
        public WebsiteRequest(int  = default(int), int  = default(int), string  = default(string))
        {
            this.FkiWebsitetypeID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for WebsiteRequest and cannot be null");
            }
