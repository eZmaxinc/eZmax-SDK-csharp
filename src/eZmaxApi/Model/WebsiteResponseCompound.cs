...
namespace eZmaxApi.Model
{
    ...
    public partial class WebsiteResponseCompound : IValidatableObject
    {
        ...
        public WebsiteResponseCompound(int  = default(int), int  = default(int), string  = default(string))
        {
            this.PkiWebsiteID = ;
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for WebsiteResponseCompound and cannot be null");
            }
