...
namespace eZmaxApi.Model
{
    ...
    public partial class CommonReportgroup : IValidatableObject
    {
        ...
        public CommonReportgroup(List<CommonReport> aObjReport = default, List<CommonReportcellstyle> aObjReportcellstyleCustom = default, List<CommonReportgroupParameter> aObjReportgroupParameter = default, string sReportgroupFilename = default)
        {
