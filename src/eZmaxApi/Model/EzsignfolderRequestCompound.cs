...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfolderRequestCompound : IValidatableObject
    {
        ...
        public EzsignfolderRequestCompound(int pkiEzsignfolderID = default, int fkiEzsignfoldertypeID = default, int fkiTimezoneID = default, int fkiEzsigntsarequirementID = default, string sEzsignfolderDescription = default, string tEzsignfolderNote = default, FieldEEzsignfolderSendreminderfrequency eEzsignfolderSendreminderfrequency = default, string sEzsignfolderExternalid = default)
        {
