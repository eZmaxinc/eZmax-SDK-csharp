...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplate-ResponseCompoundV4")]
    public partial class EzsigntemplateResponseCompoundV4 : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplateResponseCompoundV4" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplateResponseCompoundV4() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplateResponseCompoundV4" /> class.
        /// </summary>
        ...
        public EzsigntemplateResponseCompoundV4(int pkiEzsigntemplateID = default, int fkiEzsigntemplatedocumentID = default, int fkiEzsignfoldertypeID = default, CustomEzsignfoldertypeTemplateResponse objEzsignfoldertype = default, int fkiLanguageID = default, int fkiEzdoctemplatedocumentID = default, string sEzdoctemplatedocumentNameX = default, string sLanguageNameX = default, string sEzsigntemplateDescription = default, string sEzsigntemplateExternaldescription = default, string tEzsigntemplateComment = default, FieldEEzsigntemplateRecognition? eEzsigntemplateRecognition = default, string sEzsigntemplateFilenameregexp = default, bool bEzsigntemplateAdminonly = default, string sEzsignfoldertypeNameX = default, CommonAudit objAudit = default, bool bEzsigntemplateEditallowed = default, FieldEEzsigntemplateType? eEzsigntemplateType = default, EzsigntemplatedocumentResponse objEzsigntemplatedocument = default, List<EzsigntemplatesignerResponseCompoundV3> aObjEzsigntemplatesigner = default, List<EzsigntemplateannotationResponseCompound> aObjEzsigntemplateannotation = default)
        {
            ...
            {
                throw new ArgumentNullException("sLanguageNameX is a required property for EzsigntemplateResponseCompoundV4 and cannot be null");
            }
            this.SLanguageNameX = sLanguageNameX;
            // to ensure "sEzsigntemplateDescription" is required (not null)
            if (sEzsigntemplateDescription == null)
            {
                throw new ArgumentNullException("sEzsigntemplateDescription is a required property for EzsigntemplateResponseCompoundV4 and cannot be null");
            }
            ...
            if (objAudit == null)
            {
                throw new ArgumentNullException("objAudit is a required property for EzsigntemplateResponseCompoundV4 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("aObjEzsigntemplatesigner is a required property for EzsigntemplateResponseCompoundV4 and cannot be null");
            }
        ...
        */
        ...
        public List<EzsigntemplatesignerResponseCompoundV3> AObjEzsigntemplatesigner { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EzsigntemplateResponseCompoundV4 {\n");
