...
namespace eZmaxApi.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommunicationGetListV1Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CommunicationGetListV1Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CommunicationGetListV1Response" /> class.
        /// </summary>
        ...
        public CommunicationGetListV1Response(CommunicationGetListV1ResponseMPayload mPayload = default(CommunicationGetListV1ResponseMPayload), CommonResponseObjDebugPayloadGetList objDebugPayload = default(CommonResponseObjDebugPayloadGetList), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug))
        {
            ...
            if (mPayload == null)
            {
                throw new InvalidDataException("mPayload is a required property for CommunicationGetListV1Response and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CommunicationGetListV1Response);
        }

        /// <summary>
        /// Returns true if CommunicationGetListV1Response instances are equal
        /// </summary>
        /// <param name="input">Instance of CommunicationGetListV1Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommunicationGetListV1Response input)
        {
            if (input == null)
                return false;
