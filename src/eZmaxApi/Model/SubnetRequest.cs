...
namespace eZmaxApi.Model
{
    ...
    public partial class SubnetRequest :  IEquatable<SubnetRequest>, IValidatableObject
    {
        ...
        public SubnetRequest(int pkiSubnetID = default(int), int fkiUserID = default(int), int fkiApikeyID = default(int), MultilingualSubnetDescription objSubnetDescription = default(MultilingualSubnetDescription), int iSubnetNetwork = default(int), int iSubnetMask = default(int))
        {
