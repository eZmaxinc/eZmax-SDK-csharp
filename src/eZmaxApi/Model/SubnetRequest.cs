...
namespace eZmaxApi.Model
{
    ...
    public partial class SubnetRequest : IValidatableObject
    {
        ...
        public SubnetRequest(int pkiSubnetID = default, int fkiUserID = default, int fkiApikeyID = default, MultilingualSubnetDescription objSubnetDescription = default, long iSubnetNetwork = default, long iSubnetMask = default)
        {
