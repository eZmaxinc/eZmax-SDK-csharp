...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigndocumentCreateObjectV1ResponseMPayload : IValidatableObject
    {
        ...
        public EzsigndocumentCreateObjectV1ResponseMPayload(List<int>  = default(List<int>))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigndocumentCreateObjectV1ResponseMPayload and cannot be null");
            }
