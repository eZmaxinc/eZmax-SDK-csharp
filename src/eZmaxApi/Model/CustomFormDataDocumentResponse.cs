...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomFormDataDocumentResponse : IValidatableObject
    {
        ...
        public CustomFormDataDocumentResponse(int pkiEzsigndocumentID = default, int fkiEzsignfolderID = default, string sEzsigndocumentName = default, string dtModifiedDate = default, List<CustomFormDataSignerResponse> aObjFormDataSigner = default)
        {
