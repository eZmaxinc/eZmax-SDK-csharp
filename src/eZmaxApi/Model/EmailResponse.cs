...
namespace eZmaxApi.Model
{
    ...
    public partial class EmailResponse : IValidatableObject
    {
        ...
        public EmailResponse(int  = default(int), int  = default(int), string  = default(string))
        {
            this.PkiEmailID = ;
            this.FkiEmailtypeID = ;
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EmailResponse and cannot be null");
            }
            this.SEmailAddress = ;
        }
