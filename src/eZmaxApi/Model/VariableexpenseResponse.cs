...
namespace eZmaxApi.Model
{
    ...
    public partial class VariableexpenseResponse : IValidatableObject
    {
        ...
        public VariableexpenseResponse(int pkiVariableexpenseID = default, string sVariableexpenseCode = default, MultilingualVariableexpenseDescription objVariableexpenseDescription = default, FieldEVariableexpenseTaxable? eVariableexpenseTaxable = default, bool bVariableexpenseIsactive = default)
        {
