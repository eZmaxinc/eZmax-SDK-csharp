...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignfoldersignerassociation-Response")]
    public partial class EzsignfoldersignerassociationResponse : IValidatableObject
    {
        ...
        public EzsignfoldersignerassociationResponse(int pkiEzsignfoldersignerassociationID = default, int fkiEzsignfolderID = default, bool bEzsignfoldersignerassociationDelayedsend = default, bool bEzsignfoldersignerassociationReceivecopy = default, string tEzsignfoldersignerassociationMessage = default, bool bEzsignfoldersignerassociationAllowsigninginperson = default)
        {
