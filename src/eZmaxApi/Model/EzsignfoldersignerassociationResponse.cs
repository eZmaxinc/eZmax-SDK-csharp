...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignfoldersignerassociationResponse :  IEquatable<EzsignfoldersignerassociationResponse>, IValidatableObject
    {
        ...
        public EzsignfoldersignerassociationResponse(int pkiEzsignfoldersignerassociationID = default(int), int fkiEzsignfolderID = default(int), bool bEzsignfoldersignerassociationReceivecopy = default(bool), string tEzsignfoldersignerassociationMessage = default(string))
        {
