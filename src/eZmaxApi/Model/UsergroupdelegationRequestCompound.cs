...
namespace eZmaxApi.Model
{
    ...
    public partial class UsergroupdelegationRequestCompound :  IEquatable<UsergroupdelegationRequestCompound>, IValidatableObject
    {
        ...
        public UsergroupdelegationRequestCompound(int pkiUsergroupdelegationID = default(int), int fkiUsergroupID = default(int), int fkiUserID = default(int))
        {
            ...
            {
                throw new InvalidDataException("fkiUsergroupID is a required property for UsergroupdelegationRequestCompound and cannot be null");
            }
            else
            {
            ...
            if (fkiUserID == null)
            {
                throw new InvalidDataException("fkiUserID is a required property for UsergroupdelegationRequestCompound and cannot be null");
            }
            else
            {
