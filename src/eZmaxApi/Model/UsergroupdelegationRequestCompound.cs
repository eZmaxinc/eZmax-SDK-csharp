...
namespace eZmaxApi.Model
{
    ...
    public partial class UsergroupdelegationRequestCompound : UsergroupdelegationRequest, IValidatableObject
    {
        /// <summary>
        ...
        public UsergroupdelegationRequestCompound(int pkiUsergroupdelegationID = default(int), int fkiUsergroupID = default(int), int fkiUserID = default(int)) : base()
        {
        }
