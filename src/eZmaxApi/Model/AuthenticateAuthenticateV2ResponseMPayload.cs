...
namespace eZmaxApi.Model
{
    ...
    public partial class AuthenticateAuthenticateV2ResponseMPayload :  IEquatable<AuthenticateAuthenticateV2ResponseMPayload>, IValidatableObject
    {
        ...
        public AuthenticateAuthenticateV2ResponseMPayload(string sAuthorization = default(string), string sSecret = default(string))
        {
            ...
            {
                throw new InvalidDataException("sAuthorization is a required property for AuthenticateAuthenticateV2ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            if (sSecret == null)
            {
                throw new InvalidDataException("sSecret is a required property for AuthenticateAuthenticateV2ResponseMPayload and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="sAuthorization", EmitDefaultValue=true)]
        ...
        [DataMember(Name="sSecret", EmitDefaultValue=true)]
