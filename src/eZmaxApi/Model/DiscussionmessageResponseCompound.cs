...
namespace eZmaxApi.Model
{
    ...
    public partial class DiscussionmessageResponseCompound : IValidatableObject
    {
        ...
        public DiscussionmessageResponseCompound(int pkiDiscussionmessageID = default, int fkiDiscussionID = default, int fkiDiscussionmembershipID = default, int fkiDiscussionmembershipIDActionrequired = default, FieldEDiscussionmessageStatus eDiscussionmessageStatus = default, string tDiscussionmessageContent = default, string sDiscussionmessageCreatorname = default, string sDiscussionmessageActionrequiredname = default, CommonAudit objAudit = default)
        {
