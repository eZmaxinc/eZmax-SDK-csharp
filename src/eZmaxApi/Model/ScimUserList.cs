...
namespace eZmaxApi.Model
{
    ...
    public partial class ScimUserList : IValidatableObject
    {
        ...
        public ScimUserList(int totalResults = default, int itemsPerPage = default, int startIndex = default, List<string> schemas = default, List<ScimUser> resources = default)
        {
