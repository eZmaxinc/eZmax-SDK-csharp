...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplatedocumentpage-Response")]
    public partial class EzsigntemplatedocumentpageResponse : IValidatableObject
    {
        ...
        public EzsigntemplatedocumentpageResponse(int pkiEzsigntemplatedocumentpageID = default, int iEzsigntemplatedocumentpageWidthimage = default, int iEzsigntemplatedocumentpageHeightimage = default, int iEzsigntemplatedocumentpageWidthpdf = default, int iEzsigntemplatedocumentpageHeightpdf = default, int iEzsigntemplatedocumentpagePagenumber = default, string sComputedImageurl = default)
        {
