...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatedocumentpageResponse :  IEquatable<EzsigntemplatedocumentpageResponse>, IValidatableObject
    {
        ...
        public EzsigntemplatedocumentpageResponse(int pkiEzsigntemplatedocumentpageID = default(int), int iEzsigntemplatedocumentpageWidthimage = default(int), int iEzsigntemplatedocumentpageHeightimage = default(int), int iEzsigntemplatedocumentpageWidthpdf = default(int), int iEzsigntemplatedocumentpageHeightpdf = default(int), int iEzsigntemplatedocumentpagePagenumber = default(int), string sImageUrl = default(string))
        {
            ...
            // to ensure "sImageUrl" is required (not null)
            if (sImageUrl == null)
            {
                throw new InvalidDataException("sImageUrl is a required property for EzsigntemplatedocumentpageResponse and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="sImageUrl", EmitDefaultValue=true)]
        ...
        public bool Equals(EzsigntemplatedocumentpageResponse input)
        {
            ...
            return 
                ...
                (
                    this.SImageUrl == input.SImageUrl ||
                    (this.SImageUrl != null &&
                    this.SImageUrl.Equals(input.SImageUrl))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SImageUrl != null)
                    hashCode = hashCode * 59 + this.SImageUrl.GetHashCode();
                return hashCode;
            }
        }
