...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WebhookGetObjectV1ResponseMPayload :  IEquatable<WebhookGetObjectV1ResponseMPayload>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookGetObjectV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WebhookGetObjectV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookGetObjectV1ResponseMPayload" /> class.
        /// </summary>
        ...
        public WebhookGetObjectV1ResponseMPayload(int pkiWebhookID = default(int), string sWebhookDescription = default(string), int fkiEzsignfoldertypeID = default(int), string sEzsignfoldertypeNameX = default(string), FieldEWebhookModule eWebhookModule = default(FieldEWebhookModule), FieldEWebhookEzsignevent eWebhookEzsignevent = default(FieldEWebhookEzsignevent), FieldEWebhookManagementevent eWebhookManagementevent = default(FieldEWebhookManagementevent), string sWebhookUrl = default(string), string sWebhookEmailfailed = default(string), bool bWebhookIsactive = default(bool), bool bWebhookSkipsslvalidation = default(bool), string sWebhookEvent = default(string))
        {
            ...
            {
                throw new InvalidDataException("sWebhookDescription is a required property for WebhookGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("eWebhookModule is a required property for WebhookGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            if (sWebhookUrl == null)
            {
                throw new InvalidDataException("sWebhookUrl is a required property for WebhookGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sWebhookEmailfailed is a required property for WebhookGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("bWebhookSkipsslvalidation is a required property for WebhookGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sWebhookEvent is a required property for WebhookGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as WebhookGetObjectV1ResponseMPayload);
        }

        /// <summary>
        /// Returns true if WebhookGetObjectV1ResponseMPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of WebhookGetObjectV1ResponseMPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhookGetObjectV1ResponseMPayload input)
        {
            if (input == null)
                return false;
