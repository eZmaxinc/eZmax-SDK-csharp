...
namespace eZmaxApi.Model
{
    ...
    public partial class DomainRequestCompound : IValidatableObject
    {
        ...
        public DomainRequestCompound(int  = default(int), string  = default(string))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for DomainRequestCompound and cannot be null");
            }
            this.SDomainName = ;
            this.PkiDomainID = ;
        }
