...
namespace eZmaxApi.Model
{
    ...
    public partial class AuthenticationexternalAutocompleteElementResponse : IValidatableObject
    {
        ...
        public AuthenticationexternalAutocompleteElementResponse(int pkiAuthenticationexternalID = default, string sAuthenticationexternalDescription = default, bool bAuthenticationexternalIsactive = default)
        {
