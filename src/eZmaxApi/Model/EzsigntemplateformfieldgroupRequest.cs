...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplateformfieldgroup-Request")]
    public partial class EzsigntemplateformfieldgroupRequest : IValidatableObject
    {
        ...
        public EzsigntemplateformfieldgroupRequest(int pkiEzsigntemplateformfieldgroupID = default, int fkiEzsigntemplatedocumentID = default, FieldEEzsigntemplateformfieldgroupType eEzsigntemplateformfieldgroupType = default, FieldEEzsigntemplateformfieldgroupSignerrequirement? eEzsigntemplateformfieldgroupSignerrequirement = default, string sEzsigntemplateformfieldgroupLabel = default, int iEzsigntemplateformfieldgroupStep = default, string sEzsigntemplateformfieldgroupDefaultvalue = default, int iEzsigntemplateformfieldgroupFilledmin = default, int iEzsigntemplateformfieldgroupFilledmax = default, bool bEzsigntemplateformfieldgroupReadonly = default, int iEzsigntemplateformfieldgroupMaxlength = default, bool bEzsigntemplateformfieldgroupEncrypted = default, string sEzsigntemplateformfieldgroupRegexp = default, string sEzsigntemplateformfieldgroupTextvalidationcustommessage = default, EnumTextvalidation? eEzsigntemplateformfieldgroupTextvalidation = default, string tEzsigntemplateformfieldgroupTooltip = default, FieldEEzsigntemplateformfieldgroupTooltipposition? eEzsigntemplateformfieldgroupTooltipposition = default)
        {
            ...
            {
                throw new ArgumentNullException("sEzsigntemplateformfieldgroupLabel is a required property for EzsigntemplateformfieldgroupRequest and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sEzsigntemplateformfieldgroupDefaultvalue is a required property for EzsigntemplateformfieldgroupRequest and cannot be null");
            }
