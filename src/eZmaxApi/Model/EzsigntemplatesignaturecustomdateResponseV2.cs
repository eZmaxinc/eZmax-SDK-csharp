...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatesignaturecustomdateResponseV2 : IValidatableObject
    {
        ...
        public EzsigntemplatesignaturecustomdateResponseV2(int  = default(int), int  = default(int), int  = default(int), string  = default(string))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplatesignaturecustomdateResponseV2 and cannot be null");
            }
