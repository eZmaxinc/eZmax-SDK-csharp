...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "branding-getObject-v3-Response-mPayload")]
    public partial class BrandingGetObjectV3ResponseMPayload : IValidatableObject
    {
        ...
        protected BrandingGetObjectV3ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BrandingGetObjectV3ResponseMPayload" /> class.
        /// </summary>
        /// <param name="objBranding">objBranding (required).</param>
        public BrandingGetObjectV3ResponseMPayload(BrandingResponseCompoundV3 objBranding = default)
        {
