...
namespace eZmaxApi.Model
{
    ...
    public partial class AuthenticationexternalRequest : IValidatableObject
    {
        ...
        public AuthenticationexternalRequest(int pkiAuthenticationexternalID = default, string sAuthenticationexternalDescription = default, FieldEAuthenticationexternalType eAuthenticationexternalType = default)
        {
