...
namespace eZmaxApi.Model
{
    ...
    public partial class EzmaxinvoicingagentResponseCompound : IValidatableObject
    {
        ...
        public EzmaxinvoicingagentResponseCompound(int pkiEzmaxinvoicingagentID = default, int fkiEzmaxinvoicingID = default, int fkiBillingentityinternalID = default, string sBillingentityinternalDescriptionX = default, int fkiAgentID = default, int fkiBrokerID = default, int iEzmaxinvoicingagentSession = default, int iEzmaxinvoicingagentCloned = default, int iEzmaxinvoicingagentInvoice = default, int iEzmaxinvoicingagentInscription = default, int iEzmaxinvoicingagentInscriptionactive = default, int iEzmaxinvoicingagentSale = default, int iEzmaxinvoicingagentOtherincome = default, int iEzmaxinvoicingagentCommissioncalculation = default, int iEzmaxinvoicingagentEzsigndocument = default, bool bEzmaxinvoicingagentEzsignaccount = default, bool bEzmaxinvoicingagentBillableezmax = default, FieldEEzmaxinvoicingagentVariationezmax eEzmaxinvoicingagentVariationezmax = default, bool bEzmaxinvoicingagentBillableezsign = default, FieldEEzmaxinvoicingagentVariationezsign eEzmaxinvoicingagentVariationezsign = default, CustomContactNameResponse objContactName = default)
        {
