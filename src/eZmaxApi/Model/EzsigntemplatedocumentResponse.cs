...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatedocumentResponse : IValidatableObject
    {
        ...
        public EzsigntemplatedocumentResponse(int pkiEzsigntemplatedocumentID = default, int fkiEzsigntemplateID = default, string sEzsigntemplatedocumentName = default, int iEzsigntemplatedocumentPagetotal = default, int iEzsigntemplatedocumentSignaturetotal = default, int iEzsigntemplatedocumentFormfieldtotal = default, bool bEzsigntemplatedocumentHassignedsignatures = default)
        {
