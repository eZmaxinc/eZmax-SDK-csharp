...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatedocumentResponse : IValidatableObject
    {
        ...
        public EzsigntemplatedocumentResponse(int pkiEzsigntemplatedocumentID = default(int), int fkiEzsigntemplateID = default(int), string sEzsigntemplatedocumentName = default(string), int iEzsigntemplatedocumentPagetotal = default(int), int iEzsigntemplatedocumentSignaturetotal = default(int), int iEzsigntemplatedocumentFormfieldtotal = default(int), bool bEzsigntemplatedocumentHassignedsignatures = default(bool))
        {
