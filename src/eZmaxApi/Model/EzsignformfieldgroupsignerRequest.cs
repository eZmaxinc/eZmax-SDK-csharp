...
dataType                            : Object
datatypeWithEnum                    : 
name                                : ezsignformfieldgroupsigner-Request
defaultValue                        : 
...
*/
    ...
    /// </summary>
    [DataContract]
    public partial class EzsignformfieldgroupsignerRequest :  IEquatable<EzsignformfieldgroupsignerRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignformfieldgroupsignerRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsignformfieldgroupsignerRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignformfieldgroupsignerRequest" /> class.
        /// </summary>
        ...
        public EzsignformfieldgroupsignerRequest(int pkiEzsignformfieldgroupsignerID = default(int), int fkiEzsignfoldersignerassociationID = default(int))
        {
            // to ensure "fkiEzsignfoldersignerassociationID" is required (not null)
            if (fkiEzsignfoldersignerassociationID == null)
            {
                throw new InvalidDataException("fkiEzsignfoldersignerassociationID is a required property for EzsignformfieldgroupsignerRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EzsignformfieldgroupsignerRequest);
        }

        /// <summary>
        /// Returns true if EzsignformfieldgroupsignerRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of EzsignformfieldgroupsignerRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EzsignformfieldgroupsignerRequest input)
        {
            if (input == null)
                return false;
