...
namespace eZmaxApi.Model
{
    ...
    public partial class BrandingResponseCompoundV3 : IValidatableObject
    {
        ...
        public BrandingResponseCompoundV3(int pkiBrandingID = default, int fkiDomainID = default, string sDomainName = default, int fkiEmailID = default, MultilingualBrandingDescription objBrandingDescription = default, string sBrandingDescriptionX = default, string sBrandingName = default, string sEmailAddress = default, FieldEBrandingLogo eBrandingLogo = default, FieldEBrandingAlignlogo eBrandingAlignlogo = default, int iBrandingColor = default, bool bBrandingIsactive = default, string sBrandingLogourl = default, string sBrandingLogoemailurl = default, string sBrandingLogointerfaceurl = default)
        {
