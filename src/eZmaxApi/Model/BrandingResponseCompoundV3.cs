...
namespace eZmaxApi.Model
{
    ...
    public partial class BrandingResponseCompoundV3 : IValidatableObject
    {
        ...
        /// <param name="">The url of the picture used as logo in the Branding.</param>
        /// <param name="">The url of the picture used in email as logo in the Branding.</param>
        /// <param name="">The url of the picture used as logo in the Branding.</param>
        public BrandingResponseCompoundV3(int  = default(int), int  = default(int), MultilingualBrandingDescription  = default(MultilingualBrandingDescription), string  = default(string), string  = default(string), string  = default(string), FieldEBrandingLogo  = default(FieldEBrandingLogo), FieldEBrandingAlignlogo  = default(FieldEBrandingAlignlogo), int  = default(int), bool  = default(bool), string  = default(string), string  = default(string), string  = default(string))
        {
            this.PkiBrandingID = ;
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for BrandingResponseCompoundV3 and cannot be null");
            }
