...
namespace eZmaxApi.Model
{
    ...
    public partial class CommunicationGetListV1ResponseMPayload :  IEquatable<CommunicationGetListV1ResponseMPayload>, IValidatableObject
    {
        ...
        protected CommunicationGetListV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CommunicationGetListV1ResponseMPayload" /> class.
        /// </summary>
        ...
        public CommunicationGetListV1ResponseMPayload(List<CommunicationListElement> aObjCommunication = default(List<CommunicationListElement>), int iRowReturned = default(int), int iRowFiltered = default(int))
        {
            ...
            {
                throw new InvalidDataException("aObjCommunication is a required property for CommunicationGetListV1ResponseMPayload and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CommunicationGetListV1ResponseMPayload);
        }

        /// <summary>
        /// Returns true if CommunicationGetListV1ResponseMPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of CommunicationGetListV1ResponseMPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommunicationGetListV1ResponseMPayload input)
        {
            if (input == null)
                return false;
