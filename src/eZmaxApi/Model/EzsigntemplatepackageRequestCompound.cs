...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatepackageRequestCompound : IValidatableObject
    {
        ...
        public EzsigntemplatepackageRequestCompound(int pkiEzsigntemplatepackageID = default, int fkiEzsignfoldertypeID = default, int fkiEzdoctemplatedocumentID = default, int fkiLanguageID = default, string sEzsigntemplatepackageDescription = default, bool bEzsigntemplatepackageAdminonly = default, bool bEzsigntemplatepackageIsactive = default)
        {
