...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "user-createObject-v2-Request")]
    public partial class UserCreateObjectV2Request : IValidatableObject
    {
        ...
        protected UserCreateObjectV2Request() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UserCreateObjectV2Request" /> class.
        /// </summary>
        /// <param name="aObjUser">aObjUser (required).</param>
        public UserCreateObjectV2Request(List<UserRequestCompoundV2> aObjUser = default)
        {
