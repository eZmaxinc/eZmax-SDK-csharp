...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatesignatureResponseCompoundV3 : IValidatableObject
    {
        ...
        protected EzsigntemplatesignatureResponseCompoundV3() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatesignatureResponseCompoundV3" /> class.
        /// </summary>
        /// <param name="">The unique ID of the Ezsigntemplatesignature (required).</param>
        ...
        public List<EzsigntemplatesignaturecustomdateResponseCompoundV2> AObjEzsigntemplatesignaturecustomdate { get; set; }
