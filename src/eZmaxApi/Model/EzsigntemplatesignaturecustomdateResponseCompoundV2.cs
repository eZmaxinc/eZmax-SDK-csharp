...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatesignaturecustomdateResponseCompoundV2 : IValidatableObject
    {
        ...
        public EzsigntemplatesignaturecustomdateResponseCompoundV2(int  = default(int), int  = default(int), int  = default(int), string  = default(string))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplatesignaturecustomdateResponseCompoundV2 and cannot be null");
            }
