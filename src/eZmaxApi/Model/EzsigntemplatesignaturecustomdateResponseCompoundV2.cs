...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigntemplatesignaturecustomdate-ResponseCompoundV2")]
    public partial class EzsigntemplatesignaturecustomdateResponseCompoundV2 : IValidatableObject
    {
        ...
        protected EzsigntemplatesignaturecustomdateResponseCompoundV2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatesignaturecustomdateResponseCompoundV2" /> class.
        /// </summary>
        ...
        public EzsigntemplatesignaturecustomdateResponseCompoundV2(int pkiEzsigntemplatesignaturecustomdateID = default(int), int iEzsigntemplatesignaturecustomdateOffsetx = default(int), int iEzsigntemplatesignaturecustomdateOffsety = default(int), string sEzsigntemplatesignaturecustomdateFormat = default(string))
        {
            ...
            {
                throw new ArgumentNullException("sEzsigntemplatesignaturecustomdateFormat is a required property for EzsigntemplatesignaturecustomdateResponseCompoundV2 and cannot be null");
            }
