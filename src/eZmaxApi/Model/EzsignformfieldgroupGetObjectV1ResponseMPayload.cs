...
namespace eZmaxApi.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignformfieldgroupGetObjectV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsignformfieldgroupGetObjectV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignformfieldgroupGetObjectV1ResponseMPayload" /> class.
        /// </summary>
        ...
        public EzsignformfieldgroupGetObjectV1ResponseMPayload(int pkiEzsignformfieldgroupID = default(int), int fkiEzsigndocumentID = default(int), FieldEEzsignformfieldgroupType eEzsignformfieldgroupType = default(FieldEEzsignformfieldgroupType), FieldEEzsignformfieldgroupSignerrequirement eEzsignformfieldgroupSignerrequirement = default(FieldEEzsignformfieldgroupSignerrequirement), string sEzsignformfieldgroupLabel = default(string), int iEzsignformfieldgroupStep = default(int), string sEzsignformfieldgroupDefaultvalue = default(string), int iEzsignformfieldgroupFilledmin = default(int), int iEzsignformfieldgroupFilledmax = default(int), bool bEzsignformfieldgroupReadonly = default(bool), int iEzsignformfieldgroupMaxlength = default(int), bool bEzsignformfieldgroupEncrypted = default(bool), string sEzsignformfieldgroupRegexp = default(string), string tEzsignformfieldgroupTooltip = default(string), FieldEEzsignformfieldgroupTooltipposition eEzsignformfieldgroupTooltipposition = default(FieldEEzsignformfieldgroupTooltipposition), List<EzsignformfieldResponseCompound> aObjEzsignformfield = default(List<EzsignformfieldResponseCompound>), List<CustomDropdownElementResponseCompound> aObjDropdownElement = default(List<CustomDropdownElementResponseCompound>), List<EzsignformfieldgroupsignerResponseCompound> aObjEzsignformfieldgroupsigner = default(List<EzsignformfieldgroupsignerResponseCompound>))
        {
            ...
            {
                throw new InvalidDataException("pkiEzsignformfieldgroupID is a required property for EzsignformfieldgroupGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("fkiEzsigndocumentID is a required property for EzsignformfieldgroupGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("eEzsignformfieldgroupType is a required property for EzsignformfieldgroupGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("eEzsignformfieldgroupSignerrequirement is a required property for EzsignformfieldgroupGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sEzsignformfieldgroupLabel is a required property for EzsignformfieldgroupGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iEzsignformfieldgroupStep is a required property for EzsignformfieldgroupGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sEzsignformfieldgroupDefaultvalue is a required property for EzsignformfieldgroupGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iEzsignformfieldgroupFilledmin is a required property for EzsignformfieldgroupGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iEzsignformfieldgroupFilledmax is a required property for EzsignformfieldgroupGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("bEzsignformfieldgroupReadonly is a required property for EzsignformfieldgroupGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("aObjEzsignformfield is a required property for EzsignformfieldgroupGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("aObjEzsignformfieldgroupsigner is a required property for EzsignformfieldgroupGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EzsignformfieldgroupGetObjectV1ResponseMPayload);
        }

        /// <summary>
        /// Returns true if EzsignformfieldgroupGetObjectV1ResponseMPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of EzsignformfieldgroupGetObjectV1ResponseMPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EzsignformfieldgroupGetObjectV1ResponseMPayload input)
        {
            if (input == null)
                return false;
