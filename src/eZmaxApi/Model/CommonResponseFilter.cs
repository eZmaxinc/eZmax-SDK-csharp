...
namespace eZmaxApi.Model
{
    ...
    public partial class CommonResponseFilter : IValidatableObject
    {
        ...
        public CommonResponseFilter(Dictionary<string, string> aAutoType = default, Dictionary<string, string> aAutoTypeHaving = default, Dictionary<string, Dictionary<string, string>> aEnum = default)
        {
