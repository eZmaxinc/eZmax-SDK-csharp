...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsigntemplatepackageGetObjectV1Response :  IEquatable<EzsigntemplatepackageGetObjectV1Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatepackageGetObjectV1Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplatepackageGetObjectV1Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatepackageGetObjectV1Response" /> class.
        /// </summary>
        ...
        public EzsigntemplatepackageGetObjectV1Response(EzsigntemplatepackageGetObjectV1ResponseMPayload mPayload = default(EzsigntemplatepackageGetObjectV1ResponseMPayload), CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug))
        {
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new InvalidDataException("mPayload is a required property for EzsigntemplatepackageGetObjectV1Response and cannot be null");
            }
            else
            {
        ...
        public EzsigntemplatepackageGetObjectV1ResponseMPayload MPayload { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EzsigntemplatepackageGetObjectV1Response {\n");
        ...
        {
            return this.Equals(input as EzsigntemplatepackageGetObjectV1Response);
        }

        /// <summary>
        /// Returns true if EzsigntemplatepackageGetObjectV1Response instances are equal
        /// </summary>
        /// <param name="input">Instance of EzsigntemplatepackageGetObjectV1Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EzsigntemplatepackageGetObjectV1Response input)
        {
            if (input == null)
                return false;
