...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "user-getUsergroups-v1-Response-mPayload")]
    public partial class UserGetUsergroupsV1ResponseMPayload : IValidatableObject
    {
        ...
        protected UserGetUsergroupsV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UserGetUsergroupsV1ResponseMPayload" /> class.
        /// </summary>
        /// <param name="aObjUsergroup">aObjUsergroup (required).</param>
        public UserGetUsergroupsV1ResponseMPayload(List<UsergroupResponseCompound> aObjUsergroup = default)
        {
