...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "deposit-getCommunicationCount-v1-Response-mPayload")]
    public partial class DepositGetCommunicationCountV1ResponseMPayload : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DepositGetCommunicationCountV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DepositGetCommunicationCountV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DepositGetCommunicationCountV1ResponseMPayload" /> class.
        /// </summary>
        /// <param name="iCommunicationCount">The count of Communication. (required).</param>
        public DepositGetCommunicationCountV1ResponseMPayload(int iCommunicationCount = default)
        {
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DepositGetCommunicationCountV1ResponseMPayload {\n");
