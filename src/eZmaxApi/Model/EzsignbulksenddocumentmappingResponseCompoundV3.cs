...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignbulksenddocumentmapping-ResponseCompoundV3")]
    public partial class EzsignbulksenddocumentmappingResponseCompoundV3 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignbulksenddocumentmappingResponseCompoundV3" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsignbulksenddocumentmappingResponseCompoundV3() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsignbulksenddocumentmappingResponseCompoundV3" /> class.
        /// </summary>
        ...
        public EzsignbulksenddocumentmappingResponseCompoundV3(int pkiEzsignbulksenddocumentmappingID = default, int fkiEzsignbulksendID = default, int fkiEzsigntemplatepackageID = default, int fkiEzsigntemplateID = default, int iEzsignbulksenddocumentmappingOrder = default, EzsigntemplateResponseCompoundV4 objEzsigntemplate = default, EzsigntemplatepackageResponseCompoundV3 objEzsigntemplatepackage = default)
        {
