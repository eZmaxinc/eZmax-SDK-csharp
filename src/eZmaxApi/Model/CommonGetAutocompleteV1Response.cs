...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Common-getAutocomplete-v1-Response")]
    public partial class CommonGetAutocompleteV1Response : IValidatableObject
    {
        /// <summary>
        ...
        public CommonGetAutocompleteV1Response(CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug), List<CustomAutocompleteElementResponse> mPayload = default(List<CustomAutocompleteElementResponse>))
        {
            // to ensure "objDebugPayload" is required (not null)
            if (objDebugPayload == null)
            {
                throw new ArgumentNullException("objDebugPayload is a required property for CommonGetAutocompleteV1Response and cannot be null");
            }
            this.ObjDebugPayload = objDebugPayload;
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new ArgumentNullException("mPayload is a required property for CommonGetAutocompleteV1Response and cannot be null");
            }
