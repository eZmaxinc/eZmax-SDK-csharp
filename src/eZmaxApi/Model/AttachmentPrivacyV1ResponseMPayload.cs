...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "attachment-privacy-v1-Response-mPayload")]
    public partial class AttachmentPrivacyV1ResponseMPayload : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AttachmentPrivacyV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AttachmentPrivacyV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AttachmentPrivacyV1ResponseMPayload" /> class.
        /// </summary>
        /// <param name="pkiAttachmentID">The unique ID of the Attachment. (required).</param>
        public AttachmentPrivacyV1ResponseMPayload(int pkiAttachmentID = default)
        {
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AttachmentPrivacyV1ResponseMPayload {\n");
