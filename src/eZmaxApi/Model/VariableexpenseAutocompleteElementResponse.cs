...
namespace eZmaxApi.Model
{
    ...
    public partial class VariableexpenseAutocompleteElementResponse : IValidatableObject
    {
        ...
        public VariableexpenseAutocompleteElementResponse(string sVariableexpenseDescriptionX = default, int pkiVariableexpenseID = default, bool bVariableexpenseIsactive = default)
        {
