...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "attachment-rename-v1-Response-mPayload")]
    public partial class AttachmentRenameV1ResponseMPayload : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AttachmentRenameV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AttachmentRenameV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AttachmentRenameV1ResponseMPayload" /> class.
        /// </summary>
        /// <param name="pkiAttachmentID">The unique ID of the Attachment. (required).</param>
        public AttachmentRenameV1ResponseMPayload(int pkiAttachmentID = default)
        {
