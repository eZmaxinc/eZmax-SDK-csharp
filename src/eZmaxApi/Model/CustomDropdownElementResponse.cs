...
namespace eZmaxApi.Model
{
    ...
    public partial class CustomDropdownElementResponse : IValidatableObject
    {
        ...
        public CustomDropdownElementResponse(string  = default(string), string  = default(string))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for CustomDropdownElementResponse and cannot be null");
            }
            this.SLabel = ;
            // to ensure "" is required (not null)
            if ( == null)
