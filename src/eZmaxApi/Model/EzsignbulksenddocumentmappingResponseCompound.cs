...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsignbulksenddocumentmappingResponseCompound : IValidatableObject
    {
        ...
        public EzsignbulksenddocumentmappingResponseCompound(int pkiEzsignbulksenddocumentmappingID = default, int fkiEzsignbulksendID = default, int fkiEzsigntemplatepackageID = default, int fkiEzsigntemplateID = default, int iEzsignbulksenddocumentmappingOrder = default, EzsigntemplateResponseCompound objEzsigntemplate = default, EzsigntemplatepackageResponseCompound objEzsigntemplatepackage = default)
        {
