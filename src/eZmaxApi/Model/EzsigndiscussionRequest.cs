...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigndiscussionRequest : IValidatableObject
    {
        ...
        public EzsigndiscussionRequest(int pkiEzsigndiscussionID = default, int fkiEzsigndocumentID = default, int iEzsigndiscussionPagenumber = default, int iEzsigndiscussionX = default, int iEzsigndiscussionY = default, DiscussionRequest objDiscussion = default)
        {
