...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsignformfield-ResponseCompound")]
    public partial class EzsignformfieldResponseCompound : IValidatableObject
    {
        ...
        public EzsignformfieldResponseCompound(int pkiEzsignformfieldID = default, int iEzsignpagePagenumber = default, string sEzsignformfieldLabel = default, string sEzsignformfieldValue = default, int iEzsignformfieldX = default, int iEzsignformfieldY = default, int iEzsignformfieldWidth = default, int iEzsignformfieldHeight = default, bool bEzsignformfieldAutocomplete = default, bool bEzsignformfieldSelected = default, string sEzsignformfieldEnteredvalue = default, FieldEEzsignformfieldDependencyrequirement? eEzsignformfieldDependencyrequirement = default, EnumHorizontalalignment? eEzsignformfieldHorizontalalignment = default, TextstylestaticResponseCompound objTextstylestatic = default, List<EzsignelementdependencyResponseCompound> aObjEzsignelementdependency = default)
        {
            ...
            {
                throw new ArgumentNullException("sEzsignformfieldLabel is a required property for EzsignformfieldResponseCompound and cannot be null");
            }
        ...
        <example>32</example>
        */
        [DataMember(Name = "pkiEzsignformfieldID", IsRequired = true, EmitDefaultValue = true)]
