...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsigntemplatesignatureGetObjectV1ResponseMPayload :  IEquatable<EzsigntemplatesignatureGetObjectV1ResponseMPayload>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatesignatureGetObjectV1ResponseMPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplatesignatureGetObjectV1ResponseMPayload() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatesignatureGetObjectV1ResponseMPayload" /> class.
        /// </summary>
        ...
        public EzsigntemplatesignatureGetObjectV1ResponseMPayload(int pkiEzsigntemplatesignatureID = default(int), int fkiEzsigntemplatedocumentID = default(int), int fkiEzsigntemplatesignerID = default(int), int iEzsigntemplatedocumentpagePagenumber = default(int), int iEzsigntemplatesignatureX = default(int), int iEzsigntemplatesignatureY = default(int), int iEzsigntemplatesignatureStep = default(int), FieldEEzsigntemplatesignatureType eEzsigntemplatesignatureType = default(FieldEEzsigntemplatesignatureType), string tEzsigntemplatesignatureTooltip = default(string), FieldEEzsigntemplatesignatureTooltipposition eEzsigntemplatesignatureTooltipposition = default(FieldEEzsigntemplatesignatureTooltipposition), FieldEEzsigntemplatesignatureFont eEzsigntemplatesignatureFont = default(FieldEEzsigntemplatesignatureFont), bool bEzsigntemplatesignatureCustomdate = default(bool), List<EzsigntemplatesignaturecustomdateResponseCompound> aObjEzsigntemplatesignaturecustomdate = default(List<EzsigntemplatesignaturecustomdateResponseCompound>))
        {
            ...
            {
                throw new InvalidDataException("fkiEzsigntemplatedocumentID is a required property for EzsigntemplatesignatureGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("fkiEzsigntemplatesignerID is a required property for EzsigntemplatesignatureGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iEzsigntemplatedocumentpagePagenumber is a required property for EzsigntemplatesignatureGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iEzsigntemplatesignatureX is a required property for EzsigntemplatesignatureGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iEzsigntemplatesignatureY is a required property for EzsigntemplatesignatureGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("iEzsigntemplatesignatureStep is a required property for EzsigntemplatesignatureGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("eEzsigntemplatesignatureType is a required property for EzsigntemplatesignatureGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EzsigntemplatesignatureGetObjectV1ResponseMPayload);
        }

        /// <summary>
        /// Returns true if EzsigntemplatesignatureGetObjectV1ResponseMPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of EzsigntemplatesignatureGetObjectV1ResponseMPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EzsigntemplatesignatureGetObjectV1ResponseMPayload input)
        {
            if (input == null)
                return false;
