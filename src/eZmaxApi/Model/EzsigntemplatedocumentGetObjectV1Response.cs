...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsigntemplatedocumentGetObjectV1Response :  IEquatable<EzsigntemplatedocumentGetObjectV1Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatedocumentGetObjectV1Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EzsigntemplatedocumentGetObjectV1Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EzsigntemplatedocumentGetObjectV1Response" /> class.
        /// </summary>
        ...
        public EzsigntemplatedocumentGetObjectV1Response(EzsigntemplatedocumentGetObjectV1ResponseMPayload mPayload = default(EzsigntemplatedocumentGetObjectV1ResponseMPayload), CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug))
        {
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new InvalidDataException("mPayload is a required property for EzsigntemplatedocumentGetObjectV1Response and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EzsigntemplatedocumentGetObjectV1Response {\n");
        ...
        {
            return this.Equals(input as EzsigntemplatedocumentGetObjectV1Response);
        }

        /// <summary>
        /// Returns true if EzsigntemplatedocumentGetObjectV1Response instances are equal
        /// </summary>
        /// <param name="input">Instance of EzsigntemplatedocumentGetObjectV1Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EzsigntemplatedocumentGetObjectV1Response input)
        {
            if (input == null)
                return false;
