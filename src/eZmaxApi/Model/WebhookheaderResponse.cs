...
namespace eZmaxApi.Model
{
    ...
    public partial class WebhookheaderResponse : IValidatableObject
    {
        ...
        public WebhookheaderResponse(int pkiWebhookheaderID = default, int fkiWebhookID = default, string sWebhookheaderName = default, string sWebhookheaderValue = default)
        {
