...
namespace eZmaxApi.Model
{
    ...
    public partial class EzsigntemplatepublicResponse : IValidatableObject
    {
        ...
        public EzsigntemplatepublicResponse(int  = default(int), int  = default(int), string  = default(string), int  = default(int), string  = default(string), int  = default(int), int  = default(int), string  = default(string), string  = default(string), bool  = default(bool), string  = default(string), FieldEEzsigntemplatepublicLimittype  = default(FieldEEzsigntemplatepublicLimittype), int  = default(int), int  = default(int), string  = default(string), string  = default(string), string  = default(string), CommonAudit  = default(CommonAudit))
        {
            ...
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for EzsigntemplatepublicResponse and cannot be null");
            }
