...
namespace eZmaxApi.Model
{
    ...
    /// A Branding Object
    /// </summary>
    [DataContract(Name = "branding-RequestV2")]
    public partial class BrandingRequestV2 : IValidatableObject
    {
        ...
        public BrandingRequestV2(int pkiBrandingID = default, int fkiDomainID = default, MultilingualBrandingDescription objBrandingDescription = default, FieldEBrandingLogo eBrandingLogo = default, FieldEBrandingAlignlogo? eBrandingAlignlogo = default, byte[] sBrandingBase64 = default, int iBrandingColor = default, string sBrandingName = default, string sEmailAddress = default, bool bBrandingIsactive = default)
        {
