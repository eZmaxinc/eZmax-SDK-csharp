...
namespace eZmaxApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "creditcardmerchant-ListElement")]
    public partial class CreditcardmerchantListElement : IValidatableObject
    {
        ...
        protected CreditcardmerchantListElement() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreditcardmerchantListElement" /> class.
        /// </summary>
        ...
        public CreditcardmerchantListElement(int pkiCreditcardmerchantID = default(int), int fkiBankaccountID = default(int), int fkiLanguageID = default(int), bool bCreditcardmerchantDenyvisa = default(bool), bool bCreditcardmerchantDenymastercard = default(bool), bool bCreditcardmerchantDenyamex = default(bool), bool bCreditcardmerchantIsactive = default(bool), string sCreditcardmerchantDescription = default(string), string sCreditcardmerchantStoreid = default(string))
        {
            ...
            {
                throw new ArgumentNullException("sCreditcardmerchantDescription is a required property for CreditcardmerchantListElement and cannot be null");
            }
