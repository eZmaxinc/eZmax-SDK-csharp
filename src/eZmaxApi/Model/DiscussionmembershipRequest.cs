...
namespace eZmaxApi.Model
{
    ...
    public partial class DiscussionmembershipRequest : IValidatableObject
    {
        ...
        public DiscussionmembershipRequest(int pkiDiscussionmembershipID = default, int fkiDiscussionID = default, int fkiUserID = default, int fkiUsergroupID = default, int fkiModulesectionID = default, string dtDiscussionmembershipJoined = default)
        {
