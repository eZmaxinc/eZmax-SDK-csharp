...
namespace eZmaxApi.Api
{
    ...
    /// </summary>
    public interface IObjectEzsignpageApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IObjectEzsignpageApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<EzsignpageConsultV1Response> EzsignpageConsultV1Async(int pkiEzsignpageID, Object body, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<EzsignpageConsultV1Response>> EzsignpageConsultV1WithHttpInfoAsync(int pkiEzsignpageID, Object body, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IObjectEzsignpageApi : IObjectEzsignpageApiSync, IObjectEzsignpageApiAsync
    {
    ...
    public partial class ObjectEzsignpageApi : IObjectEzsignpageApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ObjectEzsignpageApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public ObjectEzsignpageApi(eZmaxApi.Client.Configuration configuration)
        {
        ...
        public ObjectEzsignpageApi(eZmaxApi.Client.ISynchronousClient client, eZmaxApi.Client.IAsynchronousClient asyncClient, eZmaxApi.Client.IReadableConfiguration configuration)
        {
        ...
        public eZmaxApi.Client.ApiResponse<EzsignpageConsultV1Response> EzsignpageConsultV1WithHttpInfo(int pkiEzsignpageID, Object body, int operationIndex = 0)
        {
            ...
            if (body == null)
            {
                throw new eZmaxApi.Client.ApiException(400, "Missing required parameter 'body' when calling ObjectEzsignpageApi->EzsignpageConsultV1");
            }
            ...
            localVarRequestOptions.PathParameters.Add("pkiEzsignpageID", eZmaxApi.Client.ClientUtils.ParameterToString(pkiEzsignpageID)); // path parameter
            localVarRequestOptions.Data = body;

            localVarRequestOptions.Operation = "ObjectEzsignpageApi.EzsignpageConsultV1";
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of EzsignpageConsultV1Response</returns>
        public async System.Threading.Tasks.Task<EzsignpageConsultV1Response> EzsignpageConsultV1Async(int pkiEzsignpageID, Object body, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (EzsignpageConsultV1Response)</returns>
        public async System.Threading.Tasks.Task<eZmaxApi.Client.ApiResponse<EzsignpageConsultV1Response>> EzsignpageConsultV1WithHttpInfoAsync(int pkiEzsignpageID, Object body, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'body' is set
            if (body == null)
            {
