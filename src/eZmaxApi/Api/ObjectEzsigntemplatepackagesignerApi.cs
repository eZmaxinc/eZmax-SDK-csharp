...
namespace eZmaxApi.Api
{
    ...
    public interface IObjectEzsigntemplatepackagesignerApi : IApiAccessor
    {
        ...
        /// <exception cref="eZmaxApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="pkiEzsigntemplatepackagesignerID"></param>
        /// <returns>EzsigntemplatepackagesignerGetObjectV1Response</returns>
        [Obsolete]
        ...
        /// <exception cref="eZmaxApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="pkiEzsigntemplatepackagesignerID"></param>
        /// <returns>ApiResponse of EzsigntemplatepackagesignerGetObjectV1Response</returns>
        [Obsolete]
        ApiResponse<EzsigntemplatepackagesignerGetObjectV1Response> EzsigntemplatepackagesignerGetObjectV1WithHttpInfo (int pkiEzsigntemplatepackagesignerID);
        /// <summary>
        /// Retrieve an existing Ezsigntemplatepackagesigner
        /// </summary>
        /// <remarks>
        ...
        /// <param name="pkiEzsigntemplatepackagesignerID"></param>
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of EzsigntemplatepackagesignerGetObjectV1Response</returns>
        [Obsolete]
        System.Threading.Tasks.Task<EzsigntemplatepackagesignerGetObjectV1Response> EzsigntemplatepackagesignerGetObjectV1Async (int pkiEzsigntemplatepackagesignerID, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="pkiEzsigntemplatepackagesignerID"></param>
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (EzsigntemplatepackagesignerGetObjectV1Response)</returns>
        [Obsolete]
        System.Threading.Tasks.Task<ApiResponse<EzsigntemplatepackagesignerGetObjectV1Response>> EzsigntemplatepackagesignerGetObjectV1WithHttpInfoAsync (int pkiEzsigntemplatepackagesignerID, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Retrieve an existing Ezsigntemplatepackagesigner
        /// </summary>
        /// <remarks>
    ...
    public partial class ObjectEzsigntemplatepackagesignerApi : IObjectEzsigntemplatepackagesignerApi
    {
        ...
        /// <returns>EzsigntemplatepackagesignerGetObjectV1Response</returns>
        [Obsolete]
        public EzsigntemplatepackagesignerGetObjectV1Response EzsigntemplatepackagesignerGetObjectV1 (int pkiEzsigntemplatepackagesignerID)
        {
             ApiResponse<EzsigntemplatepackagesignerGetObjectV1Response> localVarResponse = EzsigntemplatepackagesignerGetObjectV1WithHttpInfo(pkiEzsigntemplatepackagesignerID);
             return localVarResponse.Data;
        }
        ...
        /// <returns>ApiResponse of EzsigntemplatepackagesignerGetObjectV1Response</returns>
        [Obsolete]
        public ApiResponse<EzsigntemplatepackagesignerGetObjectV1Response> EzsigntemplatepackagesignerGetObjectV1WithHttpInfo (int pkiEzsigntemplatepackagesignerID)
        {
            // verify the required parameter 'pkiEzsigntemplatepackagesignerID' is set
            if (pkiEzsigntemplatepackagesignerID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzsigntemplatepackagesignerID' when calling ObjectEzsigntemplatepackagesignerApi->EzsigntemplatepackagesignerGetObjectV1");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("EzsigntemplatepackagesignerGetObjectV1", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<EzsigntemplatepackagesignerGetObjectV1Response>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (EzsigntemplatepackagesignerGetObjectV1Response) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(EzsigntemplatepackagesignerGetObjectV1Response)));
        }
        ...
        /// <returns>Task of EzsigntemplatepackagesignerGetObjectV1Response</returns>
        [Obsolete]
        public async System.Threading.Tasks.Task<EzsigntemplatepackagesignerGetObjectV1Response> EzsigntemplatepackagesignerGetObjectV1Async (int pkiEzsigntemplatepackagesignerID, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<EzsigntemplatepackagesignerGetObjectV1Response> localVarResponse = await EzsigntemplatepackagesignerGetObjectV1WithHttpInfoAsync(pkiEzsigntemplatepackagesignerID, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <returns>Task of ApiResponse (EzsigntemplatepackagesignerGetObjectV1Response)</returns>
        [Obsolete]
        public async System.Threading.Tasks.Task<ApiResponse<EzsigntemplatepackagesignerGetObjectV1Response>> EzsigntemplatepackagesignerGetObjectV1WithHttpInfoAsync (int pkiEzsigntemplatepackagesignerID, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'pkiEzsigntemplatepackagesignerID' is set
            if (pkiEzsigntemplatepackagesignerID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzsigntemplatepackagesignerID' when calling ObjectEzsigntemplatepackagesignerApi->EzsigntemplatepackagesignerGetObjectV1");
