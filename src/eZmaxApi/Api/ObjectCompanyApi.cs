...
namespace eZmaxApi.Api
{
    ...
    /// </summary>
    public interface IObjectCompanyApi : IApiAccessor
    {
    ...
    public partial class ObjectCompanyApi : IObjectCompanyApi
    {
        ...
        /// <returns></returns>
        public ObjectCompanyApi(eZmaxApi.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse<CompanyGetAutocompleteV2Response> CompanyGetAutocompleteV2WithHttpInfo (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?))
        {
            ...
            {
                Exception exception = ExceptionFactory("CompanyGetAutocompleteV2", localVarResponse);
