...
namespace eZmaxApi.Api
{
    ...
    public interface IObjectFranchiseofficeApi : IApiAccessor
    {
        ...
        [Obsolete]
        CommonGetAutocompleteV1Response FranchiseofficeGetAutocompleteV1 (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?));
        ...
        [Obsolete]
        ApiResponse<CommonGetAutocompleteV1Response> FranchiseofficeGetAutocompleteV1WithHttpInfo (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?));
        /// <summary>
        /// Retrieve Franchiseoffices and IDs
        /// </summary>
        /// <remarks>
        ...
        [Obsolete]
        System.Threading.Tasks.Task<ApiResponse<CommonGetAutocompleteV1Response>> FranchiseofficeGetAutocompleteV1WithHttpInfoAsync (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Retrieve Franchiseoffices and IDs
        /// </summary>
        /// <remarks>
    ...
    public partial class ObjectFranchiseofficeApi : IObjectFranchiseofficeApi
    {
        ...
        /// <returns>CommonGetAutocompleteV1Response</returns>
        [Obsolete]
        public CommonGetAutocompleteV1Response FranchiseofficeGetAutocompleteV1 (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?))
        {
             ApiResponse<CommonGetAutocompleteV1Response> localVarResponse = FranchiseofficeGetAutocompleteV1WithHttpInfo(sSelector, eFilterActive, sQuery, acceptLanguage);
        ...
        /// <returns>ApiResponse of CommonGetAutocompleteV1Response</returns>
        [Obsolete]
        public ApiResponse<CommonGetAutocompleteV1Response> FranchiseofficeGetAutocompleteV1WithHttpInfo (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?))
        {
        ...
        {
             ApiResponse<CommonGetAutocompleteV1Response> localVarResponse = await FranchiseofficeGetAutocompleteV1WithHttpInfoAsync(sSelector, eFilterActive, sQuery, acceptLanguage, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <returns>Task of ApiResponse (CommonGetAutocompleteV1Response)</returns>
        [Obsolete]
        public async System.Threading.Tasks.Task<ApiResponse<CommonGetAutocompleteV1Response>> FranchiseofficeGetAutocompleteV1WithHttpInfoAsync (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'sSelector' is set
            if (sSelector == null)
                throw new ApiException(400, "Missing required parameter 'sSelector' when calling ObjectFranchiseofficeApi->FranchiseofficeGetAutocompleteV1");
        ...
        public ApiResponse<FranchiseofficeGetAutocompleteV2Response> FranchiseofficeGetAutocompleteV2WithHttpInfo (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?))
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("FranchiseofficeGetAutocompleteV2", localVarResponse);
                if (exception != null) throw exception;
            }
