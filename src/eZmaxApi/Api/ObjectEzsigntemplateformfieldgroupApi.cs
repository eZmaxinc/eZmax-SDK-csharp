...
namespace eZmaxApi.Api
{
    ...
    public interface IObjectEzsigntemplateformfieldgroupApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<EzsigntemplateformfieldgroupDeleteObjectV1Response> EzsigntemplateformfieldgroupDeleteObjectV1Async(int pkiEzsigntemplateformfieldgroupID, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<EzsigntemplateformfieldgroupGetObjectV2Response> EzsigntemplateformfieldgroupGetObjectV2Async(int pkiEzsigntemplateformfieldgroupID, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<EzsigntemplateformfieldgroupGetObjectV2Response>> EzsigntemplateformfieldgroupGetObjectV2WithHttpInfoAsync(int pkiEzsigntemplateformfieldgroupID, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ObjectEzsigntemplateformfieldgroupApi : IObjectEzsigntemplateformfieldgroupApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of EzsigntemplateformfieldgroupDeleteObjectV1Response</returns>
        public async System.Threading.Tasks.Task<EzsigntemplateformfieldgroupDeleteObjectV1Response> EzsigntemplateformfieldgroupDeleteObjectV1Async(int pkiEzsigntemplateformfieldgroupID, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of EzsigntemplateformfieldgroupGetObjectV2Response</returns>
        public async System.Threading.Tasks.Task<EzsigntemplateformfieldgroupGetObjectV2Response> EzsigntemplateformfieldgroupGetObjectV2Async(int pkiEzsigntemplateformfieldgroupID, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
