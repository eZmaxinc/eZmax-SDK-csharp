...
namespace eZmaxApi.Api
{
    ...
    public interface IObjectEzsigntemplateformfieldgroupApi : IApiAccessor
    {
        ...
        ApiResponse<EzsigntemplateformfieldgroupGetObjectV2Response> EzsigntemplateformfieldgroupGetObjectV2WithHttpInfo (int pkiEzsigntemplateformfieldgroupID);
        ...
        System.Threading.Tasks.Task<EzsigntemplateformfieldgroupGetObjectV2Response> EzsigntemplateformfieldgroupGetObjectV2Async (int pkiEzsigntemplateformfieldgroupID, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<EzsigntemplateformfieldgroupGetObjectV2Response>> EzsigntemplateformfieldgroupGetObjectV2WithHttpInfoAsync (int pkiEzsigntemplateformfieldgroupID, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class ObjectEzsigntemplateformfieldgroupApi : IObjectEzsigntemplateformfieldgroupApi
    {
        ...
        /// <param name="pkiEzsigntemplateformfieldgroupID"></param>
        /// <returns>EzsigntemplateformfieldgroupGetObjectV2Response</returns>
        public EzsigntemplateformfieldgroupGetObjectV2Response EzsigntemplateformfieldgroupGetObjectV2 (int pkiEzsigntemplateformfieldgroupID)
        {
             ApiResponse<EzsigntemplateformfieldgroupGetObjectV2Response> localVarResponse = EzsigntemplateformfieldgroupGetObjectV2WithHttpInfo(pkiEzsigntemplateformfieldgroupID);
             return localVarResponse.Data;
        }
        ...
        /// <param name="pkiEzsigntemplateformfieldgroupID"></param>
        /// <returns>ApiResponse of EzsigntemplateformfieldgroupGetObjectV2Response</returns>
        public ApiResponse<EzsigntemplateformfieldgroupGetObjectV2Response> EzsigntemplateformfieldgroupGetObjectV2WithHttpInfo (int pkiEzsigntemplateformfieldgroupID)
        {
            // verify the required parameter 'pkiEzsigntemplateformfieldgroupID' is set
            if (pkiEzsigntemplateformfieldgroupID == null)
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("EzsigntemplateformfieldgroupGetObjectV2", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of EzsigntemplateformfieldgroupGetObjectV2Response</returns>
        public async System.Threading.Tasks.Task<EzsigntemplateformfieldgroupGetObjectV2Response> EzsigntemplateformfieldgroupGetObjectV2Async (int pkiEzsigntemplateformfieldgroupID, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<EzsigntemplateformfieldgroupGetObjectV2Response> localVarResponse = await EzsigntemplateformfieldgroupGetObjectV2WithHttpInfoAsync(pkiEzsigntemplateformfieldgroupID, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (EzsigntemplateformfieldgroupGetObjectV2Response)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<EzsigntemplateformfieldgroupGetObjectV2Response>> EzsigntemplateformfieldgroupGetObjectV2WithHttpInfoAsync (int pkiEzsigntemplateformfieldgroupID, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'pkiEzsigntemplateformfieldgroupID' is set
            if (pkiEzsigntemplateformfieldgroupID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzsigntemplateformfieldgroupID' when calling ObjectEzsigntemplateformfieldgroupApi->EzsigntemplateformfieldgroupGetObjectV2");
