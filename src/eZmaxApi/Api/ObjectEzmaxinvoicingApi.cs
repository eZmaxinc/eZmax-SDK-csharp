...
namespace eZmaxApi.Api
{
    ...
    public interface IObjectEzmaxinvoicingApi : IApiAccessor
    {
        ...
        /// <returns>EzmaxinvoicingGetObjectV1Response</returns>
        [Obsolete]
        ...
        /// <exception cref="eZmaxApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="pkiEzmaxinvoicingID"></param>
        /// <returns>ApiResponse of EzmaxinvoicingGetObjectV1Response</returns>
        [Obsolete]
        ApiResponse<EzmaxinvoicingGetObjectV1Response> EzmaxinvoicingGetObjectV1WithHttpInfo (int pkiEzmaxinvoicingID);
        /// <summary>
        /// Retrieve an existing Ezmaxinvoicing
        /// </summary>
        /// <remarks>
        ...
        /// <param name="pkiEzmaxinvoicingID"></param>
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of EzmaxinvoicingGetObjectV1Response</returns>
        [Obsolete]
        System.Threading.Tasks.Task<EzmaxinvoicingGetObjectV1Response> EzmaxinvoicingGetObjectV1Async (int pkiEzmaxinvoicingID, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="pkiEzmaxinvoicingID"></param>
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (EzmaxinvoicingGetObjectV1Response)</returns>
        [Obsolete]
        System.Threading.Tasks.Task<ApiResponse<EzmaxinvoicingGetObjectV1Response>> EzmaxinvoicingGetObjectV1WithHttpInfoAsync (int pkiEzmaxinvoicingID, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Retrieve an existing Ezmaxinvoicing
        /// </summary>
        /// <remarks>
    ...
    public partial class ObjectEzmaxinvoicingApi : IObjectEzmaxinvoicingApi
    {
        ...
        /// <returns>EzmaxinvoicingGetObjectV1Response</returns>
        [Obsolete]
        public EzmaxinvoicingGetObjectV1Response EzmaxinvoicingGetObjectV1 (int pkiEzmaxinvoicingID)
        {
             ApiResponse<EzmaxinvoicingGetObjectV1Response> localVarResponse = EzmaxinvoicingGetObjectV1WithHttpInfo(pkiEzmaxinvoicingID);
             return localVarResponse.Data;
        }
        ...
        /// <returns>ApiResponse of EzmaxinvoicingGetObjectV1Response</returns>
        [Obsolete]
        public ApiResponse<EzmaxinvoicingGetObjectV1Response> EzmaxinvoicingGetObjectV1WithHttpInfo (int pkiEzmaxinvoicingID)
        {
            // verify the required parameter 'pkiEzmaxinvoicingID' is set
            if (pkiEzmaxinvoicingID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzmaxinvoicingID' when calling ObjectEzmaxinvoicingApi->EzmaxinvoicingGetObjectV1");

            var localVarPath = "/1/object/ezmaxinvoicing/{pkiEzmaxinvoicingID}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("EzmaxinvoicingGetObjectV1", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<EzmaxinvoicingGetObjectV1Response>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (EzmaxinvoicingGetObjectV1Response) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(EzmaxinvoicingGetObjectV1Response)));
        }
        ...
        /// <returns>Task of EzmaxinvoicingGetObjectV1Response</returns>
        [Obsolete]
        public async System.Threading.Tasks.Task<EzmaxinvoicingGetObjectV1Response> EzmaxinvoicingGetObjectV1Async (int pkiEzmaxinvoicingID, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<EzmaxinvoicingGetObjectV1Response> localVarResponse = await EzmaxinvoicingGetObjectV1WithHttpInfoAsync(pkiEzmaxinvoicingID, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <returns>Task of ApiResponse (EzmaxinvoicingGetObjectV1Response)</returns>
        [Obsolete]
        public async System.Threading.Tasks.Task<ApiResponse<EzmaxinvoicingGetObjectV1Response>> EzmaxinvoicingGetObjectV1WithHttpInfoAsync (int pkiEzmaxinvoicingID, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'pkiEzmaxinvoicingID' is set
            if (pkiEzmaxinvoicingID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzmaxinvoicingID' when calling ObjectEzmaxinvoicingApi->EzmaxinvoicingGetObjectV1");
