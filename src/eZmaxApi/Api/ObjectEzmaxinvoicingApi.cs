...
namespace eZmaxApi.Api
{
    ...
    public interface IObjectEzmaxinvoicingApiSync : IApiAccessor
    {
        ...
        [Obsolete]
        CommonGetAutocompleteV1Response EzmaxinvoicingGetAutocompleteV1(string sSelector, string? eFilterActive = default(string?), string? sQuery = default(string?), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), int operationIndex = 0);
        ...
        [Obsolete]
        ApiResponse<CommonGetAutocompleteV1Response> EzmaxinvoicingGetAutocompleteV1WithHttpInfo(string sSelector, string? eFilterActive = default(string?), string? sQuery = default(string?), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), int operationIndex = 0);
        /// <summary>
        /// Retrieve Ezmaxinvoicings and IDs
        /// </summary>
        /// <remarks>
    ...
    public partial class ObjectEzmaxinvoicingApi : IObjectEzmaxinvoicingApi
    {
        ...
        /// <returns>CommonGetAutocompleteV1Response</returns>
        [Obsolete]
        public CommonGetAutocompleteV1Response EzmaxinvoicingGetAutocompleteV1(string sSelector, string? eFilterActive = default(string?), string? sQuery = default(string?), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), int operationIndex = 0)
        {
            eZmaxApi.Client.ApiResponse<CommonGetAutocompleteV1Response> localVarResponse = EzmaxinvoicingGetAutocompleteV1WithHttpInfo(sSelector, eFilterActive, sQuery, acceptLanguage);
        ...
        /// <returns>ApiResponse of CommonGetAutocompleteV1Response</returns>
        [Obsolete]
        public eZmaxApi.Client.ApiResponse<CommonGetAutocompleteV1Response> EzmaxinvoicingGetAutocompleteV1WithHttpInfo(string sSelector, string? eFilterActive = default(string?), string? sQuery = default(string?), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), int operationIndex = 0)
        {
            // verify the required parameter 'sSelector' is set
            if (sSelector == null)
            {
                throw new eZmaxApi.Client.ApiException(400, "Missing required parameter 'sSelector' when calling ObjectEzmaxinvoicingApi->EzmaxinvoicingGetAutocompleteV1");
            }
            ...
            localVarRequestOptions.Operation = "ObjectEzmaxinvoicingApi.EzmaxinvoicingGetAutocompleteV1";
            ...
            var localVarResponse = this.Client.Get<CommonGetAutocompleteV1Response>("/1/object/ezmaxinvoicing/getAutocomplete/{sSelector}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("EzmaxinvoicingGetAutocompleteV1", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            eZmaxApi.Client.ApiResponse<CommonGetAutocompleteV1Response> localVarResponse = await EzmaxinvoicingGetAutocompleteV1WithHttpInfoAsync(sSelector, eFilterActive, sQuery, acceptLanguage, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <returns>Task of ApiResponse (CommonGetAutocompleteV1Response)</returns>
        [Obsolete]
        public async System.Threading.Tasks.Task<eZmaxApi.Client.ApiResponse<CommonGetAutocompleteV1Response>> EzmaxinvoicingGetAutocompleteV1WithHttpInfoAsync(string sSelector, string? eFilterActive = default(string?), string? sQuery = default(string?), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'sSelector' is set
            if (sSelector == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<CommonGetAutocompleteV1Response>("/1/object/ezmaxinvoicing/getAutocomplete/{sSelector}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
