...
namespace eZmaxApi.Api
{
    ...
    public interface IObjectDepartmentApiSync : IApiAccessor
    {
        ...
        DepartmentGetAutocompleteV2Response DepartmentGetAutocompleteV2(string sSelector, string? eFilterActive = default, string? sQuery = default, HeaderAcceptLanguage? acceptLanguage = default, int operationIndex = 0);
        ...
        ApiResponse<DepartmentGetAutocompleteV2Response> DepartmentGetAutocompleteV2WithHttpInfo(string sSelector, string? eFilterActive = default, string? sQuery = default, HeaderAcceptLanguage? acceptLanguage = default, int operationIndex = 0);
    ...
    public interface IObjectDepartmentApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<DepartmentGetAutocompleteV2Response> DepartmentGetAutocompleteV2Async(string sSelector, string? eFilterActive = default, string? sQuery = default, HeaderAcceptLanguage? acceptLanguage = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<DepartmentGetAutocompleteV2Response>> DepartmentGetAutocompleteV2WithHttpInfoAsync(string sSelector, string? eFilterActive = default, string? sQuery = default, HeaderAcceptLanguage? acceptLanguage = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
    ...
    public partial class ObjectDepartmentApi : IObjectDepartmentApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>DepartmentGetAutocompleteV2Response</returns>
        public DepartmentGetAutocompleteV2Response DepartmentGetAutocompleteV2(string sSelector, string? eFilterActive = default, string? sQuery = default, HeaderAcceptLanguage? acceptLanguage = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DepartmentGetAutocompleteV2Response</returns>
        public eZmaxApi.Client.ApiResponse<DepartmentGetAutocompleteV2Response> DepartmentGetAutocompleteV2WithHttpInfo(string sSelector, string? eFilterActive = default, string? sQuery = default, HeaderAcceptLanguage? acceptLanguage = default, int operationIndex = 0)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DepartmentGetAutocompleteV2Response)</returns>
        public async System.Threading.Tasks.Task<eZmaxApi.Client.ApiResponse<DepartmentGetAutocompleteV2Response>> DepartmentGetAutocompleteV2WithHttpInfoAsync(string sSelector, string? eFilterActive = default, string? sQuery = default, HeaderAcceptLanguage? acceptLanguage = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'sSelector' is set
            if (sSelector == null)
            {
