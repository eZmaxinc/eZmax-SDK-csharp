...
namespace eZmaxApi.Api
{
    ...
    public interface IObjectEzsigntemplateApi : IApiAccessor
    {
        ...
        CommonGetAutocompleteV1Response EzsigntemplateGetAutocompleteV1 (string sSelector, string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?));
        ...
        ApiResponse<CommonGetAutocompleteV1Response> EzsigntemplateGetAutocompleteV1WithHttpInfo (string sSelector, string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?));
        /// <summary>
        ...
        System.Threading.Tasks.Task<CommonGetAutocompleteV1Response> EzsigntemplateGetAutocompleteV1Async (string sSelector, string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<CommonGetAutocompleteV1Response>> EzsigntemplateGetAutocompleteV1WithHttpInfoAsync (string sSelector, string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Retrieve Ezsigntemplate list
        /// </summary>
        /// <remarks>
    ...
    public partial class ObjectEzsigntemplateApi : IObjectEzsigntemplateApi
    {
        ...
        /// <param name="acceptLanguage"> (optional)</param>
        /// <returns>CommonGetAutocompleteV1Response</returns>
        public CommonGetAutocompleteV1Response EzsigntemplateGetAutocompleteV1 (string sSelector, string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?))
        {
             ApiResponse<CommonGetAutocompleteV1Response> localVarResponse = EzsigntemplateGetAutocompleteV1WithHttpInfo(sSelector, sQuery, acceptLanguage);
             return localVarResponse.Data;
        }
        ...
        /// <param name="acceptLanguage"> (optional)</param>
        /// <returns>ApiResponse of CommonGetAutocompleteV1Response</returns>
        public ApiResponse<CommonGetAutocompleteV1Response> EzsigntemplateGetAutocompleteV1WithHttpInfo (string sSelector, string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of CommonGetAutocompleteV1Response</returns>
        public async System.Threading.Tasks.Task<CommonGetAutocompleteV1Response> EzsigntemplateGetAutocompleteV1Async (string sSelector, string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<CommonGetAutocompleteV1Response> localVarResponse = await EzsigntemplateGetAutocompleteV1WithHttpInfoAsync(sSelector, sQuery, acceptLanguage, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (CommonGetAutocompleteV1Response)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<CommonGetAutocompleteV1Response>> EzsigntemplateGetAutocompleteV1WithHttpInfoAsync (string sSelector, string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'sSelector' is set
            if (sSelector == null)
                throw new ApiException(400, "Missing required parameter 'sSelector' when calling ObjectEzsigntemplateApi->EzsigntemplateGetAutocompleteV1");
