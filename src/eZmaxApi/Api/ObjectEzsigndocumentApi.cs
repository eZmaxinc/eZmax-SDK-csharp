...
namespace eZmaxApi.Api
{
    ...
    public partial class ObjectEzsigndocumentApi : IObjectEzsigndocumentApi
    {
        ...
        public ApiResponse<Object> EzsigndocumentGetChildrenV1WithHttpInfo (int pkiEzsigndocumentID)
        {
            // verify the required parameter 'pkiEzsigndocumentID' is set
            if (pkiEzsigndocumentID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzsigndocumentID' when calling ObjectEzsigndocumentApi->EzsigndocumentGetChildrenV1");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("EzsigndocumentGetChildrenV1", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        {
             await EzsigndocumentGetChildrenV1WithHttpInfoAsync(pkiEzsigndocumentID, cancellationToken);
        ...
        {
             ApiResponse<System.IO.Stream> localVarResponse = EzsigndocumentGetFormDataV1WithHttpInfo(pkiEzsigndocumentID);
             return localVarResponse.Data;
        }
        ...
        {
             ApiResponse<System.IO.Stream> localVarResponse = await EzsigndocumentGetFormDataV1WithHttpInfoAsync(pkiEzsigndocumentID, cancellationToken);
             return localVarResponse.Data;
