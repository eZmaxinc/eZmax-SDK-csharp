...
namespace eZmaxApi.Api
{
    ...
    public interface IModuleUserApiSync : IApiAccessor
    {
        ...
        UserCreateEzsignuserV1Response UserCreateEzsignuserV1(List<UserCreateEzsignuserV1Request> userCreateEzsignuserV1Request, int operationIndex = 0);
        ...
        ApiResponse<UserCreateEzsignuserV1Response> UserCreateEzsignuserV1WithHttpInfo(List<UserCreateEzsignuserV1Request> userCreateEzsignuserV1Request, int operationIndex = 0);
    ...
    public interface IModuleUserApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<UserCreateEzsignuserV1Response> UserCreateEzsignuserV1Async(List<UserCreateEzsignuserV1Request> userCreateEzsignuserV1Request, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<UserCreateEzsignuserV1Response>> UserCreateEzsignuserV1WithHttpInfoAsync(List<UserCreateEzsignuserV1Request> userCreateEzsignuserV1Request, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
    ...
    public partial class ModuleUserApi : IModuleUserApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>UserCreateEzsignuserV1Response</returns>
        public UserCreateEzsignuserV1Response UserCreateEzsignuserV1(List<UserCreateEzsignuserV1Request> userCreateEzsignuserV1Request, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of UserCreateEzsignuserV1Response</returns>
        public eZmaxApi.Client.ApiResponse<UserCreateEzsignuserV1Response> UserCreateEzsignuserV1WithHttpInfo(List<UserCreateEzsignuserV1Request> userCreateEzsignuserV1Request, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "ModuleUserApi.UserCreateEzsignuserV1";
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of UserCreateEzsignuserV1Response</returns>
        public async System.Threading.Tasks.Task<UserCreateEzsignuserV1Response> UserCreateEzsignuserV1Async(List<UserCreateEzsignuserV1Request> userCreateEzsignuserV1Request, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (UserCreateEzsignuserV1Response)</returns>
        public async System.Threading.Tasks.Task<eZmaxApi.Client.ApiResponse<UserCreateEzsignuserV1Response>> UserCreateEzsignuserV1WithHttpInfoAsync(List<UserCreateEzsignuserV1Request> userCreateEzsignuserV1Request, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'userCreateEzsignuserV1Request' is set
            if (userCreateEzsignuserV1Request == null)
            {
