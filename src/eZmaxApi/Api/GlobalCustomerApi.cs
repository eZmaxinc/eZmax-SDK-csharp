...
namespace eZmaxApi.Api
{
    ...
    public interface IGlobalCustomerApiSync : IApiAccessor
    {
        ...
        [Obsolete]
        GlobalCustomerGetEndpointV1Response GlobalCustomerGetEndpointV1(string pksCustomerCode, string? sInfrastructureproductCode = default(string?), int operationIndex = 0);
        ...
        [Obsolete]
        ApiResponse<GlobalCustomerGetEndpointV1Response> GlobalCustomerGetEndpointV1WithHttpInfo(string pksCustomerCode, string? sInfrastructureproductCode = default(string?), int operationIndex = 0);
    ...
    public partial class GlobalCustomerApi : IGlobalCustomerApi
    {
        ...
        /// <returns>GlobalCustomerGetEndpointV1Response</returns>
        [Obsolete]
        public GlobalCustomerGetEndpointV1Response GlobalCustomerGetEndpointV1(string pksCustomerCode, string? sInfrastructureproductCode = default(string?), int operationIndex = 0)
        {
        ...
        /// <returns>ApiResponse of GlobalCustomerGetEndpointV1Response</returns>
        [Obsolete]
        public eZmaxApi.Client.ApiResponse<GlobalCustomerGetEndpointV1Response> GlobalCustomerGetEndpointV1WithHttpInfo(string pksCustomerCode, string? sInfrastructureproductCode = default(string?), int operationIndex = 0)
        {
