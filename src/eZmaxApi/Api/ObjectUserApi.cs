...
namespace eZmaxApi.Api
{
    ...
    public interface IObjectUserApi : IApiAccessor
    {
        ...
        [Obsolete]
        CommonGetAutocompleteV1Response UserGetAutocompleteV1 (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?));
        ...
        [Obsolete]
        ApiResponse<CommonGetAutocompleteV1Response> UserGetAutocompleteV1WithHttpInfo (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?));
        /// <summary>
        /// Retrieve Users and IDs
        /// </summary>
        /// <remarks>
        ...
        [Obsolete]
        System.Threading.Tasks.Task<CommonGetAutocompleteV1Response> UserGetAutocompleteV1Async (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), CancellationToken cancellationToken = default(CancellationToken));
        ...
        [Obsolete]
        System.Threading.Tasks.Task<ApiResponse<CommonGetAutocompleteV1Response>> UserGetAutocompleteV1WithHttpInfoAsync (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Retrieve Users and IDs
        /// </summary>
        /// <remarks>
    ...
    public partial class ObjectUserApi : IObjectUserApi
    {
        ...
        /// <returns>CommonGetAutocompleteV1Response</returns>
        [Obsolete]
        public CommonGetAutocompleteV1Response UserGetAutocompleteV1 (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?))
        {
             ApiResponse<CommonGetAutocompleteV1Response> localVarResponse = UserGetAutocompleteV1WithHttpInfo(sSelector, eFilterActive, sQuery, acceptLanguage);
        ...
        /// <returns>ApiResponse of CommonGetAutocompleteV1Response</returns>
        [Obsolete]
        public ApiResponse<CommonGetAutocompleteV1Response> UserGetAutocompleteV1WithHttpInfo (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?))
        {
        ...
        /// <returns>Task of CommonGetAutocompleteV1Response</returns>
        [Obsolete]
        public async System.Threading.Tasks.Task<CommonGetAutocompleteV1Response> UserGetAutocompleteV1Async (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<CommonGetAutocompleteV1Response> localVarResponse = await UserGetAutocompleteV1WithHttpInfoAsync(sSelector, eFilterActive, sQuery, acceptLanguage, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <returns>Task of ApiResponse (CommonGetAutocompleteV1Response)</returns>
        [Obsolete]
        public async System.Threading.Tasks.Task<ApiResponse<CommonGetAutocompleteV1Response>> UserGetAutocompleteV1WithHttpInfoAsync (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'sSelector' is set
            if (sSelector == null)
                throw new ApiException(400, "Missing required parameter 'sSelector' when calling ObjectUserApi->UserGetAutocompleteV1");
