...
namespace eZmaxApi.Api
{
    ...
    public interface IObjectEzsigntemplatepackageApi : IApiAccessor
    {
        ...
        [Obsolete]
        CommonGetAutocompleteDisabledV1Response EzsigntemplatepackageGetAutocompleteV1 (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?));
        ...
        [Obsolete]
        ApiResponse<CommonGetAutocompleteDisabledV1Response> EzsigntemplatepackageGetAutocompleteV1WithHttpInfo (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?));
        /// <summary>
        /// Retrieve Ezsigntemplatepackages and IDs
        /// </summary>
        /// <remarks>
    ...
    public partial class ObjectEzsigntemplatepackageApi : IObjectEzsigntemplatepackageApi
    {
        ...
        /// <returns>CommonGetAutocompleteDisabledV1Response</returns>
        [Obsolete]
        public CommonGetAutocompleteDisabledV1Response EzsigntemplatepackageGetAutocompleteV1 (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?))
        {
             ApiResponse<CommonGetAutocompleteDisabledV1Response> localVarResponse = EzsigntemplatepackageGetAutocompleteV1WithHttpInfo(sSelector, eFilterActive, sQuery, acceptLanguage);
             return localVarResponse.Data;
        }
        ...
        /// <returns>ApiResponse of CommonGetAutocompleteDisabledV1Response</returns>
        [Obsolete]
        public ApiResponse<CommonGetAutocompleteDisabledV1Response> EzsigntemplatepackageGetAutocompleteV1WithHttpInfo (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?))
        {
        ...
        /// <returns>Task of CommonGetAutocompleteDisabledV1Response</returns>
        [Obsolete]
        public async System.Threading.Tasks.Task<CommonGetAutocompleteDisabledV1Response> EzsigntemplatepackageGetAutocompleteV1Async (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<CommonGetAutocompleteDisabledV1Response> localVarResponse = await EzsigntemplatepackageGetAutocompleteV1WithHttpInfoAsync(sSelector, eFilterActive, sQuery, acceptLanguage, cancellationToken);
             return localVarResponse.Data;
