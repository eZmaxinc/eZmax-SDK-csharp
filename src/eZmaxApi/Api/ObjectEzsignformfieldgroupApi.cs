...
namespace eZmaxApi.Api
{
    ...
    public interface IObjectEzsignformfieldgroupApi : IApiAccessor
    {
        ...
        ApiResponse<EzsignformfieldgroupGetObjectV2Response> EzsignformfieldgroupGetObjectV2WithHttpInfo (int pkiEzsignformfieldgroupID);
        ...
        System.Threading.Tasks.Task<EzsignformfieldgroupGetObjectV2Response> EzsignformfieldgroupGetObjectV2Async (int pkiEzsignformfieldgroupID, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<EzsignformfieldgroupGetObjectV2Response>> EzsignformfieldgroupGetObjectV2WithHttpInfoAsync (int pkiEzsignformfieldgroupID, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class ObjectEzsignformfieldgroupApi : IObjectEzsignformfieldgroupApi
    {
        ...
        /// <param name="pkiEzsignformfieldgroupID"></param>
        /// <returns>EzsignformfieldgroupGetObjectV2Response</returns>
        public EzsignformfieldgroupGetObjectV2Response EzsignformfieldgroupGetObjectV2 (int pkiEzsignformfieldgroupID)
        {
             ApiResponse<EzsignformfieldgroupGetObjectV2Response> localVarResponse = EzsignformfieldgroupGetObjectV2WithHttpInfo(pkiEzsignformfieldgroupID);
             return localVarResponse.Data;
        }
        ...
        /// <param name="pkiEzsignformfieldgroupID"></param>
        /// <returns>ApiResponse of EzsignformfieldgroupGetObjectV2Response</returns>
        public ApiResponse<EzsignformfieldgroupGetObjectV2Response> EzsignformfieldgroupGetObjectV2WithHttpInfo (int pkiEzsignformfieldgroupID)
        {
            // verify the required parameter 'pkiEzsignformfieldgroupID' is set
            if (pkiEzsignformfieldgroupID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzsignformfieldgroupID' when calling ObjectEzsignformfieldgroupApi->EzsignformfieldgroupGetObjectV2");

            var localVarPath = "/2/object/ezsignformfieldgroup/{pkiEzsignformfieldgroupID}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("EzsignformfieldgroupGetObjectV2", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<EzsignformfieldgroupGetObjectV2Response>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (EzsignformfieldgroupGetObjectV2Response) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(EzsignformfieldgroupGetObjectV2Response)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of EzsignformfieldgroupGetObjectV2Response</returns>
        public async System.Threading.Tasks.Task<EzsignformfieldgroupGetObjectV2Response> EzsignformfieldgroupGetObjectV2Async (int pkiEzsignformfieldgroupID, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<EzsignformfieldgroupGetObjectV2Response> localVarResponse = await EzsignformfieldgroupGetObjectV2WithHttpInfoAsync(pkiEzsignformfieldgroupID, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (EzsignformfieldgroupGetObjectV2Response)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<EzsignformfieldgroupGetObjectV2Response>> EzsignformfieldgroupGetObjectV2WithHttpInfoAsync (int pkiEzsignformfieldgroupID, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'pkiEzsignformfieldgroupID' is set
            if (pkiEzsignformfieldgroupID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzsignformfieldgroupID' when calling ObjectEzsignformfieldgroupApi->EzsignformfieldgroupGetObjectV2");
