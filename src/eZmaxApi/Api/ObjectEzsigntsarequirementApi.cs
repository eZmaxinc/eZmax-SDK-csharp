...
namespace eZmaxApi.Api
{
    ...
    public interface IObjectEzsigntsarequirementApiSync : IApiAccessor
    {
        ...
        EzsigntsarequirementGetAutocompleteV2Response EzsigntsarequirementGetAutocompleteV2(string sSelector, int? fkiEzsignfoldertypeID = default(int?), string? eFilterActive = default(string?), string? sQuery = default(string?), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), int operationIndex = 0);
        ...
        ApiResponse<EzsigntsarequirementGetAutocompleteV2Response> EzsigntsarequirementGetAutocompleteV2WithHttpInfo(string sSelector, int? fkiEzsignfoldertypeID = default(int?), string? eFilterActive = default(string?), string? sQuery = default(string?), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), int operationIndex = 0);
    ...
    public partial class ObjectEzsigntsarequirementApi : IObjectEzsigntsarequirementApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>EzsigntsarequirementGetAutocompleteV2Response</returns>
        public EzsigntsarequirementGetAutocompleteV2Response EzsigntsarequirementGetAutocompleteV2(string sSelector, int? fkiEzsignfoldertypeID = default(int?), string? eFilterActive = default(string?), string? sQuery = default(string?), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of EzsigntsarequirementGetAutocompleteV2Response</returns>
        public eZmaxApi.Client.ApiResponse<EzsigntsarequirementGetAutocompleteV2Response> EzsigntsarequirementGetAutocompleteV2WithHttpInfo(string sSelector, int? fkiEzsignfoldertypeID = default(int?), string? eFilterActive = default(string?), string? sQuery = default(string?), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), int operationIndex = 0)
        {
