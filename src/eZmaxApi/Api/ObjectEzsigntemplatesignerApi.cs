...
namespace eZmaxApi.Api
{
    ...
    public interface IObjectEzsigntemplatesignerApi : IApiAccessor
    {
        ...
        ApiResponse<EzsigntemplatesignerGetObjectV2Response> EzsigntemplatesignerGetObjectV2WithHttpInfo (int pkiEzsigntemplatesignerID);
        ...
        System.Threading.Tasks.Task<EzsigntemplatesignerGetObjectV2Response> EzsigntemplatesignerGetObjectV2Async (int pkiEzsigntemplatesignerID, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<EzsigntemplatesignerGetObjectV2Response>> EzsigntemplatesignerGetObjectV2WithHttpInfoAsync (int pkiEzsigntemplatesignerID, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class ObjectEzsigntemplatesignerApi : IObjectEzsigntemplatesignerApi
    {
        ...
        /// <param name="pkiEzsigntemplatesignerID"></param>
        /// <returns>EzsigntemplatesignerGetObjectV2Response</returns>
        public EzsigntemplatesignerGetObjectV2Response EzsigntemplatesignerGetObjectV2 (int pkiEzsigntemplatesignerID)
        {
             ApiResponse<EzsigntemplatesignerGetObjectV2Response> localVarResponse = EzsigntemplatesignerGetObjectV2WithHttpInfo(pkiEzsigntemplatesignerID);
             return localVarResponse.Data;
        }
        ...
        /// <param name="pkiEzsigntemplatesignerID"></param>
        /// <returns>ApiResponse of EzsigntemplatesignerGetObjectV2Response</returns>
        public ApiResponse<EzsigntemplatesignerGetObjectV2Response> EzsigntemplatesignerGetObjectV2WithHttpInfo (int pkiEzsigntemplatesignerID)
        {
            // verify the required parameter 'pkiEzsigntemplatesignerID' is set
            if (pkiEzsigntemplatesignerID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzsigntemplatesignerID' when calling ObjectEzsigntemplatesignerApi->EzsigntemplatesignerGetObjectV2");

            var localVarPath = "/2/object/ezsigntemplatesigner/{pkiEzsigntemplatesignerID}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("EzsigntemplatesignerGetObjectV2", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<EzsigntemplatesignerGetObjectV2Response>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (EzsigntemplatesignerGetObjectV2Response) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(EzsigntemplatesignerGetObjectV2Response)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of EzsigntemplatesignerGetObjectV2Response</returns>
        public async System.Threading.Tasks.Task<EzsigntemplatesignerGetObjectV2Response> EzsigntemplatesignerGetObjectV2Async (int pkiEzsigntemplatesignerID, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<EzsigntemplatesignerGetObjectV2Response> localVarResponse = await EzsigntemplatesignerGetObjectV2WithHttpInfoAsync(pkiEzsigntemplatesignerID, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (EzsigntemplatesignerGetObjectV2Response)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<EzsigntemplatesignerGetObjectV2Response>> EzsigntemplatesignerGetObjectV2WithHttpInfoAsync (int pkiEzsigntemplatesignerID, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'pkiEzsigntemplatesignerID' is set
            if (pkiEzsigntemplatesignerID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzsigntemplatesignerID' when calling ObjectEzsigntemplatesignerApi->EzsigntemplatesignerGetObjectV2");
