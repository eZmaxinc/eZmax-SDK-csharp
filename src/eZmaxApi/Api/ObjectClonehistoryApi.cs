...
namespace eZmaxApi.Api
{
    ...
    /// </summary>
    public interface IObjectClonehistoryApi : IApiAccessor
    {
    ...
    public partial class ObjectClonehistoryApi : IObjectClonehistoryApi
    {
        ...
        /// <returns></returns>
        public ObjectClonehistoryApi(eZmaxApi.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse<ClonehistoryGetListV1Response> ClonehistoryGetListV1WithHttpInfo (string eOrderBy = default(string), int? iRowMax = default(int?), int? iRowOffset = default(int?), HeaderAcceptLanguage acceptLanguage = default(HeaderAcceptLanguage), string sFilter = default(string))
        {
            ...
            {
                Exception exception = ExceptionFactory("ClonehistoryGetListV1", localVarResponse);
