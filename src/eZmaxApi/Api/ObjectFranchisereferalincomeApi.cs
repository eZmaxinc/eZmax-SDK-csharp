...
namespace eZmaxApi.Api
{
    ...
    public interface IObjectFranchisereferalincomeApiSync : IApiAccessor
    {
        ...
        [Obsolete]
        FranchisereferalincomeCreateObjectV1Response FranchisereferalincomeCreateObjectV1(List<FranchisereferalincomeCreateObjectV1Request> franchisereferalincomeCreateObjectV1Request, int operationIndex = 0);
        ...
        [Obsolete]
        ApiResponse<FranchisereferalincomeCreateObjectV1Response> FranchisereferalincomeCreateObjectV1WithHttpInfo(List<FranchisereferalincomeCreateObjectV1Request> franchisereferalincomeCreateObjectV1Request, int operationIndex = 0);
        /// <summary>
        /// Create a new Franchisereferalincome
        /// </summary>
        /// <remarks>
        ...
        FranchisereferalincomeCreateObjectV2Response FranchisereferalincomeCreateObjectV2(FranchisereferalincomeCreateObjectV2Request franchisereferalincomeCreateObjectV2Request, int operationIndex = 0);
        ...
        ApiResponse<FranchisereferalincomeCreateObjectV2Response> FranchisereferalincomeCreateObjectV2WithHttpInfo(FranchisereferalincomeCreateObjectV2Request franchisereferalincomeCreateObjectV2Request, int operationIndex = 0);
    ...
    public interface IObjectFranchisereferalincomeApiAsync : IApiAccessor
    {
        ...
        [Obsolete]
        System.Threading.Tasks.Task<FranchisereferalincomeCreateObjectV1Response> FranchisereferalincomeCreateObjectV1Async(List<FranchisereferalincomeCreateObjectV1Request> franchisereferalincomeCreateObjectV1Request, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        [Obsolete]
        System.Threading.Tasks.Task<ApiResponse<FranchisereferalincomeCreateObjectV1Response>> FranchisereferalincomeCreateObjectV1WithHttpInfoAsync(List<FranchisereferalincomeCreateObjectV1Request> franchisereferalincomeCreateObjectV1Request, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Create a new Franchisereferalincome
        /// </summary>
        /// <remarks>
    ...
    public partial class ObjectFranchisereferalincomeApi : IObjectFranchisereferalincomeApi
    {
        ...
        /// <returns>FranchisereferalincomeCreateObjectV1Response</returns>
        [Obsolete]
        public FranchisereferalincomeCreateObjectV1Response FranchisereferalincomeCreateObjectV1(List<FranchisereferalincomeCreateObjectV1Request> franchisereferalincomeCreateObjectV1Request, int operationIndex = 0)
        {
        ...
        /// <returns>ApiResponse of FranchisereferalincomeCreateObjectV1Response</returns>
        [Obsolete]
        public eZmaxApi.Client.ApiResponse<FranchisereferalincomeCreateObjectV1Response> FranchisereferalincomeCreateObjectV1WithHttpInfo(List<FranchisereferalincomeCreateObjectV1Request> franchisereferalincomeCreateObjectV1Request, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "ObjectFranchisereferalincomeApi.FranchisereferalincomeCreateObjectV1";
        ...
        /// <returns>Task of FranchisereferalincomeCreateObjectV1Response</returns>
        [Obsolete]
        public async System.Threading.Tasks.Task<FranchisereferalincomeCreateObjectV1Response> FranchisereferalincomeCreateObjectV1Async(List<FranchisereferalincomeCreateObjectV1Request> franchisereferalincomeCreateObjectV1Request, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            eZmaxApi.Client.ApiResponse<FranchisereferalincomeCreateObjectV1Response> localVarResponse = await FranchisereferalincomeCreateObjectV1WithHttpInfoAsync(franchisereferalincomeCreateObjectV1Request, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>FranchisereferalincomeCreateObjectV2Response</returns>
        public FranchisereferalincomeCreateObjectV2Response FranchisereferalincomeCreateObjectV2(FranchisereferalincomeCreateObjectV2Request franchisereferalincomeCreateObjectV2Request, int operationIndex = 0)
        {
            eZmaxApi.Client.ApiResponse<FranchisereferalincomeCreateObjectV2Response> localVarResponse = FranchisereferalincomeCreateObjectV2WithHttpInfo(franchisereferalincomeCreateObjectV2Request);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of FranchisereferalincomeCreateObjectV2Response</returns>
        public eZmaxApi.Client.ApiResponse<FranchisereferalincomeCreateObjectV2Response> FranchisereferalincomeCreateObjectV2WithHttpInfo(FranchisereferalincomeCreateObjectV2Request franchisereferalincomeCreateObjectV2Request, int operationIndex = 0)
        {
            ...
            {
                throw new eZmaxApi.Client.ApiException(400, "Missing required parameter 'franchisereferalincomeCreateObjectV2Request' when calling ObjectFranchisereferalincomeApi->FranchisereferalincomeCreateObjectV2");
            }
            ...
            localVarRequestOptions.Data = franchisereferalincomeCreateObjectV2Request;

            localVarRequestOptions.Operation = "ObjectFranchisereferalincomeApi.FranchisereferalincomeCreateObjectV2";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<FranchisereferalincomeCreateObjectV2Response>("/2/object/franchisereferalincome", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("FranchisereferalincomeCreateObjectV2", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        public async System.Threading.Tasks.Task<eZmaxApi.Client.ApiResponse<FranchisereferalincomeCreateObjectV2Response>> FranchisereferalincomeCreateObjectV2WithHttpInfoAsync(FranchisereferalincomeCreateObjectV2Request franchisereferalincomeCreateObjectV2Request, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<FranchisereferalincomeCreateObjectV2Response>("/2/object/franchisereferalincome", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
