...
namespace eZmaxApi.Api
{
    ...
    public interface IObjectSecretquestionApi : IApiAccessor
    {
        ...
        [Obsolete]
        CommonGetAutocompleteV1Response SecretquestionGetAutocompleteV1 (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?));
        ...
        [Obsolete]
        ApiResponse<CommonGetAutocompleteV1Response> SecretquestionGetAutocompleteV1WithHttpInfo (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?));
        /// <summary>
        /// Retrieve Secretquestions and IDs
        /// </summary>
        /// <remarks>
        ...
        [Obsolete]
        System.Threading.Tasks.Task<ApiResponse<CommonGetAutocompleteV1Response>> SecretquestionGetAutocompleteV1WithHttpInfoAsync (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Retrieve Secretquestions and IDs
        /// </summary>
        /// <remarks>
    ...
    public partial class ObjectSecretquestionApi : IObjectSecretquestionApi
    {
        ...
        /// <returns>CommonGetAutocompleteV1Response</returns>
        [Obsolete]
        public CommonGetAutocompleteV1Response SecretquestionGetAutocompleteV1 (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?))
        {
             ApiResponse<CommonGetAutocompleteV1Response> localVarResponse = SecretquestionGetAutocompleteV1WithHttpInfo(sSelector, eFilterActive, sQuery, acceptLanguage);
        ...
        /// <returns>ApiResponse of CommonGetAutocompleteV1Response</returns>
        [Obsolete]
        public ApiResponse<CommonGetAutocompleteV1Response> SecretquestionGetAutocompleteV1WithHttpInfo (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?))
        {
        ...
        {
             ApiResponse<CommonGetAutocompleteV1Response> localVarResponse = await SecretquestionGetAutocompleteV1WithHttpInfoAsync(sSelector, eFilterActive, sQuery, acceptLanguage, cancellationToken);
             return localVarResponse.Data;
        ...
        public ApiResponse<SecretquestionGetAutocompleteV2Response> SecretquestionGetAutocompleteV2WithHttpInfo (string sSelector, string eFilterActive = default(string), string sQuery = default(string), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?))
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("SecretquestionGetAutocompleteV2", localVarResponse);
                if (exception != null) throw exception;
            }
