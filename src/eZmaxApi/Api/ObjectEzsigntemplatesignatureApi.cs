...
namespace eZmaxApi.Api
{
    ...
    public interface IObjectEzsigntemplatesignatureApi : IApiAccessor
    {
        ...
        ApiResponse<EzsigntemplatesignatureGetObjectV2Response> EzsigntemplatesignatureGetObjectV2WithHttpInfo (int pkiEzsigntemplatesignatureID);
        ...
        System.Threading.Tasks.Task<EzsigntemplatesignatureGetObjectV2Response> EzsigntemplatesignatureGetObjectV2Async (int pkiEzsigntemplatesignatureID, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<EzsigntemplatesignatureGetObjectV2Response>> EzsigntemplatesignatureGetObjectV2WithHttpInfoAsync (int pkiEzsigntemplatesignatureID, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class ObjectEzsigntemplatesignatureApi : IObjectEzsigntemplatesignatureApi
    {
        ...
        /// <param name="pkiEzsigntemplatesignatureID"></param>
        /// <returns>EzsigntemplatesignatureGetObjectV2Response</returns>
        public EzsigntemplatesignatureGetObjectV2Response EzsigntemplatesignatureGetObjectV2 (int pkiEzsigntemplatesignatureID)
        {
             ApiResponse<EzsigntemplatesignatureGetObjectV2Response> localVarResponse = EzsigntemplatesignatureGetObjectV2WithHttpInfo(pkiEzsigntemplatesignatureID);
             return localVarResponse.Data;
        }
        ...
        /// <param name="pkiEzsigntemplatesignatureID"></param>
        /// <returns>ApiResponse of EzsigntemplatesignatureGetObjectV2Response</returns>
        public ApiResponse<EzsigntemplatesignatureGetObjectV2Response> EzsigntemplatesignatureGetObjectV2WithHttpInfo (int pkiEzsigntemplatesignatureID)
        {
            // verify the required parameter 'pkiEzsigntemplatesignatureID' is set
            if (pkiEzsigntemplatesignatureID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzsigntemplatesignatureID' when calling ObjectEzsigntemplatesignatureApi->EzsigntemplatesignatureGetObjectV2");

            var localVarPath = "/2/object/ezsigntemplatesignature/{pkiEzsigntemplatesignatureID}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("EzsigntemplatesignatureGetObjectV2", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<EzsigntemplatesignatureGetObjectV2Response>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (EzsigntemplatesignatureGetObjectV2Response) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(EzsigntemplatesignatureGetObjectV2Response)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of EzsigntemplatesignatureGetObjectV2Response</returns>
        public async System.Threading.Tasks.Task<EzsigntemplatesignatureGetObjectV2Response> EzsigntemplatesignatureGetObjectV2Async (int pkiEzsigntemplatesignatureID, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<EzsigntemplatesignatureGetObjectV2Response> localVarResponse = await EzsigntemplatesignatureGetObjectV2WithHttpInfoAsync(pkiEzsigntemplatesignatureID, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (EzsigntemplatesignatureGetObjectV2Response)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<EzsigntemplatesignatureGetObjectV2Response>> EzsigntemplatesignatureGetObjectV2WithHttpInfoAsync (int pkiEzsigntemplatesignatureID, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'pkiEzsigntemplatesignatureID' is set
            if (pkiEzsigntemplatesignatureID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzsigntemplatesignatureID' when calling ObjectEzsigntemplatesignatureApi->EzsigntemplatesignatureGetObjectV2");
