...
namespace eZmaxApi.Api
{
    ...
    public interface IObjectCommunicationApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task CommunicationGetCommunicationBodyV1Async(int pkiCommunicationID, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> CommunicationGetCommunicationBodyV1WithHttpInfoAsync(int pkiCommunicationID, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Send a new Communication
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<CommunicationSendV1Response> CommunicationSendV1Async(CommunicationSendV1Request communicationSendV1Request, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<CommunicationSendV1Response>> CommunicationSendV1WithHttpInfoAsync(CommunicationSendV1Request communicationSendV1Request, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
    ...
    public partial class ObjectCommunicationApi : IObjectCommunicationApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task CommunicationGetCommunicationBodyV1Async(int pkiCommunicationID, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<eZmaxApi.Client.ApiResponse<Object>> CommunicationGetCommunicationBodyV1WithHttpInfoAsync(int pkiCommunicationID, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CommunicationSendV1Response</returns>
        public async System.Threading.Tasks.Task<CommunicationSendV1Response> CommunicationSendV1Async(CommunicationSendV1Request communicationSendV1Request, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CommunicationSendV1Response)</returns>
        public async System.Threading.Tasks.Task<eZmaxApi.Client.ApiResponse<CommunicationSendV1Response>> CommunicationSendV1WithHttpInfoAsync(CommunicationSendV1Request communicationSendV1Request, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'communicationSendV1Request' is set
            if (communicationSendV1Request == null)
            {
