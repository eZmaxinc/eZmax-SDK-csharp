...
namespace eZmaxApi.Api
{
    ...
    /// </summary>
    public interface IObjectBillingentityexternalApiSync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>BillingentityexternalGetAutocompleteV2Response</returns>
        BillingentityexternalGetAutocompleteV2Response BillingentityexternalGetAutocompleteV2(string sSelector, string? eFilterActive = default(string?), string? sQuery = default(string?), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), int operationIndex = 0);
        ...
        /// <param name="acceptLanguage"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of BillingentityexternalGetAutocompleteV2Response</returns>
        ApiResponse<BillingentityexternalGetAutocompleteV2Response> BillingentityexternalGetAutocompleteV2WithHttpInfo(string sSelector, string? eFilterActive = default(string?), string? sQuery = default(string?), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), int operationIndex = 0);
    ...
    public interface IObjectBillingentityexternalApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<BillingentityexternalGenerateFederationTokenV1Response> BillingentityexternalGenerateFederationTokenV1Async(int pkiBillingentityexternalID, BillingentityexternalGenerateFederationTokenV1Request billingentityexternalGenerateFederationTokenV1Request, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<BillingentityexternalGenerateFederationTokenV1Response>> BillingentityexternalGenerateFederationTokenV1WithHttpInfoAsync(int pkiBillingentityexternalID, BillingentityexternalGenerateFederationTokenV1Request billingentityexternalGenerateFederationTokenV1Request, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve Billingentityexternals and IDs
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BillingentityexternalGetAutocompleteV2Response)</returns>
        System.Threading.Tasks.Task<ApiResponse<BillingentityexternalGetAutocompleteV2Response>> BillingentityexternalGetAutocompleteV2WithHttpInfoAsync(string sSelector, string? eFilterActive = default(string?), string? sQuery = default(string?), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IObjectBillingentityexternalApi : IObjectBillingentityexternalApiSync, IObjectBillingentityexternalApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ObjectBillingentityexternalApi : IObjectBillingentityexternalApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ObjectBillingentityexternalApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public ObjectBillingentityexternalApi(string basePath)
        {
        ...
        /// <returns></returns>
        public ObjectBillingentityexternalApi(eZmaxApi.Client.Configuration configuration)
        {
        ...
        public ObjectBillingentityexternalApi(eZmaxApi.Client.ISynchronousClient client, eZmaxApi.Client.IAsynchronousClient asyncClient, eZmaxApi.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>BillingentityexternalGetAutocompleteV2Response</returns>
        public BillingentityexternalGetAutocompleteV2Response BillingentityexternalGetAutocompleteV2(string sSelector, string? eFilterActive = default(string?), string? sQuery = default(string?), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), int operationIndex = 0)
        {
            eZmaxApi.Client.ApiResponse<BillingentityexternalGetAutocompleteV2Response> localVarResponse = BillingentityexternalGetAutocompleteV2WithHttpInfo(sSelector, eFilterActive, sQuery, acceptLanguage);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of BillingentityexternalGetAutocompleteV2Response</returns>
        public eZmaxApi.Client.ApiResponse<BillingentityexternalGetAutocompleteV2Response> BillingentityexternalGetAutocompleteV2WithHttpInfo(string sSelector, string? eFilterActive = default(string?), string? sQuery = default(string?), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), int operationIndex = 0)
        {
            // verify the required parameter 'sSelector' is set
            if (sSelector == null)
            {
                throw new eZmaxApi.Client.ApiException(400, "Missing required parameter 'sSelector' when calling ObjectBillingentityexternalApi->BillingentityexternalGetAutocompleteV2");
            }
            ...
            localVarRequestOptions.Operation = "ObjectBillingentityexternalApi.BillingentityexternalGetAutocompleteV2";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<BillingentityexternalGetAutocompleteV2Response>("/2/object/billingentityexternal/getAutocomplete/{sSelector}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("BillingentityexternalGetAutocompleteV2", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BillingentityexternalGetAutocompleteV2Response</returns>
        public async System.Threading.Tasks.Task<BillingentityexternalGetAutocompleteV2Response> BillingentityexternalGetAutocompleteV2Async(string sSelector, string? eFilterActive = default(string?), string? sQuery = default(string?), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            eZmaxApi.Client.ApiResponse<BillingentityexternalGetAutocompleteV2Response> localVarResponse = await BillingentityexternalGetAutocompleteV2WithHttpInfoAsync(sSelector, eFilterActive, sQuery, acceptLanguage, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BillingentityexternalGetAutocompleteV2Response)</returns>
        public async System.Threading.Tasks.Task<eZmaxApi.Client.ApiResponse<BillingentityexternalGetAutocompleteV2Response>> BillingentityexternalGetAutocompleteV2WithHttpInfoAsync(string sSelector, string? eFilterActive = default(string?), string? sQuery = default(string?), HeaderAcceptLanguage? acceptLanguage = default(HeaderAcceptLanguage?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'sSelector' is set
            if (sSelector == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<BillingentityexternalGetAutocompleteV2Response>("/2/object/billingentityexternal/getAutocomplete/{sSelector}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
