...
namespace eZmaxApi.Api
{
    ...
    public interface IObjectBillingentityexternalApiSync : IApiAccessor
    {
        ...
        BillingentityexternalGetAutocompleteV2Response BillingentityexternalGetAutocompleteV2(string sSelector, string? eFilterActive = default, string? sQuery = default, HeaderAcceptLanguage? acceptLanguage = default, int operationIndex = 0);
        ...
        ApiResponse<BillingentityexternalGetAutocompleteV2Response> BillingentityexternalGetAutocompleteV2WithHttpInfo(string sSelector, string? eFilterActive = default, string? sQuery = default, HeaderAcceptLanguage? acceptLanguage = default, int operationIndex = 0);
    ...
    public interface IObjectBillingentityexternalApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<BillingentityexternalGenerateFederationTokenV1Response> BillingentityexternalGenerateFederationTokenV1Async(int pkiBillingentityexternalID, BillingentityexternalGenerateFederationTokenV1Request billingentityexternalGenerateFederationTokenV1Request, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<BillingentityexternalGenerateFederationTokenV1Response>> BillingentityexternalGenerateFederationTokenV1WithHttpInfoAsync(int pkiBillingentityexternalID, BillingentityexternalGenerateFederationTokenV1Request billingentityexternalGenerateFederationTokenV1Request, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Retrieve Billingentityexternals and IDs
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<BillingentityexternalGetAutocompleteV2Response> BillingentityexternalGetAutocompleteV2Async(string sSelector, string? eFilterActive = default, string? sQuery = default, HeaderAcceptLanguage? acceptLanguage = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
    ...
    public partial class ObjectBillingentityexternalApi : IObjectBillingentityexternalApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>BillingentityexternalGetAutocompleteV2Response</returns>
        public BillingentityexternalGetAutocompleteV2Response BillingentityexternalGetAutocompleteV2(string sSelector, string? eFilterActive = default, string? sQuery = default, HeaderAcceptLanguage? acceptLanguage = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of BillingentityexternalGetAutocompleteV2Response</returns>
        public eZmaxApi.Client.ApiResponse<BillingentityexternalGetAutocompleteV2Response> BillingentityexternalGetAutocompleteV2WithHttpInfo(string sSelector, string? eFilterActive = default, string? sQuery = default, HeaderAcceptLanguage? acceptLanguage = default, int operationIndex = 0)
        {
