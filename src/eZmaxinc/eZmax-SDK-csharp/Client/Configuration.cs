...
namespace eZmaxinc/eZmax-SDK-csharp.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "OpenAPI-Generator/1.0.16/csharp";
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "OpenAPI-Generator/1.0.16/csharp"
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 1.0.16\n";
            report += "    SDK Package Version: 1.0.16\n";
