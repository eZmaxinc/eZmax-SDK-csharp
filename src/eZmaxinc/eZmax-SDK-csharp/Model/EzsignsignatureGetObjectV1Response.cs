...
namespace eZmaxinc/eZmax-SDK-csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsignsignatureGetObjectV1Response : CommonResponse,  IEquatable<EzsignsignatureGetObjectV1Response>, IValidatableObject
    {
        /// <summary>
        ...
        public EzsignsignatureGetObjectV1Response(Object mPayload = default(Object), CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug)) : base()
        {
            // to ensure "mPayload" is required (not null)
            if (mPayload == null)
            {
                throw new InvalidDataException("mPayload is a required property for EzsignsignatureGetObjectV1Response and cannot be null");
            }
            else
            {
