...
namespace eZmaxinc/eZmax-SDK-csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsignfolderCreateObjectV1Response : CommonResponse,  IEquatable<EzsignfolderCreateObjectV1Response>, IValidatableObject
    {
        /// <summary>
        ...
        public EzsignfolderCreateObjectV1Response(EzsignfolderCreateObjectV1ResponseMPayload mPayload = default(EzsignfolderCreateObjectV1ResponseMPayload), CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug)) : base()
        {
