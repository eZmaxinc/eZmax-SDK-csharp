...
namespace eZmaxinc/eZmax-SDK-csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CommonGetAutocompleteV1Response : CommonResponse,  IEquatable<CommonGetAutocompleteV1Response>, IValidatableObject
    {
        /// <summary>
        ...
        public CommonGetAutocompleteV1Response(List<CommonGetAutocompleteV1ResponseMPayload> mPayload = default(List<CommonGetAutocompleteV1ResponseMPayload>), CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug)) : base()
        {
