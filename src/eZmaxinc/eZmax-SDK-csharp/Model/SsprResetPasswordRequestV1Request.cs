...
namespace eZmaxinc/eZmax-SDK-csharp.Model
{
    ...
    public partial class SsprResetPasswordRequestV1Request :  IEquatable<SsprResetPasswordRequestV1Request>, IValidatableObject
    {
        ...
        public SsprResetPasswordRequestV1Request(string pksCustomerCode = default(string), int fkiLanguageID = default(int), FieldEUserTypeSSPR eUserTypeSSPR = default(FieldEUserTypeSSPR), string sEmailAddress = default(string), string sUserLoginname = default(string))
        {
            ...
            {
                throw new InvalidDataException("pksCustomerCode is a required property for SsprResetPasswordRequestV1Request and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("fkiLanguageID is a required property for SsprResetPasswordRequestV1Request and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("eUserTypeSSPR is a required property for SsprResetPasswordRequestV1Request and cannot be null");
            }
            else
            {
