...
namespace eZmaxinc/eZmax-SDK-csharp.Model
{
    ...
    public partial class EzsigndocumentRequest :  IEquatable<EzsigndocumentRequest>, IValidatableObject
    {
        ...
        public EzsigndocumentRequest(EEzsigndocumentSourceEnum eEzsigndocumentSource = default(EEzsigndocumentSourceEnum), EEzsigndocumentFormatEnum eEzsigndocumentFormat = default(EEzsigndocumentFormatEnum), byte[] sEzsigndocumentBase64 = default(byte[]), int fkiEzsignfolderID = default(int), string dtEzsigndocumentDuedate = default(string), int fkiLanguageID = default(int), string sEzsigndocumentFilename = default(string), string sEzsigndocumentName = default(string))
        {
            ...
            {
                throw new InvalidDataException("sEzsigndocumentFilename is a required property for EzsigndocumentRequest and cannot be null");
            }
            else
            {
