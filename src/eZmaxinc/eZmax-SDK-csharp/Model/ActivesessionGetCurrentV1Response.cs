...
namespace eZmaxinc/eZmax-SDK-csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ActivesessionGetCurrentV1Response : CommonResponse,  IEquatable<ActivesessionGetCurrentV1Response>, IValidatableObject
    {
        /// <summary>
        ...
        public ActivesessionGetCurrentV1Response(ActivesessionGetCurrentV1ResponseMPayload mPayload = default(ActivesessionGetCurrentV1ResponseMPayload), CommonResponseObjDebugPayload objDebugPayload = default(CommonResponseObjDebugPayload), CommonResponseObjDebug objDebug = default(CommonResponseObjDebug)) : base()
        {
