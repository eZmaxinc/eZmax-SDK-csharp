...
namespace eZmaxinc/eZmax-SDK-csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EzsigndocumentEditObjectV1Request :  IEquatable<EzsigndocumentEditObjectV1Request>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as EzsigndocumentEditObjectV1Request);
        }

        /// <summary>
        /// Returns true if EzsigndocumentEditObjectV1Request instances are equal
        /// </summary>
        /// <param name="input">Instance of EzsigndocumentEditObjectV1Request to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EzsigndocumentEditObjectV1Request input)
        {
            if (input == null)
                return false;
