...
namespace eZmaxinc/eZmax-SDK-csharp.Model
{
    ...
    public partial class EzsignfolderGetObjectV1ResponseMPayload :  IEquatable<EzsignfolderGetObjectV1ResponseMPayload>, IValidatableObject
    {
        ...
        public EzsignfolderGetObjectV1ResponseMPayload(int fkiEzsignfoldertypeID = default(int), int fkiEzsigntsarequirementID = default(int), string sEzsignfolderDescription = default(string), string tEzsignfolderNote = default(string), FieldEEzsignfolderSendreminderfrequency eEzsignfolderSendreminderfrequency = default(FieldEEzsignfolderSendreminderfrequency), int pkiEzsignfolderID = default(int), string dtEzsignfolderSentdate = default(string), FieldEEzsignfolderStep eEzsignfolderStep = default(FieldEEzsignfolderStep), string dtEzsignfolderClose = default(string), int fkiUserIDCreated = default(int), int fkiUserIDModified = default(int), int fkiApikeyIDCreated = default(int), int fkiApikeyIDModified = default(int), string dtCreatedDate = default(string), string dtModifiedDate = default(string))
        {
            ...
            {
                throw new InvalidDataException("fkiUserIDCreated is a required property for EzsignfolderGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("fkiUserIDModified is a required property for EzsignfolderGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("dtCreatedDate is a required property for EzsignfolderGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("dtModifiedDate is a required property for EzsignfolderGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
