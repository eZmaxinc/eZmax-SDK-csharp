...
namespace eZmaxinc/eZmax-SDK-csharp.Model
{
    ...
    public partial class EzsigndocumentGetObjectV1ResponseMPayload :  IEquatable<EzsigndocumentGetObjectV1ResponseMPayload>, IValidatableObject
    {
        ...
        public EzsigndocumentGetObjectV1ResponseMPayload(int fkiEzsignfolderID = default(int), string dtEzsigndocumentDuedate = default(string), int fkiLanguageID = default(int), string sEzsigndocumentFilename = default(string), string sEzsigndocumentName = default(string), int pkiEzsigndocumentID = default(int), FieldEEzsigndocumentStep eEzsigndocumentStep = default(FieldEEzsigndocumentStep), string dtEzsigndocumentFirstsend = default(string), string dtEzsigndocumentLastsend = default(string), int iEzsigndocumentOrder = default(int), int iEzsigndocumentPagetotal = default(int), int iEzsigndocumentSignaturesigned = default(int), int iEzsigndocumentSignaturetotal = default(int), string sEzsigndocumentMD5initial = default(string), string sEzsigndocumentMD5signed = default(string), int fkiUserIDCreated = default(int), int fkiUserIDModified = default(int), int fkiApikeyIDCreated = default(int), int fkiApikeyIDModified = default(int), string dtCreatedDate = default(string), string dtModifiedDate = default(string))
        {
            ...
            {
                throw new InvalidDataException("sEzsigndocumentFilename is a required property for EzsigndocumentGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("fkiUserIDCreated is a required property for EzsigndocumentGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("fkiUserIDModified is a required property for EzsigndocumentGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("dtCreatedDate is a required property for EzsigndocumentGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("dtModifiedDate is a required property for EzsigndocumentGetObjectV1ResponseMPayload and cannot be null");
            }
            else
            {
