...
namespace eZmaxinc/eZmax-SDK-csharp.Api
{
    ...
    public partial class PeriodApi : IPeriodApi
    {
        ...
        public ApiResponse<CommonGetAutocompleteV1Response> PeriodGetAutocompleteV1WithHttpInfo (string sSelector)
        {
            ...
            var localVarPath = "/1/object/period/getAutocomplete";
            ...
            if (sSelector != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "sSelector", sSelector)); // query parameter
