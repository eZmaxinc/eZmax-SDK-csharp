...
namespace eZmaxinc/eZmax-SDK-csharp.Api
{
    ...
    /// </summary>
    public interface IEzsignsignatureApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task EzsignsignatureGetObjectGetChildrenV1Async (int pkiEzsignsignatureID, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> EzsignsignatureGetObjectGetChildrenV1WithHttpInfoAsync (int pkiEzsignsignatureID, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Retrieve an existing Ezsignsignature
        /// </summary>
        /// <remarks>
    ...
    public partial class EzsignsignatureApi : IEzsignsignatureApi
    {
        ...
        /// <returns></returns>
        public EzsignsignatureApi(eZmaxinc/eZmax-SDK-csharp.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse<EzsignsignatureCreateObjectV1Response> EzsignsignatureCreateObjectV1WithHttpInfo (List<EzsignsignatureCreateObjectV1Request> ezsignsignatureCreateObjectV1Request)
        {
            ...
            if (ezsignsignatureCreateObjectV1Request == null)
                throw new ApiException(400, "Missing required parameter 'ezsignsignatureCreateObjectV1Request' when calling EzsignsignatureApi->EzsignsignatureCreateObjectV1");
        ...
        public ApiResponse<EzsignsignatureDeleteObjectV1Response> EzsignsignatureDeleteObjectV1WithHttpInfo (int pkiEzsignsignatureID)
        {
            ...
            if (pkiEzsignsignatureID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzsignsignatureID' when calling EzsignsignatureApi->EzsignsignatureDeleteObjectV1");
        ...
        public ApiResponse<EzsignsignatureEditObjectV1Response> EzsignsignatureEditObjectV1WithHttpInfo (int pkiEzsignsignatureID, EzsignsignatureEditObjectV1Request ezsignsignatureEditObjectV1Request)
        {
            // verify the required parameter 'pkiEzsignsignatureID' is set
            if (pkiEzsignsignatureID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzsignsignatureID' when calling EzsignsignatureApi->EzsignsignatureEditObjectV1");
            // verify the required parameter 'ezsignsignatureEditObjectV1Request' is set
            if (ezsignsignatureEditObjectV1Request == null)
                throw new ApiException(400, "Missing required parameter 'ezsignsignatureEditObjectV1Request' when calling EzsignsignatureApi->EzsignsignatureEditObjectV1");
        ...
        /// <param name="pkiEzsignsignatureID">The unique ID of the Ezsignsignature</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> EzsignsignatureGetObjectGetChildrenV1WithHttpInfo (int pkiEzsignsignatureID)
        {
            // verify the required parameter 'pkiEzsignsignatureID' is set
            if (pkiEzsignsignatureID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzsignsignatureID' when calling EzsignsignatureApi->EzsignsignatureGetObjectGetChildrenV1");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("EzsignsignatureGetObjectGetChildrenV1", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task EzsignsignatureGetObjectGetChildrenV1Async (int pkiEzsignsignatureID, CancellationToken cancellationToken = default(CancellationToken))
        {
             await EzsignsignatureGetObjectGetChildrenV1WithHttpInfoAsync(pkiEzsignsignatureID, cancellationToken);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> EzsignsignatureGetObjectGetChildrenV1WithHttpInfoAsync (int pkiEzsignsignatureID, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'pkiEzsignsignatureID' is set
            if (pkiEzsignsignatureID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzsignsignatureID' when calling EzsignsignatureApi->EzsignsignatureGetObjectGetChildrenV1");
        ...
        public ApiResponse<EzsignsignatureGetObjectV1Response> EzsignsignatureGetObjectV1WithHttpInfo (int pkiEzsignsignatureID)
        {
            // verify the required parameter 'pkiEzsignsignatureID' is set
            if (pkiEzsignsignatureID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzsignsignatureID' when calling EzsignsignatureApi->EzsignsignatureGetObjectV1");
