...
namespace eZmaxinc/eZmax-SDK-csharp.Api
{
    ...
    /// </summary>
    public interface IEzsigndocumentApi : IApiAccessor
    {
    ...
    public partial class EzsigndocumentApi : IEzsigndocumentApi
    {
        ...
        /// <returns></returns>
        public EzsigndocumentApi(eZmaxinc/eZmax-SDK-csharp.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse<EzsigndocumentCreateObjectV1Response> EzsigndocumentCreateObjectV1WithHttpInfo (List<EzsigndocumentCreateObjectV1Request> ezsigndocumentCreateObjectV1Request)
        {
            ...
            if (ezsigndocumentCreateObjectV1Request == null)
                throw new ApiException(400, "Missing required parameter 'ezsigndocumentCreateObjectV1Request' when calling EzsigndocumentApi->EzsigndocumentCreateObjectV1");
        ...
        public ApiResponse<EzsigndocumentDeleteObjectV1Response> EzsigndocumentDeleteObjectV1WithHttpInfo (int pkiEzsigndocumentID)
        {
            ...
            if (pkiEzsigndocumentID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzsigndocumentID' when calling EzsigndocumentApi->EzsigndocumentDeleteObjectV1");
        ...
        public ApiResponse<EzsigndocumentEditObjectV1Response> EzsigndocumentEditObjectV1WithHttpInfo (int pkiEzsigndocumentID, EzsigndocumentEditObjectV1Request ezsigndocumentEditObjectV1Request)
        {
            // verify the required parameter 'pkiEzsigndocumentID' is set
            if (pkiEzsigndocumentID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzsigndocumentID' when calling EzsigndocumentApi->EzsigndocumentEditObjectV1");
            // verify the required parameter 'ezsigndocumentEditObjectV1Request' is set
            if (ezsigndocumentEditObjectV1Request == null)
                throw new ApiException(400, "Missing required parameter 'ezsigndocumentEditObjectV1Request' when calling EzsigndocumentApi->EzsigndocumentEditObjectV1");
        ...
        public ApiResponse<EzsigndocumentGetDownloadUrlV1Response> EzsigndocumentGetDownloadUrlV1WithHttpInfo (int pkiEzsigndocumentID, string eDocumentType)
        {
            // verify the required parameter 'pkiEzsigndocumentID' is set
            if (pkiEzsigndocumentID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzsigndocumentID' when calling EzsigndocumentApi->EzsigndocumentGetDownloadUrlV1");
            // verify the required parameter 'eDocumentType' is set
            if (eDocumentType == null)
                throw new ApiException(400, "Missing required parameter 'eDocumentType' when calling EzsigndocumentApi->EzsigndocumentGetDownloadUrlV1");
        ...
        public ApiResponse<Object> EzsigndocumentGetObjectGetChildrenV1WithHttpInfo (int pkiEzsigndocumentID)
        {
            // verify the required parameter 'pkiEzsigndocumentID' is set
            if (pkiEzsigndocumentID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzsigndocumentID' when calling EzsigndocumentApi->EzsigndocumentGetObjectGetChildrenV1");
        ...
        public ApiResponse<EzsigndocumentGetObjectV1Response> EzsigndocumentGetObjectV1WithHttpInfo (int pkiEzsigndocumentID)
        {
            // verify the required parameter 'pkiEzsigndocumentID' is set
            if (pkiEzsigndocumentID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzsigndocumentID' when calling EzsigndocumentApi->EzsigndocumentGetObjectV1");
