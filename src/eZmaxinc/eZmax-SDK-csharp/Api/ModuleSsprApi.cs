...
namespace eZmaxinc/eZmax-SDK-csharp.Api
{
    ...
    public partial class ModuleSsprApi : IModuleSsprApi
    {
        ...
        /// <summary>
        /// Validate Token This endpoint validates if a Token is valid and not expired. If the token has less than an hour to its life, the TTL is reset to 1 hour.  sEmailAddress must be set if eUserTypeSSPR &#x3D; EzsignUser  sUserLoginname must be set if eUserTypeSSPR &#x3D; Native
        /// </summary>
        /// <exception cref="eZmaxinc/eZmax-SDK-csharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="ssprValidateTokenV1Request"></param>
        /// <returns></returns>
