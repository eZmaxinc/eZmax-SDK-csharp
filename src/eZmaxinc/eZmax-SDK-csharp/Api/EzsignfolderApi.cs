...
namespace eZmaxinc/eZmax-SDK-csharp.Api
{
    ...
    /// </summary>
    public interface IEzsignfolderApi : IApiAccessor
    {
    ...
    public partial class EzsignfolderApi : IEzsignfolderApi
    {
        ...
        /// <returns></returns>
        public EzsignfolderApi(eZmaxinc/eZmax-SDK-csharp.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse<EzsignfolderCreateObjectV1Response> EzsignfolderCreateObjectV1WithHttpInfo (List<EzsignfolderCreateObjectV1Request> ezsignfolderCreateObjectV1Request)
        {
            ...
            if (ezsignfolderCreateObjectV1Request == null)
                throw new ApiException(400, "Missing required parameter 'ezsignfolderCreateObjectV1Request' when calling EzsignfolderApi->EzsignfolderCreateObjectV1");
        ...
        public ApiResponse<EzsignfolderDeleteObjectV1Response> EzsignfolderDeleteObjectV1WithHttpInfo (int pkiEzsignfolderID)
        {
            ...
            if (pkiEzsignfolderID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzsignfolderID' when calling EzsignfolderApi->EzsignfolderDeleteObjectV1");
        ...
        public ApiResponse<EzsignfolderEditObjectV1Response> EzsignfolderEditObjectV1WithHttpInfo (int pkiEzsignfolderID, EzsignfolderEditObjectV1Request ezsignfolderEditObjectV1Request)
        {
            // verify the required parameter 'pkiEzsignfolderID' is set
            if (pkiEzsignfolderID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzsignfolderID' when calling EzsignfolderApi->EzsignfolderEditObjectV1");
            // verify the required parameter 'ezsignfolderEditObjectV1Request' is set
            if (ezsignfolderEditObjectV1Request == null)
                throw new ApiException(400, "Missing required parameter 'ezsignfolderEditObjectV1Request' when calling EzsignfolderApi->EzsignfolderEditObjectV1");
        ...
        public ApiResponse<Object> EzsignfolderGetObjectGetChildrenV1WithHttpInfo (int pkiEzsignfolderID)
        {
            // verify the required parameter 'pkiEzsignfolderID' is set
            if (pkiEzsignfolderID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzsignfolderID' when calling EzsignfolderApi->EzsignfolderGetObjectGetChildrenV1");
        ...
        public ApiResponse<EzsignfolderGetObjectV1Response> EzsignfolderGetObjectV1WithHttpInfo (int pkiEzsignfolderID)
        {
            // verify the required parameter 'pkiEzsignfolderID' is set
            if (pkiEzsignfolderID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzsignfolderID' when calling EzsignfolderApi->EzsignfolderGetObjectV1");
        ...
        public ApiResponse<EzsignfolderSendV1Response> EzsignfolderSendV1WithHttpInfo (int pkiEzsignfolderID, EzsignfolderSendV1Request ezsignfolderSendV1Request)
        {
            // verify the required parameter 'pkiEzsignfolderID' is set
            if (pkiEzsignfolderID == null)
                throw new ApiException(400, "Missing required parameter 'pkiEzsignfolderID' when calling EzsignfolderApi->EzsignfolderSendV1");
            // verify the required parameter 'ezsignfolderSendV1Request' is set
            if (ezsignfolderSendV1Request == null)
                throw new ApiException(400, "Missing required parameter 'ezsignfolderSendV1Request' when calling EzsignfolderApi->EzsignfolderSendV1");
