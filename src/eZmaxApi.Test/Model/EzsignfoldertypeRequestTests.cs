...
namespace eZmaxApi.Test.Model
{
    ...
    public class EzsignfoldertypeRequestTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" EzsignfoldertypeRequest
            //Assert.IsType<EzsignfoldertypeRequest>(instance);
        }
