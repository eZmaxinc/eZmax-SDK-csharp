...
namespace eZmaxApi.Test.Model
{
    ...
    public class TextstylestaticResponseTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" TextstylestaticResponse
            //Assert.IsType<TextstylestaticResponse>(instance);
        }
