...
namespace eZmaxApi.Test.Model
{
    ...
    public class EzsignformfieldRequestTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" EzsignformfieldRequest
            //Assert.IsType<EzsignformfieldRequest>(instance);
        }
