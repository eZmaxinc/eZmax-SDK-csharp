...
namespace eZmaxApi.Test.Model
{
    ...
    public class EzsignformfieldResponseTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" EzsignformfieldResponse
            //Assert.IsType<EzsignformfieldResponse>(instance);
        }
