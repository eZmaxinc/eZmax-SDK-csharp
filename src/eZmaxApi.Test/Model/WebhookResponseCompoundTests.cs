...
namespace eZmaxApi.Test.Model
{
    ...
    public class WebhookResponseCompoundTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" WebhookResponseCompound
            //Assert.IsType<WebhookResponseCompound>(instance);
        }
