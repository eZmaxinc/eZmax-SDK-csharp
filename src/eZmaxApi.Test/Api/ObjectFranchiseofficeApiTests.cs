...
namespace eZmaxApi.Test
{
    ...
    public class ObjectFranchiseofficeApiTests
    {
        ...
        public void FranchiseofficeGetAutocompleteV1Test()
        {
            ...
            //var response = instance.FranchiseofficeGetAutocompleteV1(sSelector, eFilterActive, sQuery, acceptLanguage);
            //Assert.IsInstanceOf(typeof(CommonGetAutocompleteV1Response), response, "response is CommonGetAutocompleteV1Response");
        }
        
        /// <summary>
        /// Test FranchiseofficeGetAutocompleteV2
        /// </summary>
        [Test]
        public void FranchiseofficeGetAutocompleteV2Test()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string sSelector = null;
            //string eFilterActive = null;
            //string sQuery = null;
            //HeaderAcceptLanguage? acceptLanguage = null;
            //var response = instance.FranchiseofficeGetAutocompleteV2(sSelector, eFilterActive, sQuery, acceptLanguage);
            //Assert.IsInstanceOf(typeof(FranchiseofficeGetAutocompleteV2Response), response, "response is FranchiseofficeGetAutocompleteV2Response");
        }
