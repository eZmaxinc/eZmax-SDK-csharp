...
namespace eZmaxApi.Test
{
    ...
    /// </remarks>
    public class ObjectActivesessionApiTests
    {
        ...
        {
            // TODO uncomment below to test 'IsInstanceOf' ObjectActivesessionApi
            //Assert.IsInstanceOf(typeof(ObjectActivesessionApi), instance);
        }
