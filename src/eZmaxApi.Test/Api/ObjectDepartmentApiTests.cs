...
namespace eZmaxApi.Test.Api
{
    ...
    /// </remarks>
    public class ObjectDepartmentApiTests : IDisposable
    {
        private ObjectDepartmentApi instance;

        public ObjectDepartmentApiTests()
        {
        ...
        {
            // TODO uncomment below to test 'IsType' ObjectDepartmentApi
            //Assert.IsType<ObjectDepartmentApi>(instance);
        }
        ...
        public void DepartmentGetAutocompleteV2Test()
        {
            ...
            //Assert.IsType<DepartmentGetAutocompleteV2Response>(response);
        }
    }
}
