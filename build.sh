...
${nuget_cmd} install src/eZmaxinc/eZmax-SDK-csharp/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/eZmaxinc/eZmax-SDK-csharp.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/eZmaxinc/eZmax-SDK-csharp.dll \
-recurse:'src/eZmaxinc/eZmax-SDK-csharp/*.cs' \
-doc:bin/eZmaxinc/eZmax-SDK-csharp.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/eZmaxinc/eZmax-SDK-csharp.dll was created successfully"
fi
