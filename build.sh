...
${nuget_cmd} install src/eZmaxApi/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/eZmaxApi.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/eZmaxApi.dll \
-recurse:'src/eZmaxApi/*.cs' \
-doc:bin/eZmaxApi.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/eZmaxApi.dll was created successfully"
fi
